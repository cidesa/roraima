...
require_once(dirname(__FILE__).'/sfYamlInlineNew.class.php');
...
class sfYamlParserNew
{
  ...
  public function parse($value)
  {
    ...
    while ($this->moveToNextLine())
    {
      ...
      {
        $key = sfYamlInlineNew::parseScalar($values['key']);
  ...
  protected function parseValue($value)
  {
    ...
    {
      return sfYamlInlineNew::load($value);
    }
  }

...
[?php echo form_tag('auto<?php echo $this->getModuleName() ?>/list', array('method' => 'get')) ?]
...
<?php endif; ?>
  ...
  <ul class="sf_admin_actions">
    <li>[?php echo button_to(__('reset'), 'auto<?php echo $this->getModuleName() ?>/list?filter=filter', 'class=sf_admin_action_reset_filter') ?]</li>

<?php
/**
 * CidesaDateCompareValidator: Compara 2 fechas dadas, en base a un operador dado
 *
 * @package    Roraima
 ...
 */
class CidesaDateCompareValidator extends sfValidator
{
  /**
  ...
  protected function getValidDate($value, $culture)
  {
    ...
    return adodb_strtotime("$y-$m-$d 00:00");
  }

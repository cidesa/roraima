...
abstract class BaseAtaudienciasPeer {
	...
	const CLASS_DEFAULT = 'lib.model.ciudadanos.Ataudiencias';
	...
	{
		include_once 'lib/model/ciudadanos/map/AtaudienciasMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.ciudadanos.map.AtaudienciasMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/ciudadanos/map/AtaudienciasMapBuilder.php';
	Propel::registerMapBuilder('lib.model.ciudadanos.map.AtaudienciasMapBuilder');
}

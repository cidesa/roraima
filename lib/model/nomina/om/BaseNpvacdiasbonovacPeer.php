...
abstract class BaseNpvacdiasbonovacPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npvacdiasbonovac';
	...
	{
		include_once 'lib/model/nomina/map/NpvacdiasbonovacMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpvacdiasbonovacMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpvacdiasbonovacMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpvacdiasbonovacMapBuilder');
}

...
abstract class BaseNphisconBorraPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.NphisconBorra';
	...
	{
		include_once 'lib/model/nomina/map/NphisconBorraMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NphisconBorraMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NphisconBorraMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NphisconBorraMapBuilder');
}

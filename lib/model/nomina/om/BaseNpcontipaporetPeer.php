...
abstract class BaseNpcontipaporetPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npcontipaporet';
	...
	{
		include_once 'lib/model/nomina/map/NpcontipaporetMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpcontipaporetMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpcontipaporetMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpcontipaporetMapBuilder');
}

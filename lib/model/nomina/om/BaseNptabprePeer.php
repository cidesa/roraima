...
abstract class BaseNptabprePeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Nptabpre';
	...
	{
		include_once 'lib/model/nomina/map/NptabpreMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NptabpreMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NptabpreMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NptabpreMapBuilder');
}

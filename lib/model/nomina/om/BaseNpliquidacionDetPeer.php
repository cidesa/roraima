...
abstract class BaseNpliquidacionDetPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.NpliquidacionDet';
	...
	{
		include_once 'lib/model/nomina/map/NpliquidacionDetMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpliquidacionDetMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpliquidacionDetMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpliquidacionDetMapBuilder');
}

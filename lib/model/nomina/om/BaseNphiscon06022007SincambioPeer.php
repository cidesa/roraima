...
abstract class BaseNphiscon06022007SincambioPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Nphiscon06022007Sincambio';
	...
	{
		include_once 'lib/model/nomina/map/Nphiscon06022007SincambioMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.Nphiscon06022007SincambioMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/Nphiscon06022007SincambioMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.Nphiscon06022007SincambioMapBuilder');
}

...
abstract class BaseNpmemconPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npmemcon';
	...
	{
		include_once 'lib/model/nomina/map/NpmemconMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpmemconMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(NpmemconPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpmemconMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpmemconMapBuilder');
}

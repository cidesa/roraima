...
abstract class BaseNpbenempPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npbenemp';
	...
	{
		include_once 'lib/model/nomina/map/NpbenempMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpbenempMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpbenempMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpbenempMapBuilder');
}

...
abstract class BaseNptipadiPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Nptipadi';
	...
	{
		include_once 'lib/model/nomina/map/NptipadiMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NptipadiMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NptipadiMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NptipadiMapBuilder');
}

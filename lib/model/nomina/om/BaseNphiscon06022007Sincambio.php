...
abstract class BaseNphiscon06022007Sincambio extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codnom !== $v) {
        $this->codnom = $v;
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::CODNOM;
      }
    ...
    if ($this->codemp !== $v) {
        $this->codemp = $v;
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::CODEMP;
      }
    ...
    if ($this->codcar !== $v) {
        $this->codcar = $v;
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::CODCAR;
      }
    ...
    if ($this->codcon !== $v) {
        $this->codcon = $v;
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::CODCON;
      }
    ...
    if ($this->fecnom !== $ts) {
      $this->fecnom = $ts;
      $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::FECNOM;
    }
    ...
    if ($this->monto !== $v) {
        ...
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::MONTO;
      }
    ...
    if ($this->codcat !== $v) {
        $this->codcat = $v;
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::CODCAT;
      }
    ...
    if ($this->codpar !== $v) {
        $this->codpar = $v;
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::CODPAR;
      }
    ...
    if ($this->codescuela !== $v) {
        $this->codescuela = $v;
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::CODESCUELA;
      }
    ...
    if ($this->codniv !== $v) {
        $this->codniv = $v;
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::CODNIV;
      }
    ...
    if ($this->codtipgas !== $v) {
        $this->codtipgas = $v;
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::CODTIPGAS;
      }
    ...
    if ($this->nomcon !== $v) {
        $this->nomcon = $v;
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::NOMCON;
      }
    ...
    if ($this->numrec !== $v) {
        ...
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::NUMREC;
      }
    ...
    if ($this->cantidad !== $v) {
        ...
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::CANTIDAD;
      }
    ...
    if ($this->fecnomdes !== $ts) {
      $this->fecnomdes = $ts;
      $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::FECNOMDES;
    }
    ...
    if ($this->especial !== $v) {
        $this->especial = $v;
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::ESPECIAL;
      }
    ...
    if ($this->fecnomespdes !== $ts) {
      ...
      $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::FECNOMESPDES;
    }
    ...
    if ($this->fecnomesphas !== $ts) {
      ...
      $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::FECNOMESPHAS;
    }
    ...
    if ($this->codnomesp !== $v) {
        $this->codnomesp = $v;
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::CODNOMESP;
      }
    ...
    if ($this->nomnomesp !== $v) {
        $this->nomnomesp = $v;
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::NOMNOMESP;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = Nphiscon06022007SincambioPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Nphiscon06022007Sincambio object", $e);
    }
  }
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			Nphiscon06022007SincambioPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Nphiscon06022007SincambioPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += Nphiscon06022007SincambioPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Nphiscon06022007SincambioPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Nphiscon06022007SincambioPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Nphiscon06022007SincambioPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::CODNOM)) $criteria->add(Nphiscon06022007SincambioPeer::CODNOM, $this->codnom);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::CODEMP)) $criteria->add(Nphiscon06022007SincambioPeer::CODEMP, $this->codemp);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::CODCAR)) $criteria->add(Nphiscon06022007SincambioPeer::CODCAR, $this->codcar);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::CODCON)) $criteria->add(Nphiscon06022007SincambioPeer::CODCON, $this->codcon);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::FECNOM)) $criteria->add(Nphiscon06022007SincambioPeer::FECNOM, $this->fecnom);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::MONTO)) $criteria->add(Nphiscon06022007SincambioPeer::MONTO, $this->monto);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::CODCAT)) $criteria->add(Nphiscon06022007SincambioPeer::CODCAT, $this->codcat);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::CODPAR)) $criteria->add(Nphiscon06022007SincambioPeer::CODPAR, $this->codpar);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::CODESCUELA)) $criteria->add(Nphiscon06022007SincambioPeer::CODESCUELA, $this->codescuela);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::CODNIV)) $criteria->add(Nphiscon06022007SincambioPeer::CODNIV, $this->codniv);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::CODTIPGAS)) $criteria->add(Nphiscon06022007SincambioPeer::CODTIPGAS, $this->codtipgas);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::NOMCON)) $criteria->add(Nphiscon06022007SincambioPeer::NOMCON, $this->nomcon);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::NUMREC)) $criteria->add(Nphiscon06022007SincambioPeer::NUMREC, $this->numrec);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::CANTIDAD)) $criteria->add(Nphiscon06022007SincambioPeer::CANTIDAD, $this->cantidad);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::FECNOMDES)) $criteria->add(Nphiscon06022007SincambioPeer::FECNOMDES, $this->fecnomdes);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::ESPECIAL)) $criteria->add(Nphiscon06022007SincambioPeer::ESPECIAL, $this->especial);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::FECNOMESPDES)) $criteria->add(Nphiscon06022007SincambioPeer::FECNOMESPDES, $this->fecnomespdes);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::FECNOMESPHAS)) $criteria->add(Nphiscon06022007SincambioPeer::FECNOMESPHAS, $this->fecnomesphas);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::CODNOMESP)) $criteria->add(Nphiscon06022007SincambioPeer::CODNOMESP, $this->codnomesp);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::NOMNOMESP)) $criteria->add(Nphiscon06022007SincambioPeer::NOMNOMESP, $this->nomnomesp);
		if ($this->isColumnModified(Nphiscon06022007SincambioPeer::ID)) $criteria->add(Nphiscon06022007SincambioPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Nphiscon06022007SincambioPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new Nphiscon06022007SincambioPeer();
		}
		return self::$peer;
	}

...
abstract class BaseNptipaportesPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Nptipaportes';
	...
	{
		include_once 'lib/model/nomina/map/NptipaportesMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NptipaportesMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NptipaportesMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NptipaportesMapBuilder');
}

...
abstract class BaseNphisconOldPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.NphisconOld';
	...
	{
		include_once 'lib/model/nomina/map/NphisconOldMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NphisconOldMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(NphisconOldPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NphisconOldMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NphisconOldMapBuilder');
}

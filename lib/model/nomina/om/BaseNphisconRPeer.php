...
abstract class BaseNphisconRPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.NphisconR';
	...
	{
		include_once 'lib/model/nomina/map/NphisconRMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NphisconRMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NphisconRMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NphisconRMapBuilder');
}

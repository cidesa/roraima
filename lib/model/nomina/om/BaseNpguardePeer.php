...
abstract class BaseNpguardePeer {
	...
	{
		include_once 'lib/model/nomina/map/NpguardeMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpguardeMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpguardeMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpguardeMapBuilder');
}

...
abstract class BaseNpasicarracempPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npasicarracemp';
	...
	{
		include_once 'lib/model/nomina/map/NpasicarracempMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpasicarracempMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(NpasicarracempPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpasicarracempMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpasicarracempMapBuilder');
}

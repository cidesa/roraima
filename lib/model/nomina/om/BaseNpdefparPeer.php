...
abstract class BaseNpdefparPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npdefpar';
	...
	{
		include_once 'lib/model/nomina/map/NpdefparMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpdefparMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpdefparMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpdefparMapBuilder');
}

...
abstract class BaseNptipclaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Nptipcla';
	...
	{
		include_once 'lib/model/nomina/map/NptipclaMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NptipclaMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(NptipclaPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NptipclaMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NptipclaMapBuilder');
}

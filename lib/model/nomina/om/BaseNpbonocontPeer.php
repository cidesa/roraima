...
abstract class BaseNpbonocontPeer {
	...
	{
		include_once 'lib/model/nomina/map/NpbonocontMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpbonocontMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpbonocontMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpbonocontMapBuilder');
}

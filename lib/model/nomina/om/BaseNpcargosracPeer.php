...
abstract class BaseNpcargosracPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npcargosrac';
	...
	{
		include_once 'lib/model/nomina/map/NpcargosracMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpcargosracMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpcargosracMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpcargosracMapBuilder');
}

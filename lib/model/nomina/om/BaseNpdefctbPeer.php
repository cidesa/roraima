...
abstract class BaseNpdefctbPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npdefctb';
	...
	{
		include_once 'lib/model/nomina/map/NpdefctbMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpdefctbMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpdefctbMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpdefctbMapBuilder');
}

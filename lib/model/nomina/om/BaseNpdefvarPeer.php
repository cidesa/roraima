...
abstract class BaseNpdefvarPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npdefvar';
	...
	{
		include_once 'lib/model/nomina/map/NpdefvarMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpdefvarMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(NpdefvarPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpdefvarMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpdefvarMapBuilder');
}

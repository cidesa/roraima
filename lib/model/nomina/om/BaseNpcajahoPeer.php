...
abstract class BaseNpcajahoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npcajaho';
	...
	{
		include_once 'lib/model/nomina/map/NpcajahoMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpcajahoMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpcajahoMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpcajahoMapBuilder');
}

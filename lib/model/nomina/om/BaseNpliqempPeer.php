...
abstract class BaseNpliqempPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npliqemp';
	...
	{
		include_once 'lib/model/nomina/map/NpliqempMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpliqempMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpliqempMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpliqempMapBuilder');
}

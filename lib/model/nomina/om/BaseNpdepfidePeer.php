...
abstract class BaseNpdepfidePeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npdepfide';
	...
	{
		include_once 'lib/model/nomina/map/NpdepfideMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpdepfideMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpdepfideMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpdepfideMapBuilder');
}

...
abstract class BaseNpnomespconnomtipPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npnomespconnomtip';
	...
	{
		include_once 'lib/model/nomina/map/NpnomespconnomtipMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpnomespconnomtipMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpnomespconnomtipMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpnomespconnomtipMapBuilder');
}

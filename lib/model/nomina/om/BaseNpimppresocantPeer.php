...
abstract class BaseNpimppresocantPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npimppresocant';
	...
	{
		include_once 'lib/model/nomina/map/NpimppresocantMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpimppresocantMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpimppresocantMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpimppresocantMapBuilder');
}

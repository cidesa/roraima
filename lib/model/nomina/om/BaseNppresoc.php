...
abstract class BaseNppresoc extends BaseObject  implements Persistent {
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			NppresocPeer::doDelete($this, $con);
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = NppresocPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = NppresocPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = NppresocPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NppresocPeer::CODEMP)) $criteria->add(NppresocPeer::CODEMP, $this->codemp);
		if ($this->isColumnModified(NppresocPeer::FECCOR)) $criteria->add(NppresocPeer::FECCOR, $this->feccor);
		if ($this->isColumnModified(NppresocPeer::FECCAL)) $criteria->add(NppresocPeer::FECCAL, $this->feccal);
		if ($this->isColumnModified(NppresocPeer::CODCON)) $criteria->add(NppresocPeer::CODCON, $this->codcon);
		if ($this->isColumnModified(NppresocPeer::DIASER)) $criteria->add(NppresocPeer::DIASER, $this->diaser);
		if ($this->isColumnModified(NppresocPeer::MESSER)) $criteria->add(NppresocPeer::MESSER, $this->messer);
		if ($this->isColumnModified(NppresocPeer::ANOSER)) $criteria->add(NppresocPeer::ANOSER, $this->anoser);
		if ($this->isColumnModified(NppresocPeer::DIATRA)) $criteria->add(NppresocPeer::DIATRA, $this->diatra);
		if ($this->isColumnModified(NppresocPeer::MESTRA)) $criteria->add(NppresocPeer::MESTRA, $this->mestra);
		if ($this->isColumnModified(NppresocPeer::ANOTRA)) $criteria->add(NppresocPeer::ANOTRA, $this->anotra);
		if ($this->isColumnModified(NppresocPeer::ANTACU)) $criteria->add(NppresocPeer::ANTACU, $this->antacu);
		if ($this->isColumnModified(NppresocPeer::INTACU)) $criteria->add(NppresocPeer::INTACU, $this->intacu);
		if ($this->isColumnModified(NppresocPeer::BONTRA)) $criteria->add(NppresocPeer::BONTRA, $this->bontra);
		if ($this->isColumnModified(NppresocPeer::ADEPRE)) $criteria->add(NppresocPeer::ADEPRE, $this->adepre);
		if ($this->isColumnModified(NppresocPeer::ADEINT)) $criteria->add(NppresocPeer::ADEINT, $this->adeint);
		if ($this->isColumnModified(NppresocPeer::MONPRE)) $criteria->add(NppresocPeer::MONPRE, $this->monpre);
		if ($this->isColumnModified(NppresocPeer::PASREGANT)) $criteria->add(NppresocPeer::PASREGANT, $this->pasregant);
		if ($this->isColumnModified(NppresocPeer::STAPRE)) $criteria->add(NppresocPeer::STAPRE, $this->stapre);
		if ($this->isColumnModified(NppresocPeer::REGPRE)) $criteria->add(NppresocPeer::REGPRE, $this->regpre);
		if ($this->isColumnModified(NppresocPeer::ID)) $criteria->add(NppresocPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(NppresocPeer::ID, $this->id);

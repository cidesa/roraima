...
abstract class BaseNprelcajahoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Nprelcajaho';
	...
	{
		include_once 'lib/model/nomina/map/NprelcajahoMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NprelcajahoMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NprelcajahoMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NprelcajahoMapBuilder');
}

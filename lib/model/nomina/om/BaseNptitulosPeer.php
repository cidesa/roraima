...
abstract class BaseNptitulosPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Nptitulos';
	...
	{
		include_once 'lib/model/nomina/map/NptitulosMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NptitulosMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(NptitulosPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NptitulosMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NptitulosMapBuilder');
}

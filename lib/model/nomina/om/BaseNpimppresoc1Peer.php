...
abstract class BaseNpimppresoc1Peer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npimppresoc1';
	...
	{
		include_once 'lib/model/nomina/map/Npimppresoc1MapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.Npimppresoc1MapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(Npimppresoc1Peer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/Npimppresoc1MapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.Npimppresoc1MapBuilder');
}

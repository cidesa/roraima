...
abstract class BaseNppreliqPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Nppreliq';
	...
	{
		include_once 'lib/model/nomina/map/NppreliqMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NppreliqMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NppreliqMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NppreliqMapBuilder');
}

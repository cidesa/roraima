...
abstract class BaseNppresocPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Nppresoc';
	...
	{
		include_once 'lib/model/nomina/map/NppresocMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NppresocMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NppresocMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NppresocMapBuilder');
}

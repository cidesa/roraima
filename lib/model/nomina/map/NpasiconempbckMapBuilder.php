...
class NpasiconempbckMapBuilder {

	
	const CLASS_NAME = 'lib.model.nomina.map.NpasiconempbckMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('npasiconempbck');
		$tMap->setPhpName('Npasiconempbck');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('npasiconempbck_SEQ');

...
abstract class BaseCimovajuPeer {
	...
	const CLASS_DEFAULT = 'lib.model.ingresos.Cimovaju';
	...
	{
		include_once 'lib/model/ingresos/map/CimovajuMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.ingresos.map.CimovajuMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(CimovajuPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/ingresos/map/CimovajuMapBuilder.php';
	Propel::registerMapBuilder('lib.model.ingresos.map.CimovajuMapBuilder');
}

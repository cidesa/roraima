...
abstract class BaseCiconrepPeer {
	...
	const CLASS_DEFAULT = 'lib.model.ingresos.Ciconrep';
	...
	{
		include_once 'lib/model/ingresos/map/CiconrepMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.ingresos.map.CiconrepMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(CiconrepPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/ingresos/map/CiconrepMapBuilder.php';
	Propel::registerMapBuilder('lib.model.ingresos.map.CiconrepMapBuilder');
}

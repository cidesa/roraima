...
abstract class BaseCiajustePeer {
	...
	const CLASS_DEFAULT = 'lib.model.ingresos.Ciajuste';
	...
	{
		include_once 'lib/model/ingresos/map/CiajusteMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.ingresos.map.CiajusteMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/ingresos/map/CiajusteMapBuilder.php';
	Propel::registerMapBuilder('lib.model.ingresos.map.CiajusteMapBuilder');
}

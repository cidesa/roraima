...
abstract class BaseCiasiiniPeer {
	...
	const CLASS_DEFAULT = 'lib.model.ingresos.Ciasiini';
	...
	{
		include_once 'lib/model/ingresos/map/CiasiiniMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.ingresos.map.CiasiiniMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/ingresos/map/CiasiiniMapBuilder.php';
	Propel::registerMapBuilder('lib.model.ingresos.map.CiasiiniMapBuilder');
}

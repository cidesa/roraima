...
abstract class BaseCinivelesPeer {
	...
	const CLASS_DEFAULT = 'lib.model.ingresos.Ciniveles';
	...
	{
		include_once 'lib/model/ingresos/map/CinivelesMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.ingresos.map.CinivelesMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/ingresos/map/CinivelesMapBuilder.php';
	Propel::registerMapBuilder('lib.model.ingresos.map.CinivelesMapBuilder');
}

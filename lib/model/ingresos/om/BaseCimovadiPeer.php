...
abstract class BaseCimovadiPeer {
	...
	const CLASS_DEFAULT = 'lib.model.ingresos.Cimovadi';
	...
	{
		include_once 'lib/model/ingresos/map/CimovadiMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.ingresos.map.CimovadiMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/ingresos/map/CimovadiMapBuilder.php';
	Propel::registerMapBuilder('lib.model.ingresos.map.CimovadiMapBuilder');
}

...
abstract class BaseCidisnivPeer {
	...
	const CLASS_DEFAULT = 'lib.model.ingresos.Cidisniv';
	...
	{
		include_once 'lib/model/ingresos/map/CidisnivMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.ingresos.map.CidisnivMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/ingresos/map/CidisnivMapBuilder.php';
	Propel::registerMapBuilder('lib.model.ingresos.map.CidisnivMapBuilder');
}

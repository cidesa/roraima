...
abstract class BaseContabaPeer {
	...
	const CORCOMP = 'contaba.CORCOMP';

	
	const BTNELICOMANU = 'contaba.BTNELICOMANU';

	
	const BTNMODCOM = 'contaba.BTNMODCOM';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ContabaPeer::CORCOMP);

		$criteria->addSelectColumn(ContabaPeer::BTNELICOMANU);

		$criteria->addSelectColumn(ContabaPeer::BTNMODCOM);

...
abstract class BaseCatcarterinm extends BaseObject  implements Persistent {
  ...
  public function getCatcarterId()
  {

    return $this->catcarter_id;
  ...
  public function getId()
  {
    ...
    if ($this->catreginm_id !== $v) {
        $this->catreginm_id = $v;
        $this->modifiedColumns[] = CatcarterinmPeer::CATREGINM_ID;
      }
	...
	public function setCatcarterId($v)
	{

    if ($this->catcarter_id !== $v) {
        $this->catcarter_id = $v;
        $this->modifiedColumns[] = CatcarterinmPeer::CATCARTER_ID;
      }
  
		if ($this->aCatcarter !== null && $this->aCatcarter->getId() !== $v) {
			$this->aCatcarter = null;
		}
    ...
    if ($this->dimensiones !== $v) {
        $this->dimensiones = $v;
        $this->modifiedColumns[] = CatcarterinmPeer::DIMENSIONES;
      }
    ...
    if ($this->valor !== $v) {
        $this->valor = $v;
        $this->modifiedColumns[] = CatcarterinmPeer::VALOR;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = CatcarterinmPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->catcarter_id = $rs->getInt($startcol + 1);

      $this->dimensiones = $rs->getString($startcol + 2);
      ...
      throw new PropelException("Error populating Catcarterinm object", $e);
    }
  }
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			CatcarterinmPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->aCatcarter !== null) {
				if ($this->aCatcarter->isModified()) {
					$affectedRows += $this->aCatcarter->save($con);
				}
				$this->setCatcarter($this->aCatcarter);
			}


						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CatcarterinmPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += CatcarterinmPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aCatcarter !== null) {
				if (!$this->aCatcarter->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aCatcarter->getValidationFailures());
				}
			}


			if (($retval = CatcarterinmPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CatcarterinmPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CatcarterinmPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getCatreginmId(),
			$keys[1] => $this->getCatcarterId(),
			$keys[2] => $this->getDimensiones(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setCatcarterId($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setDimensiones($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CatcarterinmPeer::CATREGINM_ID)) $criteria->add(CatcarterinmPeer::CATREGINM_ID, $this->catreginm_id);
		if ($this->isColumnModified(CatcarterinmPeer::CATCARTER_ID)) $criteria->add(CatcarterinmPeer::CATCARTER_ID, $this->catcarter_id);
		if ($this->isColumnModified(CatcarterinmPeer::DIMENSIONES)) $criteria->add(CatcarterinmPeer::DIMENSIONES, $this->dimensiones);
		if ($this->isColumnModified(CatcarterinmPeer::VALOR)) $criteria->add(CatcarterinmPeer::VALOR, $this->valor);
		if ($this->isColumnModified(CatcarterinmPeer::ID)) $criteria->add(CatcarterinmPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CatcarterinmPeer::ID, $this->id);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCatcarterId($this->catcarter_id);

		$copyObj->setDimensiones($this->dimensiones);
	...
	{
		if (self::$peer === null) {
			self::$peer = new CatcarterinmPeer();
		}
		return self::$peer;
	}
	...
	public function setCatcarter($v)
	{


		if ($v === null) {
			$this->setCatcarterId(NULL);
		} else {
			$this->setCatcarterId($v->getId());
		}
	...
	public function getCatcarter($con = null)
	{
		if ($this->aCatcarter === null && ($this->catcarter_id !== null)) {
						include_once 'lib/model/catastro/om/BaseCatcarterPeer.php';

			$this->aCatcarter = CatcarterPeer::retrieveByPK($this->catcarter_id, $con);

			
		}
		return $this->aCatcarter;
	}
		...
		if ($this->collCatreginms === null) {
			if ($this->isNew()) {
			   $this->collCatreginms = array();
				...
				$criteria->add(CatreginmPeer::CATCARTERINM_ID, $this->getId());

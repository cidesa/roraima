...
abstract class BaseDfatendocPeer {
	...
	{
		include_once 'lib/model/documentos/map/DfatendocMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.documentos.map.DfatendocMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/documentos/map/DfatendocMapBuilder.php';
	Propel::registerMapBuilder('lib.model.documentos.map.DfatendocMapBuilder');
}

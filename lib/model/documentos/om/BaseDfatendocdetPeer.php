...
abstract class BaseDfatendocdetPeer {
	...
	const CLASS_DEFAULT = 'lib.model.documentos.Dfatendocdet';
	...
	{
		include_once 'lib/model/documentos/map/DfatendocdetMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.documentos.map.DfatendocdetMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/documentos/map/DfatendocdetMapBuilder.php';
	Propel::registerMapBuilder('lib.model.documentos.map.DfatendocdetMapBuilder');
}

...
/**
 * Subclass for representing a row from the 'ocperval' table.
 *
 *
 *
 * @package lib.model
 */
class Ocperval extends BaseOcperval
{
  protected $codtipval='';
  protected $destipval='';
  protected $numval='';
  ...
  protected $monval='0,00';
	...
	public function getNomtop()
	{
       ...
       $c->addJoin(OcdefperPeer::CEDPER,OcproperPeer::CODPRO);

...
abstract class BaseHisconbPeer {
	...
	const CLASS_DEFAULT = 'lib.model.presupuesto.Hisconb';
	...
	{
		include_once 'lib/model/presupuesto/map/HisconbMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.presupuesto.map.HisconbMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/presupuesto/map/HisconbMapBuilder.php';
	Propel::registerMapBuilder('lib.model.presupuesto.map.HisconbMapBuilder');
}

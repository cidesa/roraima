...
abstract class BaseCpdisfuefinPeer {
	...
	const CLASS_DEFAULT = 'lib.model.presupuesto.Cpdisfuefin';
	...
	{
		include_once 'lib/model/presupuesto/map/CpdisfuefinMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.presupuesto.map.CpdisfuefinMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/presupuesto/map/CpdisfuefinMapBuilder.php';
	Propel::registerMapBuilder('lib.model.presupuesto.map.CpdisfuefinMapBuilder');
}

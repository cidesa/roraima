...
abstract class BaseCpimpcomPeer {
	...
	const CLASS_DEFAULT = 'lib.model.presupuesto.Cpimpcom';
	...
	{
		include_once 'lib/model/presupuesto/map/CpimpcomMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.presupuesto.map.CpimpcomMapBuilder');
	}
	...
	public static function doCountJoinCpcompro(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(CpimpcomPeer::REFCOM, CpcomproPeer::REFCOM);
	...
	public static function doCountJoinCpdeftit(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(CpimpcomPeer::CODPRE, CpdeftitPeer::CODPRE);
	...
	public static function doSelectJoinCpcompro(Criteria $c, $con = null)
	{
		...
		CpimpcomPeer::addSelectColumns($c);
		$startcol = (CpimpcomPeer::NUM_COLUMNS - CpimpcomPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		...
		while($rs->next()) {
			...
			$omClass = CpimpcomPeer::getOMClass();
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getCpcompro(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addCpimpcom($obj1); 					break;
				}
			}
			if ($newObject) {
				$obj2->initCpimpcoms();
				$obj2->addCpimpcom($obj1); 			}
			$results[] = $obj1;
		}
		return $results;
	}
	...
	public static function doSelectJoinCpdeftit(Criteria $c, $con = null)
	{
		...
		$c->addJoin(CpimpcomPeer::CODPRE, CpdeftitPeer::CODPRE);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		CpimpcomPeer::addSelectColumns($c);
		$startcol2 = (CpimpcomPeer::NUM_COLUMNS - CpimpcomPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
			...
			$obj1->hydrate($rs);
				...
				for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
					...
					$temp_obj3 = $temp_obj1->getCpdeftit(); 					if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
						$newObject = false;
						$temp_obj3->addCpimpcom($obj1); 						break;
					}
				}

				if ($newObject) {
					$obj3->initCpimpcoms();
					$obj3->addCpimpcom($obj1);
				}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/presupuesto/map/CpimpcomMapBuilder.php';
	Propel::registerMapBuilder('lib.model.presupuesto.map.CpimpcomMapBuilder');
}

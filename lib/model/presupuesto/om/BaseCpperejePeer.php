...
abstract class BaseCpperejePeer {
	...
	const CLASS_DEFAULT = 'lib.model.presupuesto.Cppereje';
	...
	{
		include_once 'lib/model/presupuesto/map/CpperejeMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.presupuesto.map.CpperejeMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/presupuesto/map/CpperejeMapBuilder.php';
	Propel::registerMapBuilder('lib.model.presupuesto.map.CpperejeMapBuilder');
}

...
abstract class BaseHisconc1 extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->numcom !== $v) {
        $this->numcom = $v;
        $this->modifiedColumns[] = Hisconc1Peer::NUMCOM;
      }
    ...
    if ($this->feccom !== $ts) {
      $this->feccom = $ts;
      $this->modifiedColumns[] = Hisconc1Peer::FECCOM;
    }
    ...
    if ($this->debcre !== $v) {
        $this->debcre = $v;
        $this->modifiedColumns[] = Hisconc1Peer::DEBCRE;
      }
    ...
    if ($this->codcta !== $v) {
        $this->codcta = $v;
        $this->modifiedColumns[] = Hisconc1Peer::CODCTA;
      }
    ...
    if ($this->numasi !== $v) {
        ...
        $this->modifiedColumns[] = Hisconc1Peer::NUMASI;
      }
    ...
    if ($this->refasi !== $v) {
        $this->refasi = $v;
        $this->modifiedColumns[] = Hisconc1Peer::REFASI;
      }
    ...
    if ($this->desasi !== $v) {
        $this->desasi = $v;
        $this->modifiedColumns[] = Hisconc1Peer::DESASI;
      }
    ...
    if ($this->monasi !== $v) {
        ...
        $this->modifiedColumns[] = Hisconc1Peer::MONASI;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = Hisconc1Peer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Hisconc1 object", $e);
    }
  }
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			Hisconc1Peer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Hisconc1Peer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += Hisconc1Peer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Hisconc1Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Hisconc1Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Hisconc1Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Hisconc1Peer::NUMCOM)) $criteria->add(Hisconc1Peer::NUMCOM, $this->numcom);
		if ($this->isColumnModified(Hisconc1Peer::FECCOM)) $criteria->add(Hisconc1Peer::FECCOM, $this->feccom);
		if ($this->isColumnModified(Hisconc1Peer::DEBCRE)) $criteria->add(Hisconc1Peer::DEBCRE, $this->debcre);
		if ($this->isColumnModified(Hisconc1Peer::CODCTA)) $criteria->add(Hisconc1Peer::CODCTA, $this->codcta);
		if ($this->isColumnModified(Hisconc1Peer::NUMASI)) $criteria->add(Hisconc1Peer::NUMASI, $this->numasi);
		if ($this->isColumnModified(Hisconc1Peer::REFASI)) $criteria->add(Hisconc1Peer::REFASI, $this->refasi);
		if ($this->isColumnModified(Hisconc1Peer::DESASI)) $criteria->add(Hisconc1Peer::DESASI, $this->desasi);
		if ($this->isColumnModified(Hisconc1Peer::MONASI)) $criteria->add(Hisconc1Peer::MONASI, $this->monasi);
		if ($this->isColumnModified(Hisconc1Peer::ID)) $criteria->add(Hisconc1Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Hisconc1Peer::ID, $this->id);

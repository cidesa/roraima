...
abstract class BaseHisconb1Peer {
	...
	const CLASS_DEFAULT = 'lib.model.presupuesto.Hisconb1';
	...
	{
		include_once 'lib/model/presupuesto/map/Hisconb1MapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.presupuesto.map.Hisconb1MapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(Hisconb1Peer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/presupuesto/map/Hisconb1MapBuilder.php';
	Propel::registerMapBuilder('lib.model.presupuesto.map.Hisconb1MapBuilder');
}

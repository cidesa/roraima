...
abstract class BaseCpimpcau extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->refcau !== $v) {
		...
		if ($this->aCpcausad !== null && $this->aCpcausad->getRefcau() !== $v) {
			$this->aCpcausad = null;
		}
  ...
  public function __call($m, $a)
	...
	{
		if ($this->aCpcausad === null && (($this->refcau !== "" && $this->refcau !== null))) {
						include_once 'lib/model/presupuesto/om/BaseCpcausadPeer.php';

      $c = new Criteria();
      $c->add(CpcausadPeer::REFCAU,$this->refcau);

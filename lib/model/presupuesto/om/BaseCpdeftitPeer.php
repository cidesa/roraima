...
abstract class BaseCpdeftitPeer {
	...
	const CLASS_DEFAULT = 'lib.model.presupuesto.Cpdeftit';
	...
	{
		include_once 'lib/model/presupuesto/map/CpdeftitMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.presupuesto.map.CpdeftitMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/presupuesto/map/CpdeftitMapBuilder.php';
	Propel::registerMapBuilder('lib.model.presupuesto.map.CpdeftitMapBuilder');
}

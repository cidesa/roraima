...
abstract class BaseDivisionPeer {
	...
	const CLASS_DEFAULT = 'lib.model.sima_user.Division';
	...
	const CODDIV = 'division.CODDIV';

	
	const DESDIV = 'division.DESDIV';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Coddiv', 'Desdiv', 'Id', ),
		BasePeer::TYPE_COLNAME => array (DivisionPeer::CODDIV, DivisionPeer::DESDIV, DivisionPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('coddiv', 'desdiv', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Coddiv' => 0, 'Desdiv' => 1, 'Id' => 2, ),
		BasePeer::TYPE_COLNAME => array (DivisionPeer::CODDIV => 0, DivisionPeer::DESDIV => 1, DivisionPeer::ID => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('coddiv' => 0, 'desdiv' => 1, 'id' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		include_once 'lib/model/sima_user/map/DivisionMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.sima_user.map.DivisionMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(DivisionPeer::CODDIV);

		$criteria->addSelectColumn(DivisionPeer::DESDIV);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/sima_user/map/DivisionMapBuilder.php';
	Propel::registerMapBuilder('lib.model.sima_user.map.DivisionMapBuilder');
}

...
abstract class BaseCatcodpos extends BaseObject  implements Persistent {
  ...
  public function getDespos()
  {

    return trim($this->despos);
  ...
  public function getId()
  {
	...
	public function setDespos($v)
	{

    if ($this->despos !== $v) {
        $this->despos = $v;
        $this->modifiedColumns[] = CatcodposPeer::DESPOS;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = CatcodposPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->despos = $rs->getString($startcol + 0);
      ...
      throw new PropelException("Error populating Catcodpos object", $e);
    }
  }
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			CatcodposPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CatcodposPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += CatcodposPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CatcodposPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CatcodposPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CatcodposPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getDespos(),
			$keys[1] => $this->getId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setDespos($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CatcodposPeer::DESPOS)) $criteria->add(CatcodposPeer::DESPOS, $this->despos);
		if ($this->isColumnModified(CatcodposPeer::ID)) $criteria->add(CatcodposPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CatcodposPeer::ID, $this->id);
		...
		if ($this->collCatreginms === null) {
			if ($this->isNew()) {
			   $this->collCatreginms = array();
				...
				$criteria->add(CatreginmPeer::CATCODPOS_ID, $this->getId());
		...
		if ($this->collCatregpers === null) {
			if ($this->isNew()) {
			   $this->collCatregpers = array();
				...
				$criteria->add(CatregperPeer::CATCODPOS_ID, $this->getId());

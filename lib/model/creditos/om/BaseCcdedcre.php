...
abstract class BaseCcdedcre extends BaseObject  implements Persistent {
  ...
  public function getCccreditId()
  {
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = CcdedcrePeer::ID;
      }
    ...
    if ($this->ccdeducc_id !== $v) {
        $this->ccdeducc_id = $v;
        $this->modifiedColumns[] = CcdedcrePeer::CCDEDUCC_ID;
      }
    ...
    if ($this->cccredit_id !== $v) {
        $this->cccredit_id = $v;
        $this->modifiedColumns[] = CcdedcrePeer::CCCREDIT_ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->ccdeducc_id = $rs->getInt($startcol + 1);
      ...
      throw new PropelException("Error populating Ccdedcre object", $e);
    }
  }
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			CcdedcrePeer::doDelete($this, $con);
		...
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			...
			if ($this->aCccredit !== null) {
				...
				$this->setCccredit($this->aCccredit);
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CcdedcrePeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += CcdedcrePeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CcdedcrePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CcdedcrePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CcdedcrePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getCcdeduccId(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setCcdeduccId($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CcdedcrePeer::ID)) $criteria->add(CcdedcrePeer::ID, $this->id);
		if ($this->isColumnModified(CcdedcrePeer::CCDEDUCC_ID)) $criteria->add(CcdedcrePeer::CCDEDUCC_ID, $this->ccdeducc_id);
		if ($this->isColumnModified(CcdedcrePeer::CCCREDIT_ID)) $criteria->add(CcdedcrePeer::CCCREDIT_ID, $this->cccredit_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CcdedcrePeer::ID, $this->id);

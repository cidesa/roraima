...
class Tabla33MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.Tabla33MapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tabla33');
		$tMap->setPhpName('Tabla33');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('tabla33_SEQ');

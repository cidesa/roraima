...
class Tabla17MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.Tabla17MapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tabla17');
		$tMap->setPhpName('Tabla17');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('tabla17_SEQ');

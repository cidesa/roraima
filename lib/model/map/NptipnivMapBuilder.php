...
class NptipnivMapBuilder {
    ...
    public function doBuild()
    {
		...
		$tMap->addColumn('MAXSUE', 'Maxsue', 'double', CreoleTypes::NUMERIC, false);

		$tMap->addColumn('MEDSUE', 'Medsue', 'double', CreoleTypes::NUMERIC, false);

		$tMap->addColumn('MINSUE', 'Minsue', 'double', CreoleTypes::NUMERIC, false);

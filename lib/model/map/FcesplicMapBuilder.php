...
class FcesplicMapBuilder {
	...
	const CLASS_NAME = 'lib.model.map.FcesplicMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('HORESPI', 'Horespi', 'string', CreoleTypes::VARCHAR, false, 20);
		...
		$tMap->addColumn('HORESPF', 'Horespf', 'string', CreoleTypes::VARCHAR, false, 20);

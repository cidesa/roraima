...
class Tabla16MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.Tabla16MapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tabla16');
		$tMap->setPhpName('Tabla16');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('tabla16_SEQ');

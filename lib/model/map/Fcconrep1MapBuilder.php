...
class Fcconrep1MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.Fcconrep1MapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('fcconrep1');
		$tMap->setPhpName('Fcconrep1');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('fcconrep1_SEQ');

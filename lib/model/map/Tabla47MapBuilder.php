...
class Tabla47MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.Tabla47MapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tabla47');
		$tMap->setPhpName('Tabla47');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('tabla47_SEQ');

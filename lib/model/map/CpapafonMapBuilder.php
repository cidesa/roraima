...
class CpapafonMapBuilder {
    ...
    public function doBuild()
    {
		...
		$tMap->addColumn('FECAPA', 'Fecapa', 'int', CreoleTypes::DATE, true);
		...
		$tMap->addColumn('MONAPA', 'Monapa', 'double', CreoleTypes::NUMERIC, false);
		...
		$tMap->addColumn('MONCIE', 'Moncie', 'double', CreoleTypes::NUMERIC, false);

...
class InventarioMapBuilder {
    ...
    public function doBuild()
    {
		...
		$tMap->addColumn('CONTEO1', 'Conteo1', 'double', CreoleTypes::NUMERIC, false);

		$tMap->addColumn('CONTEO2', 'Conteo2', 'double', CreoleTypes::NUMERIC, false);

		$tMap->addColumn('DIFE', 'Dife', 'double', CreoleTypes::NUMERIC, false);

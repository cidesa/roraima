...
class NpexplabMapBuilder {
	...
	const CLASS_NAME = 'lib.model.map.NpexplabMapBuilder';	
    ...
    public function doBuild()
    {
		...
		$tMap->addColumn('SUEOBT', 'Sueobt', 'double', CreoleTypes::NUMERIC, false);

		$tMap->addColumn('STACAR', 'Stacar', 'string', CreoleTypes::VARCHAR, true, 1);

		$tMap->addColumn('COMPOBT', 'Compobt', 'double', CreoleTypes::NUMERIC, false);

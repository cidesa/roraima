...
class FcconreprespMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.FcconreprespMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('fcconrepresp');
		$tMap->setPhpName('Fcconrepresp');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('fcconrepresp_SEQ');

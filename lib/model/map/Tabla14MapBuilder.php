...
class Tabla14MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.Tabla14MapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tabla14');
		$tMap->setPhpName('Tabla14');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('tabla14_SEQ');

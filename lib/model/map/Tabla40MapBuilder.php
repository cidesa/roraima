...
class Tabla40MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.Tabla40MapBuilder';	
    ...
    public function doBuild()
    {
		...
		$tMap = $this->dbMap->addTable('tabla40');
		$tMap->setPhpName('Tabla40');
		...
		$tMap->addColumn('FECHAFAC', 'Fechafac', 'int', CreoleTypes::DATE, false);
		...
		$tMap->addColumn('FECCOMRET', 'Feccomret', 'int', CreoleTypes::DATE, false);

		$tMap->addColumn('COMRETISLR', 'Comretislr', 'string', CreoleTypes::VARCHAR, false, 20);

		$tMap->addColumn('FECCOMRETISLR', 'Feccomretislr', 'int', CreoleTypes::DATE, false);

		$tMap->addColumn('COMRETLTF', 'Comretltf', 'string', CreoleTypes::VARCHAR, false, 20);

		$tMap->addColumn('FECCOMRETLTF', 'Feccomretltf', 'int', CreoleTypes::DATE, false);

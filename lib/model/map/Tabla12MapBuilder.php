...
class Tabla12MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.Tabla12MapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tabla12');
		$tMap->setPhpName('Tabla12');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('tabla12_SEQ');

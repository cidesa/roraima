...
class Tabla27MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.Tabla27MapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tabla27');
		$tMap->setPhpName('Tabla27');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('tabla27_SEQ');

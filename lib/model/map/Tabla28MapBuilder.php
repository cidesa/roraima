...
class Tabla28MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.Tabla28MapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tabla28');
		$tMap->setPhpName('Tabla28');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('tabla28_SEQ');

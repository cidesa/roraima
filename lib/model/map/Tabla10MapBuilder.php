...
class Tabla10MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.Tabla10MapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tabla10');
		$tMap->setPhpName('Tabla10');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('tabla10_SEQ');

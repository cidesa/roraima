...
class Tabla22MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.Tabla22MapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tabla22');
		$tMap->setPhpName('Tabla22');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('tabla22_SEQ');

...
abstract class BaseFcreciboPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcrecibo';
	...
	{
		include_once 'lib/model/hacienda/map/FcreciboMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcreciboMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcreciboMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcreciboMapBuilder');
}

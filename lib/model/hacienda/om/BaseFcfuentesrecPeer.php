...
abstract class BaseFcfuentesrecPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcfuentesrec';
	...
	{
		include_once 'lib/model/hacienda/map/FcfuentesrecMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcfuentesrecMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcfuentesrecMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcfuentesrecMapBuilder');
}

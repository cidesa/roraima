...
abstract class BaseFcesppubPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcesppub';
	...
	{
		include_once 'lib/model/hacienda/map/FcesppubMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcesppubMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcesppubMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcesppubMapBuilder');
}

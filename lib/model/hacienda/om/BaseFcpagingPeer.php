...
abstract class BaseFcpagingPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcpaging';
	...
	{
		include_once 'lib/model/hacienda/map/FcpagingMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcpagingMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcpagingMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcpagingMapBuilder');
}

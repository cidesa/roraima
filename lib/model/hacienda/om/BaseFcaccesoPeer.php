...
abstract class BaseFcaccesoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcacceso';
	...
	{
		include_once 'lib/model/hacienda/map/FcaccesoMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcaccesoMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(FcaccesoPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcaccesoMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcaccesoMapBuilder');
}

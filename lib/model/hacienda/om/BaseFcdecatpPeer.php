...
abstract class BaseFcdecatpPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcdecatp';
	...
	{
		include_once 'lib/model/hacienda/map/FcdecatpMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcdecatpMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcdecatpMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcdecatpMapBuilder');
}

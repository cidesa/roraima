...
abstract class BaseFcinmmodPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcinmmod';
	...
	{
		include_once 'lib/model/hacienda/map/FcinmmodMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcinmmodMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcinmmodMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcinmmodMapBuilder');
}

...
abstract class BaseFcajustePeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcajuste';
	...
	{
		include_once 'lib/model/hacienda/map/FcajusteMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcajusteMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcajusteMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcajusteMapBuilder');
}

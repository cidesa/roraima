...
abstract class BaseFcaliinmPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcaliinm';
	...
	{
		include_once 'lib/model/hacienda/map/FcaliinmMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcaliinmMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(FcaliinmPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcaliinmMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcaliinmMapBuilder');
}

...
abstract class BaseFcparroqPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcparroq';
	...
	{
		include_once 'lib/model/hacienda/map/FcparroqMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcparroqMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcparroqMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcparroqMapBuilder');
}

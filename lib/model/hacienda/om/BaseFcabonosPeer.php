...
abstract class BaseFcabonosPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcabonos';
	...
	{
		include_once 'lib/model/hacienda/map/FcabonosMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcabonosMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcabonosMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcabonosMapBuilder');
}

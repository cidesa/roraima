...
abstract class BaseFcdeffunPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcdeffun';
	...
	{
		include_once 'lib/model/hacienda/map/FcdeffunMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcdeffunMapBuilder');
	}
	...
	const COUNT = 'COUNT(fcdeffun.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT fcdeffun.ID)';
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(FcdeffunPeer::ID); 
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(FcdeffunPeer::ID);
			$selectCriteria->add(FcdeffunPeer::ID, $criteria->remove(FcdeffunPeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(FcdeffunPeer::ID, (array) $values, Criteria::IN);
		}
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(FcdeffunPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(FcdeffunPeer::ID, $pks, Criteria::IN);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcdeffunMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcdeffunMapBuilder');
}

...
abstract class BaseFcsoldetPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcsoldet';
	...
	{
		include_once 'lib/model/hacienda/map/FcsoldetMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcsoldetMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcsoldetMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcsoldetMapBuilder');
}

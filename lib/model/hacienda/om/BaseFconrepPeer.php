...
abstract class BaseFconrepPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fconrep';
	...
	{
		include_once 'lib/model/hacienda/map/FconrepMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FconrepMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FconrepMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FconrepMapBuilder');
}

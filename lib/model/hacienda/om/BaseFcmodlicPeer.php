...
abstract class BaseFcmodlicPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcmodlic';
	...
	{
		include_once 'lib/model/hacienda/map/FcmodlicMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcmodlicMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcmodlicMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcmodlicMapBuilder');
}

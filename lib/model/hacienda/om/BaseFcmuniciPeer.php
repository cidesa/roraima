...
abstract class BaseFcmuniciPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcmunici';
	...
	{
		include_once 'lib/model/hacienda/map/FcmuniciMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcmuniciMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcmuniciMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcmuniciMapBuilder');
}

...
abstract class BaseFcmultasPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcmultas';
	...
	{
		include_once 'lib/model/hacienda/map/FcmultasMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcmultasMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcmultasMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcmultasMapBuilder');
}

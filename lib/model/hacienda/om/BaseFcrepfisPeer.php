...
abstract class BaseFcrepfisPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcrepfis';
	...
	{
		include_once 'lib/model/hacienda/map/FcrepfisMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcrepfisMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcrepfisMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcrepfisMapBuilder');
}

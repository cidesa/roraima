...
abstract class BaseFcrangosdesPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcrangosdes';
	...
	{
		include_once 'lib/model/hacienda/map/FcrangosdesMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcrangosdesMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcrangosdesMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcrangosdesMapBuilder');
}

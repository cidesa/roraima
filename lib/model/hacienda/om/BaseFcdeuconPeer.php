...
abstract class BaseFcdeuconPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcdeucon';
	...
	{
		include_once 'lib/model/hacienda/map/FcdeuconMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcdeuconMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcdeuconMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcdeuconMapBuilder');
}

...
abstract class BaseFcmodproPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcmodpro';
	...
	{
		include_once 'lib/model/hacienda/map/FcmodproMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcmodproMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(FcmodproPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcmodproMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcmodproMapBuilder');
}

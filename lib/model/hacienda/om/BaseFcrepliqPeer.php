...
abstract class BaseFcrepliqPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcrepliq';
	...
	{
		include_once 'lib/model/hacienda/map/FcrepliqMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcrepliqMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcrepliqMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcrepliqMapBuilder');
}

...
abstract class BaseFcsoldet2Peer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcsoldet2';
	...
	{
		include_once 'lib/model/hacienda/map/Fcsoldet2MapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.Fcsoldet2MapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/Fcsoldet2MapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.Fcsoldet2MapBuilder');
}

...
abstract class BaseFcdefinsPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcdefins';
	...
	{
		include_once 'lib/model/hacienda/map/FcdefinsMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcdefinsMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(FcdefinsPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcdefinsMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcdefinsMapBuilder');
}

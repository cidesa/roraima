...
abstract class BaseFcinmmod extends BaseObject  implements Persistent {
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      $this->numdoc = $rs->getString($startcol + 44);
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			FcinmmodPeer::doDelete($this, $con);
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = FcinmmodPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = FcinmmodPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = FcinmmodPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FcinmmodPeer::NROINM)) $criteria->add(FcinmmodPeer::NROINM, $this->nroinm);
		if ($this->isColumnModified(FcinmmodPeer::CODCATFIS)) $criteria->add(FcinmmodPeer::CODCATFIS, $this->codcatfis);
		if ($this->isColumnModified(FcinmmodPeer::CODUSO)) $criteria->add(FcinmmodPeer::CODUSO, $this->coduso);
		if ($this->isColumnModified(FcinmmodPeer::CODCARINM)) $criteria->add(FcinmmodPeer::CODCARINM, $this->codcarinm);
		if ($this->isColumnModified(FcinmmodPeer::CODSITINM)) $criteria->add(FcinmmodPeer::CODSITINM, $this->codsitinm);
		if ($this->isColumnModified(FcinmmodPeer::RIFCON)) $criteria->add(FcinmmodPeer::RIFCON, $this->rifcon);
		if ($this->isColumnModified(FcinmmodPeer::FECPAG)) $criteria->add(FcinmmodPeer::FECPAG, $this->fecpag);
		if ($this->isColumnModified(FcinmmodPeer::FECCAL)) $criteria->add(FcinmmodPeer::FECCAL, $this->feccal);
		if ($this->isColumnModified(FcinmmodPeer::FECREG)) $criteria->add(FcinmmodPeer::FECREG, $this->fecreg);
		if ($this->isColumnModified(FcinmmodPeer::DIRINM)) $criteria->add(FcinmmodPeer::DIRINM, $this->dirinm);
		if ($this->isColumnModified(FcinmmodPeer::LINNOR)) $criteria->add(FcinmmodPeer::LINNOR, $this->linnor);
		if ($this->isColumnModified(FcinmmodPeer::LINSUR)) $criteria->add(FcinmmodPeer::LINSUR, $this->linsur);
		if ($this->isColumnModified(FcinmmodPeer::LINEST)) $criteria->add(FcinmmodPeer::LINEST, $this->linest);
		if ($this->isColumnModified(FcinmmodPeer::LINOES)) $criteria->add(FcinmmodPeer::LINOES, $this->linoes);
		if ($this->isColumnModified(FcinmmodPeer::MTRTER)) $criteria->add(FcinmmodPeer::MTRTER, $this->mtrter);
		if ($this->isColumnModified(FcinmmodPeer::MTRCON)) $criteria->add(FcinmmodPeer::MTRCON, $this->mtrcon);
		if ($this->isColumnModified(FcinmmodPeer::BSTER)) $criteria->add(FcinmmodPeer::BSTER, $this->bster);
		if ($this->isColumnModified(FcinmmodPeer::BSCON)) $criteria->add(FcinmmodPeer::BSCON, $this->bscon);
		if ($this->isColumnModified(FcinmmodPeer::DOCPRO)) $criteria->add(FcinmmodPeer::DOCPRO, $this->docpro);
		if ($this->isColumnModified(FcinmmodPeer::RIFREP)) $criteria->add(FcinmmodPeer::RIFREP, $this->rifrep);
		if ($this->isColumnModified(FcinmmodPeer::FUNREC)) $criteria->add(FcinmmodPeer::FUNREC, $this->funrec);
		if ($this->isColumnModified(FcinmmodPeer::FECREC)) $criteria->add(FcinmmodPeer::FECREC, $this->fecrec);
		if ($this->isColumnModified(FcinmmodPeer::ESTINM)) $criteria->add(FcinmmodPeer::ESTINM, $this->estinm);
		if ($this->isColumnModified(FcinmmodPeer::ESTDEC)) $criteria->add(FcinmmodPeer::ESTDEC, $this->estdec);
		if ($this->isColumnModified(FcinmmodPeer::CODCATINM)) $criteria->add(FcinmmodPeer::CODCATINM, $this->codcatinm);
		if ($this->isColumnModified(FcinmmodPeer::NOMCON)) $criteria->add(FcinmmodPeer::NOMCON, $this->nomcon);
		if ($this->isColumnModified(FcinmmodPeer::DIRCON)) $criteria->add(FcinmmodPeer::DIRCON, $this->dircon);
		if ($this->isColumnModified(FcinmmodPeer::CLACON)) $criteria->add(FcinmmodPeer::CLACON, $this->clacon);
		if ($this->isColumnModified(FcinmmodPeer::FECADQ)) $criteria->add(FcinmmodPeer::FECADQ, $this->fecadq);
		if ($this->isColumnModified(FcinmmodPeer::VALINM)) $criteria->add(FcinmmodPeer::VALINM, $this->valinm);
		if ($this->isColumnModified(FcinmmodPeer::CODMAN)) $criteria->add(FcinmmodPeer::CODMAN, $this->codman);
		if ($this->isColumnModified(FcinmmodPeer::CODSEC)) $criteria->add(FcinmmodPeer::CODSEC, $this->codsec);
		if ($this->isColumnModified(FcinmmodPeer::CODPAR)) $criteria->add(FcinmmodPeer::CODPAR, $this->codpar);
		if ($this->isColumnModified(FcinmmodPeer::NROINMANT)) $criteria->add(FcinmmodPeer::NROINMANT, $this->nroinmant);
		if ($this->isColumnModified(FcinmmodPeer::TOTTER)) $criteria->add(FcinmmodPeer::TOTTER, $this->totter);
		if ($this->isColumnModified(FcinmmodPeer::TOTCON)) $criteria->add(FcinmmodPeer::TOTCON, $this->totcon);
		if ($this->isColumnModified(FcinmmodPeer::TOTAL)) $criteria->add(FcinmmodPeer::TOTAL, $this->total);
		if ($this->isColumnModified(FcinmmodPeer::CODTIP)) $criteria->add(FcinmmodPeer::CODTIP, $this->codtip);
		if ($this->isColumnModified(FcinmmodPeer::CODZON)) $criteria->add(FcinmmodPeer::CODZON, $this->codzon);
		if ($this->isColumnModified(FcinmmodPeer::DESTIP)) $criteria->add(FcinmmodPeer::DESTIP, $this->destip);
		if ($this->isColumnModified(FcinmmodPeer::DESZON)) $criteria->add(FcinmmodPeer::DESZON, $this->deszon);
		if ($this->isColumnModified(FcinmmodPeer::ANUAL)) $criteria->add(FcinmmodPeer::ANUAL, $this->anual);
		if ($this->isColumnModified(FcinmmodPeer::FOLIO)) $criteria->add(FcinmmodPeer::FOLIO, $this->folio);
		if ($this->isColumnModified(FcinmmodPeer::TOMO)) $criteria->add(FcinmmodPeer::TOMO, $this->tomo);
		if ($this->isColumnModified(FcinmmodPeer::NUMDOC)) $criteria->add(FcinmmodPeer::NUMDOC, $this->numdoc);
		if ($this->isColumnModified(FcinmmodPeer::FECDOC)) $criteria->add(FcinmmodPeer::FECDOC, $this->fecdoc);
		if ($this->isColumnModified(FcinmmodPeer::USOINM)) $criteria->add(FcinmmodPeer::USOINM, $this->usoinm);
		if ($this->isColumnModified(FcinmmodPeer::DESDE)) $criteria->add(FcinmmodPeer::DESDE, $this->desde);
		if ($this->isColumnModified(FcinmmodPeer::HASTA)) $criteria->add(FcinmmodPeer::HASTA, $this->hasta);
		if ($this->isColumnModified(FcinmmodPeer::ORD)) $criteria->add(FcinmmodPeer::ORD, $this->ord);
		if ($this->isColumnModified(FcinmmodPeer::ART)) $criteria->add(FcinmmodPeer::ART, $this->art);
		if ($this->isColumnModified(FcinmmodPeer::FECDIR)) $criteria->add(FcinmmodPeer::FECDIR, $this->fecdir);
		if ($this->isColumnModified(FcinmmodPeer::FECAVA)) $criteria->add(FcinmmodPeer::FECAVA, $this->fecava);
		if ($this->isColumnModified(FcinmmodPeer::DIRINM1)) $criteria->add(FcinmmodPeer::DIRINM1, $this->dirinm1);
		if ($this->isColumnModified(FcinmmodPeer::FECELA)) $criteria->add(FcinmmodPeer::FECELA, $this->fecela);
		if ($this->isColumnModified(FcinmmodPeer::TRI)) $criteria->add(FcinmmodPeer::TRI, $this->tri);
		if ($this->isColumnModified(FcinmmodPeer::PROT)) $criteria->add(FcinmmodPeer::PROT, $this->prot);
		if ($this->isColumnModified(FcinmmodPeer::TIPOBOL)) $criteria->add(FcinmmodPeer::TIPOBOL, $this->tipobol);
		if ($this->isColumnModified(FcinmmodPeer::NOMSITINM)) $criteria->add(FcinmmodPeer::NOMSITINM, $this->nomsitinm);
		if ($this->isColumnModified(FcinmmodPeer::IMPANU)) $criteria->add(FcinmmodPeer::IMPANU, $this->impanu);
		if ($this->isColumnModified(FcinmmodPeer::IMPTRI)) $criteria->add(FcinmmodPeer::IMPTRI, $this->imptri);
		if ($this->isColumnModified(FcinmmodPeer::ID)) $criteria->add(FcinmmodPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(FcinmmodPeer::ID, $this->id);

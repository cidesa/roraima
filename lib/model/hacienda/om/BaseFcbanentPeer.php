...
abstract class BaseFcbanentPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcbanent';
	...
	{
		include_once 'lib/model/hacienda/map/FcbanentMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcbanentMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcbanentMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcbanentMapBuilder');
}

...
abstract class BaseFcactcomHcPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.FcactcomHc';
	...
	{
		include_once 'lib/model/hacienda/map/FcactcomHcMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcactcomHcMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcactcomHcMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcactcomHcMapBuilder');
}

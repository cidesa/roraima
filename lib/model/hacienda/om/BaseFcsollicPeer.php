...
abstract class BaseFcsollicPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcsollic';
	...
	const CODTIPLIC = 'fcsollic.CODTIPLIC';

	
	const FECINILIC = 'fcsollic.FECINILIC';
	...
	{
		include_once 'lib/model/hacienda/map/FcsollicMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcsollicMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(FcsollicPeer::CODTIPLIC);

		$criteria->addSelectColumn(FcsollicPeer::FECINILIC);
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(FcsollicPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcsollicMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcsollicMapBuilder');
}

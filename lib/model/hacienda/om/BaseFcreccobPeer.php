...
abstract class BaseFcreccobPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcreccob';
	...
	{
		include_once 'lib/model/hacienda/map/FcreccobMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcreccobMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcreccobMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcreccobMapBuilder');
}

...
abstract class BaseFcretencionPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcretencion';
	...
	{
		include_once 'lib/model/hacienda/map/FcretencionMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcretencionMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcretencionMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcretencionMapBuilder');
}

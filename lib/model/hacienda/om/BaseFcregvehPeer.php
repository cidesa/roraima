...
abstract class BaseFcregvehPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcregveh';
	...
	{
		include_once 'lib/model/hacienda/map/FcregvehMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcregvehMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(FcregvehPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcregvehMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcregvehMapBuilder');
}

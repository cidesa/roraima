...
abstract class BaseFcconrepcoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcconrepco';
	...
	{
		include_once 'lib/model/hacienda/map/FcconrepcoMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcconrepcoMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcconrepcoMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcconrepcoMapBuilder');
}

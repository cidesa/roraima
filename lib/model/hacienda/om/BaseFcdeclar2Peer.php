...
abstract class BaseFcdeclar2Peer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcdeclar2';
	...
	{
		include_once 'lib/model/hacienda/map/Fcdeclar2MapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.Fcdeclar2MapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(Fcdeclar2Peer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/Fcdeclar2MapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.Fcdeclar2MapBuilder');
}

...
abstract class BaseFcmodinmPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcmodinm';
	...
	{
		include_once 'lib/model/hacienda/map/FcmodinmMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcmodinmMapBuilder');
	}
	...
	const COUNT = 'COUNT(fcmodinm.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT fcmodinm.ID)';
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(FcmodinmPeer::ID); 
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(FcmodinmPeer::ID);
			$selectCriteria->add(FcmodinmPeer::ID, $criteria->remove(FcmodinmPeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(FcmodinmPeer::ID, (array) $values, Criteria::IN);
		}
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(FcmodinmPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(FcmodinmPeer::ID, $pks, Criteria::IN);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcmodinmMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcmodinmMapBuilder');
}

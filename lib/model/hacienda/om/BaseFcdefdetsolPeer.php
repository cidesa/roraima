...
abstract class BaseFcdefdetsolPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcdefdetsol';
	...
	{
		include_once 'lib/model/hacienda/map/FcdefdetsolMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcdefdetsolMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcdefdetsolMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcdefdetsolMapBuilder');
}

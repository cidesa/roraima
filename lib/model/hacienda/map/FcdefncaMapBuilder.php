...
class FcdefncaMapBuilder {
	...
	const CLASS_NAME = 'lib.model.hacienda.map.FcdefncaMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->setPrimaryKeyMethodInfo('fcdefnca_SEQ');
		...
		$tMap->addColumn('NUMNIV', 'Numniv', 'double', CreoleTypes::NUMERIC, true, 2);
		...
		$tMap->addColumn('TAMANO1', 'Tamano1', 'double', CreoleTypes::NUMERIC, true, 1);
		...
		$tMap->addColumn('TAMANO2', 'Tamano2', 'double', CreoleTypes::NUMERIC, false, 1);
		...
		$tMap->addColumn('TAMANO3', 'Tamano3', 'double', CreoleTypes::NUMERIC, false, 1);
		...
		$tMap->addColumn('TAMANO4', 'Tamano4', 'double', CreoleTypes::NUMERIC, false, 1);
		...
		$tMap->addColumn('TAMANO5', 'Tamano5', 'double', CreoleTypes::NUMERIC, false, 1);
		...
		$tMap->addColumn('TAMANO6', 'Tamano6', 'double', CreoleTypes::NUMERIC, false, 1);
		...
		$tMap->addColumn('TAMANO7', 'Tamano7', 'double', CreoleTypes::NUMERIC, false, 1);
		...
		$tMap->addColumn('TAMANO8', 'Tamano8', 'double', CreoleTypes::NUMERIC, false, 1);
		...
		$tMap->addColumn('TAMANO9', 'Tamano9', 'double', CreoleTypes::NUMERIC, false, 1);
		...
		$tMap->addColumn('TAMANO10', 'Tamano10', 'double', CreoleTypes::NUMERIC, false, 10);

		$tMap->addColumn('NIVINM', 'Nivinm', 'string', CreoleTypes::VARCHAR, false, 2);

		$tMap->addColumn('NUMPER', 'Numper', 'double', CreoleTypes::NUMERIC, false, 3);

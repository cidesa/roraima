...
class FcmodlicMapBuilder {

	
	const CLASS_NAME = 'lib.model.hacienda.map.FcmodlicMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('fcmodlic');
		$tMap->setPhpName('Fcmodlic');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('fcmodlic_SEQ');

		$tMap->addColumn('REFMOD', 'Refmod', 'string', CreoleTypes::VARCHAR, false, 12);

		$tMap->addColumn('FECMOD', 'Fecmod', 'int', CreoleTypes::DATE, false, null);

		$tMap->addColumn('MOTMOD', 'Motmod', 'string', CreoleTypes::VARCHAR, false, 300);

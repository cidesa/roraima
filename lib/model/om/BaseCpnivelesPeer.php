...
abstract class BaseCpnivelesPeer {
	...
	{
		include_once 'lib/model/map/CpnivelesMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CpnivelesMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CpnivelesMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CpnivelesMapBuilder');
}

...
abstract class BaseFcdefdetsol extends BaseObject  implements Persistent {
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			FcdefdetsolPeer::doDelete($this, $con);
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = FcdefdetsolPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = FcdefdetsolPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = FcdefdetsolPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FcdefdetsolPeer::CODSOL)) $criteria->add(FcdefdetsolPeer::CODSOL, $this->codsol);
		if ($this->isColumnModified(FcdefdetsolPeer::TIPO)) $criteria->add(FcdefdetsolPeer::TIPO, $this->tipo);
		if ($this->isColumnModified(FcdefdetsolPeer::CUANTOS)) $criteria->add(FcdefdetsolPeer::CUANTOS, $this->cuantos);
		if ($this->isColumnModified(FcdefdetsolPeer::PROPIE)) $criteria->add(FcdefdetsolPeer::PROPIE, $this->propie);
		if ($this->isColumnModified(FcdefdetsolPeer::IMPRIM)) $criteria->add(FcdefdetsolPeer::IMPRIM, $this->imprim);
		if ($this->isColumnModified(FcdefdetsolPeer::ID)) $criteria->add(FcdefdetsolPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(FcdefdetsolPeer::ID, $this->id);

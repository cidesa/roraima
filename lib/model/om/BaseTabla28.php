...
abstract class BaseTabla28 extends BaseObject  implements Persistent {
	...
	public function setRefcau($v)
	{
		...
		if ($this->refcau !== $v) {
			$this->refcau = $v;
			$this->modifiedColumns[] = Tabla28Peer::REFCAU;
		}
	...
	public function setCodpre($v)
	{
		...
		if ($this->codpre !== $v) {
			$this->codpre = $v;
			$this->modifiedColumns[] = Tabla28Peer::CODPRE;
		}
	...
	public function setMonimp($v)
	{
		...
		if ($this->monimp !== $v) {
			$this->monimp = $v;
			$this->modifiedColumns[] = Tabla28Peer::MONIMP;
		}
	...
	public function setMonpag($v)
	{
		...
		if ($this->monpag !== $v) {
			$this->monpag = $v;
			$this->modifiedColumns[] = Tabla28Peer::MONPAG;
		}
	...
	public function setMonaju($v)
	{
		...
		if ($this->monaju !== $v) {
			$this->monaju = $v;
			$this->modifiedColumns[] = Tabla28Peer::MONAJU;
		}
	...
	public function setStaimp($v)
	{
		...
		if ($this->staimp !== $v) {
			$this->staimp = $v;
			$this->modifiedColumns[] = Tabla28Peer::STAIMP;
		}
	...
	public function setRefere($v)
	{
		...
		if ($this->refere !== $v) {
			$this->refere = $v;
			$this->modifiedColumns[] = Tabla28Peer::REFERE;
		}
	...
	public function setRefprc($v)
	{
		...
		if ($this->refprc !== $v) {
			$this->refprc = $v;
			$this->modifiedColumns[] = Tabla28Peer::REFPRC;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = Tabla28Peer::ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Tabla28 object", $e);
		}
	}
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Tabla28Peer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setNew(false);
				} else {
					$affectedRows += Tabla28Peer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Tabla28Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Tabla28Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Tabla28Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Tabla28Peer::REFCAU)) $criteria->add(Tabla28Peer::REFCAU, $this->refcau);
		if ($this->isColumnModified(Tabla28Peer::CODPRE)) $criteria->add(Tabla28Peer::CODPRE, $this->codpre);
		if ($this->isColumnModified(Tabla28Peer::MONIMP)) $criteria->add(Tabla28Peer::MONIMP, $this->monimp);
		if ($this->isColumnModified(Tabla28Peer::MONPAG)) $criteria->add(Tabla28Peer::MONPAG, $this->monpag);
		if ($this->isColumnModified(Tabla28Peer::MONAJU)) $criteria->add(Tabla28Peer::MONAJU, $this->monaju);
		if ($this->isColumnModified(Tabla28Peer::STAIMP)) $criteria->add(Tabla28Peer::STAIMP, $this->staimp);
		if ($this->isColumnModified(Tabla28Peer::REFERE)) $criteria->add(Tabla28Peer::REFERE, $this->refere);
		if ($this->isColumnModified(Tabla28Peer::REFPRC)) $criteria->add(Tabla28Peer::REFPRC, $this->refprc);
		if ($this->isColumnModified(Tabla28Peer::ID)) $criteria->add(Tabla28Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Tabla28Peer::ID, $this->id);

...
abstract class BaseNpasiconPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npasicon';
	...
	{
		include_once 'lib/model/map/NpasiconMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpasiconMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpasiconMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpasiconMapBuilder');
}

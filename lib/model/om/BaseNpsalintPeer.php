...
abstract class BaseNpsalintPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npsalint';
	...
	{
		include_once 'lib/model/map/NpsalintMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpsalintMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpsalintMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpsalintMapBuilder');
}

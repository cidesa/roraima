...
abstract class BaseCpmovajuPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Cpmovaju';
	...
	{
		include_once 'lib/model/map/CpmovajuMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CpmovajuMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CpmovajuMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CpmovajuMapBuilder');
}

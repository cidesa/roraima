...
abstract class BaseNpasiconempbckPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npasiconempbck';
	...
	{
		include_once 'lib/model/map/NpasiconempbckMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpasiconempbckMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpasiconempbckMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpasiconempbckMapBuilder');
}

...
abstract class BaseTabla2 extends BaseObject  implements Persistent {
	...
	public function setRefprc($v)
	{
		...
		if ($this->refprc !== $v) {
			$this->refprc = $v;
			$this->modifiedColumns[] = Tabla2Peer::REFPRC;
		}
	...
	public function setCodpre($v)
	{
		...
		if ($this->codpre !== $v) {
			$this->codpre = $v;
			$this->modifiedColumns[] = Tabla2Peer::CODPRE;
		}
	...
	public function setMonimp($v)
	{
		...
		if ($this->monimp !== $v) {
			$this->monimp = $v;
			$this->modifiedColumns[] = Tabla2Peer::MONIMP;
		}
	...
	public function setMoncom($v)
	{
		...
		if ($this->moncom !== $v) {
			$this->moncom = $v;
			$this->modifiedColumns[] = Tabla2Peer::MONCOM;
		}
	...
	public function setMoncau($v)
	{
		...
		if ($this->moncau !== $v) {
			$this->moncau = $v;
			$this->modifiedColumns[] = Tabla2Peer::MONCAU;
		}
	...
	public function setMonpag($v)
	{
		...
		if ($this->monpag !== $v) {
			$this->monpag = $v;
			$this->modifiedColumns[] = Tabla2Peer::MONPAG;
		}
	...
	public function setMonaju($v)
	{
		...
		if ($this->monaju !== $v) {
			$this->monaju = $v;
			$this->modifiedColumns[] = Tabla2Peer::MONAJU;
		}
	...
	public function setStaimp($v)
	{
		...
		if ($this->staimp !== $v) {
			$this->staimp = $v;
			$this->modifiedColumns[] = Tabla2Peer::STAIMP;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = Tabla2Peer::ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Tabla2 object", $e);
		}
	}
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Tabla2Peer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setNew(false);
				} else {
					$affectedRows += Tabla2Peer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Tabla2Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Tabla2Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Tabla2Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Tabla2Peer::REFPRC)) $criteria->add(Tabla2Peer::REFPRC, $this->refprc);
		if ($this->isColumnModified(Tabla2Peer::CODPRE)) $criteria->add(Tabla2Peer::CODPRE, $this->codpre);
		if ($this->isColumnModified(Tabla2Peer::MONIMP)) $criteria->add(Tabla2Peer::MONIMP, $this->monimp);
		if ($this->isColumnModified(Tabla2Peer::MONCOM)) $criteria->add(Tabla2Peer::MONCOM, $this->moncom);
		if ($this->isColumnModified(Tabla2Peer::MONCAU)) $criteria->add(Tabla2Peer::MONCAU, $this->moncau);
		if ($this->isColumnModified(Tabla2Peer::MONPAG)) $criteria->add(Tabla2Peer::MONPAG, $this->monpag);
		if ($this->isColumnModified(Tabla2Peer::MONAJU)) $criteria->add(Tabla2Peer::MONAJU, $this->monaju);
		if ($this->isColumnModified(Tabla2Peer::STAIMP)) $criteria->add(Tabla2Peer::STAIMP, $this->staimp);
		if ($this->isColumnModified(Tabla2Peer::ID)) $criteria->add(Tabla2Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Tabla2Peer::ID, $this->id);

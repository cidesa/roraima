...
abstract class BaseFcesplicdetPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcesplicdet';
	...
	{
		include_once 'lib/model/map/FcesplicdetMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcesplicdetMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcesplicdetMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcesplicdetMapBuilder');
}

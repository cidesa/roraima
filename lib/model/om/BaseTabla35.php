...
abstract class BaseTabla35 extends BaseObject  implements Persistent {
	...
	public function setRefprc($v)
	{
		...
		if ($this->refprc !== $v) {
			$this->refprc = $v;
			$this->modifiedColumns[] = Tabla35Peer::REFPRC;
		}
	...
	public function setTipprc($v)
	{
		...
		if ($this->tipprc !== $v) {
			$this->tipprc = $v;
			$this->modifiedColumns[] = Tabla35Peer::TIPPRC;
		}
	...
	public function setFecprc($v)
	{
		...
		if ($this->fecprc !== $ts) {
			$this->fecprc = $ts;
			$this->modifiedColumns[] = Tabla35Peer::FECPRC;
		}
	...
	public function setAnoprc($v)
	{
		...
		if ($this->anoprc !== $v) {
			$this->anoprc = $v;
			$this->modifiedColumns[] = Tabla35Peer::ANOPRC;
		}
	...
	public function setDesprc($v)
	{
		...
		if ($this->desprc !== $v) {
			$this->desprc = $v;
			$this->modifiedColumns[] = Tabla35Peer::DESPRC;
		}
	...
	public function setDesanu($v)
	{
		...
		if ($this->desanu !== $v) {
			$this->desanu = $v;
			$this->modifiedColumns[] = Tabla35Peer::DESANU;
		}
	...
	public function setMonprc($v)
	{
		...
		if ($this->monprc !== $v) {
			$this->monprc = $v;
			$this->modifiedColumns[] = Tabla35Peer::MONPRC;
		}
	...
	public function setSalcom($v)
	{
		...
		if ($this->salcom !== $v) {
			$this->salcom = $v;
			$this->modifiedColumns[] = Tabla35Peer::SALCOM;
		}
	...
	public function setSalcau($v)
	{
		...
		if ($this->salcau !== $v) {
			$this->salcau = $v;
			$this->modifiedColumns[] = Tabla35Peer::SALCAU;
		}
	...
	public function setSalpag($v)
	{
		...
		if ($this->salpag !== $v) {
			$this->salpag = $v;
			$this->modifiedColumns[] = Tabla35Peer::SALPAG;
		}
	...
	public function setSalaju($v)
	{
		...
		if ($this->salaju !== $v) {
			$this->salaju = $v;
			$this->modifiedColumns[] = Tabla35Peer::SALAJU;
		}
	...
	public function setStaprc($v)
	{
		...
		if ($this->staprc !== $v) {
			$this->staprc = $v;
			$this->modifiedColumns[] = Tabla35Peer::STAPRC;
		}
	...
	public function setFecanu($v)
	{
		...
		if ($this->fecanu !== $ts) {
			$this->fecanu = $ts;
			$this->modifiedColumns[] = Tabla35Peer::FECANU;
		}
	...
	public function setCedrif($v)
	{
		...
		if ($this->cedrif !== $v) {
			$this->cedrif = $v;
			$this->modifiedColumns[] = Tabla35Peer::CEDRIF;
		}
	...
	public function setRefsol($v)
	{
		...
		if ($this->refsol !== $v) {
			$this->refsol = $v;
			$this->modifiedColumns[] = Tabla35Peer::REFSOL;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = Tabla35Peer::ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Tabla35 object", $e);
		}
	}
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Tabla35Peer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setNew(false);
				} else {
					$affectedRows += Tabla35Peer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Tabla35Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Tabla35Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Tabla35Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Tabla35Peer::REFPRC)) $criteria->add(Tabla35Peer::REFPRC, $this->refprc);
		if ($this->isColumnModified(Tabla35Peer::TIPPRC)) $criteria->add(Tabla35Peer::TIPPRC, $this->tipprc);
		if ($this->isColumnModified(Tabla35Peer::FECPRC)) $criteria->add(Tabla35Peer::FECPRC, $this->fecprc);
		if ($this->isColumnModified(Tabla35Peer::ANOPRC)) $criteria->add(Tabla35Peer::ANOPRC, $this->anoprc);
		if ($this->isColumnModified(Tabla35Peer::DESPRC)) $criteria->add(Tabla35Peer::DESPRC, $this->desprc);
		if ($this->isColumnModified(Tabla35Peer::DESANU)) $criteria->add(Tabla35Peer::DESANU, $this->desanu);
		if ($this->isColumnModified(Tabla35Peer::MONPRC)) $criteria->add(Tabla35Peer::MONPRC, $this->monprc);
		if ($this->isColumnModified(Tabla35Peer::SALCOM)) $criteria->add(Tabla35Peer::SALCOM, $this->salcom);
		if ($this->isColumnModified(Tabla35Peer::SALCAU)) $criteria->add(Tabla35Peer::SALCAU, $this->salcau);
		if ($this->isColumnModified(Tabla35Peer::SALPAG)) $criteria->add(Tabla35Peer::SALPAG, $this->salpag);
		if ($this->isColumnModified(Tabla35Peer::SALAJU)) $criteria->add(Tabla35Peer::SALAJU, $this->salaju);
		if ($this->isColumnModified(Tabla35Peer::STAPRC)) $criteria->add(Tabla35Peer::STAPRC, $this->staprc);
		if ($this->isColumnModified(Tabla35Peer::FECANU)) $criteria->add(Tabla35Peer::FECANU, $this->fecanu);
		if ($this->isColumnModified(Tabla35Peer::CEDRIF)) $criteria->add(Tabla35Peer::CEDRIF, $this->cedrif);
		if ($this->isColumnModified(Tabla35Peer::REFSOL)) $criteria->add(Tabla35Peer::REFSOL, $this->refsol);
		if ($this->isColumnModified(Tabla35Peer::ID)) $criteria->add(Tabla35Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Tabla35Peer::ID, $this->id);

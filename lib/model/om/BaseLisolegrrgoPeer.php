...
abstract class BaseLisolegrrgoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Lisolegrrgo';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Numsol', 'Codcat', 'Codart', 'Codrgo', 'Monrgo', 'Codpre', 'Id', ),
		BasePeer::TYPE_COLNAME => array (LisolegrrgoPeer::NUMSOL, LisolegrrgoPeer::CODCAT, LisolegrrgoPeer::CODART, LisolegrrgoPeer::CODRGO, LisolegrrgoPeer::MONRGO, LisolegrrgoPeer::CODPRE, LisolegrrgoPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('numsol', 'codcat', 'codart', 'codrgo', 'monrgo', 'codpre', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Numsol' => 0, 'Codcat' => 1, 'Codart' => 2, 'Codrgo' => 3, 'Monrgo' => 4, 'Codpre' => 5, 'Id' => 6, ),
		BasePeer::TYPE_COLNAME => array (LisolegrrgoPeer::NUMSOL => 0, LisolegrrgoPeer::CODCAT => 1, LisolegrrgoPeer::CODART => 2, LisolegrrgoPeer::CODRGO => 3, LisolegrrgoPeer::MONRGO => 4, LisolegrrgoPeer::CODPRE => 5, LisolegrrgoPeer::ID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('numsol' => 0, 'codcat' => 1, 'codart' => 2, 'codrgo' => 3, 'monrgo' => 4, 'codpre' => 5, 'id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	{
		include_once 'lib/model/map/LisolegrrgoMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.LisolegrrgoMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/LisolegrrgoMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.LisolegrrgoMapBuilder');
}

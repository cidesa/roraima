...
abstract class BaseFcdetinmPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcdetinm';
	...
	{
		include_once 'lib/model/map/FcdetinmMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcdetinmMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcdetinmMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcdetinmMapBuilder');
}

...
abstract class BaseAtreclamosPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Atreclamos';
	...
	{
		include_once 'lib/model/map/AtreclamosMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.AtreclamosMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/AtreclamosMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.AtreclamosMapBuilder');
}

...
abstract class BaseFcconrepresp extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->cedcon !== $v) {
        $this->cedcon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::CEDCON;
      }
    ...
    if ($this->rifcon !== $v) {
        $this->rifcon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::RIFCON;
      }
    ...
    if ($this->nomcon !== $v) {
        $this->nomcon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::NOMCON;
      }
    ...
    if ($this->repcon !== $v) {
        $this->repcon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::REPCON;
      }
    ...
    if ($this->dircon !== $v) {
        $this->dircon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::DIRCON;
      }
    ...
    if ($this->telcon !== $v) {
        $this->telcon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::TELCON;
      }
    ...
    if ($this->emacon !== $v) {
        $this->emacon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::EMACON;
      }
    ...
    if ($this->codsec !== $v) {
        $this->codsec = $v;
        $this->modifiedColumns[] = FcconreprespPeer::CODSEC;
      }
    ...
    if ($this->codpar !== $v) {
        $this->codpar = $v;
        $this->modifiedColumns[] = FcconreprespPeer::CODPAR;
      }
    ...
    if ($this->nitcon !== $v) {
        $this->nitcon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::NITCON;
      }
    ...
    if ($this->codmun !== $v) {
        $this->codmun = $v;
        $this->modifiedColumns[] = FcconreprespPeer::CODMUN;
      }
    ...
    if ($this->codedo !== $v) {
        $this->codedo = $v;
        $this->modifiedColumns[] = FcconreprespPeer::CODEDO;
      }
    ...
    if ($this->codpai !== $v) {
        $this->codpai = $v;
        $this->modifiedColumns[] = FcconreprespPeer::CODPAI;
      }
    ...
    if ($this->ciucon !== $v) {
        $this->ciucon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::CIUCON;
      }
    ...
    if ($this->cpocon !== $v) {
        $this->cpocon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::CPOCON;
      }
    ...
    if ($this->apocon !== $v) {
        $this->apocon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::APOCON;
      }
    ...
    if ($this->urlcon !== $v) {
        $this->urlcon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::URLCON;
      }
    ...
    if ($this->naccon !== $v) {
        $this->naccon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::NACCON;
      }
    ...
    if ($this->tipcon !== $v) {
        $this->tipcon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::TIPCON;
      }
    ...
    if ($this->faxcon !== $v) {
        $this->faxcon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::FAXCON;
      }
    ...
    if ($this->clacon !== $v) {
        $this->clacon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::CLACON;
      }
    ...
    if ($this->fecdescon !== $ts) {
      $this->fecdescon = $ts;
      $this->modifiedColumns[] = FcconreprespPeer::FECDESCON;
    }
    ...
    if ($this->fecactcon !== $ts) {
      $this->fecactcon = $ts;
      $this->modifiedColumns[] = FcconreprespPeer::FECACTCON;
    }
    ...
    if ($this->stacon !== $v) {
        $this->stacon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::STACON;
      }
    ...
    if ($this->origen !== $v) {
        $this->origen = $v;
        $this->modifiedColumns[] = FcconreprespPeer::ORIGEN;
      }
    ...
    if ($this->nomneg !== $v) {
        $this->nomneg = $v;
        $this->modifiedColumns[] = FcconreprespPeer::NOMNEG;
      }
    ...
    if ($this->reccon !== $v) {
        $this->reccon = $v;
        $this->modifiedColumns[] = FcconreprespPeer::RECCON;
      }
    ...
    if ($this->tem !== $v) {
        ...
        $this->modifiedColumns[] = FcconreprespPeer::TEM;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = FcconreprespPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Fcconrepresp object", $e);
    }
  }
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			FcconreprespPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = FcconreprespPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += FcconreprespPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = FcconreprespPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = FcconreprespPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = FcconreprespPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FcconreprespPeer::CEDCON)) $criteria->add(FcconreprespPeer::CEDCON, $this->cedcon);
		if ($this->isColumnModified(FcconreprespPeer::RIFCON)) $criteria->add(FcconreprespPeer::RIFCON, $this->rifcon);
		if ($this->isColumnModified(FcconreprespPeer::NOMCON)) $criteria->add(FcconreprespPeer::NOMCON, $this->nomcon);
		if ($this->isColumnModified(FcconreprespPeer::REPCON)) $criteria->add(FcconreprespPeer::REPCON, $this->repcon);
		if ($this->isColumnModified(FcconreprespPeer::DIRCON)) $criteria->add(FcconreprespPeer::DIRCON, $this->dircon);
		if ($this->isColumnModified(FcconreprespPeer::TELCON)) $criteria->add(FcconreprespPeer::TELCON, $this->telcon);
		if ($this->isColumnModified(FcconreprespPeer::EMACON)) $criteria->add(FcconreprespPeer::EMACON, $this->emacon);
		if ($this->isColumnModified(FcconreprespPeer::CODSEC)) $criteria->add(FcconreprespPeer::CODSEC, $this->codsec);
		if ($this->isColumnModified(FcconreprespPeer::CODPAR)) $criteria->add(FcconreprespPeer::CODPAR, $this->codpar);
		if ($this->isColumnModified(FcconreprespPeer::NITCON)) $criteria->add(FcconreprespPeer::NITCON, $this->nitcon);
		if ($this->isColumnModified(FcconreprespPeer::CODMUN)) $criteria->add(FcconreprespPeer::CODMUN, $this->codmun);
		if ($this->isColumnModified(FcconreprespPeer::CODEDO)) $criteria->add(FcconreprespPeer::CODEDO, $this->codedo);
		if ($this->isColumnModified(FcconreprespPeer::CODPAI)) $criteria->add(FcconreprespPeer::CODPAI, $this->codpai);
		if ($this->isColumnModified(FcconreprespPeer::CIUCON)) $criteria->add(FcconreprespPeer::CIUCON, $this->ciucon);
		if ($this->isColumnModified(FcconreprespPeer::CPOCON)) $criteria->add(FcconreprespPeer::CPOCON, $this->cpocon);
		if ($this->isColumnModified(FcconreprespPeer::APOCON)) $criteria->add(FcconreprespPeer::APOCON, $this->apocon);
		if ($this->isColumnModified(FcconreprespPeer::URLCON)) $criteria->add(FcconreprespPeer::URLCON, $this->urlcon);
		if ($this->isColumnModified(FcconreprespPeer::NACCON)) $criteria->add(FcconreprespPeer::NACCON, $this->naccon);
		if ($this->isColumnModified(FcconreprespPeer::TIPCON)) $criteria->add(FcconreprespPeer::TIPCON, $this->tipcon);
		if ($this->isColumnModified(FcconreprespPeer::FAXCON)) $criteria->add(FcconreprespPeer::FAXCON, $this->faxcon);
		if ($this->isColumnModified(FcconreprespPeer::CLACON)) $criteria->add(FcconreprespPeer::CLACON, $this->clacon);
		if ($this->isColumnModified(FcconreprespPeer::FECDESCON)) $criteria->add(FcconreprespPeer::FECDESCON, $this->fecdescon);
		if ($this->isColumnModified(FcconreprespPeer::FECACTCON)) $criteria->add(FcconreprespPeer::FECACTCON, $this->fecactcon);
		if ($this->isColumnModified(FcconreprespPeer::STACON)) $criteria->add(FcconreprespPeer::STACON, $this->stacon);
		if ($this->isColumnModified(FcconreprespPeer::ORIGEN)) $criteria->add(FcconreprespPeer::ORIGEN, $this->origen);
		if ($this->isColumnModified(FcconreprespPeer::NOMNEG)) $criteria->add(FcconreprespPeer::NOMNEG, $this->nomneg);
		if ($this->isColumnModified(FcconreprespPeer::RECCON)) $criteria->add(FcconreprespPeer::RECCON, $this->reccon);
		if ($this->isColumnModified(FcconreprespPeer::TEM)) $criteria->add(FcconreprespPeer::TEM, $this->tem);
		if ($this->isColumnModified(FcconreprespPeer::ID)) $criteria->add(FcconreprespPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(FcconreprespPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new FcconreprespPeer();
		}
		return self::$peer;
	}

...
abstract class BaseForniveles extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->catpar !== $v) {
        $this->catpar = $v;
        $this->modifiedColumns[] = FornivelesPeer::CATPAR;
      }
    ...
    if ($this->consec !== $v) {
        ...
        $this->modifiedColumns[] = FornivelesPeer::CONSEC;
      }
    ...
    if ($this->nomabr !== $v) {
        $this->nomabr = $v;
        $this->modifiedColumns[] = FornivelesPeer::NOMABR;
      }
    ...
    if ($this->nomext !== $v) {
        $this->nomext = $v;
        $this->modifiedColumns[] = FornivelesPeer::NOMEXT;
      }
    ...
    if ($this->lonniv !== $v) {
        ...
        $this->modifiedColumns[] = FornivelesPeer::LONNIV;
      }
    ...
    if ($this->staniv !== $v) {
        $this->staniv = $v;
        $this->modifiedColumns[] = FornivelesPeer::STANIV;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = FornivelesPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Forniveles object", $e);
    }
  }
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			FornivelesPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = FornivelesPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += FornivelesPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = FornivelesPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = FornivelesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = FornivelesPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(FornivelesPeer::CATPAR)) $criteria->add(FornivelesPeer::CATPAR, $this->catpar);
		if ($this->isColumnModified(FornivelesPeer::CONSEC)) $criteria->add(FornivelesPeer::CONSEC, $this->consec);
		if ($this->isColumnModified(FornivelesPeer::NOMABR)) $criteria->add(FornivelesPeer::NOMABR, $this->nomabr);
		if ($this->isColumnModified(FornivelesPeer::NOMEXT)) $criteria->add(FornivelesPeer::NOMEXT, $this->nomext);
		if ($this->isColumnModified(FornivelesPeer::LONNIV)) $criteria->add(FornivelesPeer::LONNIV, $this->lonniv);
		if ($this->isColumnModified(FornivelesPeer::STANIV)) $criteria->add(FornivelesPeer::STANIV, $this->staniv);
		if ($this->isColumnModified(FornivelesPeer::ID)) $criteria->add(FornivelesPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(FornivelesPeer::ID, $this->id);

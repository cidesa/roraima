...
abstract class BaseLiccomresPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Liccomres';
	...
	{
		include_once 'lib/model/map/LiccomresMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.LiccomresMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/LiccomresMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.LiccomresMapBuilder');
}

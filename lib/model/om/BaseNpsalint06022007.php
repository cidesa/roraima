...
abstract class BaseNpsalint06022007 extends BaseObject  implements Persistent {
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			Npsalint06022007Peer::doDelete($this, $con);
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Npsalint06022007Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Npsalint06022007Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Npsalint06022007Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Npsalint06022007Peer::CODCON)) $criteria->add(Npsalint06022007Peer::CODCON, $this->codcon);
		if ($this->isColumnModified(Npsalint06022007Peer::CODEMP)) $criteria->add(Npsalint06022007Peer::CODEMP, $this->codemp);
		if ($this->isColumnModified(Npsalint06022007Peer::CODASI)) $criteria->add(Npsalint06022007Peer::CODASI, $this->codasi);
		if ($this->isColumnModified(Npsalint06022007Peer::MONASI)) $criteria->add(Npsalint06022007Peer::MONASI, $this->monasi);
		if ($this->isColumnModified(Npsalint06022007Peer::FECINICON)) $criteria->add(Npsalint06022007Peer::FECINICON, $this->fecinicon);
		if ($this->isColumnModified(Npsalint06022007Peer::FECFINCON)) $criteria->add(Npsalint06022007Peer::FECFINCON, $this->fecfincon);
		if ($this->isColumnModified(Npsalint06022007Peer::ID)) $criteria->add(Npsalint06022007Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Npsalint06022007Peer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new Npsalint06022007Peer();
		}
		return self::$peer;
	}

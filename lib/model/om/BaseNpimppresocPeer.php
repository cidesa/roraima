...
abstract class BaseNpimppresocPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npimppresoc';
	...
	{
		include_once 'lib/model/map/NpimppresocMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpimppresocMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpimppresocMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpimppresocMapBuilder');
}

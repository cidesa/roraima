...
abstract class BaseNpasicodprePeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npasicodpre';
	...
	{
		include_once 'lib/model/map/NpasicodpreMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpasicodpreMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpasicodpreMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpasicodpreMapBuilder');
}

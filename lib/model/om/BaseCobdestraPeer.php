...
abstract class BaseCobdestraPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Numtra', 'Refdoc', 'Codcli', 'Coddes', 'Fecdes', 'Mondes', 'Id', ),
		BasePeer::TYPE_COLNAME => array (CobdestraPeer::NUMTRA, CobdestraPeer::REFDOC, CobdestraPeer::CODCLI, CobdestraPeer::CODDES, CobdestraPeer::FECDES, CobdestraPeer::MONDES, CobdestraPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('numtra', 'refdoc', 'codcli', 'coddes', 'fecdes', 'mondes', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Numtra' => 0, 'Refdoc' => 1, 'Codcli' => 2, 'Coddes' => 3, 'Fecdes' => 4, 'Mondes' => 5, 'Id' => 6, ),
		BasePeer::TYPE_COLNAME => array (CobdestraPeer::NUMTRA => 0, CobdestraPeer::REFDOC => 1, CobdestraPeer::CODCLI => 2, CobdestraPeer::CODDES => 3, CobdestraPeer::FECDES => 4, CobdestraPeer::MONDES => 5, CobdestraPeer::ID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('numtra' => 0, 'refdoc' => 1, 'codcli' => 2, 'coddes' => 3, 'fecdes' => 4, 'mondes' => 5, 'id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);

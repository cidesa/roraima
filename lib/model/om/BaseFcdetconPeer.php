...
abstract class BaseFcdetconPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcdetcon';
	...
	{
		include_once 'lib/model/map/FcdetconMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcdetconMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcdetconMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcdetconMapBuilder');
}

...
abstract class BaseFcinmcomPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcinmcom';
	...
	{
		include_once 'lib/model/map/FcinmcomMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcinmcomMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcinmcomMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcinmcomMapBuilder');
}

...
abstract class BaseNpexplabPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npexplab';
	...
	{
		include_once 'lib/model/map/NpexplabMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpexplabMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpexplabMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpexplabMapBuilder');
}

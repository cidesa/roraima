...
abstract class BaseNpaccadmPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npaccadm';
	...
	{
		include_once 'lib/model/map/NpaccadmMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpaccadmMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpaccadmMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpaccadmMapBuilder');
}

...
abstract class BaseNpdisccestaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npdisccesta';
	...
	{
		include_once 'lib/model/map/NpdisccestaMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpdisccestaMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpdisccestaMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpdisccestaMapBuilder');
}

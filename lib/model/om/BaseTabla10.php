...
abstract class BaseTabla10 extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->refcom !== $v) {
        $this->refcom = $v;
        $this->modifiedColumns[] = Tabla10Peer::REFCOM;
      }
    ...
    if ($this->tipcom !== $v) {
        $this->tipcom = $v;
        $this->modifiedColumns[] = Tabla10Peer::TIPCOM;
      }
    ...
    if ($this->feccom !== $ts) {
      $this->feccom = $ts;
      $this->modifiedColumns[] = Tabla10Peer::FECCOM;
    }
    ...
    if ($this->anocom !== $v) {
        $this->anocom = $v;
        $this->modifiedColumns[] = Tabla10Peer::ANOCOM;
      }
    ...
    if ($this->refprc !== $v) {
        $this->refprc = $v;
        $this->modifiedColumns[] = Tabla10Peer::REFPRC;
      }
    ...
    if ($this->tipprc !== $v) {
        $this->tipprc = $v;
        $this->modifiedColumns[] = Tabla10Peer::TIPPRC;
      }
    ...
    if ($this->descom !== $v) {
        $this->descom = $v;
        $this->modifiedColumns[] = Tabla10Peer::DESCOM;
      }
    ...
    if ($this->desanu !== $v) {
        $this->desanu = $v;
        $this->modifiedColumns[] = Tabla10Peer::DESANU;
      }
    ...
    if ($this->moncom !== $v) {
        ...
        $this->modifiedColumns[] = Tabla10Peer::MONCOM;
      }
    ...
    if ($this->salcau !== $v) {
        ...
        $this->modifiedColumns[] = Tabla10Peer::SALCAU;
      }
    ...
    if ($this->salpag !== $v) {
        ...
        $this->modifiedColumns[] = Tabla10Peer::SALPAG;
      }
    ...
    if ($this->salaju !== $v) {
        ...
        $this->modifiedColumns[] = Tabla10Peer::SALAJU;
      }
    ...
    if ($this->stacom !== $v) {
        $this->stacom = $v;
        $this->modifiedColumns[] = Tabla10Peer::STACOM;
      }
    ...
    if ($this->fecanu !== $ts) {
      $this->fecanu = $ts;
      $this->modifiedColumns[] = Tabla10Peer::FECANU;
    }
    ...
    if ($this->cedrif !== $v) {
        $this->cedrif = $v;
        $this->modifiedColumns[] = Tabla10Peer::CEDRIF;
      }
    ...
    if ($this->tipo !== $v) {
        $this->tipo = $v;
        $this->modifiedColumns[] = Tabla10Peer::TIPO;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = Tabla10Peer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Tabla10 object", $e);
    }
  }
  ...
  public function __call($m, $a)
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Tabla10Peer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += Tabla10Peer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Tabla10Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Tabla10Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Tabla10Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Tabla10Peer::REFCOM)) $criteria->add(Tabla10Peer::REFCOM, $this->refcom);
		if ($this->isColumnModified(Tabla10Peer::TIPCOM)) $criteria->add(Tabla10Peer::TIPCOM, $this->tipcom);
		if ($this->isColumnModified(Tabla10Peer::FECCOM)) $criteria->add(Tabla10Peer::FECCOM, $this->feccom);
		if ($this->isColumnModified(Tabla10Peer::ANOCOM)) $criteria->add(Tabla10Peer::ANOCOM, $this->anocom);
		if ($this->isColumnModified(Tabla10Peer::REFPRC)) $criteria->add(Tabla10Peer::REFPRC, $this->refprc);
		if ($this->isColumnModified(Tabla10Peer::TIPPRC)) $criteria->add(Tabla10Peer::TIPPRC, $this->tipprc);
		if ($this->isColumnModified(Tabla10Peer::DESCOM)) $criteria->add(Tabla10Peer::DESCOM, $this->descom);
		if ($this->isColumnModified(Tabla10Peer::DESANU)) $criteria->add(Tabla10Peer::DESANU, $this->desanu);
		if ($this->isColumnModified(Tabla10Peer::MONCOM)) $criteria->add(Tabla10Peer::MONCOM, $this->moncom);
		if ($this->isColumnModified(Tabla10Peer::SALCAU)) $criteria->add(Tabla10Peer::SALCAU, $this->salcau);
		if ($this->isColumnModified(Tabla10Peer::SALPAG)) $criteria->add(Tabla10Peer::SALPAG, $this->salpag);
		if ($this->isColumnModified(Tabla10Peer::SALAJU)) $criteria->add(Tabla10Peer::SALAJU, $this->salaju);
		if ($this->isColumnModified(Tabla10Peer::STACOM)) $criteria->add(Tabla10Peer::STACOM, $this->stacom);
		if ($this->isColumnModified(Tabla10Peer::FECANU)) $criteria->add(Tabla10Peer::FECANU, $this->fecanu);
		if ($this->isColumnModified(Tabla10Peer::CEDRIF)) $criteria->add(Tabla10Peer::CEDRIF, $this->cedrif);
		if ($this->isColumnModified(Tabla10Peer::TIPO)) $criteria->add(Tabla10Peer::TIPO, $this->tipo);
		if ($this->isColumnModified(Tabla10Peer::ID)) $criteria->add(Tabla10Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Tabla10Peer::ID, $this->id);

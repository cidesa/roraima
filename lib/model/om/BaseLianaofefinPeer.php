...
abstract class BaseLianaofefinPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Lianaofefin';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (LianaofefinPeer::NUMANAOFE, LianaofefinPeer::CODCRI, LianaofefinPeer::PUNEMP, LianaofefinPeer::POREMP, LianaofefinPeer::OBSERV, LianaofefinPeer::ID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (LianaofefinPeer::NUMANAOFE => 0, LianaofefinPeer::CODCRI => 1, LianaofefinPeer::PUNEMP => 2, LianaofefinPeer::POREMP => 3, LianaofefinPeer::OBSERV => 4, LianaofefinPeer::ID => 5, ),
	...
	{
		include_once 'lib/model/map/LianaofefinMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.LianaofefinMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/LianaofefinMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.LianaofefinMapBuilder');
}

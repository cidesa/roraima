...
abstract class BaseAtdetayuPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Atdetayu';
	...
	{
		include_once 'lib/model/map/AtdetayuMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.AtdetayuMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/AtdetayuMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.AtdetayuMapBuilder');
}

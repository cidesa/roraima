...
abstract class BaseContabb1Temp extends BaseObject  implements Persistent {
	...
	public function setCodcta($v)
	{
		...
		if ($this->codcta !== $v) {
			$this->codcta = $v;
			$this->modifiedColumns[] = Contabb1TempPeer::CODCTA;
		}
	...
	public function setFecini($v)
	{
		...
		if ($this->fecini !== $ts) {
			$this->fecini = $ts;
			$this->modifiedColumns[] = Contabb1TempPeer::FECINI;
		}
	...
	public function setFeccie($v)
	{
		...
		if ($this->feccie !== $ts) {
			$this->feccie = $ts;
			$this->modifiedColumns[] = Contabb1TempPeer::FECCIE;
		}
	...
	public function setPereje($v)
	{
		...
		if ($this->pereje !== $v) {
			$this->pereje = $v;
			$this->modifiedColumns[] = Contabb1TempPeer::PEREJE;
		}
	...
	public function setTotdeb($v)
	{
		...
		if ($this->totdeb !== $v) {
			$this->totdeb = $v;
			$this->modifiedColumns[] = Contabb1TempPeer::TOTDEB;
		}
	...
	public function setTotcre($v)
	{
		...
		if ($this->totcre !== $v) {
			$this->totcre = $v;
			$this->modifiedColumns[] = Contabb1TempPeer::TOTCRE;
		}
	...
	public function setSalact($v)
	{
		...
		if ($this->salact !== $v) {
			$this->salact = $v;
			$this->modifiedColumns[] = Contabb1TempPeer::SALACT;
		}
	...
	public function setSalprgper($v)
	{
		...
		if ($this->salprgper !== $v) {
			$this->salprgper = $v;
			$this->modifiedColumns[] = Contabb1TempPeer::SALPRGPER;
		}
	...
	public function setSalprgperfor($v)
	{
		...
		if ($this->salprgperfor !== $v) {
			$this->salprgperfor = $v;
			$this->modifiedColumns[] = Contabb1TempPeer::SALPRGPERFOR;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = Contabb1TempPeer::ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Contabb1Temp object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			Contabb1TempPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Contabb1TempPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setNew(false);
				} else {
					$affectedRows += Contabb1TempPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Contabb1TempPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Contabb1TempPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Contabb1TempPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Contabb1TempPeer::CODCTA)) $criteria->add(Contabb1TempPeer::CODCTA, $this->codcta);
		if ($this->isColumnModified(Contabb1TempPeer::FECINI)) $criteria->add(Contabb1TempPeer::FECINI, $this->fecini);
		if ($this->isColumnModified(Contabb1TempPeer::FECCIE)) $criteria->add(Contabb1TempPeer::FECCIE, $this->feccie);
		if ($this->isColumnModified(Contabb1TempPeer::PEREJE)) $criteria->add(Contabb1TempPeer::PEREJE, $this->pereje);
		if ($this->isColumnModified(Contabb1TempPeer::TOTDEB)) $criteria->add(Contabb1TempPeer::TOTDEB, $this->totdeb);
		if ($this->isColumnModified(Contabb1TempPeer::TOTCRE)) $criteria->add(Contabb1TempPeer::TOTCRE, $this->totcre);
		if ($this->isColumnModified(Contabb1TempPeer::SALACT)) $criteria->add(Contabb1TempPeer::SALACT, $this->salact);
		if ($this->isColumnModified(Contabb1TempPeer::SALPRGPER)) $criteria->add(Contabb1TempPeer::SALPRGPER, $this->salprgper);
		if ($this->isColumnModified(Contabb1TempPeer::SALPRGPERFOR)) $criteria->add(Contabb1TempPeer::SALPRGPERFOR, $this->salprgperfor);
		if ($this->isColumnModified(Contabb1TempPeer::ID)) $criteria->add(Contabb1TempPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Contabb1TempPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new Contabb1TempPeer();
		}
		return self::$peer;
	}

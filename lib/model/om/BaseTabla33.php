...
abstract class BaseTabla33 extends BaseObject  implements Persistent {
	...
	public function setRefcom($v)
	{
		...
		if ($this->refcom !== $v) {
			$this->refcom = $v;
			$this->modifiedColumns[] = Tabla33Peer::REFCOM;
		}
	...
	public function setTipcom($v)
	{
		...
		if ($this->tipcom !== $v) {
			$this->tipcom = $v;
			$this->modifiedColumns[] = Tabla33Peer::TIPCOM;
		}
	...
	public function setFeccom($v)
	{
		...
		if ($this->feccom !== $ts) {
			$this->feccom = $ts;
			$this->modifiedColumns[] = Tabla33Peer::FECCOM;
		}
	...
	public function setAnocom($v)
	{
		...
		if ($this->anocom !== $v) {
			$this->anocom = $v;
			$this->modifiedColumns[] = Tabla33Peer::ANOCOM;
		}
	...
	public function setRefprc($v)
	{
		...
		if ($this->refprc !== $v) {
			$this->refprc = $v;
			$this->modifiedColumns[] = Tabla33Peer::REFPRC;
		}
	...
	public function setTipprc($v)
	{
		...
		if ($this->tipprc !== $v) {
			$this->tipprc = $v;
			$this->modifiedColumns[] = Tabla33Peer::TIPPRC;
		}
	...
	public function setDescom($v)
	{
		...
		if ($this->descom !== $v) {
			$this->descom = $v;
			$this->modifiedColumns[] = Tabla33Peer::DESCOM;
		}
	...
	public function setDesanu($v)
	{
		...
		if ($this->desanu !== $v) {
			$this->desanu = $v;
			$this->modifiedColumns[] = Tabla33Peer::DESANU;
		}
	...
	public function setMoncom($v)
	{
		...
		if ($this->moncom !== $v) {
			$this->moncom = $v;
			$this->modifiedColumns[] = Tabla33Peer::MONCOM;
		}
	...
	public function setSalcau($v)
	{
		...
		if ($this->salcau !== $v) {
			$this->salcau = $v;
			$this->modifiedColumns[] = Tabla33Peer::SALCAU;
		}
	...
	public function setSalpag($v)
	{
		...
		if ($this->salpag !== $v) {
			$this->salpag = $v;
			$this->modifiedColumns[] = Tabla33Peer::SALPAG;
		}
	...
	public function setSalaju($v)
	{
		...
		if ($this->salaju !== $v) {
			$this->salaju = $v;
			$this->modifiedColumns[] = Tabla33Peer::SALAJU;
		}
	...
	public function setStacom($v)
	{
		...
		if ($this->stacom !== $v) {
			$this->stacom = $v;
			$this->modifiedColumns[] = Tabla33Peer::STACOM;
		}
	...
	public function setFecanu($v)
	{
		...
		if ($this->fecanu !== $ts) {
			$this->fecanu = $ts;
			$this->modifiedColumns[] = Tabla33Peer::FECANU;
		}
	...
	public function setCedrif($v)
	{
		...
		if ($this->cedrif !== $v) {
			$this->cedrif = $v;
			$this->modifiedColumns[] = Tabla33Peer::CEDRIF;
		}
	...
	public function setTipo($v)
	{
		...
		if ($this->tipo !== $v) {
			$this->tipo = $v;
			$this->modifiedColumns[] = Tabla33Peer::TIPO;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = Tabla33Peer::ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Tabla33 object", $e);
		}
	}
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Tabla33Peer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setNew(false);
				} else {
					$affectedRows += Tabla33Peer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Tabla33Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Tabla33Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Tabla33Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Tabla33Peer::REFCOM)) $criteria->add(Tabla33Peer::REFCOM, $this->refcom);
		if ($this->isColumnModified(Tabla33Peer::TIPCOM)) $criteria->add(Tabla33Peer::TIPCOM, $this->tipcom);
		if ($this->isColumnModified(Tabla33Peer::FECCOM)) $criteria->add(Tabla33Peer::FECCOM, $this->feccom);
		if ($this->isColumnModified(Tabla33Peer::ANOCOM)) $criteria->add(Tabla33Peer::ANOCOM, $this->anocom);
		if ($this->isColumnModified(Tabla33Peer::REFPRC)) $criteria->add(Tabla33Peer::REFPRC, $this->refprc);
		if ($this->isColumnModified(Tabla33Peer::TIPPRC)) $criteria->add(Tabla33Peer::TIPPRC, $this->tipprc);
		if ($this->isColumnModified(Tabla33Peer::DESCOM)) $criteria->add(Tabla33Peer::DESCOM, $this->descom);
		if ($this->isColumnModified(Tabla33Peer::DESANU)) $criteria->add(Tabla33Peer::DESANU, $this->desanu);
		if ($this->isColumnModified(Tabla33Peer::MONCOM)) $criteria->add(Tabla33Peer::MONCOM, $this->moncom);
		if ($this->isColumnModified(Tabla33Peer::SALCAU)) $criteria->add(Tabla33Peer::SALCAU, $this->salcau);
		if ($this->isColumnModified(Tabla33Peer::SALPAG)) $criteria->add(Tabla33Peer::SALPAG, $this->salpag);
		if ($this->isColumnModified(Tabla33Peer::SALAJU)) $criteria->add(Tabla33Peer::SALAJU, $this->salaju);
		if ($this->isColumnModified(Tabla33Peer::STACOM)) $criteria->add(Tabla33Peer::STACOM, $this->stacom);
		if ($this->isColumnModified(Tabla33Peer::FECANU)) $criteria->add(Tabla33Peer::FECANU, $this->fecanu);
		if ($this->isColumnModified(Tabla33Peer::CEDRIF)) $criteria->add(Tabla33Peer::CEDRIF, $this->cedrif);
		if ($this->isColumnModified(Tabla33Peer::TIPO)) $criteria->add(Tabla33Peer::TIPO, $this->tipo);
		if ($this->isColumnModified(Tabla33Peer::ID)) $criteria->add(Tabla33Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Tabla33Peer::ID, $this->id);

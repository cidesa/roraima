...
abstract class BaseTabla7 extends BaseObject  implements Persistent {
	...
	public function setRefprc($v)
	{
		...
		if ($this->refprc !== $v) {
			$this->refprc = $v;
			$this->modifiedColumns[] = Tabla7Peer::REFPRC;
		}
	...
	public function setCodpre($v)
	{
		...
		if ($this->codpre !== $v) {
			$this->codpre = $v;
			$this->modifiedColumns[] = Tabla7Peer::CODPRE;
		}
	...
	public function setMonimp($v)
	{
		...
		if ($this->monimp !== $v) {
			$this->monimp = $v;
			$this->modifiedColumns[] = Tabla7Peer::MONIMP;
		}
	...
	public function setMoncom($v)
	{
		...
		if ($this->moncom !== $v) {
			$this->moncom = $v;
			$this->modifiedColumns[] = Tabla7Peer::MONCOM;
		}
	...
	public function setMoncau($v)
	{
		...
		if ($this->moncau !== $v) {
			$this->moncau = $v;
			$this->modifiedColumns[] = Tabla7Peer::MONCAU;
		}
	...
	public function setMonpag($v)
	{
		...
		if ($this->monpag !== $v) {
			$this->monpag = $v;
			$this->modifiedColumns[] = Tabla7Peer::MONPAG;
		}
	...
	public function setMonaju($v)
	{
		...
		if ($this->monaju !== $v) {
			$this->monaju = $v;
			$this->modifiedColumns[] = Tabla7Peer::MONAJU;
		}
	...
	public function setStaimp($v)
	{
		...
		if ($this->staimp !== $v) {
			$this->staimp = $v;
			$this->modifiedColumns[] = Tabla7Peer::STAIMP;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = Tabla7Peer::ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Tabla7 object", $e);
		}
	}
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Tabla7Peer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setNew(false);
				} else {
					$affectedRows += Tabla7Peer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Tabla7Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Tabla7Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Tabla7Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Tabla7Peer::REFPRC)) $criteria->add(Tabla7Peer::REFPRC, $this->refprc);
		if ($this->isColumnModified(Tabla7Peer::CODPRE)) $criteria->add(Tabla7Peer::CODPRE, $this->codpre);
		if ($this->isColumnModified(Tabla7Peer::MONIMP)) $criteria->add(Tabla7Peer::MONIMP, $this->monimp);
		if ($this->isColumnModified(Tabla7Peer::MONCOM)) $criteria->add(Tabla7Peer::MONCOM, $this->moncom);
		if ($this->isColumnModified(Tabla7Peer::MONCAU)) $criteria->add(Tabla7Peer::MONCAU, $this->moncau);
		if ($this->isColumnModified(Tabla7Peer::MONPAG)) $criteria->add(Tabla7Peer::MONPAG, $this->monpag);
		if ($this->isColumnModified(Tabla7Peer::MONAJU)) $criteria->add(Tabla7Peer::MONAJU, $this->monaju);
		if ($this->isColumnModified(Tabla7Peer::STAIMP)) $criteria->add(Tabla7Peer::STAIMP, $this->staimp);
		if ($this->isColumnModified(Tabla7Peer::ID)) $criteria->add(Tabla7Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Tabla7Peer::ID, $this->id);

...
abstract class BaseCadefartPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codemp', 'Lonart', 'Rupart', 'Forart', 'Desart', 'Forubi', 'Desubi', 'Correq', 'Corord', 'Correc', 'Cordes', 'Generaop', 'Asiparrec', 'Generacom', 'Mercon', 'Ctadev', 'Ctavco', 'Univta', 'Artven', 'Artins', 'Artser', 'Codalmven', 'Recart', 'Ordcom', 'Reqart', 'Dphart', 'Ordser', 'Tipimprec', 'Artvenhas', 'Corcot', 'Solart', 'Apliclades', 'Solcom', 'Unidad', 'Id', ),
		BasePeer::TYPE_COLNAME => array (CadefartPeer::CODEMP, CadefartPeer::LONART, CadefartPeer::RUPART, CadefartPeer::FORART, CadefartPeer::DESART, CadefartPeer::FORUBI, CadefartPeer::DESUBI, CadefartPeer::CORREQ, CadefartPeer::CORORD, CadefartPeer::CORREC, CadefartPeer::CORDES, CadefartPeer::GENERAOP, CadefartPeer::ASIPARREC, CadefartPeer::GENERACOM, CadefartPeer::MERCON, CadefartPeer::CTADEV, CadefartPeer::CTAVCO, CadefartPeer::UNIVTA, CadefartPeer::ARTVEN, CadefartPeer::ARTINS, CadefartPeer::ARTSER, CadefartPeer::CODALMVEN, CadefartPeer::RECART, CadefartPeer::ORDCOM, CadefartPeer::REQART, CadefartPeer::DPHART, CadefartPeer::ORDSER, CadefartPeer::TIPIMPREC, CadefartPeer::ARTVENHAS, CadefartPeer::CORCOT, CadefartPeer::SOLART, CadefartPeer::APLICLADES, CadefartPeer::SOLCOM, CadefartPeer::UNIDAD, CadefartPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('codemp', 'lonart', 'rupart', 'forart', 'desart', 'forubi', 'desubi', 'correq', 'corord', 'correc', 'cordes', 'generaop', 'asiparrec', 'generacom', 'mercon', 'ctadev', 'ctavco', 'univta', 'artven', 'artins', 'artser', 'codalmven', 'recart', 'ordcom', 'reqart', 'dphart', 'ordser', 'tipimprec', 'artvenhas', 'corcot', 'solart', 'apliclades', 'solcom', 'unidad', 'id', ),

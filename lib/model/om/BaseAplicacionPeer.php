...
abstract class BaseAplicacionPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Aplicacion';
	...
	{
		include_once 'lib/model/map/AplicacionMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.AplicacionMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/AplicacionMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.AplicacionMapBuilder');
}

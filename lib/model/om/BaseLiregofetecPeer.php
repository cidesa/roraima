...
abstract class BaseLiregofetecPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Liregofetec';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (LiregofetecPeer::NUMOFE, LiregofetecPeer::CODCRI, LiregofetecPeer::OBSERV, LiregofetecPeer::ID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (LiregofetecPeer::NUMOFE => 0, LiregofetecPeer::CODCRI => 1, LiregofetecPeer::OBSERV => 2, LiregofetecPeer::ID => 3, ),
	...
	{
		include_once 'lib/model/map/LiregofetecMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.LiregofetecMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/LiregofetecMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.LiregofetecMapBuilder');
}

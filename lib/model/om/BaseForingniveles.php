...
abstract class BaseForingniveles extends BaseObject  implements Persistent {
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			ForingnivelesPeer::doDelete($this, $con);
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ForingnivelesPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ForingnivelesPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ForingnivelesPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ForingnivelesPeer::CATPAR)) $criteria->add(ForingnivelesPeer::CATPAR, $this->catpar);
		if ($this->isColumnModified(ForingnivelesPeer::CONSEC)) $criteria->add(ForingnivelesPeer::CONSEC, $this->consec);
		if ($this->isColumnModified(ForingnivelesPeer::NOMABR)) $criteria->add(ForingnivelesPeer::NOMABR, $this->nomabr);
		if ($this->isColumnModified(ForingnivelesPeer::NOMEXT)) $criteria->add(ForingnivelesPeer::NOMEXT, $this->nomext);
		if ($this->isColumnModified(ForingnivelesPeer::LONNIV)) $criteria->add(ForingnivelesPeer::LONNIV, $this->lonniv);
		if ($this->isColumnModified(ForingnivelesPeer::STANIV)) $criteria->add(ForingnivelesPeer::STANIV, $this->staniv);
		if ($this->isColumnModified(ForingnivelesPeer::ID)) $criteria->add(ForingnivelesPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ForingnivelesPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new ForingnivelesPeer();
		}
		return self::$peer;
	}

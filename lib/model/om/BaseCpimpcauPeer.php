...
abstract class BaseCpimpcauPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Cpimpcau';
	...
	{
		include_once 'lib/model/map/CpimpcauMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CpimpcauMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CpimpcauMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CpimpcauMapBuilder');
}

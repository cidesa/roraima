...
abstract class BaseForingpereje extends BaseObject  implements Persistent {
	...
	public function setFecini($v)
	{
		...
		if ($this->fecini !== $ts) {
			$this->fecini = $ts;
			$this->modifiedColumns[] = ForingperejePeer::FECINI;
		}
	...
	public function setFeccie($v)
	{
		...
		if ($this->feccie !== $ts) {
			$this->feccie = $ts;
			$this->modifiedColumns[] = ForingperejePeer::FECCIE;
		}
	...
	public function setPereje($v)
	{
		...
		if ($this->pereje !== $v) {
			$this->pereje = $v;
			$this->modifiedColumns[] = ForingperejePeer::PEREJE;
		}
	...
	public function setFecdes($v)
	{
		...
		if ($this->fecdes !== $ts) {
			$this->fecdes = $ts;
			$this->modifiedColumns[] = ForingperejePeer::FECDES;
		}
	...
	public function setFechas($v)
	{
		...
		if ($this->fechas !== $ts) {
			$this->fechas = $ts;
			$this->modifiedColumns[] = ForingperejePeer::FECHAS;
		}
	...
	public function setCerrado($v)
	{
		...
		if ($this->cerrado !== $v) {
			$this->cerrado = $v;
			$this->modifiedColumns[] = ForingperejePeer::CERRADO;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ForingperejePeer::ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Foringpereje object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			ForingperejePeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ForingperejePeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setNew(false);
				} else {
					$affectedRows += ForingperejePeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ForingperejePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ForingperejePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ForingperejePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ForingperejePeer::FECINI)) $criteria->add(ForingperejePeer::FECINI, $this->fecini);
		if ($this->isColumnModified(ForingperejePeer::FECCIE)) $criteria->add(ForingperejePeer::FECCIE, $this->feccie);
		if ($this->isColumnModified(ForingperejePeer::PEREJE)) $criteria->add(ForingperejePeer::PEREJE, $this->pereje);
		if ($this->isColumnModified(ForingperejePeer::FECDES)) $criteria->add(ForingperejePeer::FECDES, $this->fecdes);
		if ($this->isColumnModified(ForingperejePeer::FECHAS)) $criteria->add(ForingperejePeer::FECHAS, $this->fechas);
		if ($this->isColumnModified(ForingperejePeer::CERRADO)) $criteria->add(ForingperejePeer::CERRADO, $this->cerrado);
		if ($this->isColumnModified(ForingperejePeer::ID)) $criteria->add(ForingperejePeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ForingperejePeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new ForingperejePeer();
		}
		return self::$peer;
	}

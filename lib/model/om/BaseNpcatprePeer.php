...
abstract class BaseNpcatprePeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npcatpre';
	...
	{
		include_once 'lib/model/map/NpcatpreMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpcatpreMapBuilder');
	}
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(NpcatprePeer::ID);
			$selectCriteria->add(NpcatprePeer::ID, $criteria->remove(NpcatprePeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		$affectedRows = 0; 		try {
									$con->begin();
			$affectedRows += BasePeer::doDeleteAll(NpcatprePeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollback();
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof Npcatpre) {

			$criteria = $values->buildPkeyCriteria();
		} else {
						$criteria = new Criteria(self::DATABASE_NAME);
			$criteria->add(NpcatprePeer::ID, (array) $values, Criteria::IN);
		}
	...
	public static function doValidate(Npcatpre $obj, $cols = null)
	{
		$columns = array();

		if ($cols) {
			$dbMap = Propel::getDatabaseMap(NpcatprePeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(NpcatprePeer::TABLE_NAME);
		...
		$res =  BasePeer::doValidate(NpcatprePeer::DATABASE_NAME, NpcatprePeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = NpcatprePeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpcatpreMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpcatpreMapBuilder');
}

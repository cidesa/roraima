...
abstract class BaseNpcalislrPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npcalislr';
	...
	{
		include_once 'lib/model/map/NpcalislrMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpcalislrMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpcalislrMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpcalislrMapBuilder');
}

...
abstract class BaseFcrangosrecPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcrangosrec';
	...
	{
		include_once 'lib/model/map/FcrangosrecMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcrangosrecMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcrangosrecMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcrangosrecMapBuilder');
}

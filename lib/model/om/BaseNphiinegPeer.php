...
abstract class BaseNphiinegPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Nphiineg';
	...
	{
		include_once 'lib/model/map/NphiinegMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NphiinegMapBuilder');
	}
	
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = NphiinegPeer::getTableMap();
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NphiinegPeer::CODEMP);

		$criteria->addSelectColumn(NphiinegPeer::FECING);

		$criteria->addSelectColumn(NphiinegPeer::FECEGR);
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(NphiinegPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(NphiinegPeer::COUNT);
		}
		...
		$rs = NphiinegPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	public static function doSelectOne(Criteria $criteria, $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = NphiinegPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	public static function doSelectRS(Criteria $criteria, $con = null)
	{
		...
		if (!$criteria->getSelectColumns()) {
			$criteria = clone $criteria;
			NphiinegPeer::addSelectColumns($criteria);
		}
	...
	public static function doDeleteAll($con = null)
	{
		...
		$affectedRows = 0; 		try {
									$con->begin();
			$affectedRows += BasePeer::doDeleteAll(NphiinegPeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollback();
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof Nphiineg) {

			$criteria = $values->buildPkeyCriteria();
		} else {
						$criteria = new Criteria(self::DATABASE_NAME);
			$criteria->add(NphiinegPeer::ID, (array) $values, Criteria::IN);
		}
	...
	public static function doValidate(Nphiineg $obj, $cols = null)
	{
		...
		if ($cols) {
			$dbMap = Propel::getDatabaseMap(NphiinegPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(NphiinegPeer::TABLE_NAME);
		...
		$res =  BasePeer::doValidate(NphiinegPeer::DATABASE_NAME, NphiinegPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = NphiinegPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(NphiinegPeer::ID, $pk);


		$v = NphiinegPeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(NphiinegPeer::ID, $pks, Criteria::IN);
			$objs = NphiinegPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NphiinegMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NphiinegMapBuilder');
}

...
abstract class BaseNpintfecrefdanielPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npintfecrefdaniel';
	...
	{
		include_once 'lib/model/map/NpintfecrefdanielMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpintfecrefdanielMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpintfecrefdanielMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpintfecrefdanielMapBuilder');
}

...
abstract class BaseCpsoladidisPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Cpsoladidis';
	...
	{
		include_once 'lib/model/map/CpsoladidisMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CpsoladidisMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CpsoladidisMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CpsoladidisMapBuilder');
}

...
abstract class BaseCpimpcom extends BaseObject  implements Persistent {
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			CpimpcomPeer::doDelete($this, $con);
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CpimpcomPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CpimpcomPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CpimpcomPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CpimpcomPeer::REFCOM)) $criteria->add(CpimpcomPeer::REFCOM, $this->refcom);
		if ($this->isColumnModified(CpimpcomPeer::CODPRE)) $criteria->add(CpimpcomPeer::CODPRE, $this->codpre);
		if ($this->isColumnModified(CpimpcomPeer::MONIMP)) $criteria->add(CpimpcomPeer::MONIMP, $this->monimp);
		if ($this->isColumnModified(CpimpcomPeer::MONCAU)) $criteria->add(CpimpcomPeer::MONCAU, $this->moncau);
		if ($this->isColumnModified(CpimpcomPeer::MONPAG)) $criteria->add(CpimpcomPeer::MONPAG, $this->monpag);
		if ($this->isColumnModified(CpimpcomPeer::MONAJU)) $criteria->add(CpimpcomPeer::MONAJU, $this->monaju);
		if ($this->isColumnModified(CpimpcomPeer::STAIMP)) $criteria->add(CpimpcomPeer::STAIMP, $this->staimp);
		if ($this->isColumnModified(CpimpcomPeer::REFERE)) $criteria->add(CpimpcomPeer::REFERE, $this->refere);
		if ($this->isColumnModified(CpimpcomPeer::ID)) $criteria->add(CpimpcomPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CpimpcomPeer::ID, $this->id);

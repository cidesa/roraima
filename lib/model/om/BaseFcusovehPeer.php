...
abstract class BaseFcusovehPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcusoveh';
	...
	{
		include_once 'lib/model/map/FcusovehMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcusovehMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcusovehMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcusovehMapBuilder');
}

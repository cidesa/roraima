...
abstract class BaseNpvacregcondisPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npvacregcondis';
	...
	{
		include_once 'lib/model/map/NpvacregcondisMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpvacregcondisMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpvacregcondisMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpvacregcondisMapBuilder');
}

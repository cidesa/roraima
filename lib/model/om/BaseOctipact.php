...
abstract class BaseOctipact extends BaseObject  implements Persistent {
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			OctipactPeer::doDelete($this, $con);
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = OctipactPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = OctipactPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = OctipactPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(OctipactPeer::CODTIPACT)) $criteria->add(OctipactPeer::CODTIPACT, $this->codtipact);
		if ($this->isColumnModified(OctipactPeer::DESTIPACT)) $criteria->add(OctipactPeer::DESTIPACT, $this->destipact);
		if ($this->isColumnModified(OctipactPeer::ID)) $criteria->add(OctipactPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(OctipactPeer::ID, $this->id);

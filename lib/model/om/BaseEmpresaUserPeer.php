...
abstract class BaseEmpresaUserPeer {
	...
	const CLASS_DEFAULT = 'lib.model.EmpresaUser';
	...
	{
		include_once 'lib/model/map/EmpresaUserMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.EmpresaUserMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/EmpresaUserMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.EmpresaUserMapBuilder');
}

...
abstract class BaseNphisconBorra extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codnom !== $v) {
        $this->codnom = $v;
        $this->modifiedColumns[] = NphisconBorraPeer::CODNOM;
      }
    ...
    if ($this->codemp !== $v) {
        $this->codemp = $v;
        $this->modifiedColumns[] = NphisconBorraPeer::CODEMP;
      }
    ...
    if ($this->codcar !== $v) {
        $this->codcar = $v;
        $this->modifiedColumns[] = NphisconBorraPeer::CODCAR;
      }
    ...
    if ($this->codcon !== $v) {
        $this->codcon = $v;
        $this->modifiedColumns[] = NphisconBorraPeer::CODCON;
      }
    ...
    if ($this->fecnom !== $ts) {
      $this->fecnom = $ts;
      $this->modifiedColumns[] = NphisconBorraPeer::FECNOM;
    }
    ...
    if ($this->monto !== $v) {
        ...
        $this->modifiedColumns[] = NphisconBorraPeer::MONTO;
      }
    ...
    if ($this->codcat !== $v) {
        $this->codcat = $v;
        $this->modifiedColumns[] = NphisconBorraPeer::CODCAT;
      }
    ...
    if ($this->codpar !== $v) {
        $this->codpar = $v;
        $this->modifiedColumns[] = NphisconBorraPeer::CODPAR;
      }
    ...
    if ($this->codescuela !== $v) {
        $this->codescuela = $v;
        $this->modifiedColumns[] = NphisconBorraPeer::CODESCUELA;
      }
    ...
    if ($this->codniv !== $v) {
        $this->codniv = $v;
        $this->modifiedColumns[] = NphisconBorraPeer::CODNIV;
      }
    ...
    if ($this->codtipgas !== $v) {
        $this->codtipgas = $v;
        $this->modifiedColumns[] = NphisconBorraPeer::CODTIPGAS;
      }
    ...
    if ($this->nomcon !== $v) {
        $this->nomcon = $v;
        $this->modifiedColumns[] = NphisconBorraPeer::NOMCON;
      }
    ...
    if ($this->numrec !== $v) {
        ...
        $this->modifiedColumns[] = NphisconBorraPeer::NUMREC;
      }
    ...
    if ($this->cantidad !== $v) {
        ...
        $this->modifiedColumns[] = NphisconBorraPeer::CANTIDAD;
      }
    ...
    if ($this->fecnomdes !== $ts) {
      $this->fecnomdes = $ts;
      $this->modifiedColumns[] = NphisconBorraPeer::FECNOMDES;
    }
    ...
    if ($this->especial !== $v || $v === '') {
        $this->especial = $v;
        $this->modifiedColumns[] = NphisconBorraPeer::ESPECIAL;
      }
    ...
    if ($this->fecnomespdes !== $ts) {
      ...
      $this->modifiedColumns[] = NphisconBorraPeer::FECNOMESPDES;
    }
    ...
    if ($this->fecnomesphas !== $ts) {
      ...
      $this->modifiedColumns[] = NphisconBorraPeer::FECNOMESPHAS;
    }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = NphisconBorraPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating NphisconBorra object", $e);
    }
  }
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			NphisconBorraPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = NphisconBorraPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += NphisconBorraPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = NphisconBorraPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = NphisconBorraPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = NphisconBorraPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NphisconBorraPeer::CODNOM)) $criteria->add(NphisconBorraPeer::CODNOM, $this->codnom);
		if ($this->isColumnModified(NphisconBorraPeer::CODEMP)) $criteria->add(NphisconBorraPeer::CODEMP, $this->codemp);
		if ($this->isColumnModified(NphisconBorraPeer::CODCAR)) $criteria->add(NphisconBorraPeer::CODCAR, $this->codcar);
		if ($this->isColumnModified(NphisconBorraPeer::CODCON)) $criteria->add(NphisconBorraPeer::CODCON, $this->codcon);
		if ($this->isColumnModified(NphisconBorraPeer::FECNOM)) $criteria->add(NphisconBorraPeer::FECNOM, $this->fecnom);
		if ($this->isColumnModified(NphisconBorraPeer::MONTO)) $criteria->add(NphisconBorraPeer::MONTO, $this->monto);
		if ($this->isColumnModified(NphisconBorraPeer::CODCAT)) $criteria->add(NphisconBorraPeer::CODCAT, $this->codcat);
		if ($this->isColumnModified(NphisconBorraPeer::CODPAR)) $criteria->add(NphisconBorraPeer::CODPAR, $this->codpar);
		if ($this->isColumnModified(NphisconBorraPeer::CODESCUELA)) $criteria->add(NphisconBorraPeer::CODESCUELA, $this->codescuela);
		if ($this->isColumnModified(NphisconBorraPeer::CODNIV)) $criteria->add(NphisconBorraPeer::CODNIV, $this->codniv);
		if ($this->isColumnModified(NphisconBorraPeer::CODTIPGAS)) $criteria->add(NphisconBorraPeer::CODTIPGAS, $this->codtipgas);
		if ($this->isColumnModified(NphisconBorraPeer::NOMCON)) $criteria->add(NphisconBorraPeer::NOMCON, $this->nomcon);
		if ($this->isColumnModified(NphisconBorraPeer::NUMREC)) $criteria->add(NphisconBorraPeer::NUMREC, $this->numrec);
		if ($this->isColumnModified(NphisconBorraPeer::CANTIDAD)) $criteria->add(NphisconBorraPeer::CANTIDAD, $this->cantidad);
		if ($this->isColumnModified(NphisconBorraPeer::FECNOMDES)) $criteria->add(NphisconBorraPeer::FECNOMDES, $this->fecnomdes);
		if ($this->isColumnModified(NphisconBorraPeer::ESPECIAL)) $criteria->add(NphisconBorraPeer::ESPECIAL, $this->especial);
		if ($this->isColumnModified(NphisconBorraPeer::FECNOMESPDES)) $criteria->add(NphisconBorraPeer::FECNOMESPDES, $this->fecnomespdes);
		if ($this->isColumnModified(NphisconBorraPeer::FECNOMESPHAS)) $criteria->add(NphisconBorraPeer::FECNOMESPHAS, $this->fecnomesphas);
		if ($this->isColumnModified(NphisconBorraPeer::ID)) $criteria->add(NphisconBorraPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(NphisconBorraPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new NphisconBorraPeer();
		}
		return self::$peer;
	}

...
abstract class BaseNpnomcalTempPeer {
	...
	const CLASS_DEFAULT = 'lib.model.NpnomcalTemp';
	...
	{
		include_once 'lib/model/map/NpnomcalTempMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpnomcalTempMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpnomcalTempMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpnomcalTempMapBuilder');
}

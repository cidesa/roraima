...
abstract class BaseCppagosPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Cppagos';
	...
	{
		include_once 'lib/model/map/CppagosMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CppagosMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CppagosMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CppagosMapBuilder');
}

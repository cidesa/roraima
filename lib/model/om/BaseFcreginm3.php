...
abstract class BaseFcreginm3 extends BaseObject  implements Persistent {
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			Fcreginm3Peer::doDelete($this, $con);
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Fcreginm3Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Fcreginm3Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Fcreginm3Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Fcreginm3Peer::CODCATFIS)) $criteria->add(Fcreginm3Peer::CODCATFIS, $this->codcatfis);
		if ($this->isColumnModified(Fcreginm3Peer::ID)) $criteria->add(Fcreginm3Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Fcreginm3Peer::ID, $this->id);

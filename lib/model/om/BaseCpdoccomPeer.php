...
abstract class BaseCpdoccomPeer {
	...
	{
		include_once 'lib/model/map/CpdoccomMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CpdoccomMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CpdoccomMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CpdoccomMapBuilder');
}

...
abstract class BaseConprestamos extends BaseObject  implements Persistent {
	...
	public function setCodemp($v)
	{
		...
		if ($this->codemp !== $v) {
			$this->codemp = $v;
			$this->modifiedColumns[] = ConprestamosPeer::CODEMP;
		}
	...
	public function setCodcon($v)
	{
		...
		if ($this->codcon !== $v) {
			$this->codcon = $v;
			$this->modifiedColumns[] = ConprestamosPeer::CODCON;
		}
	...
	public function setCodcar($v)
	{
		...
		if ($this->codcar !== $v) {
			$this->codcar = $v;
			$this->modifiedColumns[] = ConprestamosPeer::CODCAR;
		}
	...
	public function setNomemp($v)
	{
		...
		if ($this->nomemp !== $v) {
			$this->nomemp = $v;
			$this->modifiedColumns[] = ConprestamosPeer::NOMEMP;
		}
	...
	public function setNomcon($v)
	{
		...
		if ($this->nomcon !== $v) {
			$this->nomcon = $v;
			$this->modifiedColumns[] = ConprestamosPeer::NOMCON;
		}
	...
	public function setNomcar($v)
	{
		...
		if ($this->nomcar !== $v) {
			$this->nomcar = $v;
			$this->modifiedColumns[] = ConprestamosPeer::NOMCAR;
		}
	...
	public function setCantidad($v)
	{
		...
		if ($this->cantidad !== $v) {
			$this->cantidad = $v;
			$this->modifiedColumns[] = ConprestamosPeer::CANTIDAD;
		}
	...
	public function setMonto($v)
	{
		...
		if ($this->monto !== $v) {
			$this->monto = $v;
			$this->modifiedColumns[] = ConprestamosPeer::MONTO;
		}
	...
	public function setFecini($v)
	{
		...
		if ($this->fecini !== $ts) {
			$this->fecini = $ts;
			$this->modifiedColumns[] = ConprestamosPeer::FECINI;
		}
	...
	public function setFecexp($v)
	{
		...
		if ($this->fecexp !== $ts) {
			$this->fecexp = $ts;
			$this->modifiedColumns[] = ConprestamosPeer::FECEXP;
		}
	...
	public function setFrecon($v)
	{
		...
		if ($this->frecon !== $v) {
			$this->frecon = $v;
			$this->modifiedColumns[] = ConprestamosPeer::FRECON;
		}
	...
	public function setAsided($v)
	{
		...
		if ($this->asided !== $v) {
			$this->asided = $v;
			$this->modifiedColumns[] = ConprestamosPeer::ASIDED;
		}
	...
	public function setAcucon($v)
	{
		...
		if ($this->acucon !== $v) {
			$this->acucon = $v;
			$this->modifiedColumns[] = ConprestamosPeer::ACUCON;
		}
	...
	public function setCalcon($v)
	{
		...
		if ($this->calcon !== $v) {
			$this->calcon = $v;
			$this->modifiedColumns[] = ConprestamosPeer::CALCON;
		}
	...
	public function setActivo($v)
	{
		...
		if ($this->activo !== $v) {
			$this->activo = $v;
			$this->modifiedColumns[] = ConprestamosPeer::ACTIVO;
		}
	...
	public function setAcumulado($v)
	{
		...
		if ($this->acumulado !== $v) {
			$this->acumulado = $v;
			$this->modifiedColumns[] = ConprestamosPeer::ACUMULADO;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ConprestamosPeer::ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Conprestamos object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			ConprestamosPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ConprestamosPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setNew(false);
				} else {
					$affectedRows += ConprestamosPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ConprestamosPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ConprestamosPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ConprestamosPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ConprestamosPeer::CODEMP)) $criteria->add(ConprestamosPeer::CODEMP, $this->codemp);
		if ($this->isColumnModified(ConprestamosPeer::CODCON)) $criteria->add(ConprestamosPeer::CODCON, $this->codcon);
		if ($this->isColumnModified(ConprestamosPeer::CODCAR)) $criteria->add(ConprestamosPeer::CODCAR, $this->codcar);
		if ($this->isColumnModified(ConprestamosPeer::NOMEMP)) $criteria->add(ConprestamosPeer::NOMEMP, $this->nomemp);
		if ($this->isColumnModified(ConprestamosPeer::NOMCON)) $criteria->add(ConprestamosPeer::NOMCON, $this->nomcon);
		if ($this->isColumnModified(ConprestamosPeer::NOMCAR)) $criteria->add(ConprestamosPeer::NOMCAR, $this->nomcar);
		if ($this->isColumnModified(ConprestamosPeer::CANTIDAD)) $criteria->add(ConprestamosPeer::CANTIDAD, $this->cantidad);
		if ($this->isColumnModified(ConprestamosPeer::MONTO)) $criteria->add(ConprestamosPeer::MONTO, $this->monto);
		if ($this->isColumnModified(ConprestamosPeer::FECINI)) $criteria->add(ConprestamosPeer::FECINI, $this->fecini);
		if ($this->isColumnModified(ConprestamosPeer::FECEXP)) $criteria->add(ConprestamosPeer::FECEXP, $this->fecexp);
		if ($this->isColumnModified(ConprestamosPeer::FRECON)) $criteria->add(ConprestamosPeer::FRECON, $this->frecon);
		if ($this->isColumnModified(ConprestamosPeer::ASIDED)) $criteria->add(ConprestamosPeer::ASIDED, $this->asided);
		if ($this->isColumnModified(ConprestamosPeer::ACUCON)) $criteria->add(ConprestamosPeer::ACUCON, $this->acucon);
		if ($this->isColumnModified(ConprestamosPeer::CALCON)) $criteria->add(ConprestamosPeer::CALCON, $this->calcon);
		if ($this->isColumnModified(ConprestamosPeer::ACTIVO)) $criteria->add(ConprestamosPeer::ACTIVO, $this->activo);
		if ($this->isColumnModified(ConprestamosPeer::ACUMULADO)) $criteria->add(ConprestamosPeer::ACUMULADO, $this->acumulado);
		if ($this->isColumnModified(ConprestamosPeer::ID)) $criteria->add(ConprestamosPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ConprestamosPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new ConprestamosPeer();
		}
		return self::$peer;
	}

...
abstract class BaseFadefcajPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fadefcaj';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Descaj', 'Corcaj', 'Id', ),
		BasePeer::TYPE_COLNAME => array (FadefcajPeer::DESCAJ, FadefcajPeer::CORCAJ, FadefcajPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('descaj', 'corcaj', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Descaj' => 0, 'Corcaj' => 1, 'Id' => 2, ),
		BasePeer::TYPE_COLNAME => array (FadefcajPeer::DESCAJ => 0, FadefcajPeer::CORCAJ => 1, FadefcajPeer::ID => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('descaj' => 0, 'corcaj' => 1, 'id' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		include_once 'lib/model/map/FadefcajMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FadefcajMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FadefcajMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FadefcajMapBuilder');
}

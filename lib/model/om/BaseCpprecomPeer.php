...
abstract class BaseCpprecomPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Cpprecom';
	...
	{
		include_once 'lib/model/map/CpprecomMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CpprecomMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CpprecomMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CpprecomMapBuilder');
}

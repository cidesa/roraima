...
abstract class BaseLianaofetipempPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Lianaofetipemp';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Numanaofe', 'Codtipemp', 'Punemp', 'Poremp', 'Observ', 'Id', ),
		BasePeer::TYPE_COLNAME => array (LianaofetipempPeer::NUMANAOFE, LianaofetipempPeer::CODTIPEMP, LianaofetipempPeer::PUNEMP, LianaofetipempPeer::POREMP, LianaofetipempPeer::OBSERV, LianaofetipempPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('numanaofe', 'codtipemp', 'punemp', 'poremp', 'observ', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Numanaofe' => 0, 'Codtipemp' => 1, 'Punemp' => 2, 'Poremp' => 3, 'Observ' => 4, 'Id' => 5, ),
		BasePeer::TYPE_COLNAME => array (LianaofetipempPeer::NUMANAOFE => 0, LianaofetipempPeer::CODTIPEMP => 1, LianaofetipempPeer::PUNEMP => 2, LianaofetipempPeer::POREMP => 3, LianaofetipempPeer::OBSERV => 4, LianaofetipempPeer::ID => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('numanaofe' => 0, 'codtipemp' => 1, 'punemp' => 2, 'poremp' => 3, 'observ' => 4, 'id' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	{
		include_once 'lib/model/map/LianaofetipempMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.LianaofetipempMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/LianaofetipempMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.LianaofetipempMapBuilder');
}

...
abstract class BaseFcrenlicPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcrenlic';
	...
	{
		include_once 'lib/model/map/FcrenlicMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcrenlicMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcrenlicMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcrenlicMapBuilder');
}

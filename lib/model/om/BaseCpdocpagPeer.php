...
abstract class BaseCpdocpagPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Cpdocpag';
	...
	{
		include_once 'lib/model/map/CpdocpagMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CpdocpagMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CpdocpagMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CpdocpagMapBuilder');
}

...
abstract class BaseLipliecritecPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Lipliecritec';
	...
	const LIMIT = 'lipliecritec.LIMIT';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (LipliecritecPeer::NUMPLIE, LipliecritecPeer::NUMEXP, LipliecritecPeer::CODCRI, LipliecritecPeer::PUNTUA, LipliecritecPeer::PORCEN, LipliecritecPeer::LIMIT, LipliecritecPeer::ID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (LipliecritecPeer::NUMPLIE => 0, LipliecritecPeer::NUMEXP => 1, LipliecritecPeer::CODCRI => 2, LipliecritecPeer::PUNTUA => 3, LipliecritecPeer::PORCEN => 4, LipliecritecPeer::LIMIT => 5, LipliecritecPeer::ID => 6, ),
	...
	{
		include_once 'lib/model/map/LipliecritecMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.LipliecritecMapBuilder');
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LipliecritecPeer::LIMIT);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/LipliecritecMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.LipliecritecMapBuilder');
}

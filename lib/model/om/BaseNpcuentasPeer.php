...
abstract class BaseNpcuentasPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npcuentas';
	...
	{
		include_once 'lib/model/map/NpcuentasMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpcuentasMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpcuentasMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpcuentasMapBuilder');
}

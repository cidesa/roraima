...
abstract class BaseCpmovfuefinPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Cpmovfuefin';
	...
	{
		include_once 'lib/model/map/CpmovfuefinMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CpmovfuefinMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CpmovfuefinMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CpmovfuefinMapBuilder');
}

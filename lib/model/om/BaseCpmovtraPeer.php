...
abstract class BaseCpmovtraPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Cpmovtra';
	...
	{
		include_once 'lib/model/map/CpmovtraMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CpmovtraMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CpmovtraMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CpmovtraMapBuilder');
}

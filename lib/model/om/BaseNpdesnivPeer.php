...
abstract class BaseNpdesnivPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npdesniv';
	...
	{
		include_once 'lib/model/map/NpdesnivMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpdesnivMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpdesnivMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpdesnivMapBuilder');
}

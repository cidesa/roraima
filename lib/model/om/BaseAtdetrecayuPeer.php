...
abstract class BaseAtdetrecayuPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Atdetrecayu';
	...
	{
		include_once 'lib/model/map/AtdetrecayuMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.AtdetrecayuMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/AtdetrecayuMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.AtdetrecayuMapBuilder');
}

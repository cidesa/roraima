...
abstract class BaseFctipprodetPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fctipprodet';
	...
	{
		include_once 'lib/model/map/FctipprodetMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FctipprodetMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FctipprodetMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FctipprodetMapBuilder');
}

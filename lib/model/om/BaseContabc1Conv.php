...
abstract class BaseContabc1Conv extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->numcom !== $v) {
        $this->numcom = $v;
        $this->modifiedColumns[] = Contabc1ConvPeer::NUMCOM;
      }
    ...
    if ($this->feccom !== $ts) {
      $this->feccom = $ts;
      $this->modifiedColumns[] = Contabc1ConvPeer::FECCOM;
    }
    ...
    if ($this->debcre !== $v) {
        $this->debcre = $v;
        $this->modifiedColumns[] = Contabc1ConvPeer::DEBCRE;
      }
    ...
    if ($this->codcta !== $v) {
        $this->codcta = $v;
        $this->modifiedColumns[] = Contabc1ConvPeer::CODCTA;
      }
    ...
    if ($this->numasi !== $v) {
        ...
        $this->modifiedColumns[] = Contabc1ConvPeer::NUMASI;
      }
    ...
    if ($this->refasi !== $v) {
        $this->refasi = $v;
        $this->modifiedColumns[] = Contabc1ConvPeer::REFASI;
      }
    ...
    if ($this->desasi !== $v) {
        $this->desasi = $v;
        $this->modifiedColumns[] = Contabc1ConvPeer::DESASI;
      }
    ...
    if ($this->monasi !== $v) {
        ...
        $this->modifiedColumns[] = Contabc1ConvPeer::MONASI;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = Contabc1ConvPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Contabc1Conv object", $e);
    }
  }
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			Contabc1ConvPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Contabc1ConvPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setNew(false);
				} else {
					$affectedRows += Contabc1ConvPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Contabc1ConvPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Contabc1ConvPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Contabc1ConvPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Contabc1ConvPeer::NUMCOM)) $criteria->add(Contabc1ConvPeer::NUMCOM, $this->numcom);
		if ($this->isColumnModified(Contabc1ConvPeer::FECCOM)) $criteria->add(Contabc1ConvPeer::FECCOM, $this->feccom);
		if ($this->isColumnModified(Contabc1ConvPeer::DEBCRE)) $criteria->add(Contabc1ConvPeer::DEBCRE, $this->debcre);
		if ($this->isColumnModified(Contabc1ConvPeer::CODCTA)) $criteria->add(Contabc1ConvPeer::CODCTA, $this->codcta);
		if ($this->isColumnModified(Contabc1ConvPeer::NUMASI)) $criteria->add(Contabc1ConvPeer::NUMASI, $this->numasi);
		if ($this->isColumnModified(Contabc1ConvPeer::REFASI)) $criteria->add(Contabc1ConvPeer::REFASI, $this->refasi);
		if ($this->isColumnModified(Contabc1ConvPeer::DESASI)) $criteria->add(Contabc1ConvPeer::DESASI, $this->desasi);
		if ($this->isColumnModified(Contabc1ConvPeer::MONASI)) $criteria->add(Contabc1ConvPeer::MONASI, $this->monasi);
		if ($this->isColumnModified(Contabc1ConvPeer::ID)) $criteria->add(Contabc1ConvPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Contabc1ConvPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new Contabc1ConvPeer();
		}
		return self::$peer;
	}

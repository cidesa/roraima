...
abstract class BaseNpasiconnomAuxPeer {
	...
	const CLASS_DEFAULT = 'lib.model.NpasiconnomAux';
	...
	{
		include_once 'lib/model/map/NpasiconnomAuxMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpasiconnomAuxMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpasiconnomAuxMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpasiconnomAuxMapBuilder');
}

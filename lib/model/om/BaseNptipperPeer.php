...
abstract class BaseNptipperPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Nptipper';
	...
	{
		include_once 'lib/model/map/NptipperMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NptipperMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NptipperMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NptipperMapBuilder');
}

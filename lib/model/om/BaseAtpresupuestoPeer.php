...
abstract class BaseAtpresupuestoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Atpresupuesto';
	...
	{
		include_once 'lib/model/map/AtpresupuestoMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.AtpresupuestoMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/AtpresupuestoMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.AtpresupuestoMapBuilder');
}

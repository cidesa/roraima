...
abstract class BaseDfatendocobsPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Dfatendocobs';
	...
	{
		include_once 'lib/model/map/DfatendocobsMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.DfatendocobsMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/DfatendocobsMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.DfatendocobsMapBuilder');
}

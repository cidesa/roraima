...
abstract class BaseNprelconquiPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Nprelconqui';
	...
	{
		include_once 'lib/model/map/NprelconquiMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NprelconquiMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NprelconquiMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NprelconquiMapBuilder');
}

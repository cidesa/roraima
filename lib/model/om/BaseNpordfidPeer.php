...
abstract class BaseNpordfidPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npordfid';
	...
	{
		include_once 'lib/model/map/NpordfidMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpordfidMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpordfidMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpordfidMapBuilder');
}

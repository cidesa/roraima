...
abstract class BaseNpunieje extends BaseObject  implements Persistent {
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			NpuniejePeer::doDelete($this, $con);
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = NpuniejePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = NpuniejePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = NpuniejePeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NpuniejePeer::CODUNI)) $criteria->add(NpuniejePeer::CODUNI, $this->coduni);
		if ($this->isColumnModified(NpuniejePeer::CODNIV)) $criteria->add(NpuniejePeer::CODNIV, $this->codniv);
		if ($this->isColumnModified(NpuniejePeer::NOMUNI)) $criteria->add(NpuniejePeer::NOMUNI, $this->nomuni);
		if ($this->isColumnModified(NpuniejePeer::ID)) $criteria->add(NpuniejePeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(NpuniejePeer::ID, $this->id);

...
abstract class BaseNptipconOldPeer {
	...
	const CLASS_DEFAULT = 'lib.model.NptipconOld';
	...
	{
		include_once 'lib/model/map/NptipconOldMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NptipconOldMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NptipconOldMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NptipconOldMapBuilder');
}

...
abstract class BaseNpconceptosprimaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npconceptosprima';
	...
	{
		include_once 'lib/model/map/NpconceptosprimaMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpconceptosprimaMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpconceptosprimaMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpconceptosprimaMapBuilder');
}

...
abstract class BaseFcconrep2 extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->cedcon !== $v) {
        $this->cedcon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::CEDCON;
      }
    ...
    if ($this->rifcon !== $v) {
        $this->rifcon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::RIFCON;
      }
    ...
    if ($this->nomcon !== $v) {
        $this->nomcon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::NOMCON;
      }
    ...
    if ($this->repcon !== $v) {
        $this->repcon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::REPCON;
      }
    ...
    if ($this->dircon !== $v) {
        $this->dircon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::DIRCON;
      }
    ...
    if ($this->telcon !== $v) {
        $this->telcon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::TELCON;
      }
    ...
    if ($this->emacon !== $v) {
        $this->emacon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::EMACON;
      }
    ...
    if ($this->codsec !== $v) {
        $this->codsec = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::CODSEC;
      }
    ...
    if ($this->codpar !== $v) {
        $this->codpar = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::CODPAR;
      }
    ...
    if ($this->nitcon !== $v) {
        $this->nitcon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::NITCON;
      }
    ...
    if ($this->codmun !== $v) {
        $this->codmun = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::CODMUN;
      }
    ...
    if ($this->codedo !== $v) {
        $this->codedo = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::CODEDO;
      }
    ...
    if ($this->codpai !== $v) {
        $this->codpai = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::CODPAI;
      }
    ...
    if ($this->ciucon !== $v) {
        $this->ciucon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::CIUCON;
      }
    ...
    if ($this->cpocon !== $v) {
        $this->cpocon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::CPOCON;
      }
    ...
    if ($this->apocon !== $v) {
        $this->apocon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::APOCON;
      }
    ...
    if ($this->urlcon !== $v) {
        $this->urlcon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::URLCON;
      }
    ...
    if ($this->naccon !== $v) {
        $this->naccon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::NACCON;
      }
    ...
    if ($this->tipcon !== $v) {
        $this->tipcon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::TIPCON;
      }
    ...
    if ($this->faxcon !== $v) {
        $this->faxcon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::FAXCON;
      }
    ...
    if ($this->clacon !== $v) {
        $this->clacon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::CLACON;
      }
    ...
    if ($this->fecdescon !== $ts) {
      $this->fecdescon = $ts;
      $this->modifiedColumns[] = Fcconrep2Peer::FECDESCON;
    }
    ...
    if ($this->fecactcon !== $ts) {
      $this->fecactcon = $ts;
      $this->modifiedColumns[] = Fcconrep2Peer::FECACTCON;
    }
    ...
    if ($this->stacon !== $v) {
        $this->stacon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::STACON;
      }
    ...
    if ($this->origen !== $v) {
        $this->origen = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::ORIGEN;
      }
    ...
    if ($this->nomneg !== $v) {
        $this->nomneg = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::NOMNEG;
      }
    ...
    if ($this->reccon !== $v) {
        $this->reccon = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::RECCON;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = Fcconrep2Peer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Fcconrep2 object", $e);
    }
  }
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			Fcconrep2Peer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Fcconrep2Peer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += Fcconrep2Peer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Fcconrep2Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Fcconrep2Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Fcconrep2Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Fcconrep2Peer::CEDCON)) $criteria->add(Fcconrep2Peer::CEDCON, $this->cedcon);
		if ($this->isColumnModified(Fcconrep2Peer::RIFCON)) $criteria->add(Fcconrep2Peer::RIFCON, $this->rifcon);
		if ($this->isColumnModified(Fcconrep2Peer::NOMCON)) $criteria->add(Fcconrep2Peer::NOMCON, $this->nomcon);
		if ($this->isColumnModified(Fcconrep2Peer::REPCON)) $criteria->add(Fcconrep2Peer::REPCON, $this->repcon);
		if ($this->isColumnModified(Fcconrep2Peer::DIRCON)) $criteria->add(Fcconrep2Peer::DIRCON, $this->dircon);
		if ($this->isColumnModified(Fcconrep2Peer::TELCON)) $criteria->add(Fcconrep2Peer::TELCON, $this->telcon);
		if ($this->isColumnModified(Fcconrep2Peer::EMACON)) $criteria->add(Fcconrep2Peer::EMACON, $this->emacon);
		if ($this->isColumnModified(Fcconrep2Peer::CODSEC)) $criteria->add(Fcconrep2Peer::CODSEC, $this->codsec);
		if ($this->isColumnModified(Fcconrep2Peer::CODPAR)) $criteria->add(Fcconrep2Peer::CODPAR, $this->codpar);
		if ($this->isColumnModified(Fcconrep2Peer::NITCON)) $criteria->add(Fcconrep2Peer::NITCON, $this->nitcon);
		if ($this->isColumnModified(Fcconrep2Peer::CODMUN)) $criteria->add(Fcconrep2Peer::CODMUN, $this->codmun);
		if ($this->isColumnModified(Fcconrep2Peer::CODEDO)) $criteria->add(Fcconrep2Peer::CODEDO, $this->codedo);
		if ($this->isColumnModified(Fcconrep2Peer::CODPAI)) $criteria->add(Fcconrep2Peer::CODPAI, $this->codpai);
		if ($this->isColumnModified(Fcconrep2Peer::CIUCON)) $criteria->add(Fcconrep2Peer::CIUCON, $this->ciucon);
		if ($this->isColumnModified(Fcconrep2Peer::CPOCON)) $criteria->add(Fcconrep2Peer::CPOCON, $this->cpocon);
		if ($this->isColumnModified(Fcconrep2Peer::APOCON)) $criteria->add(Fcconrep2Peer::APOCON, $this->apocon);
		if ($this->isColumnModified(Fcconrep2Peer::URLCON)) $criteria->add(Fcconrep2Peer::URLCON, $this->urlcon);
		if ($this->isColumnModified(Fcconrep2Peer::NACCON)) $criteria->add(Fcconrep2Peer::NACCON, $this->naccon);
		if ($this->isColumnModified(Fcconrep2Peer::TIPCON)) $criteria->add(Fcconrep2Peer::TIPCON, $this->tipcon);
		if ($this->isColumnModified(Fcconrep2Peer::FAXCON)) $criteria->add(Fcconrep2Peer::FAXCON, $this->faxcon);
		if ($this->isColumnModified(Fcconrep2Peer::CLACON)) $criteria->add(Fcconrep2Peer::CLACON, $this->clacon);
		if ($this->isColumnModified(Fcconrep2Peer::FECDESCON)) $criteria->add(Fcconrep2Peer::FECDESCON, $this->fecdescon);
		if ($this->isColumnModified(Fcconrep2Peer::FECACTCON)) $criteria->add(Fcconrep2Peer::FECACTCON, $this->fecactcon);
		if ($this->isColumnModified(Fcconrep2Peer::STACON)) $criteria->add(Fcconrep2Peer::STACON, $this->stacon);
		if ($this->isColumnModified(Fcconrep2Peer::ORIGEN)) $criteria->add(Fcconrep2Peer::ORIGEN, $this->origen);
		if ($this->isColumnModified(Fcconrep2Peer::NOMNEG)) $criteria->add(Fcconrep2Peer::NOMNEG, $this->nomneg);
		if ($this->isColumnModified(Fcconrep2Peer::RECCON)) $criteria->add(Fcconrep2Peer::RECCON, $this->reccon);
		if ($this->isColumnModified(Fcconrep2Peer::ID)) $criteria->add(Fcconrep2Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Fcconrep2Peer::ID, $this->id);

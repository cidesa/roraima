...
abstract class BaseTabla30 extends BaseObject  implements Persistent {
	...
	public function setRefaju($v)
	{
		...
		if ($this->refaju !== $v) {
			$this->refaju = $v;
			$this->modifiedColumns[] = Tabla30Peer::REFAJU;
		}
	...
	public function setCodpre($v)
	{
		...
		if ($this->codpre !== $v) {
			$this->codpre = $v;
			$this->modifiedColumns[] = Tabla30Peer::CODPRE;
		}
	...
	public function setMonaju($v)
	{
		...
		if ($this->monaju !== $v) {
			$this->monaju = $v;
			$this->modifiedColumns[] = Tabla30Peer::MONAJU;
		}
	...
	public function setStamov($v)
	{
		...
		if ($this->stamov !== $v) {
			$this->stamov = $v;
			$this->modifiedColumns[] = Tabla30Peer::STAMOV;
		}
	...
	public function setRefprc($v)
	{
		...
		if ($this->refprc !== $v) {
			$this->refprc = $v;
			$this->modifiedColumns[] = Tabla30Peer::REFPRC;
		}
	...
	public function setRefcom($v)
	{
		...
		if ($this->refcom !== $v) {
			$this->refcom = $v;
			$this->modifiedColumns[] = Tabla30Peer::REFCOM;
		}
	...
	public function setRefcau($v)
	{
		...
		if ($this->refcau !== $v) {
			$this->refcau = $v;
			$this->modifiedColumns[] = Tabla30Peer::REFCAU;
		}
	...
	public function setRefpag($v)
	{
		...
		if ($this->refpag !== $v) {
			$this->refpag = $v;
			$this->modifiedColumns[] = Tabla30Peer::REFPAG;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = Tabla30Peer::ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Tabla30 object", $e);
		}
	}
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Tabla30Peer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setNew(false);
				} else {
					$affectedRows += Tabla30Peer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Tabla30Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Tabla30Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Tabla30Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Tabla30Peer::REFAJU)) $criteria->add(Tabla30Peer::REFAJU, $this->refaju);
		if ($this->isColumnModified(Tabla30Peer::CODPRE)) $criteria->add(Tabla30Peer::CODPRE, $this->codpre);
		if ($this->isColumnModified(Tabla30Peer::MONAJU)) $criteria->add(Tabla30Peer::MONAJU, $this->monaju);
		if ($this->isColumnModified(Tabla30Peer::STAMOV)) $criteria->add(Tabla30Peer::STAMOV, $this->stamov);
		if ($this->isColumnModified(Tabla30Peer::REFPRC)) $criteria->add(Tabla30Peer::REFPRC, $this->refprc);
		if ($this->isColumnModified(Tabla30Peer::REFCOM)) $criteria->add(Tabla30Peer::REFCOM, $this->refcom);
		if ($this->isColumnModified(Tabla30Peer::REFCAU)) $criteria->add(Tabla30Peer::REFCAU, $this->refcau);
		if ($this->isColumnModified(Tabla30Peer::REFPAG)) $criteria->add(Tabla30Peer::REFPAG, $this->refpag);
		if ($this->isColumnModified(Tabla30Peer::ID)) $criteria->add(Tabla30Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Tabla30Peer::ID, $this->id);

...
abstract class BaseFcprolicdetPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcprolicdet';
	...
	{
		include_once 'lib/model/map/FcprolicdetMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcprolicdetMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcprolicdetMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcprolicdetMapBuilder');
}

...
abstract class BaseOcregvalPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Monval', 'Salliq', 'Retacu', 'Moniva', 'Amoant', 'Staval', 'Poriva', 'Porant', 'Monpag', 'Salant', 'Gasree', 'Subtot', 'Monful', 'Monfia', 'Monant', 'Monperiva', 'Codcon', 'Numval', 'Codtipval', 'Fecini', 'Fecfin', 'Fecreg', 'Aumobr', 'Disobr', 'Obrext', 'Monper', 'Totded', 'Id', ),

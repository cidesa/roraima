...
abstract class BaseCpadidisPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Cpadidis';
	...
	{
		include_once 'lib/model/map/CpadidisMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CpadidisMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CpadidisMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CpadidisMapBuilder');
}

...
abstract class BaseNpmovracPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npmovrac';
	...
	{
		include_once 'lib/model/map/NpmovracMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpmovracMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpmovracMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpmovracMapBuilder');
}

...
abstract class BaseCpdefaprPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Cpdefapr';
	...
	{
		include_once 'lib/model/map/CpdefaprMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CpdefaprMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CpdefaprMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CpdefaprMapBuilder');
}

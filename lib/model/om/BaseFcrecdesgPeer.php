...
abstract class BaseFcrecdesgPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcrecdesg';
	...
	{
		include_once 'lib/model/map/FcrecdesgMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcrecdesgMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcrecdesgMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcrecdesgMapBuilder');
}

...
abstract class BaseNpcalvacPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npcalvac';
	...
	{
		include_once 'lib/model/map/NpcalvacMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpcalvacMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpcalvacMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpcalvacMapBuilder');
}

...
abstract class BaseAtfacturasPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Atfacturas';
	...
	{
		include_once 'lib/model/map/AtfacturasMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.AtfacturasMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/AtfacturasMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.AtfacturasMapBuilder');
}

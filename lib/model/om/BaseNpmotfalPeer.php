...
abstract class BaseNpmotfalPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npmotfal';
	...
	{
		include_once 'lib/model/map/NpmotfalMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpmotfalMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpmotfalMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpmotfalMapBuilder');
}

...
abstract class BaseNpdesniv extends BaseObject  implements Persistent {
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			NpdesnivPeer::doDelete($this, $con);
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = NpdesnivPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = NpdesnivPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = NpdesnivPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NpdesnivPeer::CODIGO)) $criteria->add(NpdesnivPeer::CODIGO, $this->codigo);
		if ($this->isColumnModified(NpdesnivPeer::CONSEC)) $criteria->add(NpdesnivPeer::CONSEC, $this->consec);
		if ($this->isColumnModified(NpdesnivPeer::NOMABR)) $criteria->add(NpdesnivPeer::NOMABR, $this->nomabr);
		if ($this->isColumnModified(NpdesnivPeer::NOMEXT)) $criteria->add(NpdesnivPeer::NOMEXT, $this->nomext);
		if ($this->isColumnModified(NpdesnivPeer::LONNIV)) $criteria->add(NpdesnivPeer::LONNIV, $this->lonniv);
		if ($this->isColumnModified(NpdesnivPeer::ID)) $criteria->add(NpdesnivPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(NpdesnivPeer::ID, $this->id);

...
abstract class BaseNpnomespnomtipPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npnomespnomtip';
	...
	{
		include_once 'lib/model/map/NpnomespnomtipMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpnomespnomtipMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpnomespnomtipMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpnomespnomtipMapBuilder');
}

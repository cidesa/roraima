...
abstract class BaseNpforcarempPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npforcaremp';
	...
	{
		include_once 'lib/model/map/NpforcarempMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpforcarempMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpforcarempMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpforcarempMapBuilder');
}

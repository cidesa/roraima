...
abstract class BaseNpdepfidPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npdepfid';
	...
	{
		include_once 'lib/model/map/NpdepfidMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpdepfidMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpdepfidMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpdepfidMapBuilder');
}

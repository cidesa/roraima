...
abstract class BaseAtdocayuPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Atdocayu';
	...
	{
		include_once 'lib/model/map/AtdocayuMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.AtdocayuMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/AtdocayuMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.AtdocayuMapBuilder');
}

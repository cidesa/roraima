...
abstract class BaseFcsuscanPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcsuscan';
	...
	{
		include_once 'lib/model/map/FcsuscanMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcsuscanMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcsuscanMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcsuscanMapBuilder');
}

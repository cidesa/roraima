...
abstract class BaseTabla21 extends BaseObject  implements Persistent {
	...
	public function setRefpag($v)
	{
		...
		if ($this->refpag !== $v) {
			$this->refpag = $v;
			$this->modifiedColumns[] = Tabla21Peer::REFPAG;
		}
	...
	public function setCodpre($v)
	{
		...
		if ($this->codpre !== $v) {
			$this->codpre = $v;
			$this->modifiedColumns[] = Tabla21Peer::CODPRE;
		}
	...
	public function setMonimp($v)
	{
		...
		if ($this->monimp !== $v) {
			$this->monimp = $v;
			$this->modifiedColumns[] = Tabla21Peer::MONIMP;
		}
	...
	public function setMonaju($v)
	{
		...
		if ($this->monaju !== $v) {
			$this->monaju = $v;
			$this->modifiedColumns[] = Tabla21Peer::MONAJU;
		}
	...
	public function setStaimp($v)
	{
		...
		if ($this->staimp !== $v) {
			$this->staimp = $v;
			$this->modifiedColumns[] = Tabla21Peer::STAIMP;
		}
	...
	public function setRefere($v)
	{
		...
		if ($this->refere !== $v) {
			$this->refere = $v;
			$this->modifiedColumns[] = Tabla21Peer::REFERE;
		}
	...
	public function setRefprc($v)
	{
		...
		if ($this->refprc !== $v) {
			$this->refprc = $v;
			$this->modifiedColumns[] = Tabla21Peer::REFPRC;
		}
	...
	public function setRefcom($v)
	{
		...
		if ($this->refcom !== $v) {
			$this->refcom = $v;
			$this->modifiedColumns[] = Tabla21Peer::REFCOM;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = Tabla21Peer::ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Tabla21 object", $e);
		}
	}
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Tabla21Peer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setNew(false);
				} else {
					$affectedRows += Tabla21Peer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Tabla21Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Tabla21Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Tabla21Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Tabla21Peer::REFPAG)) $criteria->add(Tabla21Peer::REFPAG, $this->refpag);
		if ($this->isColumnModified(Tabla21Peer::CODPRE)) $criteria->add(Tabla21Peer::CODPRE, $this->codpre);
		if ($this->isColumnModified(Tabla21Peer::MONIMP)) $criteria->add(Tabla21Peer::MONIMP, $this->monimp);
		if ($this->isColumnModified(Tabla21Peer::MONAJU)) $criteria->add(Tabla21Peer::MONAJU, $this->monaju);
		if ($this->isColumnModified(Tabla21Peer::STAIMP)) $criteria->add(Tabla21Peer::STAIMP, $this->staimp);
		if ($this->isColumnModified(Tabla21Peer::REFERE)) $criteria->add(Tabla21Peer::REFERE, $this->refere);
		if ($this->isColumnModified(Tabla21Peer::REFPRC)) $criteria->add(Tabla21Peer::REFPRC, $this->refprc);
		if ($this->isColumnModified(Tabla21Peer::REFCOM)) $criteria->add(Tabla21Peer::REFCOM, $this->refcom);
		if ($this->isColumnModified(Tabla21Peer::ID)) $criteria->add(Tabla21Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Tabla21Peer::ID, $this->id);

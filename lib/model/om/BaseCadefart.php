...
abstract class BaseCadefart extends BaseObject  implements Persistent {
  ...
  public function getLonart()
  {
    ...
    return number_format($this->lonart,2,',','.');
  ...
  public function getRupart()
  {
    ...
    return number_format($this->rupart,2,',','.');
  ...
  public function getRecart()
  {
    ...
    return number_format($this->recart,2,',','.');
  ...
  public function getOrdcom()
  {
    ...
    return number_format($this->ordcom,2,',','.');
  ...
  public function getReqart()
  {
    ...
    return number_format($this->reqart,2,',','.');
  ...
  public function getDphart()
  {
    ...
    return number_format($this->dphart,2,',','.');
  ...
  public function getOrdser()
  {
    ...
    return number_format($this->ordser,2,',','.');
  ...
  public function getSolcom()
  {
    ...
    return number_format($this->solcom,2,',','.');

...
abstract class BaseFcvalinmoldPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcvalinmold';
	...
	{
		include_once 'lib/model/map/FcvalinmoldMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcvalinmoldMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcvalinmoldMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcvalinmoldMapBuilder');
}

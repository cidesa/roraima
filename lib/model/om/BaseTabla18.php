...
abstract class BaseTabla18 extends BaseObject  implements Persistent {
	...
	public function setRefcau($v)
	{
		...
		if ($this->refcau !== $v) {
			$this->refcau = $v;
			$this->modifiedColumns[] = Tabla18Peer::REFCAU;
		}
	...
	public function setCodpre($v)
	{
		...
		if ($this->codpre !== $v) {
			$this->codpre = $v;
			$this->modifiedColumns[] = Tabla18Peer::CODPRE;
		}
	...
	public function setMonimp($v)
	{
		...
		if ($this->monimp !== $v) {
			$this->monimp = $v;
			$this->modifiedColumns[] = Tabla18Peer::MONIMP;
		}
	...
	public function setMonpag($v)
	{
		...
		if ($this->monpag !== $v) {
			$this->monpag = $v;
			$this->modifiedColumns[] = Tabla18Peer::MONPAG;
		}
	...
	public function setMonaju($v)
	{
		...
		if ($this->monaju !== $v) {
			$this->monaju = $v;
			$this->modifiedColumns[] = Tabla18Peer::MONAJU;
		}
	...
	public function setStaimp($v)
	{
		...
		if ($this->staimp !== $v) {
			$this->staimp = $v;
			$this->modifiedColumns[] = Tabla18Peer::STAIMP;
		}
	...
	public function setRefere($v)
	{
		...
		if ($this->refere !== $v) {
			$this->refere = $v;
			$this->modifiedColumns[] = Tabla18Peer::REFERE;
		}
	...
	public function setRefprc($v)
	{
		...
		if ($this->refprc !== $v) {
			$this->refprc = $v;
			$this->modifiedColumns[] = Tabla18Peer::REFPRC;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = Tabla18Peer::ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Tabla18 object", $e);
		}
	}
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Tabla18Peer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setNew(false);
				} else {
					$affectedRows += Tabla18Peer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Tabla18Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Tabla18Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Tabla18Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Tabla18Peer::REFCAU)) $criteria->add(Tabla18Peer::REFCAU, $this->refcau);
		if ($this->isColumnModified(Tabla18Peer::CODPRE)) $criteria->add(Tabla18Peer::CODPRE, $this->codpre);
		if ($this->isColumnModified(Tabla18Peer::MONIMP)) $criteria->add(Tabla18Peer::MONIMP, $this->monimp);
		if ($this->isColumnModified(Tabla18Peer::MONPAG)) $criteria->add(Tabla18Peer::MONPAG, $this->monpag);
		if ($this->isColumnModified(Tabla18Peer::MONAJU)) $criteria->add(Tabla18Peer::MONAJU, $this->monaju);
		if ($this->isColumnModified(Tabla18Peer::STAIMP)) $criteria->add(Tabla18Peer::STAIMP, $this->staimp);
		if ($this->isColumnModified(Tabla18Peer::REFERE)) $criteria->add(Tabla18Peer::REFERE, $this->refere);
		if ($this->isColumnModified(Tabla18Peer::REFPRC)) $criteria->add(Tabla18Peer::REFPRC, $this->refprc);
		if ($this->isColumnModified(Tabla18Peer::ID)) $criteria->add(Tabla18Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Tabla18Peer::ID, $this->id);

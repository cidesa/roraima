...
abstract class BaseCpimpapaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Cpimpapa';
	...
	{
		include_once 'lib/model/map/CpimpapaMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CpimpapaMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CpimpapaMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CpimpapaMapBuilder');
}

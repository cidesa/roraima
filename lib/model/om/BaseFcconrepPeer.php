...
abstract class BaseFcconrepPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcconrep';
	...
	{
		include_once 'lib/model/map/FcconrepMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcconrepMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcconrepMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcconrepMapBuilder');
}

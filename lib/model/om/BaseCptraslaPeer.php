...
abstract class BaseCptraslaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Cptrasla';
	...
	{
		include_once 'lib/model/map/CptraslaMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CptraslaMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CptraslaMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CptraslaMapBuilder');
}

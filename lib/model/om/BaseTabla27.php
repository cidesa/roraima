...
abstract class BaseTabla27 extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->refcom !== $v) {
        $this->refcom = $v;
        $this->modifiedColumns[] = Tabla27Peer::REFCOM;
      }
    ...
    if ($this->codpre !== $v) {
        $this->codpre = $v;
        $this->modifiedColumns[] = Tabla27Peer::CODPRE;
      }
    ...
    if ($this->monimp !== $v) {
        ...
        $this->modifiedColumns[] = Tabla27Peer::MONIMP;
      }
    ...
    if ($this->moncau !== $v) {
        ...
        $this->modifiedColumns[] = Tabla27Peer::MONCAU;
      }
    ...
    if ($this->monpag !== $v) {
        ...
        $this->modifiedColumns[] = Tabla27Peer::MONPAG;
      }
    ...
    if ($this->monaju !== $v) {
        ...
        $this->modifiedColumns[] = Tabla27Peer::MONAJU;
      }
    ...
    if ($this->staimp !== $v) {
        $this->staimp = $v;
        $this->modifiedColumns[] = Tabla27Peer::STAIMP;
      }
    ...
    if ($this->refere !== $v) {
        $this->refere = $v;
        $this->modifiedColumns[] = Tabla27Peer::REFERE;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = Tabla27Peer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Tabla27 object", $e);
    }
  }
  ...
  public function __call($m, $a)
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Tabla27Peer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += Tabla27Peer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Tabla27Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Tabla27Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Tabla27Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Tabla27Peer::REFCOM)) $criteria->add(Tabla27Peer::REFCOM, $this->refcom);
		if ($this->isColumnModified(Tabla27Peer::CODPRE)) $criteria->add(Tabla27Peer::CODPRE, $this->codpre);
		if ($this->isColumnModified(Tabla27Peer::MONIMP)) $criteria->add(Tabla27Peer::MONIMP, $this->monimp);
		if ($this->isColumnModified(Tabla27Peer::MONCAU)) $criteria->add(Tabla27Peer::MONCAU, $this->moncau);
		if ($this->isColumnModified(Tabla27Peer::MONPAG)) $criteria->add(Tabla27Peer::MONPAG, $this->monpag);
		if ($this->isColumnModified(Tabla27Peer::MONAJU)) $criteria->add(Tabla27Peer::MONAJU, $this->monaju);
		if ($this->isColumnModified(Tabla27Peer::STAIMP)) $criteria->add(Tabla27Peer::STAIMP, $this->staimp);
		if ($this->isColumnModified(Tabla27Peer::REFERE)) $criteria->add(Tabla27Peer::REFERE, $this->refere);
		if ($this->isColumnModified(Tabla27Peer::ID)) $criteria->add(Tabla27Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Tabla27Peer::ID, $this->id);

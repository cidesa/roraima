...
abstract class BaseFcactcomPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcactcom';
	...
	{
		include_once 'lib/model/map/FcactcomMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcactcomMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcactcomMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcactcomMapBuilder');
}

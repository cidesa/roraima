...
abstract class BaseCitipingPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Citiping';
	...
	{
		include_once 'lib/model/map/CitipingMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CitipingMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CitipingMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CitipingMapBuilder');
}

...
abstract class BaseNpcalconcolPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npcalconcol';
	...
	{
		include_once 'lib/model/map/NpcalconcolMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpcalconcolMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpcalconcolMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpcalconcolMapBuilder');
}

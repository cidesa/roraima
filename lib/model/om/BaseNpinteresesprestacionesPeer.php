...
abstract class BaseNpinteresesprestacionesPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npinteresesprestaciones';
	...
	{
		include_once 'lib/model/map/NpinteresesprestacionesMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpinteresesprestacionesMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpinteresesprestacionesMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpinteresesprestacionesMapBuilder');
}

...
abstract class BaseNphojintincPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Nphojintinc';
	...
	{
		include_once 'lib/model/map/NphojintincMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NphojintincMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NphojintincMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NphojintincMapBuilder');
}

...
abstract class BaseTabla14 extends BaseObject  implements Persistent {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Tabla14Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Tabla14Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Tabla14Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Tabla14Peer::REFPAG)) $criteria->add(Tabla14Peer::REFPAG, $this->refpag);
		if ($this->isColumnModified(Tabla14Peer::TIPPAG)) $criteria->add(Tabla14Peer::TIPPAG, $this->tippag);
		if ($this->isColumnModified(Tabla14Peer::FECPAG)) $criteria->add(Tabla14Peer::FECPAG, $this->fecpag);
		if ($this->isColumnModified(Tabla14Peer::ANOPAG)) $criteria->add(Tabla14Peer::ANOPAG, $this->anopag);
		if ($this->isColumnModified(Tabla14Peer::REFCAU)) $criteria->add(Tabla14Peer::REFCAU, $this->refcau);
		if ($this->isColumnModified(Tabla14Peer::TIPCAU)) $criteria->add(Tabla14Peer::TIPCAU, $this->tipcau);
		if ($this->isColumnModified(Tabla14Peer::DESPAG)) $criteria->add(Tabla14Peer::DESPAG, $this->despag);
		if ($this->isColumnModified(Tabla14Peer::DESANU)) $criteria->add(Tabla14Peer::DESANU, $this->desanu);
		if ($this->isColumnModified(Tabla14Peer::MONPAG)) $criteria->add(Tabla14Peer::MONPAG, $this->monpag);
		if ($this->isColumnModified(Tabla14Peer::SALAJU)) $criteria->add(Tabla14Peer::SALAJU, $this->salaju);
		if ($this->isColumnModified(Tabla14Peer::STAPAG)) $criteria->add(Tabla14Peer::STAPAG, $this->stapag);
		if ($this->isColumnModified(Tabla14Peer::FECANU)) $criteria->add(Tabla14Peer::FECANU, $this->fecanu);
		if ($this->isColumnModified(Tabla14Peer::CEDRIF)) $criteria->add(Tabla14Peer::CEDRIF, $this->cedrif);
		if ($this->isColumnModified(Tabla14Peer::ID)) $criteria->add(Tabla14Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Tabla14Peer::ID, $this->id);

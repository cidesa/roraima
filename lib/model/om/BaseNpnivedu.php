...
abstract class BaseNpnivedu extends BaseObject  implements Persistent {
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			NpniveduPeer::doDelete($this, $con);
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = NpniveduPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = NpniveduPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = NpniveduPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NpniveduPeer::CODNIV)) $criteria->add(NpniveduPeer::CODNIV, $this->codniv);
		if ($this->isColumnModified(NpniveduPeer::DESNIV)) $criteria->add(NpniveduPeer::DESNIV, $this->desniv);
		if ($this->isColumnModified(NpniveduPeer::ID)) $criteria->add(NpniveduPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(NpniveduPeer::ID, $this->id);

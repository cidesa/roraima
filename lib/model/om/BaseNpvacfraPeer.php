...
abstract class BaseNpvacfraPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npvacfra';
	...
	{
		include_once 'lib/model/map/NpvacfraMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpvacfraMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpvacfraMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpvacfraMapBuilder');
}

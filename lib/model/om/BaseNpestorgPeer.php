...
abstract class BaseNpestorgPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npestorg';
	...
	{
		include_once 'lib/model/map/NpestorgMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpestorgMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpestorgMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpestorgMapBuilder');
}

...
abstract class BaseTabla34 extends BaseObject  implements Persistent {
	...
	public function setRefcom($v)
	{
		...
		if ($this->refcom !== $v) {
			$this->refcom = $v;
			$this->modifiedColumns[] = Tabla34Peer::REFCOM;
		}
	...
	public function setTipcom($v)
	{
		...
		if ($this->tipcom !== $v) {
			$this->tipcom = $v;
			$this->modifiedColumns[] = Tabla34Peer::TIPCOM;
		}
	...
	public function setFeccom($v)
	{
		...
		if ($this->feccom !== $ts) {
			$this->feccom = $ts;
			$this->modifiedColumns[] = Tabla34Peer::FECCOM;
		}
	...
	public function setAnocom($v)
	{
		...
		if ($this->anocom !== $v) {
			$this->anocom = $v;
			$this->modifiedColumns[] = Tabla34Peer::ANOCOM;
		}
	...
	public function setRefprc($v)
	{
		...
		if ($this->refprc !== $v) {
			$this->refprc = $v;
			$this->modifiedColumns[] = Tabla34Peer::REFPRC;
		}
	...
	public function setTipprc($v)
	{
		...
		if ($this->tipprc !== $v) {
			$this->tipprc = $v;
			$this->modifiedColumns[] = Tabla34Peer::TIPPRC;
		}
	...
	public function setDescom($v)
	{
		...
		if ($this->descom !== $v) {
			$this->descom = $v;
			$this->modifiedColumns[] = Tabla34Peer::DESCOM;
		}
	...
	public function setDesanu($v)
	{
		...
		if ($this->desanu !== $v) {
			$this->desanu = $v;
			$this->modifiedColumns[] = Tabla34Peer::DESANU;
		}
	...
	public function setMoncom($v)
	{
		...
		if ($this->moncom !== $v) {
			$this->moncom = $v;
			$this->modifiedColumns[] = Tabla34Peer::MONCOM;
		}
	...
	public function setSalcau($v)
	{
		...
		if ($this->salcau !== $v) {
			$this->salcau = $v;
			$this->modifiedColumns[] = Tabla34Peer::SALCAU;
		}
	...
	public function setSalpag($v)
	{
		...
		if ($this->salpag !== $v) {
			$this->salpag = $v;
			$this->modifiedColumns[] = Tabla34Peer::SALPAG;
		}
	...
	public function setSalaju($v)
	{
		...
		if ($this->salaju !== $v) {
			$this->salaju = $v;
			$this->modifiedColumns[] = Tabla34Peer::SALAJU;
		}
	...
	public function setStacom($v)
	{
		...
		if ($this->stacom !== $v) {
			$this->stacom = $v;
			$this->modifiedColumns[] = Tabla34Peer::STACOM;
		}
	...
	public function setFecanu($v)
	{
		...
		if ($this->fecanu !== $ts) {
			$this->fecanu = $ts;
			$this->modifiedColumns[] = Tabla34Peer::FECANU;
		}
	...
	public function setCedrif($v)
	{
		...
		if ($this->cedrif !== $v) {
			$this->cedrif = $v;
			$this->modifiedColumns[] = Tabla34Peer::CEDRIF;
		}
	...
	public function setTipo($v)
	{
		...
		if ($this->tipo !== $v) {
			$this->tipo = $v;
			$this->modifiedColumns[] = Tabla34Peer::TIPO;
		}
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = Tabla34Peer::ID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating Tabla34 object", $e);
		}
	}
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Tabla34Peer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setNew(false);
				} else {
					$affectedRows += Tabla34Peer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Tabla34Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Tabla34Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Tabla34Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Tabla34Peer::REFCOM)) $criteria->add(Tabla34Peer::REFCOM, $this->refcom);
		if ($this->isColumnModified(Tabla34Peer::TIPCOM)) $criteria->add(Tabla34Peer::TIPCOM, $this->tipcom);
		if ($this->isColumnModified(Tabla34Peer::FECCOM)) $criteria->add(Tabla34Peer::FECCOM, $this->feccom);
		if ($this->isColumnModified(Tabla34Peer::ANOCOM)) $criteria->add(Tabla34Peer::ANOCOM, $this->anocom);
		if ($this->isColumnModified(Tabla34Peer::REFPRC)) $criteria->add(Tabla34Peer::REFPRC, $this->refprc);
		if ($this->isColumnModified(Tabla34Peer::TIPPRC)) $criteria->add(Tabla34Peer::TIPPRC, $this->tipprc);
		if ($this->isColumnModified(Tabla34Peer::DESCOM)) $criteria->add(Tabla34Peer::DESCOM, $this->descom);
		if ($this->isColumnModified(Tabla34Peer::DESANU)) $criteria->add(Tabla34Peer::DESANU, $this->desanu);
		if ($this->isColumnModified(Tabla34Peer::MONCOM)) $criteria->add(Tabla34Peer::MONCOM, $this->moncom);
		if ($this->isColumnModified(Tabla34Peer::SALCAU)) $criteria->add(Tabla34Peer::SALCAU, $this->salcau);
		if ($this->isColumnModified(Tabla34Peer::SALPAG)) $criteria->add(Tabla34Peer::SALPAG, $this->salpag);
		if ($this->isColumnModified(Tabla34Peer::SALAJU)) $criteria->add(Tabla34Peer::SALAJU, $this->salaju);
		if ($this->isColumnModified(Tabla34Peer::STACOM)) $criteria->add(Tabla34Peer::STACOM, $this->stacom);
		if ($this->isColumnModified(Tabla34Peer::FECANU)) $criteria->add(Tabla34Peer::FECANU, $this->fecanu);
		if ($this->isColumnModified(Tabla34Peer::CEDRIF)) $criteria->add(Tabla34Peer::CEDRIF, $this->cedrif);
		if ($this->isColumnModified(Tabla34Peer::TIPO)) $criteria->add(Tabla34Peer::TIPO, $this->tipo);
		if ($this->isColumnModified(Tabla34Peer::ID)) $criteria->add(Tabla34Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Tabla34Peer::ID, $this->id);

...
abstract class BaseAtrecayuPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Atrecayu';
	...
	{
		include_once 'lib/model/map/AtrecayuMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.AtrecayuMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/AtrecayuMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.AtrecayuMapBuilder');
}

...
abstract class BaseNphojintbanPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Nphojintban';
	...
	{
		include_once 'lib/model/map/NphojintbanMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NphojintbanMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NphojintbanMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NphojintbanMapBuilder');
}

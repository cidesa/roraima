...
abstract class BaseNpacumulacptPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npacumulacpt';
	...
	{
		include_once 'lib/model/map/NpacumulacptMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpacumulacptMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpacumulacptMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpacumulacptMapBuilder');
}

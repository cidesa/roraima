...
abstract class BaseFcpreingPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcpreing';
	...
	{
		include_once 'lib/model/map/FcpreingMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcpreingMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcpreingMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcpreingMapBuilder');
}

...
abstract class BaseCausuuniPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Causuuni';
	...
	{
		include_once 'lib/model/map/CausuuniMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CausuuniMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CausuuniMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CausuuniMapBuilder');
}

...
abstract class BaseNpordpagPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npordpag';
	...
	{
		include_once 'lib/model/map/NpordpagMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpordpagMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpordpagMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpordpagMapBuilder');
}

...
abstract class BaseFadescartPeer {
	...
	{
		include_once 'lib/model/map/FadescartMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FadescartMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FadescartMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FadescartMapBuilder');
}

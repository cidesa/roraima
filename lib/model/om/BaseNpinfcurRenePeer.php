...
abstract class BaseNpinfcurRenePeer {
	...
	const CLASS_DEFAULT = 'lib.model.NpinfcurRene';
	...
	{
		include_once 'lib/model/map/NpinfcurReneMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpinfcurReneMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpinfcurReneMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpinfcurReneMapBuilder');
}

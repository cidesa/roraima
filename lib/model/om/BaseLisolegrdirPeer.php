...
abstract class BaseLisolegrdirPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Lisolegrdir';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Numsol', 'Codart', 'Cantid', 'Coduniste', 'Id', ),
		BasePeer::TYPE_COLNAME => array (LisolegrdirPeer::NUMSOL, LisolegrdirPeer::CODART, LisolegrdirPeer::CANTID, LisolegrdirPeer::CODUNISTE, LisolegrdirPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('numsol', 'codart', 'cantid', 'coduniste', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Numsol' => 0, 'Codart' => 1, 'Cantid' => 2, 'Coduniste' => 3, 'Id' => 4, ),
		BasePeer::TYPE_COLNAME => array (LisolegrdirPeer::NUMSOL => 0, LisolegrdirPeer::CODART => 1, LisolegrdirPeer::CANTID => 2, LisolegrdirPeer::CODUNISTE => 3, LisolegrdirPeer::ID => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('numsol' => 0, 'codart' => 1, 'cantid' => 2, 'coduniste' => 3, 'id' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	{
		include_once 'lib/model/map/LisolegrdirMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.LisolegrdirMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/LisolegrdirMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.LisolegrdirMapBuilder');
}

...
abstract class BaseFcdprinmPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcdprinm';
	...
	{
		include_once 'lib/model/map/FcdprinmMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcdprinmMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcdprinmMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcdprinmMapBuilder');
}

...
abstract class BaseFctipespdetPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fctipespdet';
	...
	{
		include_once 'lib/model/map/FctipespdetMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FctipespdetMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FctipespdetMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FctipespdetMapBuilder');
}

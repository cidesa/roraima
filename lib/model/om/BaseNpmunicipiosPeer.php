...
abstract class BaseNpmunicipiosPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npmunicipios';
	...
	{
		include_once 'lib/model/map/NpmunicipiosMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpmunicipiosMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpmunicipiosMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpmunicipiosMapBuilder');
}

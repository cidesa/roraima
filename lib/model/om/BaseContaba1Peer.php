...
abstract class BaseContaba1Peer {
	...
	const CLASS_DEFAULT = 'lib.model.Contaba1';
	...
	{
		include_once 'lib/model/map/Contaba1MapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.Contaba1MapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/Contaba1MapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.Contaba1MapBuilder');
}

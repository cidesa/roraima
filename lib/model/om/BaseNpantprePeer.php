...
abstract class BaseNpantprePeer {
	...
	{
		include_once 'lib/model/map/NpantpreMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpantpreMapBuilder');
	}
	
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = NpantprePeer::getTableMap();
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(NpantprePeer::CODEMP);

		$criteria->addSelectColumn(NpantprePeer::FECANT);
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(NpantprePeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(NpantprePeer::COUNT);
		}
		...
		$rs = NpantprePeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	public static function doSelectOne(Criteria $criteria, $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = NpantprePeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	public static function doSelectRS(Criteria $criteria, $con = null)
	{
		...
		if (!$criteria->getSelectColumns()) {
			$criteria = clone $criteria;
			NpantprePeer::addSelectColumns($criteria);
		}
	...
	public static function doDeleteAll($con = null)
	{
		...
		$affectedRows = 0; 		try {
									$con->begin();
			$affectedRows += BasePeer::doDeleteAll(NpantprePeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollback();
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof Npantpre) {

			$criteria = $values->buildPkeyCriteria();
		} else {
						$criteria = new Criteria(self::DATABASE_NAME);
			$criteria->add(NpantprePeer::ID, (array) $values, Criteria::IN);
		}
	...
	public static function doValidate(Npantpre $obj, $cols = null)
	{
		...
		if ($cols) {
			$dbMap = Propel::getDatabaseMap(NpantprePeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(NpantprePeer::TABLE_NAME);
		...
		$res =  BasePeer::doValidate(NpantprePeer::DATABASE_NAME, NpantprePeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = NpantprePeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(NpantprePeer::ID, $pk);


		$v = NpantprePeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(NpantprePeer::ID, $pks, Criteria::IN);
			$objs = NpantprePeer::doSelect($criteria, $con);
		}
		return $objs;
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpantpreMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpantpreMapBuilder');
}

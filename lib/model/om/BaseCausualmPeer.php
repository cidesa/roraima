...
abstract class BaseCausualmPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Causualm';
	...
	{
		include_once 'lib/model/map/CausualmMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CausualmMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CausualmMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CausualmMapBuilder');
}

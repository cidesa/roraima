...
abstract class BaseFcestingPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcesting';
	...
	{
		include_once 'lib/model/map/FcestingMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcestingMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcestingMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcestingMapBuilder');
}

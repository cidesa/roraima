...
abstract class BaseCpartleyPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Cpartley';
	...
	{
		include_once 'lib/model/map/CpartleyMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CpartleyMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CpartleyMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CpartleyMapBuilder');
}

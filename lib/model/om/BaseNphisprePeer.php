...
abstract class BaseNphisprePeer {
	...
	const CLASS_DEFAULT = 'lib.model.Nphispre';
	...
	{
		include_once 'lib/model/map/NphispreMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NphispreMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NphispreMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NphispreMapBuilder');
}

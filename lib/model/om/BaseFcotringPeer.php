...
abstract class BaseFcotringPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcotring';
	...
	{
		include_once 'lib/model/map/FcotringMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcotringMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcotringMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcotringMapBuilder');
}

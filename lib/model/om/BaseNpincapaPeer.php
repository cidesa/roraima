...
abstract class BaseNpincapaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npincapa';
	...
	{
		include_once 'lib/model/map/NpincapaMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpincapaMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpincapaMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpincapaMapBuilder');
}

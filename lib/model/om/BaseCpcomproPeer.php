...
abstract class BaseCpcomproPeer {
	...
	{
		include_once 'lib/model/map/CpcomproMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CpcomproMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CpcomproMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CpcomproMapBuilder');
}

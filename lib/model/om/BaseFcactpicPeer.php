...
abstract class BaseFcactpicPeer {
	...
	{
		include_once 'lib/model/map/FcactpicMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcactpicMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcactpicMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcactpicMapBuilder');
}

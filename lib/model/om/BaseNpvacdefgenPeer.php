...
abstract class BaseNpvacdefgenPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npvacdefgen';
	...
	{
		include_once 'lib/model/map/NpvacdefgenMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpvacdefgenMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpvacdefgenMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpvacdefgenMapBuilder');
}

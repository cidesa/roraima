...
abstract class BaseCpasiini extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->codpre !== $v) {
        $this->codpre = $v;
        $this->modifiedColumns[] = CpasiiniPeer::CODPRE;
      }
    ...
    if ($this->nompre !== $v) {
        $this->nompre = $v;
        $this->modifiedColumns[] = CpasiiniPeer::NOMPRE;
      }
    ...
    if ($this->perpre !== $v) {
        $this->perpre = $v;
        $this->modifiedColumns[] = CpasiiniPeer::PERPRE;
      }
    ...
    if ($this->anopre !== $v) {
        $this->anopre = $v;
        $this->modifiedColumns[] = CpasiiniPeer::ANOPRE;
      }
    ...
    if ($this->monasi !== $v) {
        ...
        $this->modifiedColumns[] = CpasiiniPeer::MONASI;
      }
    ...
    if ($this->monprc !== $v) {
        ...
        $this->modifiedColumns[] = CpasiiniPeer::MONPRC;
      }
    ...
    if ($this->moncom !== $v) {
        ...
        $this->modifiedColumns[] = CpasiiniPeer::MONCOM;
      }
    ...
    if ($this->moncau !== $v) {
        ...
        $this->modifiedColumns[] = CpasiiniPeer::MONCAU;
      }
    ...
    if ($this->monpag !== $v) {
        ...
        $this->modifiedColumns[] = CpasiiniPeer::MONPAG;
      }
    ...
    if ($this->montra !== $v) {
        ...
        $this->modifiedColumns[] = CpasiiniPeer::MONTRA;
      }
    ...
    if ($this->montrn !== $v) {
        ...
        $this->modifiedColumns[] = CpasiiniPeer::MONTRN;
      }
    ...
    if ($this->monadi !== $v) {
        ...
        $this->modifiedColumns[] = CpasiiniPeer::MONADI;
      }
    ...
    if ($this->mondim !== $v) {
        ...
        $this->modifiedColumns[] = CpasiiniPeer::MONDIM;
      }
    ...
    if ($this->monaju !== $v) {
        ...
        $this->modifiedColumns[] = CpasiiniPeer::MONAJU;
      }
    ...
    if ($this->mondis !== $v) {
        ...
        $this->modifiedColumns[] = CpasiiniPeer::MONDIS;
      }
    ...
    if ($this->difere !== $v) {
        ...
        $this->modifiedColumns[] = CpasiiniPeer::DIFERE;
      }
    ...
    if ($this->status !== $v) {
        $this->status = $v;
        $this->modifiedColumns[] = CpasiiniPeer::STATUS;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = CpasiiniPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Cpasiini object", $e);
    }
  }
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			CpasiiniPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CpasiiniPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += CpasiiniPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CpasiiniPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CpasiiniPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CpasiiniPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CpasiiniPeer::CODPRE)) $criteria->add(CpasiiniPeer::CODPRE, $this->codpre);
		if ($this->isColumnModified(CpasiiniPeer::NOMPRE)) $criteria->add(CpasiiniPeer::NOMPRE, $this->nompre);
		if ($this->isColumnModified(CpasiiniPeer::PERPRE)) $criteria->add(CpasiiniPeer::PERPRE, $this->perpre);
		if ($this->isColumnModified(CpasiiniPeer::ANOPRE)) $criteria->add(CpasiiniPeer::ANOPRE, $this->anopre);
		if ($this->isColumnModified(CpasiiniPeer::MONASI)) $criteria->add(CpasiiniPeer::MONASI, $this->monasi);
		if ($this->isColumnModified(CpasiiniPeer::MONPRC)) $criteria->add(CpasiiniPeer::MONPRC, $this->monprc);
		if ($this->isColumnModified(CpasiiniPeer::MONCOM)) $criteria->add(CpasiiniPeer::MONCOM, $this->moncom);
		if ($this->isColumnModified(CpasiiniPeer::MONCAU)) $criteria->add(CpasiiniPeer::MONCAU, $this->moncau);
		if ($this->isColumnModified(CpasiiniPeer::MONPAG)) $criteria->add(CpasiiniPeer::MONPAG, $this->monpag);
		if ($this->isColumnModified(CpasiiniPeer::MONTRA)) $criteria->add(CpasiiniPeer::MONTRA, $this->montra);
		if ($this->isColumnModified(CpasiiniPeer::MONTRN)) $criteria->add(CpasiiniPeer::MONTRN, $this->montrn);
		if ($this->isColumnModified(CpasiiniPeer::MONADI)) $criteria->add(CpasiiniPeer::MONADI, $this->monadi);
		if ($this->isColumnModified(CpasiiniPeer::MONDIM)) $criteria->add(CpasiiniPeer::MONDIM, $this->mondim);
		if ($this->isColumnModified(CpasiiniPeer::MONAJU)) $criteria->add(CpasiiniPeer::MONAJU, $this->monaju);
		if ($this->isColumnModified(CpasiiniPeer::MONDIS)) $criteria->add(CpasiiniPeer::MONDIS, $this->mondis);
		if ($this->isColumnModified(CpasiiniPeer::DIFERE)) $criteria->add(CpasiiniPeer::DIFERE, $this->difere);
		if ($this->isColumnModified(CpasiiniPeer::STATUS)) $criteria->add(CpasiiniPeer::STATUS, $this->status);
		if ($this->isColumnModified(CpasiiniPeer::ID)) $criteria->add(CpasiiniPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CpasiiniPeer::ID, $this->id);

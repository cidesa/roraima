...
abstract class BaseNpconceptosbonoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npconceptosbono';
	...
	{
		include_once 'lib/model/map/NpconceptosbonoMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpconceptosbonoMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpconceptosbonoMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpconceptosbonoMapBuilder');
}

...
abstract class BaseAttipvivPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Attipviv';
	...
	{
		include_once 'lib/model/map/AttipvivMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.AttipvivMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/AttipvivMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.AttipvivMapBuilder');
}

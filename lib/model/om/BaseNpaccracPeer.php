...
abstract class BaseNpaccracPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Npaccrac';
	...
	{
		include_once 'lib/model/map/NpaccracMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NpaccracMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NpaccracMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NpaccracMapBuilder');
}

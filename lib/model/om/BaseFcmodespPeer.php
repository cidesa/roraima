...
abstract class BaseFcmodespPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcmodesp';
	...
	{
		include_once 'lib/model/map/FcmodespMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcmodespMapBuilder');
	}
	...
	const COUNT = 'COUNT(fcmodesp.REFMOD)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT fcmodesp.REFMOD)';
	...
	public static function doCountJoinFcesppub(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(FcmodespPeer::NROCON, FcesppubPeer::NROCON);
	...
	public static function doSelectJoinFcesppub(Criteria $c, $con = null)
	{
		$c = clone $c;
		...
		FcmodespPeer::addSelectColumns($c);
		$startcol = (FcmodespPeer::NUM_COLUMNS - FcmodespPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		FcesppubPeer::addSelectColumns($c);

		$c->addJoin(FcmodespPeer::NROCON, FcesppubPeer::NROCON);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getFcesppub(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		FcmodespPeer::addSelectColumns($c);
		$startcol2 = (FcmodespPeer::NUM_COLUMNS - FcmodespPeer::NUM_LAZY_LOAD_COLUMNS) + 1;

		FcesppubPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + FcesppubPeer::NUM_COLUMNS;
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(FcmodespPeer::REFMOD);
			$selectCriteria->add(FcmodespPeer::REFMOD, $criteria->remove(FcmodespPeer::REFMOD), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(FcmodespPeer::REFMOD, (array) $values, Criteria::IN);
		}
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(FcmodespPeer::REFMOD, $pk);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(FcmodespPeer::REFMOD, $pks, Criteria::IN);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcmodespMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcmodespMapBuilder');
}

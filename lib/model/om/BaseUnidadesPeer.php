...
abstract class BaseUnidadesPeer {
	...
	const CODUBI = 'unidades.CODUBI';

	
	const DESUBI = 'unidades.DESUBI';

	
	const STACOD = 'unidades.STACOD';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (UnidadesPeer::CODUBI, UnidadesPeer::DESUBI, UnidadesPeer::STACOD, UnidadesPeer::ID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (UnidadesPeer::CODUBI => 0, UnidadesPeer::DESUBI => 1, UnidadesPeer::STACOD => 2, UnidadesPeer::ID => 3, ),
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UnidadesPeer::CODUBI);

		$criteria->addSelectColumn(UnidadesPeer::DESUBI);

		$criteria->addSelectColumn(UnidadesPeer::STACOD);

		$criteria->addSelectColumn(UnidadesPeer::ID);

	}

	const COUNT = 'COUNT(unidades.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT unidades.ID)';
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(UnidadesPeer::ID); 
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(UnidadesPeer::ID);
			$selectCriteria->add(UnidadesPeer::ID, $criteria->remove(UnidadesPeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(UnidadesPeer::ID, (array) $values, Criteria::IN);
		}
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(UnidadesPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(UnidadesPeer::ID, $pks, Criteria::IN);

...
abstract class BaseCpdefnivPeer {
	...
	{
		include_once 'lib/model/map/CpdefnivMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.CpdefnivMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/CpdefnivMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.CpdefnivMapBuilder');
}

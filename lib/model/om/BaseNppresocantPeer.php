...
abstract class BaseNppresocantPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Nppresocant';
	...
	{
		include_once 'lib/model/map/NppresocantMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.NppresocantMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/NppresocantMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.NppresocantMapBuilder');
}

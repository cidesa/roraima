...
abstract class BaseReimpcau extends BaseObject  implements Persistent {
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			ReimpcauPeer::doDelete($this, $con);
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ReimpcauPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ReimpcauPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ReimpcauPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ReimpcauPeer::REFCAU)) $criteria->add(ReimpcauPeer::REFCAU, $this->refcau);
		if ($this->isColumnModified(ReimpcauPeer::CODPRE)) $criteria->add(ReimpcauPeer::CODPRE, $this->codpre);
		if ($this->isColumnModified(ReimpcauPeer::MONIMP)) $criteria->add(ReimpcauPeer::MONIMP, $this->monimp);
		if ($this->isColumnModified(ReimpcauPeer::MONPAG)) $criteria->add(ReimpcauPeer::MONPAG, $this->monpag);
		if ($this->isColumnModified(ReimpcauPeer::MONAJU)) $criteria->add(ReimpcauPeer::MONAJU, $this->monaju);
		if ($this->isColumnModified(ReimpcauPeer::STAIMP)) $criteria->add(ReimpcauPeer::STAIMP, $this->staimp);
		if ($this->isColumnModified(ReimpcauPeer::REFERE)) $criteria->add(ReimpcauPeer::REFERE, $this->refere);
		if ($this->isColumnModified(ReimpcauPeer::REFPRC)) $criteria->add(ReimpcauPeer::REFPRC, $this->refprc);
		if ($this->isColumnModified(ReimpcauPeer::ID)) $criteria->add(ReimpcauPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ReimpcauPeer::ID, $this->id);

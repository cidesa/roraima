...
abstract class BaseFcdefncaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fcdefnca';
	...
	{
		include_once 'lib/model/map/FcdefncaMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FcdefncaMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FcdefncaMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FcdefncaMapBuilder');
}

...
abstract class BaseFadefcomPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Fadefcom';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Codcom', 'Nomcom', 'Id', ),
		BasePeer::TYPE_COLNAME => array (FadefcomPeer::CODCOM, FadefcomPeer::NOMCOM, FadefcomPeer::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('codcom', 'nomcom', 'id', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Codcom' => 0, 'Nomcom' => 1, 'Id' => 2, ),
		BasePeer::TYPE_COLNAME => array (FadefcomPeer::CODCOM => 0, FadefcomPeer::NOMCOM => 1, FadefcomPeer::ID => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('codcom' => 0, 'nomcom' => 1, 'id' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		include_once 'lib/model/map/FadefcomMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FadefcomMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FadefcomMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FadefcomMapBuilder');
}

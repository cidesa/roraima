...
class cidesaDefineEnvironmentConfigHandler extends sfDefineEnvironmentConfigHandler
{
  ...
  public function execute($configFiles)
  {
	...
	$dir=CIDESA_CONFIG.'/app.yml';
	cidesaTools::exitsfile($dir) ? $myConfig=$this->mergeEnvironment($this->parseYamls(array('0'=>$dir))) : $myConfig = $this->mergeEnvironment($this->parseYamls($configFiles));

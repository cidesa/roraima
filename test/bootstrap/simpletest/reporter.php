<?php
    ...
    class HtmlReporter extends SimpleReporter {
        ...
        function paintFooter($test_name) {
            ...
            print "<strong>" . $this->getPassCount() . "</strong> pasadas, ";
            print "<strong>" . $this->getFailCount() . "</strong> fallos y ";
            print "<strong>" . $this->getExceptionCount() . "</strong> excepciones.";
            print "</div>\n";
            print "</body>\n</html>\n";
        }
        ...
        function paintFail($message) {
            ...
            print "\n<span class=\"fail\">Fall&oacute;</span> ";
            $breadcrumb = $this->getTestList();
            array_shift($breadcrumb);
            //print implode(" -&gt; ", $breadcrumb);
            print "<br> -&gt; " . $this->_htmlEntities($message) . "</br>\n";
        ...
        function paintError($message) {
            ...
            print "<span class=\"fail\">Excepci&oacute;n</span>: ";
            $breadcrumb = $this->getTestList();
            array_shift($breadcrumb);
            print implode(" -&gt; ", $breadcrumb);

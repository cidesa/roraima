                              ...
                              <? } ?>
                                      ...
                                      <td width="94">
                                        <div align="center">
                                          <label>
                                  <? if ($reqaut=='S') { ?>
                                              <input type="radio" name="reqaut" id="radio" value="">
                                <? } else { ?>
                                  <input type="radio" name="reqaut" id="radio" value="" checked>
                                <? } ?>
                                          No</label></div>
                                          </div></td>
                                    </tr>
     ...
     function consulta()
      {
          ...
          pagina='http://'+host+'/herramientas_dev.php/generales/catalogo/metodo/Cpdoccom_Predoccom/clase/Cpdoccom/frame/form1/obj1/tipdoc/campo1/tipcom/submit/true';

...
//para que corra sin datos
			...
			$this->sqla="select sum(lonniv) + (count(catpar)-1) as suma, count(catpar) as cont
						from forniveles
						where catpar='C'";//H::PrintR($this->sqla);exit;
...
// para que corra sin datos
			...
			$this->sqlg="select substr(a.codcat,1,".$this->agrup.") as cat,a.codcar,a.nomcar,b.codtip,moncar,
						...
						order by substr(a.codcat,1,".$this->agrup.")";//H::PrintR($this->sqlg);exit;
		...
		function Cuerpo()
		{
			...
			if (!$tbg2->EOF)
			{
				...
				$this->Multicell(15,3,"C�digo Cargo",0,"C");
				...
				$this->SetX(90);
				$this->setFont("Arial","B",6);
				$this->Multicell(16,3,"N� Cargos Asignados",0,"C");

				$this->SetY(55);
				$this->SetX(102);
				$this->setFont("Arial","B",6);
				$this->Multicell(16,3,"N� Cargos Vacantes",0,"C");
				...
				$this->SetX(138);
				$this->setFont("Arial","B",6);
				$this->Multicell(15,3,"N� Total Cargos",0,"C");

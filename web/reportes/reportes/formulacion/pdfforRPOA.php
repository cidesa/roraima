	...
	class pdfreporte extends fpdf
	{
		...
		function Cuerpo()
		{
			...
			while (!$tbg->EOF)
			{
				...
				$this->cell(5,5,"ALCALDIA DEL MUNICIPIO 'JOSE FELIX RIBAS'");
				$this->SetTextColor(140,0,0);
				$this->SetY(25);
				$this->SetX(130);
				...
				$sqlx="select sum(b.monto) as monto
				...
				$this->SetX(60);
				$this->setFont("Arial","B",8);
				$this->cell(36,5,"Bs. ".number_format($tbx->fields["monto"],2,'.',','),0,0,"C");
				...
				$this->Multicell(50,3,"14.- TIEMPO DE EJECUCION",0,"L");
					...
					$this->SetY($y+6);
					$this->SetX(215);
					$this->Multicell(60,3,"   1º SEM           %        2º SEM           %",0,"L");

				
					//PRIMER
					$sqlx="select sum(b.monto) as primer
						from

        ...
        <div align="left">&nbsp; 
          <table width="88%" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>PRESUPUESTO DE INGRESOS  
            ...
            <tr>
              <td class="form_label_01" align="left"><strong>Filtro:</strong></td>
              <td colspan="2"><div align="left">
            ...
            <tr> 
              ...
              <td colspan="2"> <div align="left" class="Estilo2">3-02%</div></td>
            </tr>
          </table>
        </div>
        <div align="left">&nbsp; </div>
...
{
	f=document.form1;
	f.titulo.value="PRESUPUESTO DE INGRESOS";
	f.action="rforRPREING.php";
	f.submit();
}
function cerrar()
{

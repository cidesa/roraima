            ...
            <tr>
              ...
              <td><div align="left">
                <?
			  	...
			  	$tb=$bd->select("select
								...
								order by x.par");
			  ?>
                <select name="filtro1" class="breadcrumb" id="filtro1">
                  <?
				  	while(!$tb->EOF)	
					{
				  ?>
                  <option value="<? print $tb->fields["par"];?>"><? print $tb->fields["par"];?></option>
                  <?
					$tb->MoveNext();
					}
				?>
              ...
              <td><?
			  	...
			  	$tb=$bd->select("select
								...
								order by x.par desc");
			  ?>
                <select name="filtro2" class="breadcrumb" id="filtro2">
                  <?
				  	while(!$tb->EOF)	
					{
				  ?>

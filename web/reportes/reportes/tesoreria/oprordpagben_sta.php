        ...
        <div align="left">&nbsp;
          <table width="647" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Listado de Ordenes de Pago  por Beneficiario y Status
            ...
            <tr>
              ...
              <td colspan="2"><input name="nombreben" type="text" class="breadcrumb" id="nombreben" value="%" size="20"></td>
            </tr>
...
{
	f=document.form1;
	f.titulo.value="Listado de Ordenes de Pago por Beneficiario y Status";
	f.action="roprordpagben_sta.php";
	f.submit();
}
function cerrar()
{
...
function catalogo2(campo)
   {
      mysql='select distinct(cedrif) as C.I/RIF. from OPBENEFI order by cedrif';

        ...
        <div align="left">&nbsp;
          <table width="647" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>CIERRE DE CAJA
             ...
             <td> <div align="left">
                   ...
                   value="<?$sql="select min(numcue) as cod from tsdefban";
 					LlenarTextoSql($sql,"cod",$bd); ?>" size ="20">
 					 <input type="button" name="Button5" value="..." onClick=" catalogo4('numcuedes');">
 			      </div></td>
 			      <td> <div align="left">
               	<input name="numcuehas" type="text" class="breadcrumb" id="numcuehas"
                   value="<?$sql="select max(numcue) as cod from tsdefban";
 					LlenarTextoSql($sql,"cod",$bd); ?>" size ="20">
 					 <input type="button" name="Button5" value="..." onClick=" catalogo4('numcuehas');">
 			      </div></td>
              ...
              <td><select name="meses" id="meses" class="breadcrumb">
...
{
	f=document.form1;
	f.titulo.value="Cierre de Caja";
	f.action="rtsrciecaj.php";
	f.submit();
}
function cerrar()
{
...
function catalogo4(campo)
   {
   	   mysql='SELECT DISTINCT(numcue) as CODIGO, numcue as DESCRIPCION FROM tsdefban ORDER BY numcue';

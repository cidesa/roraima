        ...
        <div align="left">&nbsp;
          <table width="678"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#6699CC">
              ...
              <td width="204"> <input name="tamano" type="text" class="breadcrumb" id="tamano" readonly="true"></td>
              <td width="239">&nbsp;</td>
            </tr>
            <tr bordercolor="#6699CC">
            ...
            <tr>
              <td class="form_label_01"> <div align="left"><strong>Nro. de Orden:</strong></div></td>
              <td><div align="left"> </div>
                  <div align="left">
                    <input name="orden" type="text" value="<?
				$sql="select min(numord) as cod from opordpag";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="orden" size="20" maxlength="100">
                    <input type="button" name="Button" value="..." onClick="catalogo('orden');">
                </div></td>
            </tr>
            <tr bordercolor="#FFFFFF">
...
{
	f=document.form1;
	f.titulo.value="COMPROBANTE DE RETENCION DE FIEL CUMPLIMIENTO";
	f.action="roprcompret_fc.php";
	f.submit();
}

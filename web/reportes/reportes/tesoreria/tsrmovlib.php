      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes
            ...
            <tr bordercolor="#6699CC">
             ...
             <td> <div align="left">
                   ...
                   value="<?$sql="select min(numcue) as cod from tsdefban";
 					LlenarTextoSql($sql,"cod",$bd); ?>" size ="21">
		 ...
		 <tr>
             ...
             <td> <div align="left">
              ...
              <td> <div align="left">
                   ...
                   value="<?$sql="SELECT max(codtip) as cod FROM tstipmov";
 					LlenarTextoSql($sql,"cod",$bd); ?>" size ="20">
		...
		<tr>
             ...
             <td> <div align="left">
                   ...
                   value="<?$sql="SELECT min(reflib) as cod FROM tsmovlib";
 					LlenarTextoSql($sql,"cod",$bd); ?>" size ="20">
              ...
              <td> <div align="left">
                   ...
                   value="<?$sql="SELECT max(reflib) as cod FROM tsmovlib";
 					LlenarTextoSql($sql,"cod",$bd); ?>" size ="20">
            ...
            <tr>
              <td class="form_label_01"> <div align="left"><strong>Fecha Transcripci&oacute;n:</strong></div></td>
              <td> <div align="left"> </div>
                <div align="left">
                  <?

			  	$tb=$bd->select("select to_char(MIN(fecing),'DD/MM/YYYY') as fecha1 from tsmovlib");
				if(!$tb->EOF)
				{
					$fecha1=$tb->fields["fecha1"];
				}

			  	$tb2=$bd->select("select to_char(MAX(fecing),'DD/MM/YYYY') as fecha2 from tsmovlib");
				if(!$tb2->EOF)
				{
					$fecha2=$tb2->fields["fecha2"];
				}
				...
				?>
                  <input name="fechat1" type="text" class="breadcrumb" id="fechat1" datepicker="true" value="<? print $fecha1;?>">
                </div></td>
              <td><input name="fechat2" type="text" class="breadcrumb" id="fechat2" datepicker="true" value="<? print $fecha2;?>"></td>
            </tr>

            <tr>
              <td class="form_label_01"> <p><strong>Status</strong><strong>
              ...
              <td colspan="2"> <select name="status" class="breadcrumb" id="select">
                  ...
                  <option value="n">No Contabilizados</option>
                  <option value="ta">Todos menos Anulados</option>
                </select></td>
            </tr>
...
{
	f=document.form1;
	f.titulo.value="MOVIMIENTOS SEGUN LIBROS";
	f.action="rtsrmovlib.php";
	f.submit();
}
function cerrar()
{
...
function catalogo3(campo)
   {
      mysql='SELECT DISTINCT(codtip) as CODIGO, destip as DESCRIPCION  FROM tstipmov ORDER BY codtip';
...
function catalogo4(campo)
   {
      mysql='SELECT DISTINCT(numcue) as CODIGO, nomcue as Nombre FROM TSDEFBAN ORDER BY numcue';
	   pagina="../../lib/general/catalogoobj.php?sql="+mysql+"&campo="+campo;
	  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,resizable=yes,left=50,top=50");
   }
...
function catalogo5(campo)
   {
      mysql='SELECT DISTINCT(reflib) as CODIGO FROM tsmovlib ORDER BY reflib';
	   pagina="../../lib/general/catalogoobj.php?sql="+mysql+"&campo="+campo;
	  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,resizable=yes,left=50,top=50");
   }

          ...
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              ...
              <td> <div align="left">
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(numche) FROM tscheemi ORDER BY numche");
			  ?>
                  <select name="che1" class="breadcrumb" id="che1">
                    <?
				  	while(!$tb->EOF)
					{
				  ?>
                    <option value="<? print $tb->fields["numche"];?>"><? print $tb->fields["numche"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>
              ...
              <td>
                <?
			  	...
			  	$tb2=$bd->select("SELECT DISTINCT(numche) FROM tscheemi ORDER BY numche desc");
			  ?>
                <select name="che2" class="breadcrumb" id="che2">
                  <?
				  while(!$tb2->EOF)
				{
			  ?>
                  <option value="<? print $tb2->fields["numche"];?>"><? print $tb2->fields["numche"];?></option>
                  <?
				  $tb2->MoveNext();
					}
				?>

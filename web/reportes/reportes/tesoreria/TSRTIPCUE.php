          ...
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo 
                  Cuenta:</strong></div></td>
              <td> <div align="left"> 
                  <?
			  	
			  	$tb=$bd->select("select distinct(codtip) from tstipcue order by codtip");
			  ?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select distinct(codtip) from tstipcue order by codtip desc");
			  ?>
...
{
	f=document.form1;
	f.titulo.value="TIPOS DE CUENTA";
	f.action="rTSRTIPCUE.php";
	f.submit();
}
function cerrar()
{

...
$bd->validar();
?>
<form name="form1" method="post" action="roprautpag" id="form1">
            ...
            <tr bordercolor="#6699CC">
              ...
              <td>
                <div align="left">
                  ...
                  <input  type="text" name="numau" class="breadcrumb" id="numau" value="<? print $tb->fields["valor"];?>"/>
                  <input type="button" name="Button" value="..." onclick="catalogo1('numau')" />
</div></td>
              <td>&nbsp;</td>
		    </tr>
			     <!--      <td class="form_label_01">&nbsp;</td>
			           ...
			           <tr bordercolor="#FFFFFF">
                         <td class="form_label_01"><div align="left"><strong> Nombre Beneficiario  Desde:</strong></div></td>
                         <td colspan="2">
			  	$tb2=$bd->select("select min(nomben) as valor from opbenefi");

			    <input size="52" type="text"  name="nomasc" class="breadcrumb" id="nomasc" value="<? print $tb2->fields["valor"];?>"/>
                  <input type="button" name="Button" value="..." onclick="catalogo2('nomasc')" />
                             </td>
            </tr>
			           <tr bordercolor="#FFFFFF">
                         <td class="form_label_01"><div align="left"><strong>Nombre Beneficiario Hasta :</strong></div></td>
                         <td colspan="2">
			  	$tb2=$bd->select("select max(nomben) as valor from opbenefi");

			    <input size="52" type="text" name="nomdes" class="breadcrumb" id="nomdes" value="<? print $tb2->fields["valor"];?>"/>
                  <input type="button" name="Button" value="..." onclick="catalogo2('nomdes')" />
                  </td>
			           </tr> -->
            <tr bordercolor="#FFFFFF">

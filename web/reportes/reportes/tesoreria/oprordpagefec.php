        ...
        <div align="left">&nbsp;
          <table width="647" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Listado de Ordenes de Pago Efectivas
            ...
            <tr>
              ...
              <td colspan="2"><select name="estatus" class="breadcrumb" id="estatus">
				<option value="E" selected="selected">Efectivas</option>
...
{
	f=document.form1;
	f.titulo.value="Listado de Ordenes de Pagos Efectivas";
	f.action="roprordpagefec.php";
	f.submit();
}
function cerrar()
{

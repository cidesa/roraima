	...
	class pdfreporte extends fpdf
	{
		...
		function Cuerpo()
		{
			...
			while(!$tb->EOF)
			{
				...
				$this->cell(25,5,"Nota de Débito:");
				$this->setFont("Arial","B",9);
				$this->cell(55,5,$tb->fields["refpag"]);
				$this->setFont("Arial","",8);
				$this->cell(25,5,"Fecha Emisión:");
				...
				$this->setFont("Arial","",8);
				$this->cell(180,5,strtoupper($tb->fields["descon"]));
				$this->ln(20); 
				$this->Line(10,$this->GetY()-2,200,$this->GetY()-2);
				$this->setFont("Arial","B",8);
				...
				$this->cell(70,5,"Descripción de la Cuenta");
				$this->cell(35,5,"Débitos");
				$this->cell(35,5,"Créditos");
				$this->ln(); 
				//--------
				...
				$this->cell(70,5,$tb2->fields["descta"]);
				...
				$this->setFont("Arial","B",8);
				$this->cell(20,5,"");
				$this->cell(120,5,"Código Presupuestario");

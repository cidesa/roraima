...
select
   ...
   if ($this->rete=="V")
	...
	function llenartitulos()
	{
		...
		$this->aliniacion[]='C';
		$this->aliniacion2[]='R';
        $this->titulos[]="%Alicuota Del LTF";
		$this->anchos[]=12;
		$this->aliniacion[]='C';
		$this->aliniacion2[]='C';
        $this->titulos[]="Monto Del LTF";
		$this->anchos[]=20;
		$this->aliniacion[]='C';
		$this->aliniacion2[]='R';
...
//     			 	$exe=$tb->fields["exeiva"];
                  ...
                  if ($tb->fields["tiptra"]=='01')
                  {
					...
					{
                	$this->RowM(array($cont,$tb->fields["fecfac"],strtoupper(trim($tb->fields["rifalt"])),trim($tbrif->fields["nomben"]),"C",$tb->fields["numfac"],$tb->fields["numctr"],$tb->fields["comprobante"],H::FormatoMonto($tb->fields["totfac"]),H::FormatoMonto($tb->fields["basltf"]),$tb->fields["porltf"],H::FormatoMonto($tb->fields["monltf"]),$fechemi,$numche));
					}
					else
					{
					$this->RowM(array($cont,$tb->fields["fecfac"],strtoupper(trim($tb->fields["cedrif"])),trim($tb->fields["nomben"]),"C",$tb->fields["numfac"],$tb->fields["numctr"],$tb->fields["comprobante"],H::FormatoMonto($tb->fields["totfac"]),H::FormatoMonto($tb->fields["basltf"]),$tb->fields["porltf"],H::FormatoMonto($tb->fields["monltf"]),$fechemi,$numche));
					}
                  }

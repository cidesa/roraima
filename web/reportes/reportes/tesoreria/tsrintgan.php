        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>RELACION DE INTERES GANADOS
            ...
            <tr bordercolor="#6699CC">
             ...
             <td> <div align="left">
               	<input name="codban1" type="text" class="breadcrumb" id="codban1"
                   value="<?$sql="SELECT min(numcue) as cod FROM TSMOVLIB WHERE TIPMOV LIKE '%'";
 					LlenarTextoSql($sql,"cod",$bd); ?>" size ="20">
 					 <input type="button" name="Button5" value="..." onClick=" catalogo3('codban1');">
 			      </div></td>

              <td> <div align="left">
               	<input name="codban2" type="text" class="breadcrumb" id="codban2"
                   value="<?$sql="SELECT max(numcue) as cod FROM TSMOVLIB WHERE TIPMOV LIKE '%'";
 					LlenarTextoSql($sql,"cod",$bd); ?>" size ="20">
 					 <input type="button" name="Button6" value="..." onClick=" catalogo4('codban2');">
 			      </div></td>
...
<tr>
             ...
             <td> <div align="left">
               	<input name="fecha1" type="text" class="breadcrumb" id="fecha1"
                   value="<?$sql="SELECT DISTINCT(to_char(MIN(fecini),'DD/MM/YYYY')) as fecha FROM CONTABA";
 					LlenarTextoSql($sql,"fecha",$bd); ?>" size ="20" datepicker='true'>
 					 </div></td>

              <td> <div align="left">
                 	<input name="fecha2" type="text" class="breadcrumb" id="fecha2"
                   value="<?$sql="SELECT DISTINCT(to_char(MIN(feccie),'DD/MM/YYYY')) as fec FROM CONTABA";
 					LlenarTextoSql($sql,"fec",$bd); ?>" size ="20" datepicker='true'>
 					 </div></td>
            </tr>
...
function catalogo3(campo)
   {
      mysql='select distinct (numcue) as CODIGO from tsmovlib order by numcue asc';
   ...
   {
      mysql='SELECT DISTINCT(numcue) as CODIGO FROM TSMOVLIB ORDER BY NUMCUE DESC';
	  pagina="../../lib/general/catalogoobj.php?sql="+mysql+"&campo="+campo;
	  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,resizable=yes,left=50,top=50");
   }

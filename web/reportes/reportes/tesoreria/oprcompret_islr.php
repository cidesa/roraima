          ...
          <table width="678"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              ...
              <td colspan="2"> <div align="left"><strong>
                  <input name="ag" type="text" class="breadcrumb" id="ag" value="FONDO DE DESARROLLO NACIONAL, FONDEN S.A" size="89">
                  </strong> </div></td>
            </tr>
            <tr>
              ...
              <td colspan="2"> <div align="left"><strong>
                  <input name="rif" type="text" class="breadcrumb" id="rif" value="G-200053577" size="40">
                  </strong> </div></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="2"> <div align="left">
                 ...
                 $tb=$bd->select("SELECT distinct(a.numord) from opfactur a,opordpag b,opretord c,tsrepret d

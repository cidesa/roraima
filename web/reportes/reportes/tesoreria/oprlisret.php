        ...
        <div align="left">&nbsp; 
          <table width="649"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Ordenes de Pago de Retenciones 
            ...
            <tr bordercolor="#6699CC">
              ...
              <td colspan="2"><select name="select" class="breadcrumb">
...
{
	f=document.form1;
	f.titulo.value="Ordenes de Pago de Retenciones";
	f.action="roprlisret.php";
	f.submit();
}
function cerrar()
{

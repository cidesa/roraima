          ...
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo
                  Movimiento:</strong></div></td>
              <td> <div align="left">
                  <?

			  	$tb=$bd->select("select distinct(codtip) from tstipmov order by codtip");
			  ?>
                  <select name="cod1" class="breadcrumb" id="cod1">
					...
					{
				  ?>
                    <option value="<? print $tb->fields["codtip"];?>"><? print $tb->fields["codtip"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>
              ...
              <td>
                <?
			  	...
			  	$tb2=$bd->select("select distinct(codtip) from tstipmov order by codtip desc");
			  ?>
				...
				{
			  ?>
                  <option value="<? print $tb2->fields["codtip"];?>"><? print $tb2->fields["codtip"];?></option>
                  <?
				  $tb2->MoveNext();
					}
				?>
            ...
            <tr>
              <td class="form_label_01"><strong>Tipo de Movimiento:</strong></td>
...
{
	f=document.form1;
	f.titulo.value="TIPOS DE MOVIMIENTOS";
	f.action="rTSRTIPMOV.php";
	f.submit();
}
function cerrar()
{

      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes
        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>RELACI&Oacute;N DE ORDENES DE PAGO ENTREGADAS
		...
		<tr>
             ...
             <td> <div align="left">
                   ...
                   value="<?$sql="SELECT min(cedrif)as cod FROM OPBENEFI";
 					LlenarTextoSql($sql,"cod",$bd); ?>" size ="20">
 					 <input type="button" name="Button5" value="..." onClick=" catalogo5('ben1');">
 			      </div></td>
 			        <td> <div align="left">
               	<input name="ben2" type="text" class="breadcrumb" id="ben2"
                   value="<?$sql="SELECT max(cedrif)as cod FROM OPBENEFI";
 					LlenarTextoSql($sql,"cod",$bd); ?>" size ="20">
 					 <input type="button" name="Button5" value="..." onClick=" catalogo5('ben2');">
 			      </div></td>

            <tr bordercolor="#6699CC">
              <td height="23" class="form_label_01"><strong>Fecha Entrega:</strong></td>
              <td> <div align="left"> </div>
                <div align="left">
                  <?

			  	$tb=$bd->select("SELECT to_char(MIN(fecent),'DD/MM/YYYY') as fecha FROM tscheemi");
				if(!$tb->EOF)
				{
					$fecini=$tb->fields["fecha"];
				}

			  	$tb2=$bd->select("SELECT to_char(MAX(fecent),'DD/MM/YYYY') as fecha FROM tscheemi");
				if(!$tb2->EOF)
				{
...
{
	f=document.form1;
	f.titulo.value="RELACIÓN DE ORDENES DE PAGO ENTREGADAS";
	f.action="rtsrcheent.php";
	f.submit();
}
function cerrar()
{

<?
	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->diradm=$_POST["diradm"];
				...
				$this->sql="select a.numord,b.cedrif,b.nomben,b.fecemi,to_char(a.fecfac,'dd/mm/yyyy') as fecfac,a.numfac,
							...
							a.totfac,a.exeiva,a.basislr,a.porislr,a.monislr,c.destip
		
							from opfactur a,opordpag b,optipret c,opretord d 
							where
		...
		function Header()
		{
			...
			$this->ln(-1);
			$this->cell(163,7,"Reglamento Parcial de la ley de Impuesto Sobre la Renta en materia de Retenciones Dec 1808 6.0.36.203 de 12/05/1997");
			...
			//$this->setx(212);
			//$this->cell(50,5,"Concepto del Pago:");
			$this->ln(17);
			...
			$this->cell(16,5,"Nro Control");
			$this->cell(19,5,"Numero Nota");
			$this->cell(20,5,"Numero Nota");
			$this->cell(11,5,"Tipo");
			$this->cell(32,5," Nro de Factura");
	    ...
	    $this->cell(77,5,strtoupper($tira));
		...
		$this->cell(34,5,number_format($tb->fields["basislr"],2,'.',','),0,0,"R");
		$basimp=$basimp+$tb->fields["basislr"];
		$this->cell(14,5,number_format($tb->fields["porislr"],2,'.',','),0,0,"C");

        ...
        <div align="left">&nbsp; 
          <table width="647" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Listado de Ordenes de Pago Enviadas a Finanzas
            ...
            <tr>
              ...
              <td><div align="left">
                <?
			  	$tb=$bd->select("SELECT a.numord FROM TMPORDPAGCON as A 
								...
								WHERE B.ORDPAG='N' order by NUMORD asc");				
			    ?>
              ...
              <td class="form_label_01"><div align="left">
			  	...
			  	$tb1=$bd->select("SELECT a.numord FROM TMPORDPAGCON as A 
									UNION SELECT B.REFAJU FROM CPAJUSTE as B
									WHERE B.ORDPAG='N' ORDER BY NUMORD DESC");									
			  ?>
...
{
	f=document.form1;
	f.titulo.value="Listado de Ordenes de Pago Enviadas a Finanzas ";
	f.action="roprordenvfin.php";
	f.submit();
}
function cerrar()
{

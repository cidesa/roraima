          ...
          <table width="678"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#6699CC">
              ...
              <td colspan="2"> <div align="left"><strong>
                 <input name="responsable" type="text"  value="" class="breadcrumb" id="responsable" size="40" maxlength="80">
                  </strong> </div></td>
            </tr>
            <tr bordercolor="#6699CC">
            <?php
			...
			?>
              ...
              <td colspan="2"> <div align="left"><strong>
                 <input name="ag" type="text"  value="<?echo $nomage;?>" class="breadcrumb" id="ag" size="40" maxlength="80">
                  </strong> </div></td>
            </tr>
            <tr bordercolor="#6699CC">
              ...
              <td colspan="2"> <div align="left"><strong>
              <input name="rif" type="text"  value="<?echo $rifage;?>" class="breadcrumb" id="rif" size="40" maxlength="80">
            ...
            <tr bordercolor="#6699CC">
              ...
              <td class="form_label_01"> <div align="left"><strong>Direcci&oacute;n
                  ...
                  :</strong></div></td>
              <td colspan="2"> <div align="left"><strong>
              <input name="dire" type="text"  value="<?echo $dirage;?>" class="breadcrumb" id="dire" size="40" maxlength="80">
			...
			<tr>
              <td class="form_label_01" width='100'> <div align="left"><strong>Numero de Orden:</strong></div></td>
              <td colspan="2" width='100'> <div align="left">
                <input name="orde" type="text"  value="<?
                $sql="SELECT distinct(a.numord) as numord from opfactur a,opordpag b
								where a.numord=b.numord
								order by a.numord";
               LlenarTextoSql($sql,"numord",$bd);
				?>" class="breadcrumb" id="orde" size="20" maxlength="50">
                <input type="button" name="Button3" value="..." onClick="catalogo1('orde');">
                </div></td>
              <td>
            </tr>
            <tr bordercolor="#FFFFFF">
            ...
            <tr>
              ...
              <td> <div align="left">
                  <select onClick="desactivar(this.selectedIndex);" name="corr" class="breadcrumb" id="corr">
                    <option value="n">No</option>
                    <option value="s">Si</option>
                  </select>
                  <font color="#FF0000" size="-4"></font></div></td>
              <td><font color="#FF0000" size="-4"><strong>La opci&oacute;n por
                defecto NO genera un correlativo solo en caso de que no se haya
                generado un correlativo para la orden.</strong></font></td>
            </tr>
            <tr>
              <td class="form_label_01"> <div align="left"><strong>Correlativo:</strong></div></td>
              <td colspan="2"> <div align="left">
                  <p><strong>
                    <input name="corre" type="text" class="breadcrumb" id="corre" size="25">
                    <font color="#FF0000" size="-5">Solo los ultimos 8 d&iacute;gitos
                    </font></strong></p>
                </div></td>
            </tr>
            -->
...
function desactivar(valor)
{
	...
	if (valor==0)
	{
	  document.getElementById("corre").disabled=true;
	  document.getElementById("corre").style.backgroundColor='#dddddd';

	}
    if (valor==1)
    {
      document.getElementById("corre").disabled=false;
	  document.getElementById("corre").style.backgroundColor='#ffffcc';
...
{
 	mysql='SELECT distinct(numord) as numord from opordpag';

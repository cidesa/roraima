...
else
{
		...
		function Header()
		{
            ...
            $this->MultiCell(149,5,"Ley I.V.A.-Art 11: Serán responsables del pago de impuesto en calidad de agentes de retención, los compradores o adquirientes de determinados bienes muebles y los receptores desiertos servicios, a quienes la Administración Tributaria designa como tal",0,"J",0);			$this->setFont("Arial","",8);
...
//print strlen($tb->fields["cedrifres"])."  ".strlen($ref);exit;
		...
		$this->Rect(128,$this->GetY()-0.2,25,7);print
		$this->Rect(153,$this->GetY()-0.2,27,7);
		$this->Rect(180,$this->GetY()-0.2,28,7);
		$this->Rect(217,$this->GetY()-0.2,28,7);
		$this->Rect(245,$this->GetY()-0.2,25,7);

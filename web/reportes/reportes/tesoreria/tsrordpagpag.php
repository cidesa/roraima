        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
             ...
             <tr>
              <td class="form_label_01"><div align="left"><strong>N&uacute;mero de Cuenta:</strong></div></td>
              <td><div align="left">
                <input name="nro1" type="text"  value="<?
				$sql="SELECT min(NUMCUE) as cod FROM TSDEFBAN";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="nro1" size="20" maxlength="50">
                <input type="button" name="Button3" value="..." onClick="catalogo2('nro1');">
              </div></td>
              <td><input name="nro2" type="text" value="<?
				$sql="SELECT max(NUMCUE) as cod FROM TSDEFBAN";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="nro2" size="20" maxlength="50">
              <input type="button" name="Button2" value="..." onClick="catalogo2('nro2');"></td>
            </tr>
             ...
             <tr>
              ...
              <td><div align="left">
                ...
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="ben1" size="20" maxlength="50">
                <input type="button" name="Button3" value="..." onClick="catalogo('ben1');">
              </div></td>
              <td><input name="ben2" type="text" value="<?
				$sql="SELECT max(CEDRIF) AS cod FROM OPBENEFI";
                LlenarTextoSql($sql,"cod",$bd);
				?>" class="breadcrumb" id="ben2" size="20" maxlength="50">
              <input type="button" name="Button2" value="..." onClick="catalogo('ben2');"></td>
            </tr>
           ...
           <tr>
              ...
              <td><div align="left">
				...
				$sql="SELECT to_char(MIN(a.fecemi),'DD/MM/YYYY') as fecemi FROM opordpag a";
              ...
              <td><input name="fechas" type="text" value="<?
				$sql="SELECT to_char(Max(a.fecemi),'DD/MM/YYYY') as fecemi FROM opordpag a";
                LlenarTextoSql($sql,"fecemi",$bd);
...
{
	f=document.form1;
	f.titulo.value="ORDENES DE PAGO PAGADAS ";
    f.action="rtsrordpagpag.php";
	f.submit();
}
function cerrar()
{
...
function catalogo(campo)
   {
      mysql='SELECT distinct(CEDRIF) as CODIGO, NOMBEN as DESCRIPCION FROM OPBENEFI ORDER BY CEDRIF';
...
function catalogo2(campo)
   {
      mysql='SELECT distinct(NUMCUE) as NUMERO, NOMCUE as DESCRIPCION FROM TSDEFBAN ORDER BY NUMCUE';
	  pagina="../../lib/general/catalogoobj.php?sql="+mysql+"&campo="+campo;
	  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,resizable=yes,left=50,top=50");
   }

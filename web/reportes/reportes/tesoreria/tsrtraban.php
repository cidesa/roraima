        ...
        <div align="left">&nbsp; 
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              ...
              <td> 
              <input name="reftra1" type="text"  value="<?
				$sql="SELECT MIN(reftra) as ref FROM tsmovtra";
                LlenarTextoSql($sql,"ref",$bd);				
				?>" class="breadcrumb" id="reftra1" size="10" maxlength="50">
              <input type="button" name="Button1" value="..." onClick="catalogo('reftra1');">
                </td>
              <td> 
              <input name="reftra2" type="text"  value="<?
				$sql="SELECT MAX(reftra) as ref FROM tsmovtra";
                LlenarTextoSql($sql,"ref",$bd);				
				?>" class="breadcrumb" id="reftra2" size="10" maxlength="50">
              <input type="button" name="Button2" value="..." onClick="catalogo('reftra2');">
			  </td>
            </tr>
            <tr bordercolor="#6699CC"> 
              ...
              <td> <div align="left"> </div>
				...
				?>
                  <input name="fecreg1" type="text" class="breadcrumb" id="feccom1" datepicker="true" value="<? print $fecini;?>" size="13">
                </div></td>
              <td><input name="fecreg2" type="text" class="breadcrumb" id="feccom2" datepicker="true" value="<? print $fecdes;?>" size="13"></td>
            </tr>
            <tr> 
              <td class="form_label_01">&nbsp;</td>
...
{
 	pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT reftra as ref, destra FROM tsmovtra";

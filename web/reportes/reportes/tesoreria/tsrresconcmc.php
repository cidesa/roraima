      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes
        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
			...
			<tr>
              <td class="form_label_01"><strong>Resultado:</strong></td>
              <td>
                <?

			  	$tb=$bd->select("SELECT DISTINCT result from tsconcil order by result");
			  ?>

                <select name="result" class="breadcrumb" id="result">
                  ...
                  <option value="<? print $tb->fields["result"];?>"><? print $tb->fields["result"];?></option>
                  <?
						$tb->MoveNext();
					}
			...
			<tr>
              <td class="form_label_01"><strong>Tipo Movimiento:</strong></td>
              <td>
                <?

			  	$tb=$bd->select("SELECT DISTINCT movlib from tsconcil order by movlib");
			  ?>

                <select name="tipmov" class="breadcrumb" id="tipmov">
                	<option value="T">Todos</option>
                  <?
				  	while(!$tb->EOF)
					{
                  ...
                  <option value="<? print $tb->fields["movlib"];?>"><? print $tb->fields["movlib"];?></option>
                  <?
						$tb->MoveNext();
					}

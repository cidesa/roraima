        ...
        <div align="left">&nbsp;
          <table width="678"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>COMPROBANTE DE RETENCION DEL IMPUESTO SOBRE LA RENTA
            ...
            <tr>
              ...
              <td colspan="2"> <div align="left">
				...
				$sql="select to_number(max(comretislr),'00000000') as cod from opordpag";
...
{
	f=document.form1;
	f.titulo.value="COMPROBANTE DE RETENCION DEL IMPUESTO SOBRE LA RENTA";
	f.action="roprcompret_islr_lote.php";
	f.submit();
}

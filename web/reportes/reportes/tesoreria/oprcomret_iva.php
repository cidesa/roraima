          ...
          <table width="678"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              ...
              <td><div align="left"> </div>
				...
				?>" class="breadcrumb" id="orde" size="20" maxlength="8">
                    <input type="button" name="Button" value="..." onClick="catalogo3('orde');">
                </div></td>
             </tr>
            <tr>
              ...
              <td> <div align="left">
                  <p><strong>
                    <input name="rifben" type="text" class="breadcrumb" id="rifben" size="25">
                    <font color="#FF0000" size="-5">RIF
                    </font></strong></p>
                </div></td>
              <td> <div align="left">
                  <p><strong>
                    <input name="nombre" type="text" class="breadcrumb" id="nombre" size="25">
                    <font color="#FF0000" size="-5">Nombre
                    </font></strong></p>
                </div></td>
            </tr>
            <tr>
...
function catalogo3(campo)
   {
      mysql='SELECT DISTINCT(NUMORD) as Numero, DESORD as descripcion FROM OPORDPAG ORDER BY DESORD';
	   pagina="../../lib/general/catalogoobj.php?sql="+mysql+"&campo="+campo;
	  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,resizable=yes,left=50,top=50");
   }

          ...
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo 
                  Moneda:</strong></div></td>
              <td> <div align="left"> 
                  <?
			  	
			  	$tb=$bd->select("select distinct(codmon) from tsdesmon order by codmon");
			  ?>
                  <select name="cod1" class="breadcrumb" id="cod1">
					...
					{
				  ?>
                    <option value="<? print $tb->fields["codmon"];?>"><? print $tb->fields["codmon"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select distinct(codmon) from tsdesmon order by codmon desc");
			  ?>
				...
				{
			  ?>
                  <option value="<? print $tb2->fields["codmon"];?>"><? print $tb2->fields["codmon"];?></option>
                  <?
				  $tb2->MoveNext();
					}
				?>
            ...
            <tr> 
              ...
              <td colspan="2"> <select name="estado" class="breadcrumb" id="select">
                  ...
                  <option value="a">Aumenta</option>
                  <option value="d">Disminuye</option>
                </select></td>
            </tr>
            <tr> 

         ...
         <tr>
              ...
              <td>
				...
				?>" class="breadcrumb" id="NUMORDDES" size="16" maxlength="20">
                    <a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('oprordpre2',0); "></a>
                </div></td>
                <td>
                  <div align="left">
				...
				?>" class="breadcrumb" id="NUMORDHAS" size="16" maxlength="20">
                    <a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('oprordpre2',1); "></a>
                </div></td>
            </tr>
	...
	<tr bordercolor="#6699CC">
              ...
              <td>
				...
				?>" class="breadcrumb" id="BENDES" size="16" maxlength="20">
                      <a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('oprordpre2',2); "></a>
                </div></td>
                <td>
                  <div align="left">
				...
				?>" class="breadcrumb" id="BENHAS" size="16" maxlength="20">
                      <a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('oprordpre2',3); "></a>
                </div></td>
            </tr>
          <!--  <tr bordercolor="#6699CC">
              ...
              <td>
                  <div align="left">
                    <input name="ces" type="text" value="" class="breadcrumb" id="ces" size="16" maxlength="20">
                      <a href="#"><img src="../../img/search.gif" align="top" onclick="catalogo('oprordpre2',4); "></a>
                </div></td>

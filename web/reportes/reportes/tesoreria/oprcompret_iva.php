...
function enviar()
{
	...
	{
		alert('no se puede reemplazar el correlativo ya asignado('+orden[1]+') por el correlativo automatico seleecione no generar correlativo, si desea cambiar el correlativo habitile la actualizacion ');
	}
	else
	f.submit();
}

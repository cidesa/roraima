      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes 
        ...
        <div align="left">&nbsp; 
          <table width="647"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td colspan="2"> <div align="left">
                  ...
                  <select name="codempdes" class="breadcrumb" id="codempdes">
                    <?
				  print "a";
				  $sql="SELECT distinct(CODEMP) as codemp,UPPER(nomemp) as nombre FROM NPASICAREMP order by codemp";
				  $tb1=$bd->select($sql);
				  	while(!$tb1->EOF)
					{
				  ?>
            ...
            <tr>
              <td class="form_label_01"><strong>C&oacute;digo Gasto Desde :</strong></td>
              <td colspan="2">                <select name="codgasdes" size="1" class=breadcrumb id="codgasdes">
            ...
            <tr>
              <td class="form_label_01"><strong>C&oacute;digo <strong>Gasto</strong> Hasta
                  :</strong></td>
              <td colspan="2">                <select name="codgashas" size="1" class=breadcrumb id="codgashas">
                    <? $tb=$bd->select("SELECT * FROM NPTIPGAS ORDER BY CODTIPGAS desc"); 
				       while(!$tb->EOF){
					   ?>
                    <option value="<? print $tb->fields["codtipgas"]; ?>"><? print $tb->fields["codtipgas"]." - ".ucwords($tb->fields["destipgas"]); ?></option>
                    <? $tb->MoveNext(); } ?>
                  </select></td>
            </tr>
            <tr>

  ...
  <table width="760"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes 
        ...
        <div align="left">&nbsp; 
          <table width="677"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("select codtipapo,destipapo
								from nptipaportes  order by codtipapo");
			  ?>
                  <select name="apor1" class="breadcrumb" id="apor1">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
                    <option value="<? print $tb->fields["codtipapo"];?>"><? print $tb->fields["codtipapo"]." - ".$tb->fields["destipapo"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select codtipapo,destipapo
								from nptipaportes  order by codtipapo desc");
			  ?>
                <select name="apor2" class="breadcrumb" id="apor2">
                  <?
				  while(!$tb2->EOF)	
				{
			  ?>
                  <option value="<? print $tb2->fields["codtipapo"];?>"><? print $tb2->fields["codtipapo"]." - ".$tb2->fields["destipapo"];?></option>
                  <?
				  $tb2->MoveNext();
					}
				?>
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("select distinct(codemp),nomemp from NPASICAREMP order by codemp");
			  ?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select distinct(codemp),nomemp from NPASICAREMP order by codemp desc");
			  ?>
            ...
            <tr> 
              <td class="form_label_01"> <div align="left"><strong>Categor&iacute;a:</strong></div></td>
              <td> <div align="left"> 
                  <?
			  	
			  	$tb=$bd->select("select codcat,nomcat from npcatpre order by codcat");
			  ?>
                  <select name="cat1" class="breadcrumb" id="cat1">
					...
					{
				  ?>
                    <option value="<? print $tb->fields["codcat"];?>"><? print $tb->fields["codcat"]." - ".substr($tb->fields["nomcat"],0,36);?></option>
                    <?
					$tb->MoveNext();
					}
				?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select codcat,nomcat from npcatpre order by codcat desc");
			  ?>
				...
				{
			  ?>
                  <option value="<? print $tb2->fields["codcat"];?>"><? print $tb2->fields["codcat"]." - ".substr($tb2->fields["nomcat"],0,36);?></option>
                  <?
				  $tb2->MoveNext();
					}
				?>
            ...
            <tr> 
              ...
              <td colspan="2"> <div align="left"> 
			  	...
			  	$tb=$bd->select("select distinct(codnom),nomnom from npnomina order by codnom");
			  ?>

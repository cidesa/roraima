<?
	...
	class pdfreporte extends fpdf
	{
		...
		{
				$this->titulos[0]="Código Categoría";
				$this->titulos[1]="Descripción Categoría";
		}
		...
		function Cuerpo()
		{
			...
			while (!$tb->EOF)
			{
				...
				$this->cell($this->anchos[0],5,"          ".$tb->fields["codcat"]);
				$this->cell($this->anchos[1],5,substr($tb->fields["nomcat"],0,120));

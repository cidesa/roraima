          ...
          <table width="612"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("select distinct(to_char(fecnom,'dd/mm/yyyy')) as fecnom1, fecnom from nphiscon order by fecnom");
			  ?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select distinct(to_char(fecnom,'dd/mm/yyyy')) as fecnom1,fecnom from nphiscon order by fecnom desc");
			  ?>

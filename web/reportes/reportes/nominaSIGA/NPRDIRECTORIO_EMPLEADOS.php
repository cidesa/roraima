          ...
          <table width="612"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("select distinct codemp from npnomcal order by codemp");
			  ?>
            ...
            <tr> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo 
                  de Cargo:</strong></div></td>
              <td> <div align="left"> 
                  <?
			  	
			  	$tb=$bd->select("select distinct codcar from npnomcal order by codcar");
			  ?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select distinct codcar from npnomcal order by codcar desc");
			  ?>
            ...
            <tr> 
              ...
              <td colspan="2"> <div align="left"> 
			  	...
			  	$tb=$bd->select("select distinct codnom,nomnom from npnomcal order by codnom");
			  ?>
...
function enviar()
{
	f=document.form1;
	f.titulo.value="";
	f.action="rNPRDIRECTORIO_EMPLEADOS.php";
	f.submit();
}
function cerrar()
{

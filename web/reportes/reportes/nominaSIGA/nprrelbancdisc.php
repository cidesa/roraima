        ...
        <div align="left">&nbsp; 
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>RELACION DE PAGO
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td colspan="2"><select name="codnom" class="breadcrumb" id="codnom">
                <?
				  $tb1=$bd->select("select distinct codnom from npnomcal order by codnom");
				  	while(!$tb1->EOF)
					{
				  ?>
                <option value="<? print $tb1->fields["codnom"];?>"><? print $tb1->fields["codnom"];?></option>
                <?
				  		$tb1->MoveNext();
					}
				  ?>
            ...
            <tr>
              ...
              <td colspan="2"><select name="codban" class="breadcrumb" id="codban">
                <?
				  $tb1=$bd->select("select * from npsucban order by codban");
				  	while(!$tb1->EOF)
					{
				  ?>
            ...
            <tr>
              ...
              <td colspan="2"><input name="cta" type="text" id="cta" size="60"></td>
            </tr>
            <tr>
              <td class="form_label_01"><strong>Fecha Efectiva del Pago  :</strong></td>
              <td colspan="2"><input name="fecha" type="text" id="fecha" value="<? echo date("d/m/Y");?>" size="10" maxlength="10" datepicker="true"></td>
            </tr>
            <tr bordercolor="#6699CC"> 
...
{
	f=document.form1;
	f.titulo.value="Relación de Pago";

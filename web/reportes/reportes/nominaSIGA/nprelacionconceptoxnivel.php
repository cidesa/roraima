        ...
        <div align="left">&nbsp; 
          <table width="647"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Relaci&oacute;n Nomina por Conceptos y Niveles Organizacionales 
            ...
            <tr>
              <td class="form_label_01"><strong>C&oacute;digo del Nivel Desde :</strong></td>
              <td colspan="2"><?
					$tb2=$bd->select("SELECT CODNIV,DESNIV as nombre FROM NPESTORG ORDER BY CODNIV");
				?>
                  <select name="codnivdes" class="breadcrumb" id="codnivdes">
					...
					{
				  ?>
                    <option value="<? print $tb2->fields["codniv"];?>"><? print $tb2->fields["codniv"].' - '.$tb2->fields["nombre"];?></option>
                    <?
				  		$tb2->MoveNext();
					}
				  ?>
            ...
            <tr>
              <td class="form_label_01"><strong>C&oacute;digo del Nivel Hasta :</strong></td>
              <td colspan="2"><?
					$tb2=$bd->select("SELECT CODNIV,DESNIV as nombre FROM NPESTORG ORDER BY CODNIV DESC");
				?>
...
{
	f=document.form1;
	f.titulo.value="Relación Nomina por Conceptos y Niveles Organizacionales";
	f.action="rnprelacionconceptoxnivel.php";
	f.submit();
}
function cerrar()
{

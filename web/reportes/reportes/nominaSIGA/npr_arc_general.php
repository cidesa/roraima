        ...
        <div align="left">&nbsp; 
          <table width="647"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Relaci&oacute;n de Ingreso Anual 
            ...
            <tr>
              <td class="form_label_01"><strong>C&oacute;digo Empleado Desde :</strong></td>
              <td colspan="2"><?
					$tb2=$bd->select("SELECT CODEMP,NOMEMP FROM NPHOJINT order by NOMEMP");
				?>
            ...
            <tr>
              <td class="form_label_01"><strong>C&oacute;digo Empleado Hasta :</strong></td>
              <td colspan="2"><?
					$tb2=$bd->select("SELECT CODEMP,NOMEMP FROM NPHOJINT order by NOMEMP DESC");
				?>
            ...
            <tr>
              <td class="form_label_01"><strong>A&ntilde;o Fiscal : </strong></td>
              <td colspan="2"><select name="annofiscal" class="breadcrumb" id="annofiscal">
...
{
	f=document.form1;
	f.titulo.value="Relación de Ingreso Anual";
	f.action="rnpr_arc_general.php";
	f.submit();
}
function cerrar()
{

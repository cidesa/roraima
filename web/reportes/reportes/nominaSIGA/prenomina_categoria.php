        ...
        <div align="left">&nbsp; 
          <table width="647"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Res&uacute;men Pre-N&oacute;mina por Categoria
...
{
	f=document.form1;
	f.titulo.value="Pre-Nómina de Pago por Categoría";
	f.action="rprenomina_categoria.php";
	f.submit();
}
function cerrar()
{

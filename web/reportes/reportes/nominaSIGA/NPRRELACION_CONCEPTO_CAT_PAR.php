          ...
          <table width="612"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>RELACION 
                  CONCEPTOS-CATEGORIAS Y PARTIDAS PRESUPUESTARIAS 
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("select codcon from npdefcpt order by codcon");
			  ?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select codcon from npdefcpt order by codcon desc");
			  ?>
            ...
            <tr> 
              ...
              <td colspan="2"> <div align="left"> 
                  <select name="con" class="breadcrumb" id="con">
                    <option value="T">Todos</option>
                    <option value="a">Asiganciones</option>
...
{
	f=document.form1;
	f.titulo.value="RELACION CONCEPTOS-CATEGORIAS Y PARTIDAS PRESUPUESTARIAS";
	f.action="rNPRRELACION_CONCEPTO_CAT_PAR.php";
	f.submit();
}
function cerrar()
{

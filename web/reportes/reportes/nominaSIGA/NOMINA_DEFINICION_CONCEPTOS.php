          ...
          <table width="612"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              ...
              <td> 
               ...
               ?>
                <select name="cod1" class="breadcrumb" id="select2">
                  <?
				  	while(!$tb->EOF)	
					{
				  ?>
              ...
              <td> 
                <?
			  	...
			  	$tb=$bd->select("select codcon from npdefcpt order by codcon desc");
               ?>
                <select name="cod2" class="breadcrumb" id="select3">
                  <?
				  	while(!$tb->EOF)	
					{
				  ?>
...
{
	f=document.form1;
	f.titulo.value="DEFINICION DE CONCEPTOS";

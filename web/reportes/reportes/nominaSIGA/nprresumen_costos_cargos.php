...
<form name="form1" method="post" action="">
  ...
  <table width="760"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td width="691" rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes 
        </p>
        <fieldset>
       
        <div align="left">&nbsp; 
          <table width="589"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Resumen de Costos por Cargos
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td colspan="2"> <div align="left">
				...
				<?
					$tb1=$bd->select("SELECT distinct(CODEMP) FROM NPNOMCAL order by codemp");
				?>
				  ...
				  <?
					...
					{
				  ?>
				  <option value="<? print $tb1->fields["codemp"];?>"><? print $tb1->fields["codemp"];?></option>
				  <?
				  		$tb1->MoveNext();
					}
				  ?>
            ...
            <tr>
              ...
              <td colspan="2">
                ...
                <div align="left">
                  <?
					$tb2=$bd->select("SELECT distinct(CODEMP) FROM NPNOMCAL order by codemp DESC");
				?>
            ...
            <tr>
              ...
              <td colspan="2"><?
					$tb2=$bd->select("SELECT DISTINCT(CODCON) FROM NPNOMCAL ORDER BY CODCON");
				?>
            ...
            <tr>
              ...
              <td colspan="2"><?
					$tb2=$bd->select("SELECT DISTINCT(CODNOM) FROM NPNOMCAL ORDER BY CODNOM");
				?>
                  <select name="tipnom" class="breadcrumb" id="tipnom">
					...
					{
				  ?>
                    <option value="<? print $tb2->fields["codnom"];?>"><? print $tb2->fields["codnom"];?></option>
                    <?
				  		$tb2->MoveNext();
					}
				  ?>
      ...
      <td width="52" rowspan="2" align="center" bgcolor="#EEEEEE">&nbsp;</td>
    </tr>
    <tr> 
...
{
	f=document.form1;
	f.titulo.value="Resumen de Costos Por Cargos";
	f.action="rnprresumen_costos_cargos.php";
	f.submit();
}
function cerrar()
{

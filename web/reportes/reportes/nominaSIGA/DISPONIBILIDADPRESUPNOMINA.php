        ...
        <div align="left">&nbsp; 
          <table width="612"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              ...
              <td colspan="2"><div align="center"><strong>DIRECCION DE RECURSOS 
                  </strong><strong>HUMANOS</strong></div></td>
            </tr>
            <tr> 
              <td class="form_label_01"> <div align="left"><strong>Revisado Por:</strong></div></td>
              <td colspan="2"><div align="left"> 
                  <input name="p_e" type="text" id="p_e">
                </div>
                <div align="left"> </div></td>
            </tr>
            <tr> 
              <td class="form_label_01"> <div align="left"><strong>Autorizado 
                  Por :</strong></div></td>
              <td colspan="2"><div align="left"> 
                  <input name="p_a" type="text" id="p_a">
                </div>
                <div align="left"> </div></td>
            </tr>
            <tr> 
              <td bordercolor="#FFFFFF" class="form_label_01">&nbsp;</td>
              <td colspan="2"><div align="center"><strong>DIRECCION DE PRESUPUESTO</strong><strong></strong></div></td>
            </tr>
            <tr> 
              <td class="form_label_01"><strong>Revisado Por:</strong></td>
              <td colspan="2"><input name="p_r" type="text" id="p_r"></td>
            </tr>
            <tr> 
              <td class="form_label_01"><strong>Conformado Por:</strong></td>
              <td colspan="2"><div align="left"> 
                  <input name="p_conf" type="text" id="p_conf">
                </div>
                <div align="left"> </div></td>
            </tr>
            <tr> 

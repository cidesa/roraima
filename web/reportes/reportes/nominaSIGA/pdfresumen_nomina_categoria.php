	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->sql="SELECT 
						...
						WHERE
							...
							B.CODCAT <= RPAD('".$this->codcathas."',16,' ') AND 
							B.STATUS='V' AND
		...
		function Cuerpo()
		{
			...
			if(!$tb2->EOF)
			{
				 ...
				 $this->cell(45,5,'Trabajador');
				 $this->cell(50,5,'Cargo');
				 ...
				 $this->cell(45,5,ucwords($tb->fields["nomemp"]));
			...
			while(!$tb->EOF)
			{
				if($tb->fields["codemp"]!=$ref)
				{
				 ...
				 $this->line(10,$this->getY(),200,$this->getY());
				 $this->ln(5);
				 $this->cell(115,5,'TOTAL NOMINA:  '.$this->nombre);

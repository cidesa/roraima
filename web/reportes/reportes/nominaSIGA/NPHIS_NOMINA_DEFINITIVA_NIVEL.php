        ...
        <div align="left">&nbsp; 
          <table width="689"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>NOMINA 
                  DEFINITIVA 
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("select distinct(to_char(fecnom,'dd/mm/yyyy')) as fecnom1, fecnom as fecnom from nphiscon a order by fecnom asc");
			  ?>
                  <select name="fecha1" class="breadcrumb" id="fecha1">
					...
					{
				  ?>
                    <option value="<? print $tb->fields["fecnom1"];?>"><? print $tb->fields["fecnom1"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select distinct(to_char(fecnom,'dd/mm/yyyy')) as fecnom1, fecnom as fecnom from nphiscon a order by fecnom desc");
			  ?>
				...
				{
			  ?>
                  <option value="<? print $tb2->fields["fecnom1"];?>"><? print $tb2->fields["fecnom1"];?></option>
                  <?
				  $tb2->MoveNext();
					}
				?>
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("SELECT codniv,desniv  FROM NPESTORG ORDER BY CODNIV ASC");
			  ?>
                  <select name="niv1" class="breadcrumb" id="niv1">
					...
					{
				  ?>
                    <option value="<? print $tb->fields["codniv"];?>"><? print $tb->fields["codniv"]." - ".substr($tb->fields["desniv"],0,20);?></option>
                    <?
					$tb->MoveNext();
					}
				?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("SELECT codniv,desniv  FROM NPESTORG ORDER BY CODNIV desc");
			  ?>
				...
				{
			  ?>
                  <option value="<? print $tb2->fields["codniv"];?>"><? print $tb2->fields["codniv"]." - ".substr($tb2->fields["desniv"],0,20);?></option>
                  <?
				  $tb2->MoveNext();
					}
				?>
...
{
	f=document.form1;
	f.titulo.value="NOMINA DEFINITIVA";
	f.action="rNPHIS_NOMINA_DEFINITIVA_NIVEL.php";
	f.submit();
}
function cerrar()
{

        ...
        <div align="left">&nbsp; 
          <table width="647"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Consolidado de Nomina 
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>Fecha Desde  :</strong></div></td>
              <td colspan="2"> <div align="left">
                </div> <div align="left">
				<?
					$tb1=$bd->select("Select distinct (to_char(fecnom,'dd/mm/yyyy')) as fecnom from nphiscon order by fecnom");
				?>
                  <select name="fecnomdes" class="breadcrumb" id="fecnomdes">
				  <?
				  	while(!$tb1->EOF)
					{
				  ?>
				  <option value="<? print $tb1->fields["fecnom"];?>"><? print $tb1->fields["fecnom"];?></option>
				  <?
				  		$tb1->MoveNext();
					}
				  ?>
            ...
            <tr>
              <td class="form_label_01">
                <div align="left"><strong>Fecha Hasta  :</strong></div></td>
              <td colspan="2">
                <div align="left"> </div>
                <div align="left">
                  <?
					$tb1=$bd->select("Select distinct to_char(fecnom,'dd/mm/yyyy') as fecnom from nphiscon order by fecnom desc");
				?>
                  <select name="fecnomhas" class="breadcrumb" id="fecnomhas">
                    <?
				  	while(!$tb1->EOF)
					{
				  ?>
...
{
	f=document.form1;
	f.titulo.value="Consolidado de Nomina";
	f.action="rnprhis_consolidado.php";
	f.submit();
}
function cerrar()
{

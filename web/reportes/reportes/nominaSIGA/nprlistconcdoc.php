          ...
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td> <div align="left"> 
				...
				$tb=$bd->select("Select min(codemp) as codemp from npnomcal where codnom='009'");
			  ?>
              ...
              <td> 
                <?
				$tb=$bd->select("Select max(codemp) as codemp from npnomcal where codnom='009'");
			  ?>
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td> <div align="left">
			    <?
				$tb=$bd->select("Select min(codcar) as codcar from npnomcal where codnom='009'");
			  ?>
              ...
              <td> <div align="left">
				...
				$tb=$bd->select("Select max(codcar) as codcar from npnomcal where codnom='009'");
			  ?>
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td colspan="2"> <div align="left">
				...
				<?
					$tb1=$bd->select("SELECT rtrim(codcat) as codcat, nomcat from npcatpre where char_length(rtrim(codcat))='11' order by codcat");
				?>
            ...
            <tr>
              ...
              <td colspan="2">
                ...
                <div align="left">
                  <?
					$tb2=$bd->select("SELECT rtrim(codcat) as codcat, nomcat FROM npcatpre WHERE char_length(rtrim(CODCAT))=11 ORDER BY codcat DESC");
				?>
            ...
            <tr bordercolor="#6699CC">
              ...
              <td colspan="2">
				<?
					$tb2=$bd->select("SELECT distinct(codcon) as codcon FROM npnomcal where CODNOM='009'");
				?>

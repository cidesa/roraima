        ...
        <div align="left">&nbsp; 
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Relaci&oacute;n - Histórico de Vacaciones 
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td> <div align="left"> 
                  <?
				$tb=$bd->select("Select A.codemp, A.nomemp from NPasicaremp A, NPVACREGSAL B where A.codemp=B.codemp order by codemp asc");
			  ?>
              ...
              <td> 
                <?
				$tb=$bd->select("Select A.codemp, A.nomemp from NPasicaremp A, NPVACREGSAL B where A.codemp=B.codemp order by codemp desc");
			  ?>
...
{
	f=document.form1;
	f.titulo.value="Relación - Histórico de Vacaciones";

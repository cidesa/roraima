      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes 
        ...
        <div align="left">&nbsp; 
          <table width="647" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              <td class="form_label_01"><strong>Fecha de Nomina Desde :</strong></td>
              <td colspan="2"><select name="fechades" class="breadcrumb" id="select">
                <?
					$tb2=$bd->select("SELECT  DISTINCT to_char(FECNOM,'dd/mm/yyyy') as FECNOM FROM NPHISCON ORDER BY FECNOM asc");										
				  	while(!$tb2->EOF)
					{
				  ?>
            ...
            <tr>
              <td class="form_label_01"><strong>Fecha de Nomina Hasta :</strong></td>
              <td colspan="2"><select name="fechahas" class="breadcrumb" id="select2">
                <?
					$tb2=$bd->select("SELECT DISTINCT to_char(FECNOM,'dd/mm/yyyy') as FECNOM FROM NPHISCON ORDER BY FECNOM asc");
				  	while(!$tb2->EOF)
					{
...
{
	f=document.form1;
	f.titulo.value="IMPUESTO SOBRE LA RENTA";

        ...
        <div align="left">&nbsp; 
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>ANTIGUEDAD
                      PRESTACIONES SOCIALES (Regimen Viejo) 
            ...
            <tr>
              <td class="form_label_01"><div align="left"><strong>C&oacute;digo
                    Empleado Desde :</strong></div></td>
              <td colspan="2"><div align="left"> </div>
                  <div align="left">
                    <select name="codempdes" class="breadcrumb" id="codempdes">
                      <?
				  print "a";
				  $sql="select distinct a.codemp,nomemp as nombre from nppresocant a,nphojint b where a.codemp=b.codemp  order by codemp";
				  $tb1=$bd->select($sql);
				  	while(!$tb1->EOF)
					{
				  ?>
            ...
            <tr>
              <td class="form_label_01"><div align="left"><strong>C&oacute;digo
                    Empleado Hasta :</strong></div></td>
              <td colspan="2"><div align="left"> </div>
                  <div align="left">
                    <select name="codemphas" class="breadcrumb" id="codemphas">
                      <?
					$tb2=$bd->select("select distinct a.codemp,nomemp as nombre from nppresocant a,nphojint b where a.codemp=b.codemp  order by codemp desc");
				  	while(!$tb2->EOF)
					{
				  ?>
            ...
            <tr>
              ...
              <td colspan="2"><input name="e1" type="text" class="breadcrumb" id="e1" value="ING. WALDO NEGR&Oacute;N" size="60"></td>
            </tr>
            <tr>
              <td class="form_label_01"><strong>Revisado por  : </strong></td>
              <td colspan="2"><input name="e2" type="text" class="breadcrumb" id="e2" value="YOLANDA HURTADO" size="60"></td>
            </tr>
            <tr>
              <td class="form_label_01"><strong>Autorizado por   : </strong></td>
              <td colspan="2"><input name="e3" type="text" class="breadcrumb" id="e3" value="JOS&Eacute; FROIL&Aacute;N GARC&Iacute;A" size="60"></td>
            </tr>
...
{
	f=document.form1;
		f.titulo.value="ANTIGUEDAD PRESTACIONES SOCIALES (Régimen Viejo)";
	f.action="rNPCALPRESOC_RV.php";
	f.submit();
}
function cerrar()
{

      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes 
        ...
        <div align="left">&nbsp; 
          <table width="612"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#6699CC"> 
              <td rowspan="2" class="form_label_01"><strong>Cargo:</strong></td>
              <td height="30" colspan="2"> 
                <?
			  	
			  	$tb=$bd->select("SELECT DISTINCT(CODCAR) as codc FROM NPNOMCAL order by codcar");
			  ?>
            ...
            <tr bordercolor="#6699CC"> 
              <td colspan="2"> 
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(CODCAR) as codc FROM NPNOMCAL order by codcar DESC");
			  ?>
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td> 
                <?
			  	...
			  	$tb=$bd->select("SELECT DISTINCT(CODNOM) as codn FROM NPNOMCAL");
			  ?>

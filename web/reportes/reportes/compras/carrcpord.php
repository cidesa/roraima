    ...
    <tr>
      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes
        ...
        <div align="left">&nbsp;
          ...
          $tb=$bd->select("select min(ordcom) as ordcom from caordcom");
        ?>
          ...
          $tb2=$bd->select("select max(ordcom) as ordcom from caordcom");
        ?>
            <input type="text" name="com2" class="breadcrumb" id="com2" value="<? print $tb->fields["ordcom"];?>">
        ...
        ?>
                 <input type="text" name="pro2" class="breadcrumb" id="pro2" value="<? print $tb->fields["codpro"];?>">
        ...
        ?>
                 <input type="text" name="art2" class="breadcrumb" id="art2" value="<? print $tb->fields["codart"];?>">

          ...
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("select ordcom from caordcom order by ordcom");
			  ?>
                  <select name="com1" class="breadcrumb" id="com1">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
                    <option value="<? print $tb->fields["ordcom"];?>"><? print $tb->fields["ordcom"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select ordcom from caordcom order by ordcom desc");
			  ?>
                <select name="com2" class="breadcrumb" id="com2">
                  <?
				  while(!$tb2->EOF)	
				{
			  ?>
                  <option value="<? print $tb2->fields["ordcom"];?>"><? print $tb2->fields["ordcom"];?></option>
                  <?
				  $tb2->MoveNext();
					}
				?>
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("select distinct(codpro) from caordcom order by codpro");
			  ?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select distinct(codpro) from caordcom order by codpro desc");
			  ?>
            ...
            <tr> 
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select distinct(codart) from caartord order by codart desc");
			  ?>

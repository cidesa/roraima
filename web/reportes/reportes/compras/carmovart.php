...
{
    pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=select distinct(codart) as cod from caregart where length(rtrim(codart))=(select (length(trim( forart))) from cadefart) order by codart";

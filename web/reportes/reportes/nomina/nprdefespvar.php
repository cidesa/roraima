        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Variables 
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo de Variables:</strong></div></td>
              <td> <div align="left"> 
			  
			  
				<?
			  	$tb=$bd->select("SELECT codvar as codvar FROM npdefvar order by codvar asc");
			    ?>
                  <select name="codvar1" class="breadcrumb" id="codvar1">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
                    <option value="<? print $tb->fields["codvar"];?>"><? print $tb->fields["codvar"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>			  
              ...
              <td> <div align="left"> 
                <?
				$tb=$bd->select("SELECT codvar as codvar FROM npdefvar order by codvar desc");
				?>
                  <select name="codvar2" class="breadcrumb" id="codvar2">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
...
{
	f=document.form1;
	f.titulo.value="Variables";
	f.action="rnprdefespvar.php";
	f.submit();
}
function cerrar()
{

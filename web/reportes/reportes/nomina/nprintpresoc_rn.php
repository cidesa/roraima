        ...
        <div align="left">&nbsp; 
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>INTERESES
                      SOBRE  PRESTACIONES
                      SOCIALES (Regimen Nuevo) 
              ...
              <td colspan="2"><div align="left"> </div>
                  <div align="left">
                    <select name="codempdes" class="breadcrumb" id="codempdes">
                      <?
				  $sql="select distinct a.codemp,nomemp as nombre from nppresoc a,nphojint b where a.codemp=b.codemp  order by codemp";
				  $tb1=$bd->select($sql);
				  	while(!$tb1->EOF)
					{
				  ?>
              ...
              <td colspan="2"><div align="left"> </div>
                  <div align="left">
                    <select name="codemphas" class="breadcrumb" id="codemphas">
                      <?
					$tb2=$bd->select("select distinct a.codemp,nomemp as nombre from nppresoc a,nphojint b where a.codemp=b.codemp  order by codemp desc");
				  	while(!$tb2->EOF)
					{
				  ?>
...
{
	f=document.form1;
		f.titulo.value="INTERESES SOBRE PRESTACIONES SOCIALES (Régimen Nuevo)";
	f.action="rNPRINTPRESOC_RN.php";
	f.submit();
}
function cerrar()
{

...
require_once("../../lib/modelo/sqls/nomina/Nprrecpagci.class.php");
...
class pdfreporte extends fpdf
{
  function pdfreporte()
  {
    ...
    $this->cabe='s';
      ...
      $this->objNprrecpag= new Nprrecpagci();
      $this->arrp = $this->objNprrecpag->SQLp($this->cedula,$this->mes,$this->ano);

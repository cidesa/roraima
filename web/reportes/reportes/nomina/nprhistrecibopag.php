        ...
        <div align="left">&nbsp;
          <table width="647"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>HISTORICO RECIBO DE PAGO
...
{
	f=document.form1;
	f.titulo.value="HISTORICO RECIBO DE PAGO";
	f.action="rnprhistrecibopag.php";
	f.submit();
}
function cerrar()
{

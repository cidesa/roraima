      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes 
        ...
        <div align="left">&nbsp; 
          <table width="647"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>A&ntilde;o para Listado  :</strong></div></td>
              <td colspan="2"> <div align="left">
                </div> <div align="left">
				<?
					$tb1=$bd->select("SELECT DISTINCT(SUBSTR(TO_CHAR(FECNOM,'DD/MM/YYYY'),7,4)) as anno  FROM NPHISCON");
				?>
                  <select name="annos" class="breadcrumb" id="annos">
				  <?
				  	while(!$tb1->EOF)
					{
				  ?>
				  <option value="<? print $tb1->fields["anno"];?>"><? print $tb1->fields["anno"];?></option>
				  <?
				  		$tb1->MoveNext();
					}
				  ?>
...
function enviar()
{
	...
	f.action="rnprhis_consolidado_anual.php";
	f.submit();
}
function cerrar()
{

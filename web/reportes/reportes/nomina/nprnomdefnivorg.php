            ...
            <tr bordercolor="#6699CC">
              ...
              <td colspan="2">
                <select name="codcardes" class="breadcrumb" id="codcardes">
                  <?
				  $tb2=$bd->select("SELECT distinct(CODcar),UPPER(nomcar) as nombre FROM NPASICAREMP where (nomcar<>'') order by codcar");
				  	while(!$tb2->EOF)
					{
				  ?>
            ...
            <tr>
              ...
              <td colspan="2">
                  <select name="codcarhas" class="breadcrumb" id="codcarhas">
                    <?
					$tb2=$bd->select("SELECT distinct(CODcar),UPPER(nomcar) as nombre FROM NPASICAREMP where (nomcar<>'') order by codcar DESC");					
				  	while(!$tb2->EOF)
					{
				  ?>
                    <option value="<? print $tb2->fields["codcar"];?>"><? print $tb2->fields["codcar"].' - '.$tb2->fields["nombre"];?></option>

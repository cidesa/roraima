          ...
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
			 ...
			 <tr>
              ...
              <td ><input name="recibido" type="text" class="breadcrumb" id="recibido" value="" size="30"></td>
            ...
            <tr>
              <td height="23" class="form_label_01">
		<!-- <strong>Per&iacute;odo de
                N&oacute;mina:</strong> -->
		</td>
              <td> <div align="left"> </div>
                <div align="left">
                  <?
            ...
            <tr>
              ...
              <td>
                <!-- <select name="consecutivo" class="breadcrumb" id="consecutivo">

        ...
        <div align="left">&nbsp; 
          <table width="612"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Listado de Tipos de Cursos 
            ...
            <tr bordercolor="#6699CC"> 
              <td height="27" class="form_label_01"> <div align="left"><strong>C&oacute;digo de Tipo:</strong></div></td>
              <td> <div align="left">
              <?
			  	$tb=$bd->select("SELECT DISTINCT(CODTIPCUR) as codtip,DESTIPCUR as destip FROM RHTIPCUR ORDER BY CODTIPCUR");
			  ?>                
				...
				<?
					...
					{
				?>
				<option value="<? print $tb->fields["codtip"];?>" selected><? print $tb->fields["codtip"].' - '.$tb->fields["destip"];?></option>
				<?
						$tb->MoveNext();
					}
				?>
              ...
              <td> <div align="left">
			  <?
			  	$tb=$bd->select("SELECT DISTINCT(CODTIPCUR) as codtip,DESTIPCUR as destip FROM RHTIPCUR ORDER BY CODTIPCUR DESC");
			  ?>
...
{
	f=document.form1;
	f.titulo.value="Listado de Tipos de Cursos";
	f.action="rrhrdeftipcur.php";
	f.submit();
}
function cerrar()
{

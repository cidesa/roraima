        ...
        <div align="left">&nbsp; 
          <table width="612"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>HISTORICO 
                  DE PRESTAMOS 
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("select distinct a.codemp,b.nomemp from npnomcal a, nphojint b
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select distinct a.codemp,b.nomemp from npnomcal a, nphojint b
...
{
	f=document.form1;
	f.titulo.value="HISTORICO DE PRESTAMOS";
	f.action="rNPRHISTPRES.php";
	f.submit();
}
function cerrar()
{

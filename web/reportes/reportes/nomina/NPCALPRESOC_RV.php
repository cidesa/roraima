            ...
            <tr>
              ...
              <td> <div align="left"> 
                   <input name="codempdes" type="text" class="breadcrumb" id="codempdes" 
                   		  value="<?$sql="select min(codemp) as codemp from nppresocant";
              ...
              <td> <div align="left"> 
                  <input name="codemphas" type="text" class="breadcrumb" id="codemphas"
                		 value="<?$sql="select max(codemp) as codemp from nppresocant";
 				    	LlenarTextoSql($sql,"codemp",$bd); ?>" size ="20">
...
{
	f=document.form1;
		f.titulo.value="ANTIGUEDAD PRESTACIONES SOCIALES (Regimen Viejo)";
...
function catalogo(campo)
 
   {
       ...
       mysql='select distinct a.codemp,nomemp as nombre from nppresocant a,nphojint b where a.codemp=b.codemp  order by codemp';

        ...
        <div align="left">&nbsp;
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Relaci&oacute;n - Hist&oacute;rico de Vacaciones
            ...
            <tr bordercolor="#6699CC">
              ...
              <td> <div align="left">
                  <?
				$tb=$bd->select("Select distinct( A.codemp) as codemp, A.nomemp from NPasicaremp A, NPVACREGSAL B where A.codemp=B.codemp order by codemp asc");
			  ?>
              ...
              <td>
                <?
				$tb=$bd->select("Select distinct( A.codemp) as codemp, A.nomemp from NPasicaremp A, NPVACREGSAL B where A.codemp=B.codemp order by codemp desc");
			  ?>
            ...
            <tr bordercolor="#6699CC">
              <td class="form_label_01"> <div align="left">
                <p><strong>C&oacute;digo Niveles:</strong></p>
              </div></td>
              <td> <div align="left">
                  <?
				$tb=$bd->select("SELECT codniv, desniv FROM npestorg where char_length(rtrim(codniv))=14 order by codniv asc");
			  ?>
                  <select name="codnivdes" class="breadcrumb" id="codnivdes">
					...
					{
				  ?>
                    <option value="<? print $tb->fields["codniv"];?>"><? print $tb->fields["codniv"]." - ".substr($tb->fields["desniv"],'0','25')."..."; ?></option>
                    <?
					$tb->MoveNext();
					}
				?>
              ...
              <td>
                <?
				$tb=$bd->select("SELECT codniv, desniv FROM npestorg where char_length(rtrim(codniv))=14 order by codniv desc");
			  ?>
            ...
            <tr bordercolor="#6699CC">
              ...
              <td colspan="2"> <div align="left">
			    <?
				$tb=$bd->select("SELECT DISTINCT(codnom) as codnom, nomnom FROM npnomina ORDER BY CODNOM ASC");
			  ?>
                <select name="tipnomdes" class="breadcrumb" id="tipnomdes">
                  <?
					...
					{
				  ?>
                  <option value="<? print $tb->fields["codnom"];?>"><? print $tb->fields["nomnom"]; ?></option>
                  <?
					$tb->MoveNext();
					}
				?>
...
{
	f=document.form1;
	f.titulo.value="Relación - Historico de Vacaciones";
	f.action="rnpvac_relacionhistoricos.php";
	f.submit();
}
function cerrar()
{

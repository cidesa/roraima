        ...
        <div align="left">&nbsp;
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Listado de Prenomina  por Categoria
...
<tr>
		 ...
		 <tr>
            ...
            <tr>
              ...
              <td colspan="2"><input name="revisado" type="text" class="breadcrumb" id="revisado" value="Lic. Esther N. Perez U." size="60"></td>
            </tr>
            <tr>
              <td class="form_label_01"><strong>Autorizado Por: </strong></td>
              <td colspan="2"><input name="autorizado" type="text" class="breadcrumb" id="autorizado" value="Lic. Rafael N. Sáez" size="60"></td>
            </tr>
            <tr bordercolor="#6699CC">
...
{
	f=document.form1;
	f.titulo.value="Nomina de Pago por Categoria";

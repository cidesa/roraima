        ...
        <div align="left">&nbsp; 
          <table width="689"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>REPORTE 
                  CONSOLIDADO 
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("select distinct(to_char(fecnom,'dd/mm/yyyy')) as fecnom from npnomcal order by to_char(fecnom,'dd/mm/yyyy') desc");
			  ?>
                  <select name="fecha1" class="breadcrumb" id="fecha1">
					...
					{
				  ?>
                    <option value="<? print $tb->fields["fecnom"];?>"><? print $tb->fields["fecnom"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select distinct(to_char(fecnom,'dd/mm/yyyy')) as fecnom from npnomcal order by to_char(fecnom,'dd/mm/yyyy') asc");
			  ?>
            ...
            <tr> 
              ...
              <td colspan="2"> <div align="left"> 
			  	...
			  	$tb=$bd->select("select distinct codban,nomban from npbancos order by codban asc");
			  ?>
                  <select name="nom" class="breadcrumb" id="nom">
					...
					{
				  ?>
                    <option value="<? print $tb->fields["codban"];?>"><? print $tb->fields["codban"]." - ".strtoupper($tb->fields["nomban"]);?></option>
                    <?
					$tb->MoveNext();
					}
				?>
...
{
	f=document.form1;
	f.titulo.value="REPORTE CONSOLIDADO DE TIPOS DE NOMINA";
	f.action="rNPRCONSOLIDADO.php";
	f.submit();
}
function cerrar()
{

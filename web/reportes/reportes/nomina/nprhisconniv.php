          ...
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              ...
              <td><div align="left">
              	...
              	<input name="fecnomdes" type="text"  value="<?
                $sql="SELECT min(FECNOM) as fecnom  FROM NPHISCON";
                LlenarTextoSql($sql,"fecnom",$bd);				
				?>" class="breadcrumb" id="fecnomdes" size="20" maxlength="50" datepicker="true">                              
              
              </div></td>
              <td>
              	<input name="fecnomhas" type="text"  value="<?
                $sql="SELECT max(FECNOM) as fecnom  FROM NPHISCON";
                LlenarTextoSql($sql,"fecnom",$bd);				
				?>" class="breadcrumb" id="fecnomhas" size="20" maxlength="50" datepicker="true">                 

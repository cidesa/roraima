        ...
        <div align="left">&nbsp; 
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
			  ...
			  ?>
                  <select name="codmundes" class="breadcrumb" id="codmundes">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
              ...
              <td><?
			  	...
			  	$tb=$bd->select("select * from npciudad order by codciu desc");
			  ?>
                <select name="codmunhas" class="breadcrumb" id="codmunhas">
                  <?
				  	while(!$tb->EOF)	
					{
				  ?>

        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>ACCION ADMINISTRATIVA 
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td> <div align="left"> 
				...
				<?
			  	$tb=$bd->select("select codaccadm from npaccadm order by codaccadm asc");
			    ?>
                  <select name="codaccadm1" class="breadcrumb" id="codaccadm1">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
                    <option value="<? print $tb->fields["codaccadm"];?>"><? print $tb->fields["codaccadm"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>			  
              ...
              <td> <div align="left"> 
                <?
				$tb=$bd->select("select codaccadm from npaccadm order by codaccadm desc");
				?>
                  <select name="codaccadm2" class="breadcrumb" id="codaccadm2">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
...
{
	f=document.form1;
	f.titulo.value="ACCION ADMINISTRATIVA";
	f.action="rnpraccadm.php";
	f.submit();
}
function cerrar()
{

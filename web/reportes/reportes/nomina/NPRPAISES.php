          ...
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo 
                  Pa&iacute;s:</strong></div></td>
              <td> <div align="left"> 
                  <?
			  	
			  	$tb=$bd->select("select codpai from nppais order by codpai");
			  ?>
                  <select name="cod1" class="breadcrumb" id="cod1">
					...
					{
				  ?>
                    <option value="<? print $tb->fields["codpai"];?>"><? print $tb->fields["codpai"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select codpai from nppais order by codpai desc");
			  ?>
				...
				{
			  ?>
                  <option value="<? print $tb2->fields["codpai"];?>"><? print $tb2->fields["codpai"];?></option>
                  <?
				  $tb2->MoveNext();
					}
				?>
...
{
	f=document.form1;
	f.titulo.value="DEFINICION DE PAISES";
	f.action="rNPRPAISES.php";
	f.submit();
}
function cerrar()
{

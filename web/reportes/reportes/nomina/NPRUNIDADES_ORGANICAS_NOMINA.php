          ...
          <table width="612"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("select codemp from npnomcal order by codemp");
			  ?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select codemp from npnomcal order by codemp desc");
			  ?>
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("select codcon from npnomcal order by codcon");
			  ?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select codcon from npnomcal order by codcon desc");
			  ?>
...
{
	f=document.form1;
	f.titulo.value="CATEGORIAS PRESUPUESTARIAS POR NOMINA";
	f.action="rNPRUNIDADES_ORGANICAS_NOMINA.php";
	f.submit();
}
function cerrar()
{

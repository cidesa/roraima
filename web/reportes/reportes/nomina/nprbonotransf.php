        ...
        <div align="left">&nbsp; 
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>COMPENSACION BONO DE TRANSFERENCIA
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("Select distinct A.codemp,nomemp from nppresocant A,NPHOJINT B WHERE A.CODEMP=B.CODEMP  order by CODEMP");
			  ?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("Select distinct A.codemp,nomemp from nppresocant A,NPHOJINT B WHERE A.CODEMP=B.CODEMP  order by CODEMP  desc");
			  ?>
...
{
	f=document.form1;
	f.titulo.value="COMPENSACION BONO DE TRANSFERENCIA";
	f.action="rnprbonotransf.php";
	f.submit();
}

        ...
        <div align="left">&nbsp;
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Resumen de Nomina
...
{
	f=document.form1;
	f.titulo.value="Resumen de Nomina ";
	f.action="rnpresumen_nomina_aporte.php";
	f.submit();
}
function cerrar()
{

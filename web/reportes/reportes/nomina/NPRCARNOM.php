          ...
          <table width="612"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              ...
              <td> <div align="left"> 
			  	...
			  	$tb=$bd->select("select codcar from npcargos order by codcar");
			  ?>
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select codcar from npcargos order by codcar desc");
			  ?>
				...
				{
			  ?>
                  <option value="<? print $tb2->fields["codcar"];?>"><? print $tb2->fields["codcar"];?></option>
                  <?
				  $tb2->MoveNext();
					}
				?>
            ...
            <tr> 
              ...
              <td> 
                <?
			  	...
			  	$tb2=$bd->select("select distinct(codnom),nomnom from npnomina order by codnom desc");
			  ?>
...
{
	f=document.form1;
	f.titulo.value="CARGOS POR NOMINA";
	f.action="rNPRCARNOM.php";
	f.submit();
}
function cerrar()
{

        ...
        <div align="left">&nbsp;
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Hist�rico de Vacaciones
            ...
            <tr bordercolor="#6699CC">
              ...
              <td> <div align="left">
				...
				$tb=$bd->select("Select codemp, nomemp from NPasicaremp order by codemp asc");
			  ?>
              ...
              <td>
                <?
				$tb=$bd->select("Select codemp, nomemp from NPasicaremp order by codemp desc");
			  ?>
...
{
	f=document.form1;
	f.titulo.value="Histórico de Vacaciones";
	f.action="rnpvac_historico.php";
	f.submit();
}
function cerrar()
{

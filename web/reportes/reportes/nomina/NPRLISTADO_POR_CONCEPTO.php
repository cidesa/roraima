      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes 
        ...
        <div align="left">&nbsp; 
          <table width="689"  border="1" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              <td class="form_label_01"> <div align="left"><strong>Categor&iacute;a 
            ...
            <tr> 
              <td class="form_label_01"><strong>Periodo N&oacute;mina:</strong></td>
              <td> <div align="left"> 
                  <input name="per1" type="text" class="breadcrumb" id="per1" size="20">
                </div></td>
              <td> <input name="per2" type="text" class="breadcrumb" id="per2" size="20"></td>
            </tr>
            <tr bordercolor="#FFFFFF"> 
...
function enviar()
{
	...
	f.action="rNPRLISTADO_POR_CONCEPTO.php";
	f.submit();
}
function cerrar()
{

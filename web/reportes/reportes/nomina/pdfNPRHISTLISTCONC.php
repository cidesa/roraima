	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
            ...
            {  if ($this->especial == 'N')           $especial = " A.especial = 'N' AND";
				...
				if ($this->pf_10=='t')
				{
				$this->sql="SELECT DISTINCT A.CODEMP, D.NOMCON, A.CODCON, A.CODCAR,sum(A.monto) as saldo, A.CODNOM, C.NOMEMP, C.CEDEMP, C.CODBAN, E.NOMBAN,
							B.NOMCAR, D.OPECON, D.CODCON, D.IMPCPT,cast(REPLACE(c.cedemp,'.', '') as int)

        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>SITUACION DEL EMPLEADO 
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td> <div align="left"> 
				...
				<?
			  	$tb=$bd->select("select codsitemp from npsitemp order by codsitemp asc");
			    ?>
                  <select name="codsitemp1" class="breadcrumb" id="codsitemp1">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
                    <option value="<? print $tb->fields["codsitemp"];?>"><? print $tb->fields["codsitemp"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>			  
              ...
              <td> <div align="left"> 
                <?
				$tb=$bd->select("select codsitemp from npsitemp order by codsitemp desc");
				?>
                  <select name="codsitemp2" class="breadcrumb" id="codsitemp2">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
...
{
	f=document.form1;
	f.titulo.value="SITUACION DEL EMPLEADO";
	f.action="rnprdefespsitemp.php";
	f.submit();
}
function cerrar()
{

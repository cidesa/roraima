...
{
	f=document.form1;
		f.titulo.value="ANTIGUEDAD PRESTACIONES SOCIALES (Regimen Nuevo)";
...
function catalogo(campo)
 
   {
       ...
       mysql='select distinct a.codemp as CODIGO, nomemp as DESCRIPCION from nppresoc a,nphojint b where a.codemp=b.codemp order by codemp';

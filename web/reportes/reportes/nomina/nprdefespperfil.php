        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>PERFIL 
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo de Perfil:</strong></div></td>
              <td> <div align="left"> 
			  
			  
				<?
			  	$tb=$bd->select("select codperfil from npperfil order by codperfil asc");
			    ?>
                  <select name="codperfil1" class="breadcrumb" id="codperfil1">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
                    <option value="<? print $tb->fields["codperfil"];?>"><? print $tb->fields["codperfil"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>			  
              ...
              <td> <div align="left"> 
                <?
				$tb=$bd->select("select codperfil from npperfil order by codperfil desc");
				?>
                  <select name="codperfil2" class="breadcrumb" id="codperfil2">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
...
{
	f=document.form1;
	f.titulo.value="PERFIL";
	f.action="rnprdefespperfil.php";
	f.submit();
}
function cerrar()
{

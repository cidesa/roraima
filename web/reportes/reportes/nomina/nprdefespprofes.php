        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>PROFESIONES 
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo de Profesiones:</strong></div></td>
              <td> <div align="left"> 
			  
			  
				<?
			  	$tb=$bd->select("select codprofes from npprofesion order by codprofes asc");
			    ?>
                  <select name="codprofes1" class="breadcrumb" id="codprofes1">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
                    <option value="<? print $tb->fields["codprofes"];?>"><? print $tb->fields["codprofes"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>			  
              ...
              <td> <div align="left"> 
                <?
				$tb=$bd->select("select codprofes from npprofesion order by codprofes desc");
				?>
                  <select name="codprofes2" class="breadcrumb" id="codprofes2">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
...
{
	f=document.form1;
	f.titulo.value="Profesiones";
	f.action="rnprdefespprofes.php";
	f.submit();
}
function cerrar()
{

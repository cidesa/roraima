      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes 
        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo de Concepto:</strong></div></td>
              <td> <div align="left"> 
			  
			  
				<?
			  	$tb=$bd->select("SELECT codcon as codcon FROM npdefcpt order by codcon asc");
			    ?>
              ...
              <td> <div align="left"> 
                <?
				$tb=$bd->select("SELECT codcon as codcon FROM npdefcpt order by codcon desc");
				?>
...
{
	f=document.form1;
	f.titulo.value="Catalogo de Conceptos";

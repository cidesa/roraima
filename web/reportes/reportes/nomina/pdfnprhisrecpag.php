...
class pdfreporte extends fpdf
{
  function pdfreporte()
  {
	...
	$this->nommaxesp= H::GetPost('nommaxesp');
      ...
      $this->arrp = $this->objNprhisrecpag->SQLp($this->codnomdes,$this->codempdes,$this->codemphas,$this->codcardes,$this->codcarhas,$this->codcondes,$this->codconhas,$this->especial,$this->nomminesp,$this->nommaxesp,$this->fecnomdes,$this->fecnomhas);
...
$this->cell(30,5,H::FormatoMonto($arrsueldo[$this->index]["valor"]),0,0,"R");
   ...
   $this->ln(20);
      	  $this->cell(0,5,"Recibe Conforme:_____________________________________________",0,'C');
          //$this->setAutoPageBreak(true,25);
          $y2=$this->GetY();
           //if ($y2>180) {
           //	  $this->ln();

...
<!-- codigo concepto-->
		 ...
		 <tr> 
	  	<td class="form_label_01"> <div align="left"><strong> Tipo de Gasto:</strong></div></td>
              <td> <div align="left"> 
               	<input name="gas1" type="text" class="breadcrumb" id="gas1" 
                   value="<?$sql="select min(codtipgas) as codgas from nptipgas";
 					LlenarTextoSql($sql,"codgas",$bd); ?>" size ="20">
 					 <input type="button" name="Button8" value="..." onClick="catalogo6('gas1');">
 			      </div></td>
 			      
              <td> <div align="left"> 
               	<input name="gas2" type="text" class="breadcrumb" id="gas2" 
                   value="<?$sql="select max(codtipgas) as codgas from nptipgas";
 					LlenarTextoSql($sql,"codgas",$bd); ?>" size ="20">
 					 <input type="button" name="Button9" value="..." onClick="catalogo6('gas2');">
 			      </div></td>
            </tr>
...
{
	f=document.form1;
	f.titulo.value="RELACION NOMINA PRESUPUESTO POR GASTO";
...
function catalogo6(campo)
   {
      mysql='select distinc (codtipgas) as CODIGO,destipgas as DESCRIPCION from nptipgas order by codtipgas';

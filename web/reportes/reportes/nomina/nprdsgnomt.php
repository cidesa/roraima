      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes
        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>DESGLOSE DE NOMINA
            ...
            <tr>
              ...
              <td><div align="left">
				...
				$sql="SELECT min(CODEMP) as codemp FROM NPNOMCAL";
              ...
              <td><input name="emphas" type="text" value="<?
				$sql="SELECT max(CODEMP) as codemp FROM NPNOMCAL";
                LlenarTextoSql($sql,"codemp",$bd);
       ...
       <tr>
              ...
              <td><div align="left">
				...
				$sql="SELECT min(codcar) as codcar FROM NPNOMCAL where trim(codcar)!='' ";
              ...
              <td><input name="carhas" type="text" value="<?
				$sql="SELECT max(codcar) as codcar FROM NPNOMCAL";
                LlenarTextoSql($sql,"codcar",$bd);
...
{
	f=document.form1;
	f.titulo.value="DESGLOSE DE NOMINA";
	f.action="rnprdsgnomt.php";
	f.submit();
}
function cerrar()
{
...
function catalogo(campo)
   {
      mysql='SELECT distinct(a.CODEMP) as Código,b.nomemp as Nombre FROM NPNOMCAL a, nphojint b where a.CODEMP=b.CODEMP order by a.codemp';
...
function catalogo1(campo)
   {
      mysql='select distinct(a.codcar) as Codigo,b.nomcar as Nombre FROM NPNOMCAL a, npcargos b WHERE A.CODCAR=B.CODCAR order by A.codcar';
	  pagina="../../lib/general/catalogoobj.php?sql="+mysql+"&campo="+campo;
	  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,resizable=yes,left=50,top=50");
   }

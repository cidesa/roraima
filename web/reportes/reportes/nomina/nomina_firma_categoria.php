...
<tr>
            ...
            <tr>
              ...
              <td colspan="2"><input name="elaborado" type="text" class="breadcrumb" id="elaborado" value="INGRID HERMOSO" size="60"></td>
            </tr>
            <tr>
              <td class="form_label_01"><strong>Revisado Por: </strong></td>
              <td colspan="2"><input name="revisado" type="text" class="breadcrumb" id="revisado" value="LIC. REINIER PARRA" size="60"></td>
            </tr>
            <tr>
              <td class="form_label_01"><strong>Autorizado Por: </strong></td>
              <td colspan="2"><input name="autorizado" type="text" class="breadcrumb" id="autorizado" value="RAFAEL SAEZ" size="60"></td>
            </tr>
            <tr bordercolor="#6699CC">

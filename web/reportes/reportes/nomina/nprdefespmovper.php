        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>CONCEPTOS VARIABLES 
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo Nomina:</strong></div></td>
              <td> <div align="left"> 
			  
			  
				<?
			  	$tb=$bd->select("select distinct(codnom) as codnom from npdefmov order by codnom asc");
			    ?>
                  <select name="codcom1" class="breadcrumb" id="codcom1">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
              ...
              <td> <div align="left"> 
                <?
				$tb=$bd->select("select distinct(codnom) as codnom from npdefmov order by codnom desc");
				?>
                  <select name="codcom2" class="breadcrumb" id="codcom2">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td> <div align="left"> 
				...
				<?
			  	$tb=$bd->select("select distinct(codcon) as codcon from npdefmov order by codcon asc");
			    ?>
                  <select name="codcon1" class="breadcrumb" id="codcon1">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
              ...
              <td> <div align="left"> 
                <?
				$tb=$bd->select("select distinct(codcon) as codcon from npdefmov order by codcon desc");
				?>
                  <select name="codcon2" class="breadcrumb" id="codcon2">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
...
{
	f=document.form1;
	f.titulo.value="CONCEPTOS VARIABLES";
	f.action="rnprdefespmovper.php";
	f.submit();
}
function cerrar()
{

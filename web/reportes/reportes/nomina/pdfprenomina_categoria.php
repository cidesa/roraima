<?
	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->sql="SELECT DISTINCT
						...
						WHERE
							...
							B.CODcat >= RPAD('".$this->codcatdes."',16,' ') AND
							B.CODcat <= RPAD('".$this->codcathas."',16,' ') AND 							B.STATUS='V' AND
		...
		function Header()
		{
			...
			$this->cell(100,5,'NOMINA: '.$this->tipnom.' - '.ucwords($this->nombre));
		...
		function Cuerpo()
		{
			...
			if(!$tb2->EOF)
			{
				 ...
				 $contador=$contador+1;
				 $this->setFont("Arial","B",8); 
				 $this->cell(80,5,$tb2->fields["codcat"].' '.ucwords($tb2->fields["nomcat"]));
			...
			while(!$tb->EOF)
			{
				if($tb->fields["codemp"]!=$ref)
				{
				 ...
				 $this->cell(75,5,ucwords($tb->fields["nomcon"]));
				 ...
				 $this->line(10,$this->getY(),200,$this->getY());
				 $this->ln(8);
				 $this->cell(95,5,'TOTAL NOMINA:  '.ucwords($this->nombre));

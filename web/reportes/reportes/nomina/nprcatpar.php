        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Partidas Presupuestarias Presupuestarias 
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo de Partidas:</strong></div></td>
              <td> <div align="left"> 
			  
			  
				<?
			  	$tb=$bd->select("select codpar,nompar from nppartidas order by codpar asc");
			    ?>
                  <select name="codpar1" class="breadcrumb" id="codpar1">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
                    <option value="<? print $tb->fields["codpar"];?>"><? print $tb->fields["codpar"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>			  
              ...
              <td> <div align="left"> 
                <?
				$tb=$bd->select("select codpar,nompar from nppartidas order by codpar desc");
				?>
                  <select name="codpar2" class="breadcrumb" id="codpar2">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
...
{
	f=document.form1;
	f.titulo.value="Partidas Presupuestarias Presupuestarias";
	f.action="rnprcatpar.php";
	f.submit();
}
function cerrar()
{

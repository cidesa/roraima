<?
	...
	class pdfreporte extends fpdf
	{
		...
		{
				$this->titulos[0]="Codigo Nivel";
				$this->titulos[1]="Descripcion Nivel";
				//$this->titulos[2]="             Telefono Nivel";
		}
		...
		function Cuerpo()
		{
			...
			{
				//$this->setFont("Arial","B",8);
				$this->cell($this->anchos[0],3,"".$tb->fields["codniv"]);
				$x=$this->GetX();
				$this->cell($this->anchos[1]+5);
				$this->cell($this->anchos[2],3,"  ".$tb->fields["telext"]);
				$this->SetX($x);
				$this->Multicell($this->anchos[1]+5,3,$tb->fields["desniv"]);
				$this->ln();
				$tb->MoveNext();
			}
		}

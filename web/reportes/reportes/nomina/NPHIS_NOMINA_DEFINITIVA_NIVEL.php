        ...
        <div align="left">&nbsp; 
          <table width="689"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr> 
              ...
              <td> <div align="left"> 
                  <input name="fecha1" type="text" class="breadcrumb" id="fecha1" datepicker="true" size="12" maxlength="10"
                  value="<? $sql="select distinct(to_char(min(fecnom),'dd/mm/yyyy')) as fecha from nphiscon";
                    LlenarTextoSql($sql,"fecha",$bd);	?>">
                </div></td>
               
                             
            <td> <div align="left"> 
                  <input name="fecha2" type="text" class="breadcrumb" id="fecha2" datepicker="true" size="12" maxlength="10"
                  value="<? $sql="select distinct(to_char(max(fecnom),'dd/mm/yyyy')) as fecha from nphiscon";
                    LlenarTextoSql($sql,"fecha",$bd);	?>">
                </div></td>
            </tr>
            <tr> 
...
<!-- cODIGO DE cARGO -->
              ...
              <td> <div align="left"> 
                   ...
                   value="<?$sql="SELECT min(codcar)as codcar FROM NPASICAREMP a";
 					LlenarTextoSql($sql,"codcar",$bd); ?>" size ="20">
 					 <input type="button" name="Button3" value="..." onClick="catalogo3('car1');">
                </div></td>
            ...
            <tr> 
             ...
             <td> <div align="left"> 
               	<input name="niv1" type="text" class="breadcrumb" id="niv1" 
                   value="<?$sql="select min(codniv) as codniv from npestorg";
 					LlenarTextoSql($sql,"codniv",$bd); ?>" size ="20">
 					 <input type="button" name="Button8" value="..." onClick="catalogo5('niv1');">
 			      </div></td>
 			      
             <td> <div align="left"> 
               	<input name="niv2" type="text" class="breadcrumb" id="niv2" 
                   value="<?$sql="select max(codniv) as codniv from npestorg";
 					LlenarTextoSql($sql,"codniv",$bd); ?>" size ="20">
 					 <input type="button" name="Button8" value="..." onClick="catalogo5('niv2');">
 			      </div></td>
            </tr>
            <tr> 

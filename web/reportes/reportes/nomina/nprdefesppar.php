        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>TIPOS DE PARIENTES 
            ...
            <tr bordercolor="#6699CC"> 
              ...
              <td> <div align="left"> 
				...
				<?
			  	$tb=$bd->select("select tippar from nptippar order by tippar asc");
			    ?>
                  <select name="tippar1" class="breadcrumb" id="tippar1">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
                    <option value="<? print $tb->fields["tippar"];?>"><? print $tb->fields["tippar"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>			  
              ...
              <td> <div align="left"> 
                <?
				$tb=$bd->select("select tippar from nptippar order by tippar desc");
				?>
                  <select name="tippar2" class="breadcrumb" id="tippar2">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
...
{
	f=document.form1;
	f.titulo.value="TIPOS DE PARIENTES";
	f.action="rnprdefesppar.php";
	f.submit();
}
function cerrar()
{

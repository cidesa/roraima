<?
  ...
  require_once("../../lib/modelo/sqls/nomina/Nprnomdef.class.php");
  ...
  class pdfreporte extends fpdf
  {
    ...
    function pdfreporte()
    {
      ...
      $this->objNprnomdef = new Nprnomdef();
            $this->arrp = $this->objNprnomdef->SQLp($this->codempdes,$this->codemphas,$this->tipnomdes,$this->tipnomhas,$this->codcardes,$this->codcarhas,$this->especial,$this->codnomesp,$this->codcondes,$this->codconhas);
    ...
    function Header()
    {
      ...
      {
        $this->arrnomesp = $this->objNprnomdef->SQLnpnomesptipos($this->especial);
    ...
    function Cuerpo()
    {
      ...
      $this->setFont("Arial","",7);
      $this->arrconsue = $this->objNprnomdef->SQLnpconsueldo($this->arrp[$i]["codemp"],$this->arrp[$i]["codcar"],$this->arrp[$i]["codnom"]);
      $this->setX($this->GetX()+5);$this->cell(15,5,H::FormatoMonto($this->arrconsue[0]["sueldo"]));
      $this->ln();
      $this->setFont("Arial","B",7);
      ...
      for ($i=0;$i<count($this->arrp);$i++)
      {
        ...
        //  $this->setAutoPageBreak(false);
          ...
          $this->setX($this->GetX()+5);$this->cell(15,5,"CARGO:  ");
          $this->setFont("Arial","",7);
          $this->setX($this->GetX()+5);$this->cell(50,5,$this->arrp[$i]["codcar"]."    ".substr($this->arrp[$i]["nomcar"],0,40));
          $this->ln();
          $this->setFont("Arial","B",7);
          $this->setX(15);$this->cell(25,5,"Fecha de Ingreso:  ");
          $this->setFont("Arial","",7);
        ...
        if ($this->arrp[$i]["asigna"]!=0 || $this->arrp[$i]["deduc"]!=0)
        {
          ...
          //CALCULO DE PRESTAMO
          $arrasicon= $this->objNprnomdef->SQLnpasiconemp($this->arrp[$i]["codemp"],$this->arrp[$i]["codcar"],$this->arrp[$i]["codcon"]);
          $acumulado= $arrasicon[0]["saldo"];
          $arrtippre= $this->objNprnomdef->SQLnptippre($this->arrp[$i]["codcon"]);

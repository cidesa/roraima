	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->sql="SELECT 
							...
							B.CODEMP as codemp,
							C.NOMEMP as nomemp,
							(CASE WHEN B.ASICLA='S' THEN 'SI' WHEN B.ASICLA='N' THEN 'NO' ELSE '' END) as asical
						FROM RHDEFCUR A, RHASICUR B,NPHOJINT C
						WHERE 

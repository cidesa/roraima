            ...
            <tr>
              ...
              <td> <div align="left"> </div>
                <div align="left">
			  	...
			  	$tb=$bd->select("select to_char(min(a.fecasi),'dd/mm/yyyy') as fecha from  npasicaremp a");
				if(!$tb->EOF)
				{
					$fecini=$tb->fields["fecha"];
				}

			  	$tb2=$bd->select("select to_char(max(a.fecasi),'dd/mm/yyyy') as fecha from  npasicaremp a");
				if(!$tb2->EOF)
				{
				...
				?>
                  <input name="fec1" type="text" class="breadcrumb" id="fec1" datepicker="true" value="<? print $fecini;?>">
                </div></td>
              <td><input name="fec2" type="text" class="breadcrumb" id="fec2" datepicker="true" value="<? print $fecdes;?>"></td>
            </tr>
            <tr bordercolor="#FFFFFF">
...
{
	f=document.form1;
	f.titulo.value="REGISTRO DE ASIGNACION DE CARGOS";

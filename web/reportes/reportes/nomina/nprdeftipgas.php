        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>TIPOS DE GASTOS 
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo del Pariente:</strong></div></td>
              <td> <div align="left"> 
			  
			  
				<?
			  	$tb=$bd->select("select codtipgas from nptipgas order by codtipgas asc");
			    ?>
                  <select name="codtipgas1" class="breadcrumb" id="codtipgas1">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
                    <option value="<? print $tb->fields["codtipgas"];?>"><? print $tb->fields["codtipgas"];?></option>
                    <?
					$tb->MoveNext();
					}
				?>			  
              ...
              <td> <div align="left"> 
                <?
				$tb=$bd->select("select codtipgas from nptipgas order by codtipgas desc");
				?>
                  <select name="codtipgas2" class="breadcrumb" id="codtipgas2">
                    <?
				  	while(!$tb->EOF)	
					{
				  ?>
...
{
	f=document.form1;
	f.titulo.value="TIPOS DE GASTOS";
	f.action="rnprdeftipgas.php";
	f.submit();
}
function cerrar()
{

        ...
        <div align="left">&nbsp; 
          <table width="647" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>RELACION DE TRANSFERENCIAS POR RECIBIR DE ORGANOS DEL SECTOR PUBLICO
...
{
	f=document.form1;
	f.titulo.value="RELACION DE TRANSFERENCIAS POR RECIBIR DE ORGANOS DEL SECTOR PUBLICO";
	f.action="rfordontrarecsecpub.php";
	f.submit();
}
function cerrar()
{

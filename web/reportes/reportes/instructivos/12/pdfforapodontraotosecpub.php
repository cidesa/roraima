<?
	...
	class pdfreporte extends fpdf
	{
		...
		function Formato()
		{
			...
			$this->setXY(80,50);		
			$this->Cell(10,10,'C O N C E P T O');	
		...
		{	
			...
			while (!$tb->EOF)
			{
				...
				$this->sql2="SELECT b.nomparegr,sum(c.monpre) as monpre
					from fordefparegr b, fordetpryaccespmet c
					where rtrim('".$tb->fields["codpre"]."')=rtrim(b.codparegr)
					and rtrim('".$tb->fields["codpre"]."')=rtrim(c.codpar)
					group by b.nomparegr";
				$tb2=$this->bd->select($this->sql2);
				
				$this->setX(12);
				$this->cell(15,5,$tb->fields["codpre"]);
				$this->setX(32);
				$this->cell(15,5,$tb2->fields["nomparegr"]);
				$this->setX(150);

        ...
        <div align="left">&nbsp; 
          <table width="647" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>RESUMEN DE CREDITOS POR PARTODAS 
...
{
	f=document.form1;
	f.titulo.value="RESUMEN DE CREDITOS POR PARTIDAS";
	f.action="rforrescrepar.php";
	f.submit();
}
function cerrar()
{

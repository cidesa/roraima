        ...
        <div align="left">&nbsp; 
          <table width="647" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Comentarios a la Situacion General del Ente
            ...
            <tr>
              <td colspan="3" class="form_label_01"><strong>Explicacion de las Desviaciones .... </strong></td>
            </tr>
            <tr>
              <td class="form_label_01">&nbsp;</td>
              <td colspan="2"><label>
                <textarea name="explicacion" cols="80" id="explicacion"></textarea>
              </label></td>
            </tr>
            <tr bordercolor="#6699CC">
              <td colspan="3" class="form_label_01">&nbsp;</td>
            ...
            <tr bordercolor="#6699CC">
              <td colspan="3" class="form_label_01"><strong>Problemas mas Previsibles mas Importantes: </strong></td>
            </tr>
            <tr>
              <td class="form_label_01">&nbsp;</td>
              <td colspan="2"><label>
                <textarea name="problemas" cols="80" id="problemas"></textarea>
              </label></td>
            </tr>
            <tr bordercolor="#6699CC">
              <td colspan="3" class="form_label_01">&nbsp;</td>
            ...
            <tr bordercolor="#6699CC">
              <td colspan="3" class="form_label_01"><strong>Soluciones Posibles a los Problemas: </strong></td>
            </tr>
            <tr>
              <td class="form_label_01">&nbsp;</td>
              <td colspan="2"><label>
                <textarea name="soluciones" cols="80" id="soluciones"></textarea>
              </label></td>
            </tr>
            <tr bordercolor="#6699CC">
              <td colspan="3" class="form_label_01">&nbsp;</td>
...
{
	f=document.form1;
	f.titulo.value="COMENTARIOS A LA SITUACION GENERAL DEL ENTE";
	f.action="rprecomsitgen.php";
	f.submit();
}
function cerrar()
{

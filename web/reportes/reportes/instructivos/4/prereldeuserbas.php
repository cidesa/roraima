          ...
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> 
                  <p><font color="#000066" size="4"><strong>Relaci&oacute;n de 
                    Deudas por Servicios B&aacute;sicos 
...
{
  f=document.form1;
  f.action="rprereldeuserbas.php";
  f.titulo.value="RELACION DE DEUDAS POR SERVICIOS BASICOS";
  f.submit();
}

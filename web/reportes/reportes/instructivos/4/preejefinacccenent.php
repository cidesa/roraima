      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes 
        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> 
                  <p><font color="#000066" size="4"><strong>Ejecuci&oacute;n Financiera 
                    de las Acciones Centralizadas del Ente 
            ...
            <tr bordercolor="#FFFFFF">
              <td class="form_label_01"><strong>Período Desde:</strong>&nbsp;</td>
              <td colspan="2"><select name="perdes" id="perdes" class="breadcrumb">
            ...
            <tr bordercolor="#FFFFFF"> 
              <td class="form_label_01"><strong>Período Hasta:</strong>&nbsp;</td>
              <td colspan="2"><select name="perhas" id="perhas" class="breadcrumb">
                <option value="<? echo date('m') ?>" selected>Actual (<? echo date('m').' - '.$me ?>)</option>
                <? for ($i=1;$i<=2;$i++)
				{?>
                <option value="01">01 - Enero</option>
...
{
  f=document.form1;
  f.action="rpreejefinacccenent.php";
  f.titulo.value="EJECUCIÓN FINANCIERA DE LAS ACCIONES CENTRALIZADAS DEL ENTE";
  f.submit();
}

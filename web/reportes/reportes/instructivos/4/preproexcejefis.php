      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes 
        ...
        <div align="left">&nbsp; 
          <table width="647" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              <td class="form_label_01"><strong>Fuente Financiamiento    :</strong></td>
             
			  <td colspan="2"><select name="fuefin" class="breadcrumb" id="fuefin">
			  
			  <?
			  	$tb4=$bd->select("select distinct(a.codparing),b.nomext from fordisfuefinpryaccmet a, fortipfin b
								where rtrim(a.codpro)=rtrim('".$proyecto."') and rtrim(a.codaccesp)=rtrim('".$accesp."')
								and rtrim(a.codparing)=rtrim(b.codfin)");
			  	while (!$tb4->EOF)
				{
				?>
			  		<option value="<? print $tb4->fields["codparing"];?>" selected><? print $tb4->fields["codparing"]." - ".substr($tb4->fields["nomext"],0,60);?></option>					  
				<?
				 $tb4->MoveNext();
				 }		
...
function enviar()
{
	...
	f.action="rpreproexcejefis.php";
	f.submit();
}
function recargar()
{
	f=document.form1;
	f.action="preproexcejefis.php";
	f.submit();
}
function cerrar()
{

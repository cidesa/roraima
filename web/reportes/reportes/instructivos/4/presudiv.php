        ...
        <div align="left">&nbsp; 
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>ORDENES DE PAGO POR CUENTA BANCARIA Y POR CREDITO
            ...
            <tr bordercolor="#6699CC">
              <td height="15" valign="top" class="form_label_01"><strong>Periodos:</strong></td>
              <td></td>
              <td></td>
              <td></td>
            </tr>
            ...
            <tr bordercolor="#6699CC">
              <td height="26" align="right" valign="top"><strong>Desde:</strong></td>
              <td colspan="2" valign="bottom"><select name="periododes" id="periododes" class="breadcrumb">
            ...
            <tr bordercolor="#6699CC">
              <td height="26" align="right" valign="top"><strong>Hasta:</strong></td>
              <td colspan="2" valign="top"><select name="periodohas" id="periodohas" class="breadcrumb">
                <option selected>1</option>
                <option>2</option>
                <option>3</option>
                <option>4</option>

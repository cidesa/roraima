...
//	require_once("../../lib/general/fpdfadds.php");
	...
	class pdfreporte extends fpdf
	{
		...
		function Header()
		{
			...
			$this->Image("../../img/logo_1.jpg",25,11,20);
			$this->SetLinewidth(0);
			//Logo de la Empresa
...
//			$this->ln(10);
			...
			$this->Cell(250,5,'EJECUCIÓN FÍSICA DE LAS ACCIONES CENTRALIZADAS DEL ENTE',0,0,'C');
			...
			$this->Cell(190);$this->Cell(1,3,'Periodo desde   ('.$this->perdes.') '.$mes[$desde].'    hasta    ('.$this->perhas.') '.$mes[$hasta]);
		...
		function Cuerpo()
		{
			...
			$pry=$this->bd->select("select codpro, nompro from fordefpry where trim(codpro) like '1%' order by codpro");

		...
		{	
			...
			while (!$tb->EOF)
			{
				...
				if (($sw==0))
				{
					...
					$this->setXY(32,80);
					$this->SetFont("Arial","B",9);					
					$this->Cell(10,10,'AUTOFINANCIAMIENTO');
				...
				if (($sw==1) and ($ing==6))
				{
					...
					$this->setX(35);
					$this->Cell(94,0,'TOTAL DE ORIGENES DE FONDOS');
			   ...
			   if ($mon_prog!=0)
				...
				$this->setY($this->getY()+4);
				$this->setX(33);
				$this->MultiCell(75,3,$tb2->fields["descta"],0,'L',0);
				...
				$this->setX(35);
				$this->Cell(94,10,'TOTAL APLICACIONES DE FONDOS');
				$this->setTextcolor(0,0,250);	

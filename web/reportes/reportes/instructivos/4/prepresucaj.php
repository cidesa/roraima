        ...
        <div align="left">&nbsp; 
          <table width="647"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>PRESUPUESTO DE CAJA
            ...
            <tr bordercolor="#6699CC">
              <td height="25" valign="top" class="form_label_01"><strong>Hasta el Periodo:</strong></td>
              <td colspan="2" valign="bottom"><select name="periodo" id="periodo" class="breadcrumb">
            ...
            <tr bordercolor="#6699CC">
              <td height="26" align="right" valign="top"><!--DWLayoutEmptyCell-->&nbsp;</td>

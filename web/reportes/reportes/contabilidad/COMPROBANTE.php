            ...
            <tr bordercolor="#6699CC">
              ...
              <td>
                <?
			  	...
			  	$tb=$bd->select("select distinct(numcom), descom from contabc order by numcom");
               ?>
                <select name="com1" class="breadcrumb" id="select2">
                  <?
				  	while(!$tb->EOF)
					{
				  ?>
                  <option value="<? print $tb->fields["numcom"];?>"><? print $tb->fields["numcom"];?></option>
                  <?
				  $tb->MoveNext();
					}
				?>
              ...
              <td>
                <?
			  	...
			  	$tb=$bd->select("select distinct(numcom), descom from contabc order by numcom desc");
               ?>
                <select name="com2" class="breadcrumb" id="select3">
                  <?
				  	while(!$tb->EOF)
					{
				  ?>
             ...
             <tr bordercolor="#6699CC">
              ...
              <td colspan="2"> <select name="estado" class="breadcrumb" id="estado">
               ...
               <tr bordercolor="#6699CC">
              <td class="form_label_01"> <div align="left"><strong>ELABORADO:</strong></div></td>
              <td colspan="2"> <div align="left"></div>
                <div align="left">
                  <input name="elaborado" type="text" class="breadcrumb" id="elaborado" value="" size="50">
                </div></td>
            </tr>
             <tr bordercolor="#6699CC">

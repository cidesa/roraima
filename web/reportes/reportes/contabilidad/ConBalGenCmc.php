          ...
          <table width="548" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              ...
              <td>
                <div align="left">
                  <?
				$tb=$bd->select("SELECT DISTINCT(CODCTA)  FROM CONTABB WHERE CODCTA<'4' ORDER BY CODCTA");
              ...
              <td>
                <div align="left">
				<?
   			    $tb2=$bd->select("SELECT DISTINCT(CODCTA)  FROM CONTABB WHERE CODCTA<'4'  ORDER BY CODCTA DESC");

      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes 
        ...
        <div align="left">&nbsp; 
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>C&oacute;digo de Cuenta:</strong></div></td>
              <td> <div align="left"> 
			  <?
			  	$tb=$bd->select("SELECT CODCTA FROM CONTABB WHERE CARGAB='C' ORDER BY CODCTA");
				print $tb->GetMenu('codctades','1-01-01-01-01-001',false,false,0,'class=breadcrumb');
			  ?>
                </div></td>
              <td>
			   <?
			  	$tb2=$bd->select("SELECT CODCTA FROM CONTABB WHERE CARGAB='C' ORDER BY CODCTA DESC");
				print $tb2->GetMenu('codctahas','7-15-02-99-05',false,false,0,'class=breadcrumb');
			  ?>
			</td>
            </tr>
            <tr bordercolor="#6699CC"> 

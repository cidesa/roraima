          ...
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr>
              ...
              <td><div align="left">
                  ...
                  <input type="button" name="Button1" value="..." onClick=" catalogo1('com1','1');">
              </div></td>
              <td><input name="com2" type="text" class="breadcrumb" id="com2"
                   value="<?$sql="select max(a.codcta) as cod from contabc1 a, contabb b where a.codcta=b.codcta";
 					LlenarTextoSql($sql,"cod",$bd); ?>" size ="20">
                  <input type="button" name="Button2" value="..." onClick=" catalogo1('com2','0');">              </td>
            </tr>
            <tr>
...
function cerrar()
{
   ...
   function catalogo1(campo,valor)
   {
   	if (valor=='1')
   	{
      mysql='select distinct(a.codcta) as Codigo, b.descta as Descripcion from contabc1 a, contabb b where a.codcta=b.codcta order by a.codcta';
   	}
   	else
   	{
   	   mysql='select distinct(a.codcta) as Codigo, b.descta as Descripcion from contabc1 a, contabb b where a.codcta=b.codcta order by a.codcta desc';
   	}

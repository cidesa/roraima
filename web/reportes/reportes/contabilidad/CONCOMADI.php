        ...
        <div align="left">&nbsp;
          <table width="612"  border="0" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>REPORTES
                  DE COMPROBANTES
            ...
            <tr bordercolor="#6699CC">
              <td width="151" class="form_label_01"><strong>Tama&ntilde;o Hoja:</strong></td>
              <td width="216"> <input name="tamano" type="text" class="breadcrumb" id="tamano" readonly="true"></td>
              <td width="231">&nbsp;</td>
            </tr>
            <tr bordercolor="#6699CC">
           ...
           <tr bordercolor="#6699CC">
              ...
              <td> <div align="left"> </div>
                <div align="left">
			  	...
			  	$tb=$bd->select("select to_char(MIN(feccomadi),'DD/MM/YYYY') as fecha1 from contabc");
				if(!$tb->EOF)
				{
					$fecha1=$tb->fields["fecha1"];
				}

			  	$tb2=$bd->select("select to_char(MAX(feccomadi),'DD/MM/YYYY') as fecha2 from contabc");
				if(!$tb2->EOF)
				{
            ...
            <tr>
              ...
              <td><input name="com1" type="text" class="breadcrumb" id="com1"
                   value="<?$sql="select min(numcomadi) as cod from contabc where trim(numcomadi)<>''";
 					LlenarTextoSql($sql,"cod",$bd); ?>" size ="20">
                  <input type="button" name="Button3" value="..." onClick=" catalogo1('com1');">
              </td>
            </tr>
...
{
	f=document.form1;
	f.titulo.value="REPORTES DE COMPROBANTES";
	f.action="rCONCOMADI.php";
	f.submit();
}
function cerrar()
{
   ...
   {
      mysql="select distinct(numcomadi) as comprobante from contabc order by numcomadi";

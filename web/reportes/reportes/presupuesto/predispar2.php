    ...
    <tr bordercolor="#FFFFFF">
              ...
              <td> <div align="left">
                 <?
				    ...
				    print $tb->GetMenu('nivhasta','pereje',false,false,0,'class="breadcrumb"');
			     ?>
			  </div></td>
              <td> </tr>
			<tr>
              ...
              <td colspan="2">
                ...
                <select name="agrupar" class="breadcrumb" id="agrupar">
				 <?
					...
					{
				 ?>
                   <option><? print $tb->fields["agrupar"];?></option>
                 <?
				       $tb->MoveNext();
					}
				 ?>
...
{
	f=document.form1;
	f.titulo.value="Ejecución Presupuestaria por Partidas";
	f.action="rpredispar2.php";
	f.submit();
}
function cerrar()
{

        ...
        <div align="left">&nbsp;
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"><div align="center"><font color="#000066" size="4"><strong>Resumen General de la Ejec. Presup. por Partidas
           ...
           <tr bordercolor="#6699CC">
              ...
              <td>
                <?
			  	...
			  	$tb=$bd->select("Select Distinct(PerPre) as pereje from CPASIINI where PerPre <> '00' order by perpre");
               ?>
...
{
	f=document.form1;
	f.titulo.value="Resumen General de la Ejec. Presup. por Partidas";
	f.action="rpreresgenejepar.php";
	f.submit();
}

        ...
        <div align="left">&nbsp;
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Autorizacion Presupuestaria
            ...
            <tr>
              <td class="form_label_01"><div align="left"><strong>Beneficiario 
                :</strong></div></td>
              <td><div align="left">
                <input name="bendes" type="text"  value="<?
				$sql="SELECT MIN(CEDRIF) AS REF FROM CPCOMPRO WHERE CEDRIF IS NOT NULL";
                LlenarTextoSql($sql,"ref",$bd);				
				?>" class="breadcrumb" id="bendes" size="20" maxlength="15">
                <input type="button" name="Button2" value="..." onClick="catalogo('bendes');">
              </div></td>
              <td><input name="benhas" type="text"  value="<?
				$sql="SELECT MAX(CEDRIF) AS REF FROM CPCOMPRO WHERE CEDRIF IS NOT NULL";
                LlenarTextoSql($sql,"ref",$bd);				
				?>" class="breadcrumb" id="benhas" size="20" maxlength="15">
                <input type="button" name="Button22" value="..." onClick="catalogo('benhas');"></td>
            </tr>
            <tr bordercolor="#6699CC"> 
            ...
            <tr bordercolor="#6699CC"> 
              <td colspan="3" class="form_label_01">Filtra los Nombres </td>
            </tr>
          </table>
        </div>
        <div align="left">&nbsp; </div>
...
{
	f=document.form1;
	f.titulo.value="Autorización Presupuestaria";
	f.action="rpreautpres.php";
	f.submit();
}
function cerrar()
{
...
function catalogo(campo)
   {
      mysql='select distinct(a.cedrif) as RefCom,b.nomben as Proveedor,¿¿ as Campo3 from cpcompro a,opbenefi b where a.cedrif=b.cedrif and upper(b.nomben) like upper(¿%¿) order by b.nomben';
	  pagina="catalogoobj.php?sql="+mysql+"&campo="+campo;

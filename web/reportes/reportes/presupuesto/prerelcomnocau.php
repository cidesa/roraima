        ...
        <fieldset>
          ...
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#FFFFFF">
              <td colspan="3"  align="center">  <font color="#000066" size="4"><strong>RELACION DE COMPROMISO NO CAUSADOS</strong></font><input name="titulo" type="hidden" id="titulo"></td>
              <td></td>
            </tr>
            <tr bordercolor="#FFFFFF">
              <td height="15"></td>
            ...
            <tr bordercolor="#6699CC">
			  ...
			  ?>
                  ...
                  <?
					...
					{
				  ?>
                    <option value="<? print $tb1->fields["tipcom"];?>"><? print $tb1->fields["tipcom"]." - ".$tb1->fields["nomabr"];?></option>
                    <?
					$tb1->MoveNext();
					}
				?>
            ...
            <tr bordercolor="#6699CC">
              <td height="32" valign="top" class="form_label_01"><strong>Tipo de Gasto :</strong></td>
              <td colspan="2" valign="top"><select name="tipo_gasto" class="breadcrumb" id="tipo_gasto">
                <option value="CONSOLIDADO" selected="selected">CONSOLIDADO</option>
...
{
	f=document.form1;
	f.titulo.value="Relación de Gastos Comprometidos No Causados";
	f.action="rprerelcomnocau.php";
	f.submit();
}
function cerrar()
{

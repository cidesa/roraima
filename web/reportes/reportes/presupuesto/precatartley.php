        ...
        <div align="left">&nbsp; 
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF"> 
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Catalogo de Articulos de Ley
            ...
            <tr bordercolor="#6699CC"> 
              <td class="form_label_01"> <div align="left"><strong>Tipo de Ley:</strong></div></td>
              <td> <div align="left">
			  <?
			  	$tb=$bd->select("SELECT codart as codart FROM cpartley ORDER BY codart");
			  ?>
              ...
              <td> <div align="left"> 
			 <?
			  	$tb=$bd->select("SELECT codart as codart FROM cpartley ORDER BY codart desc");
			  ?>
...
{
	f=document.form1;
	f.titulo.value="Catalogo de Articulos de Ley";
	f.action="rprecatartley.php";
	f.submit();
}
function cerrar()
{

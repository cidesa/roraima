    ...
    <tr>
      ...
      <td rowspan="2" valign="top" class="cell_padding_01"> <p class="breadcrumb">Reportes
        ...
        <div align="left">&nbsp;
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"><div align="center"><font color="#000066" size="4"><strong> EJECUCION PRESUPUESTARIA COORDINADA <br>
                (DISP. COMPROMISOS)
        ...
        ?>
              ...
              <td><?
          $tb=$bd->select("Select consec as niv from cpniveles order by consec desc");
               ?>
        ...
        ?>
            ...
            <tr>
              ...
              <td><div align="left"> </div>
                  <div align="left">
                    <?
          $tb=$bd->select("select distinct(codpre) as codpre FROM CPASIINI WHERE PERPRE='00' order by codpre asc");
        ?>
                    <select name="codpredes" class="breadcrumb" id="codpredes">
                      <?
            while(!$tb->EOF)
          {
          ?>
        ...
        ?>
              ...
              <td><?
          $tb=$bd->select("select distinct(codpre) as codpre FROM CPASIINI WHERE PERPRE='00' order by codpre desc");
        ?>
                  <select name="codprehas" class="breadcrumb" id="codprehas">
                    <?
            while(!$tb->EOF)
          {
          ?>
...
{
  f=document.form1;
  f.titulo.value=" EJECUCION PRESUPUESTARIA COORDINADA (DISP. COMPROMISOS)";
  f.action="rPREDISPERCOO_DISCOM.php";
  f.submit();
}
function cerrar()
{

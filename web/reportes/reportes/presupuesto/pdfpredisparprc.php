...
//H::printR($this->sql);exit;
		...
		function llenartitulosmaestro()
		{
				...
				$this->titulos[9]="PRECOMPROMISO";
				$this->titulos[10]="COMPROMISOS";
				$this->titulos[11]="CAUSADO";
				$this->titulos[12]="PAGADO";
				$this->titulos[13]="DEUDA";
				$this->titulos[14]="DISPONIBILIDAD PRESUPUESTARIA";
		}
		...
		function Header()
		{
			...
			$this->cell(330,4,"EJECUCIÓN PRESUPUESTARIA POR ESPECÍFICA (PreCompromisos)",0,0,'C');
			...
			$this->ln(3);
			$this->Line(10,35,332,35);
			$this->Line(10,48,332,48);
			$this->ln(2);
		}
...
//			$this->bd->actualizar('SET search_path TO "SIMA055"');
			...
			while(!$tb->EOF)
			{
				...
				if (($partida!=$tb->fields["partida"] && $partida!="-1" ) || ($categoria!=$tb->fields["categoria"])&&($categoria!="-1"))
				{
				    if (!empty($tb->fields["partida"]))
				    {
				    	$this->setFont("Arial","B",7);
						$this->ln(2);
						$this->cell(72,4,"SubT. ".$partida." ",0,0,'R');
						$this->cell(25,4,H::FormatoMonto($totalasipar),0,0,'R');
						$this->cell(25,4,H::FormatoMonto($totalmodpospar),0,0,'R');
						$this->cell(25,4,H::FormatoMonto($totalmodnegpar),0,0,'R');
						$this->cell(25,4,H::FormatoMonto($totalacopar),0,0,'R');
						$this->cell(25,4,H::FormatoMonto($totalprcpar),0,0,'R');
						$this->cell(25,4,H::FormatoMonto($totalprcpar),0,0,'R');
						$this->cell(25,4,H::FormatoMonto($totalcaupar),0,0,'R');
						$this->cell(25,4,H::FormatoMonto($totalpagpar),0,0,'R');
						$this->cell(25,4,H::FormatoMonto($totalcaupar-$totalpagpar),0,0,'R');
						$this->cell(25,4,H::FormatoMonto($totaldispar),0,0,'R');
				...
				if (($categoria!=$tb->fields["categoria"])&&($categoria!="-1") )
				{
				    $this->setFont("Arial","B",7);
					$this->ln(2);
					$this->cell(72,4,"SUB-TOTAL ".$categoria." ",0,0,'R');
					$this->cell(25,4,H::FormatoMonto($totalasicat),0,0,'R');
					$this->cell(25,4,H::FormatoMonto($totalmodposcat),0,0,'R');
					$this->cell(25,4,H::FormatoMonto($totalmodnegcat),0,0,'R');
					$this->cell(25,4,H::FormatoMonto($totalacocat),0,0,'R');
					$this->cell(25,4,H::FormatoMonto($totalprccat),0,0,'R');
					$this->cell(25,4,H::FormatoMonto($totalprccat),0,0,'R');
					$this->cell(25,4,H::FormatoMonto($totalcaucat),0,0,'R');
					$this->cell(25,4,H::FormatoMonto($totalpagcat),0,0,'R');
					$this->cell(25,4,H::FormatoMonto($totalcaucat-$totalpagcat),0,0,'R');
					$this->cell(25,4,H::FormatoMonto($totaldiscat),0,0,'R');
				...
				$this->cell(25,4,H::FormatoMonto($tb->fields["modpos"]),0,0,'R');
				$this->cell(25,4,H::FormatoMonto($tb->fields["modneg"]),0,0,'R');
				$modificacion=$tb->fields["modpos"]+$tb->fields["modneg"];
				$this->cell(25,4,H::FormatoMonto($tb->fields["asignacion"]+$modificacion),0,0,'R');
				$this->cell(25,4,H::FormatoMonto($tb->fields["compromiso"]),0,0,'R');
				$this->cell(25,4,H::FormatoMonto($tb->fields["compromiso"]),0,0,'R');
				//$this->cell(23,4,H::FormatoMonto($tb->fields["asignacion"]+$tb->fields["modificado"]-$tb->fields["compromiso"]),0,0,'R');
				$this->cell(25,4,H::FormatoMonto($tb->fields["causado"]),0,0,'R');
				$this->cell(25,4,H::FormatoMonto($tb->fields["pagado"]),0,0,'R');
				$this->cell(25,4,H::FormatoMonto($tb->fields["causado"]-$tb->fields["pagado"]),0,0,'R');
				$this->cell(25,4,H::FormatoMonto($tb->fields["asignacion"]+$modificacion-$tb->fields["compromiso"]),0,0,'R');
				//$acordado=$tb->fields["asignacion"]+$tb->fields["modpos"]+$tb->fields["modneg"];
				/*if (($acordado)==0)
				...
				$this->multicell(42,4,(strtoupper($tbcod->fields["nompre"])));
			...
			$this->Line(10,$this->GetY(),332,$this->GetY());
			$this->cell(72,7,"TOTAL GENERAL",0,0,'R');
			$this->cell(25,7,H::FormatoMonto($totalasi),0,0,'R');
			$this->cell(25,7,H::FormatoMonto($totalmodneg),0,0,'R');
			$this->cell(25,7,H::FormatoMonto($totalmodpos),0,0,'R');
			$this->cell(25,7,H::FormatoMonto($totalaco),0,0,'R');
			$this->cell(25,7,H::FormatoMonto($totalprc),0,0,'R');
			$this->cell(25,7,H::FormatoMonto($totalprc),0,0,'R');
			//$this->cell(23,7,H::FormatoMonto($totalcom),0,0,'R');
			$this->cell(25,7,H::FormatoMonto($totalcau),0,0,'R');
			$this->cell(25,7,H::FormatoMonto($totalpag),0,0,'R');
			$this->cell(25,7,H::FormatoMonto($totalcau-$totalpag),0,0,'R');
			$this->cell(25,7,H::FormatoMonto($totaldiscat),0,0,'R');

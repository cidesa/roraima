        ...
        <div align="left">&nbsp;
          <table width="612" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>Asignaci&oacute;n Inicial
                      Por Partidas
            ...
            <tr bordercolor="#6699CC">
              ...
              <td>
			 <?
			  	$tb=$bd->select("Select Distinct(PerPre) as  cod from CPASIINI  order by perpre");
			  ?>
              ...
              <td>
			    <?
			  	$tb=$bd->select("Select Distinct(PerPre) as cod from CPASIINI order by perpre desc");
			  ?>
            ...
            <tr bordercolor="#6699CC">
              <td class="form_label_01"><strong>Hasta Nivel N&ordm;:</strong></td>
              <td>
			   <?
			  	$tb=$bd->select("Select consec as cod from cpniveles where catpar = 'P' order by consec desc ");
			  ?>
			...
			<tr>
			  ...
			  ?>
				...
				<input type="button" name="Button" value="..." onclick="catalogo1('codpredesde')"/>
			  ...
			  ?>
				...
				<input type="button" name="Button" value="..." onclick="catalogo1('codprehasta')"/>
              </div></td>
            </tr>
            ...
            <tr bordercolor="#6699CC">
              <td class="form_label_01"> <div align="left"><strong>Movimientos:</strong></div></td>
              <td> <div align="left">
                <select name="movimientos" class="breadcrumb" id="movimientos">
            ...
            <tr bordercolor="#6699CC">
              <td class="form_label_01"><strong>Agrupar Por: </strong></td>
              <td>
			  	<select name="grupo" class="breadcrumb" id="grupo">
...
{
	f=document.form1;
	f.titulo.value="Asignación Inicial Por Partidas";
	f.action="rprerasiinipar.php";
	f.submit();
}
function cerrar()
{
...
{
    pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=select distinct(codpre) as codpre from cpasiini order by codpre";

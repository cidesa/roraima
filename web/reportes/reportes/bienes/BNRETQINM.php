 ...
 <tr bordercolor="#6699CC">
              ...
              <td>
                <?
			  	...
			  	$tb=$bd->select("SELECT min(a.codinm) as codinmFROM bnreginm a");
               ?>
                <input name="codinm1" type="text" value="<?print $tb->fields["codinm"];

			  ?>"class="breadcrumb" id="codinm1" size="16" maxlength="100">

         				<input type="button" name="Button" value="..." onClick="catalogo2(codinm1);">
         		</td>
		 <td>
                <?

			  	$tb=$bd->select("SELECT max(a.codinm) as codmue FROM bnreginm a");
               ?>
                <input name="codinm2" type="text" value="<?print $tb->fields["codinm"];

			  ?>"class="breadcrumb" id="codinm2" size="16" maxlength="100">

         				<input type="button" name="Button" value="..." onClick="catalogo2('codinm2');">
		</td>
            </tr>
...
{
    pagina="../../lib/general/catalogoobj.php?campo="+campo+"&sql=SELECT distinct(a.codinm) as codinm, a.desinm FROM bnreginm a";
	window.open(pagina,"Catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,heigth=400,resizable=yes,left=50,top=50");
}
</script>
</html>

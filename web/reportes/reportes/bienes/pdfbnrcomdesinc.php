<?
    ...
    require_once("../../lib/modelo/sqls/bienes/Bnrcomdesinc.class.php");
	...
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->bnrcomdesinc= new Bnrcomdesinc();
			$this->llenarTitulosAnchos();
			$this->SetAutoPageBreak(true,25);

		    $this->arrp = $this->bnrcomdesinc->sqlp($this->ubides,$this->ubihas,$this->fecdes,$this->fechas);
		...
		function llenarTitulosAnchos()
		{
			...
			$this->titulos[13]="Desincorporación";      $this->anchos[13] = 60;

<?
    ...
    require_once("../../lib/modelo/sqls/ciudadanos/Atestado.class.php");
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
		    ...
		    $this->arrp = $this->atestado->Sqlp($this->iddes,$this->idhas);
...
/*print '<pre>';
		...
		function Cuerpo()
		{
			...
			$this->rowM(array($this->arrp[0]["id"],$this->arrp[0]["desest"]));
			foreach($this->arrp as $dato)
			{
			   if($dato["id"]!=$id){
				$this->setFont("Arial","B",7);
				$this->setx(10);
				$this->rowM(array($dato["id"],$dato["desest"]));
			   }
			}

<?
    ...
    require_once("../../lib/modelo/sqls/ciudadanos/Atdenuncia.class.php");
	class pdfreporte extends fpdf
	{
		...
		function pdfreporte()
		{
			...
			$this->atdenuncia = new Atdenuncia();
		    $this->arrp = $this->atdenuncia->Sqlp($this->iddes,$this->idhas,$this->fechades,$this->fechahas,$this->cedula);

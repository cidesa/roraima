<?
    ...
    require_once("../../lib/modelo/sqls/ciudadanos/Ataudiencia.class.php");
	class pdfreporte extends fpdf
	{
		function pdfreporte()
		{
			...
			$this->ataudiencia = new Ataudiencia();
		    $this->arrp = $this->ataudiencia->Sqlp($this->iddes,$this->idhas,$this->fechades,$this->                          fechahas,$this->cedula);

<?
    ...
    require_once("../../lib/modelo/sqls/ciudadanos/Atatipayu.class.php");
	...
	var $bd;
		...
		function pdfreporte()
		{
			...
			$this->atatipayu = new Atatipayu();
		    $this->arrp = $this->atatipayu->sqlp($this->coddes,$this->codhas);
			 ...
			 if($dato["tipo"]!=$tipo)

               {
                ...
                $this->Row(array($dato["tipo"]));
               	...
               	$this->arrp1 = $this->atatipayu->sqlp1($dato["tipo"]);
                $this->Ln(5);
    	        ...
    	        $this->setBorder();
                $this->Row(array($dato1["expediente"],$dato1["nombre"].'   '.$dato1["apellido"],H::Formatomonto($dato1["monto"])));

            ...
            <tr bordercolor="#6699CC">
             ...
             <tr>
              ...
              <td>
				...
				$sql="SELECT MIN(CODREC) as cod FROM CARECAUD";
				...
				$sql="SELECT max(CODREC) as cod FROM CARECAUD";
                LlenarTextoSql($sql,"cod",$bd);
...
function catalogo2(campo)
   {
      mysql='SELECT DISTINCT(CODREC) FROM CARECAUD ORDER BY CODREC';

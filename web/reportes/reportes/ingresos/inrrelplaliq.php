        ...
        <div align="left">&nbsp;
          <table width="647" align="center" cellspacing="0" bordercolor="#6699CC" class="grid_line01_tl">
            ...
            <tr bordercolor="#FFFFFF">
              <td colspan="3" class="form_label_01"> <div align="center"> <font color="#000066" size="4"><strong>RELACION DE PLANILLAS DE LIQUIDACION
                                 <input name="titulo" type="hidden" id="titulo">
</strong></font></div></td>
            </tr>
            <tr bordercolor="#FFFFFF">
              <td width="191" class="form_label_01">&nbsp;</td>
              <td width="178">&nbsp;</td>
              <td width="264"><font color="#00FFCC">&nbsp; </font></td>
            </tr>
            ...
            <tr bordercolor="#6699CC">
             ...
             <tr>
              <td height="97" class="form_label_01">&nbsp;</td>
              <td>&nbsp;</td>
                  <td>&nbsp;</td>
            </tr>
          </table>
...
{
	f=document.form1;
	f.titulo.value="RELACION DE PLANILLAS DE LIQUIDACION";
	f.action="rinrrelplaliq.php";
	f.submit();
}
function cerrar()
{

...
class Tsrvoucher_n extends baseClases
{
...
//print $sql;
  ...
  {
	$sql="select a.numche, b.refpag, b.codpre, sum(b.monimp) as monimp, b.refere, substr(b.codpre,10,3) as par,
		...
		substr(b.codpre,23,2) as cre, c.refpag
			...
			where
				...
				b.refpag=c.refpag
		 group by codpre, a.numche, b.refpag, b.refere, c.refpag

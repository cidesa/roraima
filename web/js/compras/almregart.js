function mostrar(id)
{
	...
	if ($(codalm).value!="")
	{
	    ...
	    new Ajax.Updater('divGrid', '/compras_dev.php/almregart/ajax', {asynchronous:true, evalScripts:true, onComplete:function(request, json){AjaxJSON(request, json), actualizarsaldos_b(); distribuirExistencia(); }, parameters:'ajax=7&articulo='+articulo+'&almacen='+almacen+'&fil='+fil})
	}
	else
	{

	...
	['SIGA', null,
		['Compras y Almacen', null,
			...
			['Almacen',null,
				...
				['Requisiciones', 'almacen/AlmReq'],
				['Recepci&oacute;n de Productos Terminados', 'almacen/AlmOrdRecTer'],
				['Requisiciones de Servicios', Compras+'almreqser'],
				['Requisiciones por Departamento (Solicitud de Egresos)', 'almacen/AlmSolEgr'],
				['Despachos', 'almacen/AlmDesp'],
				['Prestacion de Servicios', Compras+'almdespser'],
				['Despachos con Pistola', 'almacen/AlmDespPist'],
				['Recepci&oacute;n de Art&iacute;culo', 'almacen/AlmOrdRec'],
				['Inventario F&iacute;sico', 'almacen/AlmInvFis'],
				['Traspaso de Art&iacute;culos', 'almacen/AlmTraAlm'],
				['Unidades para Despacho', 'almacen/per_01/per_01_01'],

...
function distribuirPeriodos2()
{
 ...
 function monto(e,id)
 {
   ...
   if (monto4 > monto)
   {
   	 alert('El Monto del Per�odo no puede exceder el Presupuesto de A�o');
   	 $(id).value="0,00";
   	 $(porcen).value="0,00";
   	 actualizarsaldos();
   }
 ...
 function Calculo(id)
 {
  	...
  	if (monto2 > montosreal){
  		alert('El Monto del Periodo no puede exceder el Presupuesto de A�o'); $(id).value="0,00"; $(id).focus();
...
//	    alert($(cajatxt).value.toString());
	    ...
	    if (total > montosreal)
	    {
	    	alert('El Monto del Periodo no puede exceder el Presupuesto de A�o');
		   	$(id).value="0,00";
	//	   	actualizarsaldos();
		   	$(id).focus();
	    }else{

...
TO_DATE(TO_CHAR(A.FECING,'DD/')||TO_CHAR(A.FECFIN,'MM/YYYY'),'DD/MM/YYYY') AS FECINIREAL,
ADD_MONTHS(TO_DATE(TO_CHAR(A.FECING,'DD/')||TO_CHAR(A.FECFIN,'MM/YYYY'),'DD/MM/YYYY'),1)-1 AS FECFINREAL,

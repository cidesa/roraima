...
antpub('A',A.CODEMP,A.FECRET,'S') AS ANNOANTIGPUBTOT,
antpub('A',A.CODEMP,A.FECRET,'N') AS ANNOANTIGTOT,
antpub('M',A.CODEMP,A.FECRET,'S') AS MESANTIGPUBTOT,
antpub('M',A.CODEMP,A.FECRET,'N') AS MESANTIGTOT,
antpub('D',A.CODEMP,A.FECRET,'S') AS DIAANTIGPUBTOT,
antpub('D',A.CODEMP,A.FECRET,'N') AS DIAANTIGTOT,
A.FECING,
B.FECINI,
B.FECFIN,

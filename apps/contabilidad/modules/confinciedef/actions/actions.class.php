...
class confinciedefActions extends autoconfinciedefActions
{
  ...
  {
    $this->params[0]= Herramientas::getX('codemp','Contaba','etadef','001');
  }
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
        $this->executebtnAbrir();
        $output = '[["","",""],["","",""],["","",""]]';
        break;
      case '2':
        $this->executebtnCerrar();
        $output = '[["","",""],["","",""],["","",""]]';
        break;
      default:
        $output = '[["","",""],["","",""],["","",""]]';
  ...
  public function executebtnAbrir() {
	return Contabilidad::abrirEtadef();
  }

  public function executebtnCerrar() {
	return Contabilidad::cerrarEtadef();
  }

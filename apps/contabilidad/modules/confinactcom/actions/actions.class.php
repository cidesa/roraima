...
class confinactcomActions extends autoconfinactcomActions
{
   public function executeIndex(){
      return $this->redirect('confinactcom/edit');
  }
  ...
  public function configGrid($reg = array())
  {
    ...
    $reg = ContabcPeer::doSelect($c); //select * from contabc

    //                                                                            /nombreformulario/
    $this->obj = H::getConfigGrid('grid_contabc_edit' ,$reg);
  ...
  public function saving($clasemodelo){
    ...
    return Comprobante::salvarConfinactcom($clasemodelo,$grid);
  }

 ...
 * @version SVN: $Id: actions.class.php 32838 2009-09-08 20:56:21Z aperez $
 *
...
class confininsActions extends autoconfininsActions
{
  ...
  public function configGrid($fecini = date,$feccie = date )
  {
    ...
    $reg = Contaba1Peer::doSelect($c); //select * from contaba1

    //                                                                            /nombreformulario/
    $this->obj = H::getConfigGrid('grid_contaba1_edit' ,$reg);
  ...
  public function configGrid_distribuir($fecini = date,$feccie = date ){
    ...
    $reg = Contabilidad::Distribuir($fecini,$feccie);
 ...
 /**
  ...
  public function executeAjax(){
    ...
    switch ($ajax){
      case '1':
		...
		if($fecini && $feccie){
			$this->configGrid_distribuir($fecini,$feccie);
	  		$output = '[["","",""]]';
		}else{
			$this->configGrid('','');
			$output = '[["javascript","alert(\'Debe seleccionar la fecha de inicio y cierre\')",""]]';
		}
        break;
      default:
        $output = '[["","",""],["","",""],["","",""]]';
  ...
  public function validateEdit()
  {
    ...
    if($this->getRequest()->getMethod() == sfRequest::POST){
	  ...
	  $formato = $this->contaba->getForcta();

	  // Validacion deñl valor de $formato

...
class confintipcueconActions extends autoconfintipcueconActions
{
  ...
  public function saving($clasemodelo){
  	...
  	$c = new Criteria();
    $c->add(ContabbPeer::CODCTA,$clasemodelo->getCodresant());
    $contab = ContabbPeer::doSelectOne($c);
 	if ($contab->getCargab()=='C'){
  		return Contabilidad::salvarConfintipcuecon($clasemodelo);
  	}else{
  		return 601;
  	}
  	$c = new Criteria();
    $c->add(ContabbPeer::CODCTA,$clasemodelo->getCodres());
    $contab = ContabbPeer::doSelectOne($c);
  	if ($contab->getCargab()=='C'){
  		return Contabilidad::salvarConfintipcuecon($clasemodelo);
  	}else{

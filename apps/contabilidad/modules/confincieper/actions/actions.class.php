 ...
 * @version SVN: $Id: actions.class.php 32378 2009-09-01 16:45:21Z lhernandez $
 * 
...
class confincieperActions extends autoconfincieperActions
{
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
        $fecdes = Herramientas::getX('PEREJE','Contaba1','fecdes',$codigo);
        $fechas = Herramientas::getX('PEREJE','Contaba1','fechas',$codigo);
        $output = '[["contaba1_fecdes","'.date('d/m/Y',strtotime($fecdes)).'",""],["contaba1_fechas","'.date('d/m/Y',strtotime($fechas)).'",""]]';
        break;
      default:
        $output = '[["","",""],["","",""],["","",""]]';
    }
  ...
  /*public function executebtnAbrir() {
	return Contabilidad::abrirPeriodo();
  }

  public function executebtnCerrar() {
	return Contabilidad::cerrarPeriodo();
  }*/
  ...
  public function saving($clasemodelo)
  {
  	...
  	switch ($accion) {
		case '1':
			return Contabilidad::abrirPeriodo($clasemodelo);
        break;
        case '2':
			return Contabilidad::cerrarPeriodo($clasemodelo);
        break;
  	}
  }

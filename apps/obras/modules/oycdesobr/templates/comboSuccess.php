...
<?php if ($tipo=='P')
{
 echo select_tag('ocregobr[codedo]', options_for_select($estados,'0001'),array('onChange'=> remote_function(array(
...
{
	echo select_tag('ocregobr[codmun]', options_for_select($municipio,'0001'),array('onChange'=> remote_function(array(
	'update'   => 'divParroquia',
...
{
	echo select_tag('ocregobr[codpar]', options_for_select($parroquia,'0001'),array('onChange'=> remote_function(array(
	'update'   => 'divSector',
...
{
	echo select_tag('ocregobr[codsec]', options_for_select($sector,'0001'),array('onChange'=> remote_function(array(
	'update'   => 'divCasa',

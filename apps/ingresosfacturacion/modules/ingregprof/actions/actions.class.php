 ...
 *
 * @package    siga
 * @subpackage ingregprof
 * @author     Your name here
 * @version    SVN: $Id: actions.class.php 2288 2006-10-02 15:22:13Z fabien $
 */
class ingregprofActions extends autoingregprofActions
{

  // Para incluir funcionalidades al executeEdit()
  public function editing()
  {
    $muni = Ingresosfacturacion::getMunicipio($this->getRequestParameter('inprofes[inestado_id]',''));
    $parr = Ingresosfacturacion::getParroquia($this->getRequestParameter('inprofes[inmunicipio_id]',''));
//    H::PrintR($muni);
    $this->inprofes->setMunicipio($muni);
    $this->inprofes->setParroquia($parr);
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
        ...
        $this->inprofes = $this->getInprofesOrCreate($codigo);
        $this->inprofes->setMunicipio(Ingresosfacturacion::getMunicipio($codigo));

        break;
      case '2':
        $output = '[["","",""],["","",""],["","",""]]';

        $this->inprofes = $this->getInprofesOrCreate();
        $this->inprofes->setParroquia(Ingresosfacturacion::getParroquia($codigo));

 ...
 *
 * @package    siga
 * @subpackage ingregempr
 * @author     Your name here
 * @version    SVN: $Id: actions.class.php 2288 2006-10-02 15:22:13Z fabien $
 */
class ingregemprActions extends autoingregemprActions
{
  // Para incluir funcionalidades al executeEdit()
  public function editing()
  {
	$muni = Ingresosfacturacion::getMunicipio($this->getRequestParameter('inempresa[inestado_id]',''));
    $parr = Ingresosfacturacion::getParroquia($this->getRequestParameter('inempresa[inmunicipio_id]',''));
//    H::PrintR($muni);
    $this->inempresa->setMunicipio($muni);
    $this->inempresa->setParroquia($parr);
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
        ...
        $this->inempresa = $this->getInempresaOrCreate($codigo);
        $this->inempresa->setMunicipio(Ingresosfacturacion::getMunicipio($codigo));

        break;
      case '2':
        $output = '[["","",""],["","",""],["","",""]]';

        $this->inempresa = $this->getInempresaOrCreate();
        $this->inempresa->setParroquia(Ingresosfacturacion::getParroquia($codigo));

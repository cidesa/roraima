 ...
 *
 * @package    siga
 * @subpackage ingdefmun
 * @author     Your name here
 * @version    SVN: $Id: actions.class.php 2288 2006-10-02 15:22:13Z fabien $
 */
class ingdefmunActions extends autoingdefmunActions
{
  ...
  public function saving($inmunicipio)
  {
  	  $sql="select max(id) as num from inmunicipio";

      if (Herramientas::BuscarDatos($sql,&$result))
		{
		          	//H::printR ($result);
		          	$inmunicipio->setCodmun((str_pad($result[0]["num"]+1, 4, '0', STR_PAD_LEFT)));
		 }

    return parent::saving($inmunicipio);

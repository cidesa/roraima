...
/**
 * bieregactsemd actions.
 *
 * @package    Roraima
 * @subpackage bieregactsemd
 ...
 */
class bieregactsemdActions extends autobieregactsemdActions
{
   ...
   *
   */
  public function saveBnregsem($Bnregsem)
  {
    $coderr = -1;
  ...
  public function deleteBnregsem($Bnregsem)
  {
    ...
    try {
      ...
      // OJO ----> Eliminar esta linea al modificar este método
      parent::deleteBnregsem($Bnregsem);
  ...
  public function handleErrorEdit()
  {
    ...
    $this->Bnregsem= $this->getBnregsemOrCreate();
    $this->updateBnregsemFromRequest();    

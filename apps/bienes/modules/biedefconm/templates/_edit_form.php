...
// date: 2007/04/02 13:08:44
?>
<?php echo form_tag('biedefconm/edit', array(
...
<div
	class="content<?php if ($sf_request->hasError('bndefcon{codmue}')): ?> form-error<?php endif; ?>">
<?php if ($sf_request->hasError('bndefcon{codmue}')): ?> <?php echo form_error('bndefcon{codmue}', array('class' => 'form-error-msg')) ?>
<?php endif; ?> <?php $value = object_input_tag($bndefcon, 'getCodmue', array (
'size' => 20,
'control_name' => 'bndefcon[codmue]',
)); echo $value ? $value : '&nbsp;' ?></div>
<br>
<?php echo label_for('bndefcon[desmue]', __($labels['bndefcon{desmue}']), '') ?>
<div
	class="content<?php if ($sf_request->hasError('bndefcon{desmue}')): ?> form-error<?php endif; ?>">
<?php if ($sf_request->hasError('bndefcon{desmue}')): ?> <?php echo form_error('bndefcon{desmue}', array('class' => 'form-error-msg')) ?>
<?php endif; ?> <?php $value = object_input_tag($bndefcon, 'getDesmue', array (
'disabled' => true,
...
<ul class="sf_admin_actions">
	<li class="float-left"><?php if ($bndefcon->getId()): ?> <?php echo button_to(__('delete'), 'biedefconm/delete?id='.$bndefcon->getId(), array (
	'post' => true,

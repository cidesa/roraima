 ...
 *
 * @package    siga
 * @subpackage fordefobr
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class fordefobrActions extends autofordefobrActions
{
          ...
          if ($result)
          {
            if (strlen($codigo)==strlen(H::getObtener_FormatoPartida_Formulacion())){
             $dato=$result->getNomparegr();
                ...
                $javascript="alert('La Partida no es de Ultimo Nivel'); $('fordefobr_codparegr').value=''; $('fordefobr_codparegr').focus(); ";
            }
          }else{
            $javascript="alert('La Partida no existe'); $('fordefobr_codparegr').value=''; $('fordefobr_codparegr').focus(); ";
          }

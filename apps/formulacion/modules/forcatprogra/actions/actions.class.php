...
/**
 * forcatprogra actions.
 *
 * @package    siga
 * @subpackage forcatprogra
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class forcatprograActions extends autoforcatprograActions
{
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
        $r= new Criteria();
        $r->add(FordefuniejePeer::CODUNI,$codigo);
        $resul= FordefuniejePeer::doSelectOne($r);
        if ($resul)
        {
            $dato=$resul->getNomuni();
        }else $javascript="alert_('La Unidad Ejecutora no existe'); $('fordefcatpre_coduni').value=''; $('fordefcatpre_coduni').focus();";
  ...
  public function validateEdit()
  {
    ...
    if($this->getRequest()->getMethod() == sfRequest::POST){
       ...
       $this->coderr=Formulacion::validarCodcat($this->fordefcatpre->getCodcat());

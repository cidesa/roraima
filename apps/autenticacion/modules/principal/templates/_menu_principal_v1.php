...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <?php } elseif($menu=='documentos') { ?>
    ...
    <?php } elseif($menu=='presupuesto') { ?>
    <?php echo javascript_tag("new tree (TREE_ITEMSCOM_PRE, tree_tpl);");?>
    <?php } elseif($menu=='contabilidad') { ?>
    <?php echo javascript_tag("new tree (TREE_ITEMSCOM_CON, tree_tpl);");?>
    <?php } elseif($menu=='ciudadanos') { ?>
    <?php echo javascript_tag("new tree (TREE_ITEMSCOM_ACIUDADANO, tree_tpl);");?>
  <?php }?>

    ...
    <tr>
      ...
      <table align="center" border="0" cellpadding="3" cellspacing="3" width="310">
        <tbody>
          ...
          <tr>
            <td class="form_label_01 Order tiny style15">&nbsp;<?php echo label_for('labeldb', 'Base de Dato') ?></td>
            <td><?php echo select_tag('selectdb', options_for_select($db),array('onChange' => "javascript: CargarEmpresa(this.value);")); ?></td>
          </tr>
          <?php } ?>
          <tr>
            
            <td class="form_label_01 Order tiny style15">&nbsp;<?php echo label_for('labelempresa', 'Empresa') ?></td>
            <td> <div id="divemp" > <?php echo select_tag('selectemp', options_for_select($empresas)); ?></div></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
...
<script>
    function CargarEmpresa(v)
    {
        toAjaxUpdater('divemp','1',getUrlModulo()+'empresa',v,'','');
    }
</script>

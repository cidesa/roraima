...
<div class="form-row">
  <?php echo label_for('usuarios[pasuse]', __($labels['usuarios{pasuse}']), 'class="required" ') ?>
  ...
  <?php $value = input_password_tag('pasuse', '', array (
  'size' => 20,
)); echo $value ? $value : '&nbsp;' ?>
    </div>
</div>
...
<div class="form-row">
  <?php echo label_for('usuarios[pasuse]', __('Verificar Contraseña'), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('usuarios{pasuse}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('usuarios{pasuse}')): ?>
    <?php echo form_error('usuarios{pasuse}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = input_password_tag('repasuse', '', array (
  'size' => 20,
)); echo $value ? $value : '&nbsp;' ?>
    </div>
</div>

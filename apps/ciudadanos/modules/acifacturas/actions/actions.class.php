 ...
 *
 * @package    siga
 * @subpackage acifacturas
 * @author     Your name here
 * @version    SVN: $Id: actions.class.php 2288 2006-10-02 15:22:13Z fabien $
 */
class acifacturasActions extends autoacifacturasActions
{
  ...
  protected function addFiltersCriteria($c)
  {
    ...
    {
      $criterion = $c->getNewCriterion(AtfacturasPeer::ATAYUDAS_ID, '');
      $criterion->addOr($c->getNewCriterion(AtfacturasPeer::ATAYUDAS_ID, null, Criteria::ISNULL));
      $c->add($criterion);
    }
  ...
  public function getLabels()
  {
    ...
    $labels['atfacturas{atayudas_id}'] = "Expediente";
    return $labels;
  }

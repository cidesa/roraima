 ...
 */
class acitipayuActions extends autoacitipayuActions
{
  ...
  {
    //$this->attipayu = $this->getAttipayuOrCreate();
    //$mascarapresupuestaria = Herramientas::Obtener_FormatoPresupuesto();
    //$longpre=strlen($mascarapresupuestaria);
    //$this->attipayu->setMascarapresupuestaria($mascarapresupuestaria);
    //$this->attipayu->setLongpre($longpre);
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
        ...
        if($cpdeftit) $nompre = $cpdeftit->getNompre();
        else $nompre = Constantes::REGVACIO;

        $output = '[["'.$cajtexmos.'","'.$nompre.'",""],["","",""],["","",""]]';
        break;
      default:
        $output = '[["","",""],["","",""],["","",""]]';
    }

...
<? 
$titulo2=array(0 => 'Nro. Orden', 1 => 'Fecha', 2 => 'Codigo Presupuestario', 3 => 'Monto Descuento', 4 => 'Monto Retencion');
...
<?php echo button_to(__('delete'), 'pagemiret/delete?id='.$opordpag->getId(), array (
  'post' => true,

...
{
   public function imppreSQL()    
    {
        $con = sfContext::getInstance()->getDatabaseConnection($connection='propel');
        $sql = "SELECT codpre, refcom, moncau, mondes, monret FROM opdetord where numord ='".($this->opordpag->getNumord())."'";
  ...
  public function executeEdit()
  {
    ...
    if ($this->getRequest()->getMethod() == sfRequest::POST)
    {
      ...
      {
        return $this->redirect('pagemiord/edit?id='.$this->opordpag->getId());
      }
    }
    else
    {

...
<div class="form-row">
  ...
  <?php $value = object_input_tag($tsdesmon, 'getValmon', array (
  'size' => 7,
...
<div class="form-row">
  ...
  <?php echo "Aumenta" . radiobutton_tag('radio1', 'A', $val) ?>
  <?php echo "  Disminuye" . radiobutton_tag('radio1', 'D', !$val)?>
    </div>
</div>
...
<ul class="sf_admin_actions">
      <li class="float-left"><?php if ($tsdesmon->getId()): ?>

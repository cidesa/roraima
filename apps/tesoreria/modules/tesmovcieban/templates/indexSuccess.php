...
<h1><?php echo 'Cierre de Bancos' ?></h1>
...
<?php echo button_to('...','#') ?>
  ...
  <?php echo input_tag('descue', '','disabled=true,size=80') ?>  
   ...
   <div class="form-row">
  <?php echo label_for('lmescon','Mes a Cerrar' , 'class="required"') ?>
  ...
  '12'  => 'Diciembre'
   ...
   <div class="form-row">
  	<?php echo label_for('lannocon','Del Año' , 'class="required"') ?>
  ...
  <fieldset id="sf_fieldset_none"  class="">
   <div class="form-row" align="center">
  	  <?php echo button_to('  Cerrar  ','#') ?>
  	    &nbsp;
  	    &nbsp;
  	    &nbsp;
  	  <?php echo button_to('  Abrir ','#') ?>
   </div>
   </fieldset>
    </div>
</fieldset>

...
<div id="divGrid"><?php echo form_tag('tesmovsegbanant/edit', array(
...
<?php echo button_to('Salvar', 'tesmovsegbanant/salvaranu?refban='.$tsmovban->getRefban().'&fecban='.$tsmovban->getFecban().'&tipmov='.$tsmovban->getTipmov().'&id='.$tsmovban->getId().'&numcue='.$tsmovban->getNumcue()) ?></fieldset>
</form>

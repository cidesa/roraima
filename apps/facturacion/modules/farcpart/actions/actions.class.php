 ...
 */
class farcpartActions extends autofarcpartActions
{
  ...
  public function configGrid($reg = array(),$regelim = array())
  {
    ...
    $obj = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/farcpart/'.sfConfig::get('sf_app_module_config_dir_name').'/grid_caartrcp',$reg);
    $this->caartrcp->setObj($obj);

 ...
 */
class faartcomActions extends autofaartcomActions
{
  ...
  public function configGrid($reg = array(),$regelim = array())
  {
    ...
    $obj = Herramientas::getConfigGrid(sfConfig::get('sf_app_module_dir').'/faartcom/'.sfConfig::get('sf_app_module_config_dir_name').'/grid_caregart',$reg);
    $this->faartcom->setObj($obj);

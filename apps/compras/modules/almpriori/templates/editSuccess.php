...
<?php include_partial('almpriori/edit_form', array('casolart' => $casolart, 'labels' => $labels, 'articulos' => $articulos, 'grid' => $grid, 'elimina' => $elimina, 'grid2' => $grid2, 'actualiza' => $actualiza)) ?>
</div>

 ...
 *
 * @package    siga
 * @subpackage almmedcom
 * @author     Your name here
 * @version    SVN: $Id: actions.class.php 2288 2006-10-02 15:22:13Z fabien $
 */
class almmedcomActions extends autoalmmedcomActions
{
  ...
  public function saveCamedcom($Camedcom)
  {
    $coderr = -1;
  ...
  public function deleteCamedcom($Camedcom)
  {
    ...
    try {
      ...
      // OJO ----> Eliminar esta linea al modificar este método
      parent::deleteCamedcom($Camedcom);
  ...
  public function validateEdit()
  {
    ...
    if($this->getRequest()->getMethod() == sfRequest::POST){
      ...
      // $this->Camedcom= $this->getCamedcomOrCreate();
      // $this->configGrid();
      // $grid = Herramientas::CargarDatosGrid($this,$this->obj);
  ...
  public function handleErrorEdit()
  {
    ...
    $this->camedcom= $this->getCamedcomOrCreate();
    $this->updateCamedcomFromRequest();

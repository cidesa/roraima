...
/**
 * almdefcatsnc actions.
 *
 * @package    Roraima
 * @subpackage almdefcatsnc
 ...
 */
class almdefcatsncActions extends autoalmdefcatsncActions
{
   ...
   *
   */
  public function saveCacatsnc($Cacatsnc)
  {
    $coderr = -1;
  ...
  public function deleteCacatsnc($Cacatsnc)
  {
    ...
    try {
      ...
      // OJO ----> Eliminar esta linea al modificar este método
      parent::deleteCacatsnc($Cacatsnc);
  ...
  public function validateEdit()
  {
    ...
    if($this->getRequest()->getMethod() == sfRequest::POST){
      ...
      // $this->Cacatsnc= $this->getCacatsncOrCreate();
      // $this->configGrid();
      // $grid = Herramientas::CargarDatosGrid($this,$this->obj);
  ...
  public function handleErrorEdit()
  {
    ...
    $this->cacatsnc= $this->getCacatsncOrCreate();
    $this->updateCacatsncFromRequest();
     $this->setVars();
  ...
  {
    $this->formatosnc = Herramientas::ObtenerFormato('Cadefart','forsnc');
    $this->longsnc=strlen($this->formatosnc);
  }

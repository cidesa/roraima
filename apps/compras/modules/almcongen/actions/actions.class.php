 ...
 */
class almcongenActions extends autoalmcongenActions
{
  ...
  public function executeIndex()
  {
    ...
    if ($data)
    { $id=$data->getId();
    return $this->redirect('almcongen/edit?id='.$id);
    }
    else { return $this->redirect('almcongen/edit');}
  }

...
/**
 * almtipptoven actions.
 *
 * @package    siga
 * @subpackage almtipptoven
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class almtipptovenActions extends autoalmtipptovenActions
{

  // Para incluir funcionalidades al executeEdit()
  public function editing()
  {
     if (!$this->catipalmpv->getId()) {

           $t= new Criteria();
           $t->setLimit(1);
           $t->addDescendingOrderByColumn(CatipalmpvPeer::CODTIPPV);
           $reg= CatipalmpvPeer::doSelectOne($t);
           if ($reg)
           {
               $this->catipalmpv->setCodtippv(str_pad(($reg->getCodtippv()+1),3,'0',STR_PAD_LEFT));
           }else $this->catipalmpv->setCodtippv('001');
         }

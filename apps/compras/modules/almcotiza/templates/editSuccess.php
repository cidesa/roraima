...
<?php include_partial('almcotiza/edit_form', array('cacotiza' => $cacotiza, 'moneda' => $moneda, 'valor' => $valor, 'aumdis' => $aumdis, 'numreg' => $numreg, 'labels' => $labels, 'obj' => $obj, 'mansolocor' => $mansolocor, 'bloqfec' => $bloqfec, 'oculeli' => $oculeli, 'obj2' => $obj2)) ?>
</div>

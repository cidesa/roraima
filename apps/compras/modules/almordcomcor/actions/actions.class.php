...
class almordcomcorActions extends autoalmordcomcorActions
{
  ...
  public function configGrid($ordcom='',$referencia='',$tipo='')
  {
    ...
    $col2 = new Columna('CÃ³digo  ArtÃ­culo');
  ...
  public function configGrid_ResumenPartidas($ordcom='')
  {
    ...
    // Se generan las columnas
    $col1 = new Columna('CÃ³digo  Partida');
    $col1->setTipo(Columna::TEXTO);
    $col1->setEsGrabable(true);
    $col1->setAlineacionObjeto(Columna::CENTRO);
    $col1->setAlineacionContenido(Columna::CENTRO);
  ...
  public function configGrid_Entregas($ordcom='')
  {
    ...
    **************************************************************************/
    ...
    $opciones2->setName('c');
    $opciones2->setTitulo('Detalle de la Orden de RequisiciÃ³n');

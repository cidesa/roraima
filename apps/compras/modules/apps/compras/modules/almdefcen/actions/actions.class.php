 ...
 *
 * @package    siga
 * @subpackage almdefcen
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class almdefcenActions extends autoalmdefcenActions
{

  // Para incluir funcionalidades al executeEdit()
  public function editing()
  {
    if (!$this->cadefcen->getId())
    {
       $t= new Criteria();
       $t->setLimit(1);
       $t->addDescendingOrderByColumn(CadefcenPeer::CODCEN);
       $reg= CadefcenPeer::doSelectOne($t);
       if ($reg)
       {
           $this->cadefcen->setCodcen(str_pad(($reg->getCodcen()+1),4,'0',STR_PAD_LEFT));
       }else $this->cadefcen->setCodcen('0001');
    }

 ...
 *
 * @package    siga
 * @subpackage ingdefper
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class ingdefperActions extends autoingdefperActions
{

  // Para incluir funcionalidades al executeEdit()
  public function editing()
  {
    if (!$this->citipper->getId()) {
           $t= new Criteria();
           $t->setLimit(1);
           $t->addDescendingOrderByColumn(CitipperPeer::CODTIPPER);
           $reg= CitipperPeer::doSelectOne($t);
           if ($reg)
           {
               $this->citipper->setCodtipper(str_pad(($reg->getCodtipper()+1),3,'0',STR_PAD_LEFT));
           }else $this->citipper->setCodtipper('001');
         }

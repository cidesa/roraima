 ...
 */
class licressolActions extends autolicressolActions
{
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
     case '1':
         $num = 'liressol_numsol';
         $des = 'liressol_dessol';
         $id = 'liressol_liregsol_id';
         $coduni = 'liressol_coduniste';
         $desuni = 'liressol_desuniste';
         $c = new Criteria();
        ...
        break;
      case '2':
         $ced = 'liressol_codempfir';
         $nom = 'liressol_nomempfir';
         $c = new Criteria();
         $c->add(NphojintPeer::CODEMP,trim($codigo));
          ...
          if($empleado){
            $output = '[["'.$nom.'","'.$empleado->getNomemp().'",""],["'.$ced.'","'.$empleado->getCodemp().'",""]]';
          }else{
            $output = '[["'.$nom.'","'.H::REGVACIO.'",""],["'.$ced.'","",""],["","",""]]';
          }
        break;
      case '3':
         $ced = 'liressol_codempemi';
         $nom = 'liressol_nomempemi';
         $c = new Criteria();
         $c->add(NphojintPeer::CODEMP,trim($codigo));
   ...
   *
   */
  public function saving($liressol)
  {
  	 //actualizar la fecha de respuesta a grabar en esta tabla tambien en la solicitud de licitacion
  	 $liregistrosol = $liressol->getLiregsol();
  	 $liregistrosol->setFecres($liressol->getFecres());
     $liregistrosol->save();

     return parent::saving($liressol);
  }

 ...
 */
class docpendetActions extends autodocpendetActions
{
   ...
   *
   */
  public function saveDfatendocdet($Dfatendocdet)
  {
    $coderr = -1;
    ...
    try {
      ...
      parent::saveDfatendocdet($Dfatendocdet);
  ...
  public function deleteDfatendocdet($Dfatendocdet)
  {
    ...
    try {
      ...
      // OJO ----> Eliminar esta linea al modificar este método
      parent::deleteDfatendocdet($Dfatendocdet);
  ...
  public function executeList()
  {
    ...
    if($this->getRequestParameter('dfatendoc', '')!='') $c->add(DfatendocdetPeer::ID_DFATENDOC,$this->getRequestParameter('dfatendoc'));

...
class facotringregActions extends autofacotringregActions
{
  ...
  public function editing()
  {
	...
	public function setVars() {
		$this->params[0] = $this->fcotring->getFunrec()=='' ? $this->getUser()->getAttribute('loguse') : $this->fcotring->getFunrec();
  ...
  public function configGridDistribucion($registro=array())
  {
		...
		$this->columnas = Herramientas :: getConfigGrid(sfConfig :: get('sf_app_module_dir') . '/facotringreg/' . sfConfig :: get('sf_app_module_config_dir_name') . '/grid_distribucion');

		$this->grid2 = $this->columnas[0]->getConfig($per);
		$this->fcotring->setGriddistribucion($this->grid2);

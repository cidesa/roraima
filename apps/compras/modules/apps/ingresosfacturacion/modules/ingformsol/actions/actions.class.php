 ...
 */
class ingformsolActions extends autoingformsolActions
{
   ...
   *
   */
  public function saving($informsol)
  {

  	  $sql="select max(id) as num from informsol";
      if (Herramientas::BuscarDatos($sql,&$result))
		 {
		   	//H::printR ($result);
		   	$informsol->setCodformsol((str_pad($result[0]["num"]+1, 4, '0', STR_PAD_LEFT)));
		 }

    return parent::saving($informsol);
  }

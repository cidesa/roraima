...
<?php else: ?>
<?php include_partial('generales/list', array('pager' => $pager)) ?>
<?php endif; ?>
</div>
...
<div id="sf_admin_bar">
<?php include_partial('filters', array('filters' => $filters, 'tabla' => $tabla )) ?>
</div>


<?php tabPageOpenClose("tp1", "tabPage3", 'Catálogo v1');?>

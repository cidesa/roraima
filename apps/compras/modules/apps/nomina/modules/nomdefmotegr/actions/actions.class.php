...
/**
 * nomdefmotegr actions.
 *
 * @package    siga
 * @subpackage nomdefmotegr
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class nomdefmotegrActions extends autonomdefmotegrActions
{

  // Para incluir funcionalidades al executeEdit()
  public function editing()
  {
    if (!$this->npmotegr->getId())
    {
       $t= new Criteria();
       $t->setLimit(1);
       $t->addDescendingOrderByColumn(NpmotegrPeer::CODMOT);
       $reg= NpmotegrPeer::doSelectOne($t);
       if ($reg)
       {
           $this->npmotegr->setCodmot(str_pad(($reg->getCodmot()+1),4,'0',STR_PAD_LEFT));
       }else $this->npmotegr->setCodmot('0001');
    }

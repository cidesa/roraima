...
/**
 * nomdefconsuelretenciones actions.
 *
 * @package    siga
 * @subpackage nomdefconsuelretenciones
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class nomdefconsuelretencionesActions extends autonomdefconsuelretencionesActions
{
  ...
  {
    $this->configGridRetenciones($this->nptipaportes->getCodtipapo());
  }
   ...
   *
   */
  public function configGridRetenciones($codtipapo='')
  {
    $a= new Criteria();
    $a->add(NpconsuelaporetPeer::CODTIPAPO,$codtipapo);
    $a->add(NpconsuelaporetPeer::TIPO,'R');
  ...
  {
    $grid = Herramientas::CargarDatosGridv2($this,$this->objeto);
    Nomina::salvarConceptosSueldosRetenciones($nptipaportes,$grid);
    return -1;
  ...
  {
    Nomina::eliminarConceptosSueldosRetenciones($nptipaportes);
    return -1;

...
/**
 * presnomreghisadeint actions.
 *
 * @package    Roraima
 * @subpackage presnomreghisadeint
 ...
 */
class presnomreghisadeintActions extends autopresnomreghisadeintActions
{
  ...
  public function validateEdit()
  {
    ...
    if($this->getRequest()->getMethod() == sfRequest::POST){
		...
		if(intval($this->npadeint->getMonade())==0)
		{
			$this->coderr=471;

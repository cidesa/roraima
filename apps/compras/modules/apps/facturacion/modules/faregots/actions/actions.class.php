...
class faregotsActions extends autofaregotsActions
{
  ...
  public function executeAjax()
  {
    ...
    switch ($ajax){
      case '1':
         ...
         $c->add(CaproveePeer::TIPO,'P');
         $reg= CaproveePeer::doSelectOne($c);
         if ($reg)
         {
             $dato=$reg->getNompro();
         }else $javascript="alert('La Contratista no existe'); $('faregots_rifpro').value=''; $('faregots_rifpro').focus();";

...
abstract class BaseCierrePeer {
	...
	const CLASS_DEFAULT = 'lib.model.ingresos.Cierre';
	...
	{
		include_once 'lib/model/ingresos/map/CierreMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.ingresos.map.CierreMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/ingresos/map/CierreMapBuilder.php';
	Propel::registerMapBuilder('lib.model.ingresos.map.CierreMapBuilder');
}

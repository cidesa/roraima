...
abstract class BaseFcreginmPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcreginm';
	...
	{
		include_once 'lib/model/hacienda/map/FcreginmMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcreginmMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcreginmMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcreginmMapBuilder');
}

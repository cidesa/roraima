...
abstract class BaseFcvalinmPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcvalinm';
	...
	{
		include_once 'lib/model/hacienda/map/FcvalinmMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcvalinmMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcvalinmMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcvalinmMapBuilder');
}

...
abstract class BaseFccobradPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fccobrad';
	...
	{
		include_once 'lib/model/hacienda/map/FccobradMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FccobradMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FccobradMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FccobradMapBuilder');
}

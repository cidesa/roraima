...
abstract class BaseFcconPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fccon';
	...
	{
		include_once 'lib/model/hacienda/map/FcconMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcconMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcconMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcconMapBuilder');
}

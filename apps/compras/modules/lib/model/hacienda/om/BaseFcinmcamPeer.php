...
abstract class BaseFcinmcamPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcinmcam';
	...
	{
		include_once 'lib/model/hacienda/map/FcinmcamMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcinmcamMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcinmcamMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcinmcamMapBuilder');
}

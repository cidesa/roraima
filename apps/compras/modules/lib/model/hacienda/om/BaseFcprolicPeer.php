...
abstract class BaseFcprolicPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcprolic';
	...
	{
		include_once 'lib/model/hacienda/map/FcprolicMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcprolicMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcprolicMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcprolicMapBuilder');
}

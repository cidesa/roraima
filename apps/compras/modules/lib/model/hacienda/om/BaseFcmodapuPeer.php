...
abstract class BaseFcmodapuPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcmodapu';
	...
	{
		include_once 'lib/model/hacienda/map/FcmodapuMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcmodapuMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcmodapuMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcmodapuMapBuilder');
}

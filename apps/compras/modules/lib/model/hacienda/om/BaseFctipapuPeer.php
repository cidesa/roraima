...
abstract class BaseFctipapuPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fctipapu';
	...
	{
		include_once 'lib/model/hacienda/map/FctipapuMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FctipapuMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FctipapuMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FctipapuMapBuilder');
}

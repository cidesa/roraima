...
abstract class BaseFccatfisPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fccatfis';
	...
	{
		include_once 'lib/model/hacienda/map/FccatfisMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FccatfisMapBuilder');
	}
	...
	const COUNT = 'COUNT(fccatfis.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT fccatfis.ID)';
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(FccatfisPeer::ID);
			$selectCriteria->add(FccatfisPeer::ID, $criteria->remove(FccatfisPeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(FccatfisPeer::ID, (array) $values, Criteria::IN);
		}
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(FccatfisPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(FccatfisPeer::ID, $pks, Criteria::IN);
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FccatfisMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FccatfisMapBuilder');
}

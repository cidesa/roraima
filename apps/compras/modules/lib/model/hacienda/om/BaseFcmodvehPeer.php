...
abstract class BaseFcmodvehPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcmodveh';
	...
	{
		include_once 'lib/model/hacienda/map/FcmodvehMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcmodvehMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcmodvehMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcmodvehMapBuilder');
}

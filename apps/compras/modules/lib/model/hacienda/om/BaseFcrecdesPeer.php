...
abstract class BaseFcrecdesPeer {
	...
	const CLASS_DEFAULT = 'lib.model.hacienda.Fcrecdes';
	...
	{
		include_once 'lib/model/hacienda/map/FcrecdesMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.hacienda.map.FcrecdesMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/hacienda/map/FcrecdesMapBuilder.php';
	Propel::registerMapBuilder('lib.model.hacienda.map.FcrecdesMapBuilder');
}

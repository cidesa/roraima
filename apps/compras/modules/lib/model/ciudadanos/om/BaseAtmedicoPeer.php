...
abstract class BaseAtmedicoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.ciudadanos.Atmedico';
	...
	{
		include_once 'lib/model/ciudadanos/map/AtmedicoMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.ciudadanos.map.AtmedicoMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/ciudadanos/map/AtmedicoMapBuilder.php';
	Propel::registerMapBuilder('lib.model.ciudadanos.map.AtmedicoMapBuilder');
}

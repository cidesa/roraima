...
abstract class BaseAtgrufamPeer {
	...
	const CLASS_DEFAULT = 'lib.model.ciudadanos.Atgrufam';
	...
	{
		include_once 'lib/model/ciudadanos/map/AtgrufamMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.ciudadanos.map.AtgrufamMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/ciudadanos/map/AtgrufamMapBuilder.php';
	Propel::registerMapBuilder('lib.model.ciudadanos.map.AtgrufamMapBuilder');
}

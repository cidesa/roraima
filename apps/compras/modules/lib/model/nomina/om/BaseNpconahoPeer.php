...
abstract class BaseNpconahoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npconaho';
	...
	{
		include_once 'lib/model/nomina/map/NpconahoMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpconahoMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpconahoMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpconahoMapBuilder');
}

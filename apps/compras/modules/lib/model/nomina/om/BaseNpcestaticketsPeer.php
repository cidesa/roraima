...
abstract class BaseNpcestaticketsPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npcestatickets';
	...
	{
		include_once 'lib/model/nomina/map/NpcestaticketsMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpcestaticketsMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpcestaticketsMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpcestaticketsMapBuilder');
}

...
abstract class BaseNpintprePeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npintpre';
	...
	{
		include_once 'lib/model/nomina/map/NpintpreMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpintpreMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpintpreMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpintpreMapBuilder');
}

...
abstract class BaseNpsalint05022007Peer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npsalint05022007';
	...
	{
		include_once 'lib/model/nomina/map/Npsalint05022007MapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.Npsalint05022007MapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(Npsalint05022007Peer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/Npsalint05022007MapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.Npsalint05022007MapBuilder');
}

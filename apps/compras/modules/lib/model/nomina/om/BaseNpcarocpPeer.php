...
abstract class BaseNpcarocpPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npcarocp';
	...
	{
		include_once 'lib/model/nomina/map/NpcarocpMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpcarocpMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(NpcarocpPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpcarocpMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpcarocpMapBuilder');
}

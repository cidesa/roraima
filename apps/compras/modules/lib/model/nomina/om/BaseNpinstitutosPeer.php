...
abstract class BaseNpinstitutosPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npinstitutos';
	...
	{
		include_once 'lib/model/nomina/map/NpinstitutosMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpinstitutosMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(NpinstitutosPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpinstitutosMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpinstitutosMapBuilder');
}

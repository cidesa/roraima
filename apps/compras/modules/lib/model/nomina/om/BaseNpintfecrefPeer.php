...
abstract class BaseNpintfecrefPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npintfecref';
	...
	{
		include_once 'lib/model/nomina/map/NpintfecrefMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpintfecrefMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(NpintfecrefPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpintfecrefMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpintfecrefMapBuilder');
}

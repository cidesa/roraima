...
abstract class BaseNpdefpreliqPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npdefpreliq';
	...
	{
		include_once 'lib/model/nomina/map/NpdefpreliqMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpdefpreliqMapBuilder');
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(NpdefpreliqPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpdefpreliqMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpdefpreliqMapBuilder');
}

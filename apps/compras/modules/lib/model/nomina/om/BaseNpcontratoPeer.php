...
abstract class BaseNpcontratoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npcontrato';
	...
	{
		include_once 'lib/model/nomina/map/NpcontratoMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpcontratoMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpcontratoMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpcontratoMapBuilder');
}

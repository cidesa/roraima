...
abstract class BaseNpmemosPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npmemos';
	...
	{
		include_once 'lib/model/nomina/map/NpmemosMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpmemosMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpmemosMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpmemosMapBuilder');
}

...
abstract class BaseNpinfadiPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npinfadi';
	...
	{
		include_once 'lib/model/nomina/map/NpinfadiMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpinfadiMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpinfadiMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpinfadiMapBuilder');
}

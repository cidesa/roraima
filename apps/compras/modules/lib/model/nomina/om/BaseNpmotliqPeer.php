...
abstract class BaseNpmotliqPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npmotliq';
	...
	{
		include_once 'lib/model/nomina/map/NpmotliqMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpmotliqMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpmotliqMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpmotliqMapBuilder');
}

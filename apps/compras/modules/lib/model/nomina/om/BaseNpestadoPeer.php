...
abstract class BaseNpestadoPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npestado';
	...
	{
		include_once 'lib/model/nomina/map/NpestadoMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpestadoMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpestadoMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpestadoMapBuilder');
}

...
abstract class BaseNpdefpagextPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npdefpagext';
	...
	{
		include_once 'lib/model/nomina/map/NpdefpagextMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpdefpagextMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpdefpagextMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpdefpagextMapBuilder');
}

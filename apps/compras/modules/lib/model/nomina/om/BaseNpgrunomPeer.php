...
abstract class BaseNpgrunomPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npgrunom';
	...
	{
		include_once 'lib/model/nomina/map/NpgrunomMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpgrunomMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpgrunomMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpgrunomMapBuilder');
}

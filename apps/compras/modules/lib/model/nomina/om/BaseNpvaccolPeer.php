...
abstract class BaseNpvaccolPeer {
	...
	const CLASS_DEFAULT = 'lib.model.nomina.Npvaccol';
	...
	{
		include_once 'lib/model/nomina/map/NpvaccolMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.nomina.map.NpvaccolMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/nomina/map/NpvaccolMapBuilder.php';
	Propel::registerMapBuilder('lib.model.nomina.map.NpvaccolMapBuilder');
}

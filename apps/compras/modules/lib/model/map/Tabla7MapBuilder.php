...
class Tabla7MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.Tabla7MapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tabla7');
		$tMap->setPhpName('Tabla7');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('tabla7_SEQ');

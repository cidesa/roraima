...
class ForregartMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.ForregartMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('forregart');
		$tMap->setPhpName('Forregart');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('forregart_SEQ');

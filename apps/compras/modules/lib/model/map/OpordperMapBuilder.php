...
class OpordperMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->setPrimaryKeyMethodInfo('opordper_SEQ');
		...
		$tMap->addColumn('NUMCUO', 'Numcuo', 'double', CreoleTypes::NUMERIC, true, 6);
		...
		$tMap->addColumn('MONOPP', 'Monopp', 'double', CreoleTypes::NUMERIC, true, 14);

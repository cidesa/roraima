...
class Tabla34MapBuilder {

	
	const CLASS_NAME = 'lib.model.map.Tabla34MapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tabla34');
		$tMap->setPhpName('Tabla34');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('tabla34_SEQ');

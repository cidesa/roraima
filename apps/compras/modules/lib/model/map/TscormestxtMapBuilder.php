...
class TscormestxtMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.TscormestxtMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('tscormestxt');
		$tMap->setPhpName('Tscormestxt');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('tscormestxt_SEQ');

...
class EjecuciondocumentoMapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('MONAJUPRC', 'Monajuprc', 'double', CreoleTypes::NUMERIC, false, 32);

		$tMap->addColumn('MONCOM', 'Moncom', 'double', CreoleTypes::NUMERIC, false, 32);

		$tMap->addColumn('MONAJUCOM', 'Monajucom', 'double', CreoleTypes::NUMERIC, false, 32);

		$tMap->addColumn('MONCAU', 'Moncau', 'double', CreoleTypes::NUMERIC, false, 32);

		$tMap->addColumn('MONAJUCAU', 'Monajucau', 'double', CreoleTypes::NUMERIC, false, 32);

		$tMap->addColumn('MONPAG', 'Monpag', 'double', CreoleTypes::NUMERIC, false, 32);

		$tMap->addColumn('MONAJUPAG', 'Monajupag', 'double', CreoleTypes::NUMERIC, false, 32);

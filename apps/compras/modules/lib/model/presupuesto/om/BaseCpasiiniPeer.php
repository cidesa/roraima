...
abstract class BaseCpasiiniPeer {
	...
	const CLASS_DEFAULT = 'lib.model.presupuesto.Cpasiini';
	...
	{
		include_once 'lib/model/presupuesto/map/CpasiiniMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.presupuesto.map.CpasiiniMapBuilder');
	}
	...
	public static function doCountJoinCpdeftit(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(CpasiiniPeer::CODPRE, CpdeftitPeer::CODPRE);
	...
	public static function doSelectJoinCpdeftit(Criteria $c, $con = null)
	{
		...
		CpasiiniPeer::addSelectColumns($c);
		$startcol = (CpasiiniPeer::NUM_COLUMNS - CpasiiniPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		CpdeftitPeer::addSelectColumns($c);

		$c->addJoin(CpasiiniPeer::CODPRE, CpdeftitPeer::CODPRE);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();

		while($rs->next()) {

			$omClass = CpasiiniPeer::getOMClass();
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getCpdeftit(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addCpasiini($obj1); 					break;
				}
			}
			if ($newObject) {
				$obj2->initCpasiinis();
				$obj2->addCpasiini($obj1); 			}
			$results[] = $obj1;
		}
		return $results;
	}
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		CpasiiniPeer::addSelectColumns($c);
		$startcol2 = (CpasiiniPeer::NUM_COLUMNS - CpasiiniPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(CpasiiniPeer::ID); 
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/presupuesto/map/CpasiiniMapBuilder.php';
	Propel::registerMapBuilder('lib.model.presupuesto.map.CpasiiniMapBuilder');
}

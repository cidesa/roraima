...
abstract class BaseCpimprelPeer {
	...
	const CLASS_DEFAULT = 'lib.model.presupuesto.Cpimprel';
	...
	{
		include_once 'lib/model/presupuesto/map/CpimprelMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.presupuesto.map.CpimprelMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/presupuesto/map/CpimprelMapBuilder.php';
	Propel::registerMapBuilder('lib.model.presupuesto.map.CpimprelMapBuilder');
}

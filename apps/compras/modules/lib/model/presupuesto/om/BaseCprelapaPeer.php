...
abstract class BaseCprelapaPeer {
	...
	const CLASS_DEFAULT = 'lib.model.presupuesto.Cprelapa';
	...
	{
		include_once 'lib/model/presupuesto/map/CprelapaMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.presupuesto.map.CprelapaMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/presupuesto/map/CprelapaMapBuilder.php';
	Propel::registerMapBuilder('lib.model.presupuesto.map.CprelapaMapBuilder');
}

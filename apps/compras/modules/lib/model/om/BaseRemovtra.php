...
abstract class BaseRemovtra extends BaseObject  implements Persistent {
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			RemovtraPeer::doDelete($this, $con);
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RemovtraPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RemovtraPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = RemovtraPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RemovtraPeer::REFTRA)) $criteria->add(RemovtraPeer::REFTRA, $this->reftra);
		if ($this->isColumnModified(RemovtraPeer::CODORI)) $criteria->add(RemovtraPeer::CODORI, $this->codori);
		if ($this->isColumnModified(RemovtraPeer::CODDES)) $criteria->add(RemovtraPeer::CODDES, $this->coddes);
		if ($this->isColumnModified(RemovtraPeer::MONMOV)) $criteria->add(RemovtraPeer::MONMOV, $this->monmov);
		if ($this->isColumnModified(RemovtraPeer::STAMOV)) $criteria->add(RemovtraPeer::STAMOV, $this->stamov);
		if ($this->isColumnModified(RemovtraPeer::ID)) $criteria->add(RemovtraPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(RemovtraPeer::ID, $this->id);

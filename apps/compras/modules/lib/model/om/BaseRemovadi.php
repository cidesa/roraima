...
abstract class BaseRemovadi extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->refadi !== $v) {
        $this->refadi = $v;
        $this->modifiedColumns[] = RemovadiPeer::REFADI;
      }
    ...
    if ($this->codpre !== $v) {
        $this->codpre = $v;
        $this->modifiedColumns[] = RemovadiPeer::CODPRE;
      }
    ...
    if ($this->perpre !== $v) {
        $this->perpre = $v;
        $this->modifiedColumns[] = RemovadiPeer::PERPRE;
      }
    ...
    if ($this->monmov !== $v) {
        ...
        $this->modifiedColumns[] = RemovadiPeer::MONMOV;
      }
    ...
    if ($this->stamov !== $v) {
        $this->stamov = $v;
        $this->modifiedColumns[] = RemovadiPeer::STAMOV;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = RemovadiPeer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Removadi object", $e);
    }
  }
  ...
  public function __call($m, $a)
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			RemovadiPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = RemovadiPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += RemovadiPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = RemovadiPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = RemovadiPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = RemovadiPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(RemovadiPeer::REFADI)) $criteria->add(RemovadiPeer::REFADI, $this->refadi);
		if ($this->isColumnModified(RemovadiPeer::CODPRE)) $criteria->add(RemovadiPeer::CODPRE, $this->codpre);
		if ($this->isColumnModified(RemovadiPeer::PERPRE)) $criteria->add(RemovadiPeer::PERPRE, $this->perpre);
		if ($this->isColumnModified(RemovadiPeer::MONMOV)) $criteria->add(RemovadiPeer::MONMOV, $this->monmov);
		if ($this->isColumnModified(RemovadiPeer::STAMOV)) $criteria->add(RemovadiPeer::STAMOV, $this->stamov);
		if ($this->isColumnModified(RemovadiPeer::ID)) $criteria->add(RemovadiPeer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(RemovadiPeer::ID, $this->id);

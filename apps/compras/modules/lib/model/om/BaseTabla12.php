...
abstract class BaseTabla12 extends BaseObject  implements Persistent {
  ...
  public function getId()
  {
    ...
    if ($this->refcau !== $v) {
        $this->refcau = $v;
        $this->modifiedColumns[] = Tabla12Peer::REFCAU;
      }
    ...
    if ($this->tipcau !== $v) {
        $this->tipcau = $v;
        $this->modifiedColumns[] = Tabla12Peer::TIPCAU;
      }
    ...
    if ($this->feccau !== $ts) {
      $this->feccau = $ts;
      $this->modifiedColumns[] = Tabla12Peer::FECCAU;
    }
    ...
    if ($this->anocau !== $v) {
        $this->anocau = $v;
        $this->modifiedColumns[] = Tabla12Peer::ANOCAU;
      }
    ...
    if ($this->refcom !== $v) {
        $this->refcom = $v;
        $this->modifiedColumns[] = Tabla12Peer::REFCOM;
      }
    ...
    if ($this->tipcom !== $v) {
        $this->tipcom = $v;
        $this->modifiedColumns[] = Tabla12Peer::TIPCOM;
      }
    ...
    if ($this->descau !== $v) {
        $this->descau = $v;
        $this->modifiedColumns[] = Tabla12Peer::DESCAU;
      }
    ...
    if ($this->desanu !== $v) {
        $this->desanu = $v;
        $this->modifiedColumns[] = Tabla12Peer::DESANU;
      }
    ...
    if ($this->moncau !== $v) {
        ...
        $this->modifiedColumns[] = Tabla12Peer::MONCAU;
      }
    ...
    if ($this->salpag !== $v) {
        ...
        $this->modifiedColumns[] = Tabla12Peer::SALPAG;
      }
    ...
    if ($this->salaju !== $v) {
        ...
        $this->modifiedColumns[] = Tabla12Peer::SALAJU;
      }
    ...
    if ($this->stacau !== $v) {
        $this->stacau = $v;
        $this->modifiedColumns[] = Tabla12Peer::STACAU;
      }
    ...
    if ($this->fecanu !== $ts) {
      $this->fecanu = $ts;
      $this->modifiedColumns[] = Tabla12Peer::FECANU;
    }
    ...
    if ($this->cedrif !== $v) {
        $this->cedrif = $v;
        $this->modifiedColumns[] = Tabla12Peer::CEDRIF;
      }
    ...
    if ($this->id !== $v) {
        $this->id = $v;
        $this->modifiedColumns[] = Tabla12Peer::ID;
      }
  ...
  public function hydrate(ResultSet $rs, $startcol = 1)
  {
    try {
      ...
      throw new PropelException("Error populating Tabla12 object", $e);
    }
  }
  ...
  public function __call($m, $a)
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = Tabla12Peer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += Tabla12Peer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = Tabla12Peer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = Tabla12Peer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = Tabla12Peer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(Tabla12Peer::REFCAU)) $criteria->add(Tabla12Peer::REFCAU, $this->refcau);
		if ($this->isColumnModified(Tabla12Peer::TIPCAU)) $criteria->add(Tabla12Peer::TIPCAU, $this->tipcau);
		if ($this->isColumnModified(Tabla12Peer::FECCAU)) $criteria->add(Tabla12Peer::FECCAU, $this->feccau);
		if ($this->isColumnModified(Tabla12Peer::ANOCAU)) $criteria->add(Tabla12Peer::ANOCAU, $this->anocau);
		if ($this->isColumnModified(Tabla12Peer::REFCOM)) $criteria->add(Tabla12Peer::REFCOM, $this->refcom);
		if ($this->isColumnModified(Tabla12Peer::TIPCOM)) $criteria->add(Tabla12Peer::TIPCOM, $this->tipcom);
		if ($this->isColumnModified(Tabla12Peer::DESCAU)) $criteria->add(Tabla12Peer::DESCAU, $this->descau);
		if ($this->isColumnModified(Tabla12Peer::DESANU)) $criteria->add(Tabla12Peer::DESANU, $this->desanu);
		if ($this->isColumnModified(Tabla12Peer::MONCAU)) $criteria->add(Tabla12Peer::MONCAU, $this->moncau);
		if ($this->isColumnModified(Tabla12Peer::SALPAG)) $criteria->add(Tabla12Peer::SALPAG, $this->salpag);
		if ($this->isColumnModified(Tabla12Peer::SALAJU)) $criteria->add(Tabla12Peer::SALAJU, $this->salaju);
		if ($this->isColumnModified(Tabla12Peer::STACAU)) $criteria->add(Tabla12Peer::STACAU, $this->stacau);
		if ($this->isColumnModified(Tabla12Peer::FECANU)) $criteria->add(Tabla12Peer::FECANU, $this->fecanu);
		if ($this->isColumnModified(Tabla12Peer::CEDRIF)) $criteria->add(Tabla12Peer::CEDRIF, $this->cedrif);
		if ($this->isColumnModified(Tabla12Peer::ID)) $criteria->add(Tabla12Peer::ID, $this->id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(Tabla12Peer::ID, $this->id);

...
abstract class BaseFaciudadPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Faciudad';
	...
	{
		include_once 'lib/model/map/FaciudadMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.FaciudadMapBuilder');
	}
...
if (Propel::isInit()) {
		...
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
			...
			require_once 'lib/model/map/FaciudadMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.FaciudadMapBuilder');
}

										...
										$nomnom,$conceptotickets,$periodosefectivos,$cuotas,$redondeo,$ultfec,$profec,$nroope,$acumulacre,$acumuladeb,&$cont,$codnomesp)
{
	if ($tgrid[0]["tipcal"]=='F') // EVALUAMOS UNA FORMULA
	{
		...
		Nomina::evalEcua(&$ecuacion,&$resecu,&$error,$codemp,$cargo,$conceptos["codcon"],$codnom,'btnCalcular','nrosem','datosins(2)','datosins(2)','datosins(2)','datosins(2)',$hasta,$fechanac,$fechaing,$sexo,&$vars,$especial='SI');

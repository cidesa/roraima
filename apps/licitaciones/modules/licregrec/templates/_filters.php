 ...
 * @version    SVN: $Id: _filters.php 35660 2009-12-16 19:53:29Z jlobaton $
 */
...
<?php echo form_tag('licregrec/list', array('method' => 'get')) ?>
  ...
  <ul class="sf_admin_actions">
    <li><?php echo button_to(__('reset'), 'licregrec/list?filter=filter', 'class=sf_admin_action_reset_filter') ?></li>

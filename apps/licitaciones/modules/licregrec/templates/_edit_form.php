 ...
 * @version    SVN: $Id: _edit_form.php 37659 2010-04-20 14:02:00Z dmartinez $
 */
// date: 2007/03/16 09:30:03
?>
<?php echo form_tag('licregrec/edit', array(
...
<?php echo label_for('carecaud[codtiprec]', __($labels['carecaud{codtiprec}']), 'class="required" ') ?>
  ...
  <?php echo input_auto_complete_tag('carecaud[codtiprec]', $carecaud->getCodtiprec(),
    'licregrec/autocomplete?ajax=1',  array('autocomplete' => 'off',
	'maxlength' => 4,
	'readonly'  =>  $carecaud->getId()!='' ? true : false ,
...
<th valign="top">&nbsp;&nbsp;
<?php echo  button_to_popup('...',cross_app_link_to('herramientas','catalogo').'/metodo/Catiprec_licregrec/clase/Catiprec/frame/sf_admin_edit_form/obj1/carecaud_codtiprec/obj2/carecaud_destiprec','','','botoncat')?>
&nbsp;&nbsp;
</th>
...
<tr>
    <th>
<?php echo label_for('carecaud[puntua]', __($labels['carecaud{puntua}']),'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('carecaud{puntua}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('carecaud{puntua}')): ?>
    <?php echo form_error('carecaud{puntua}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_input_tag($carecaud, array('getPuntua',true), array (
  'size' => 7,
  'control_name' => 'carecaud[puntua]',
  'onBlur' => "javascript:event.keyCode=13;return entermontootro(event, this.id)",
)); echo $value ? $value : '&nbsp;' ?>
    </div></th>
</tr>
...
<?php echo button_to(__('delete'), 'licregrec/delete?id='.$carecaud->getId(), array (
  'post' => true,

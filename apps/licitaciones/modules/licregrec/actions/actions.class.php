 ...
 *
 * @package    Roraima
 * @subpackage licregrec
 * @author     $Author: dmartinez $ <desarrollo@cidesa.com.ve>
 * @version SVN: $Id: actions.class.php 37659 2010-04-20 14:02:00Z dmartinez $
 *
 * @copyright  Copyright 2007, Cide S.A.
 * @license    http://opensource.org/licenses/gpl-2.0.php GPLv2
 */
class licregrecActions extends autolicregrecActions
{
   private $coderror = -1;
		...
		if(array_key_exists('aplicacion',$varemp))
		 if(array_key_exists('compras',$varemp['aplicacion']))
		   if(array_key_exists('modulos',$varemp['aplicacion']['compras']))
		     if(array_key_exists('licregrec',$varemp['aplicacion']['compras']['modulos']))
		       if(array_key_exists('mansolocor',$varemp['aplicacion']['compras']['modulos']['licregrec']))
		       {
		       	$this->mansolocor=$varemp['aplicacion']['compras']['modulos']['licregrec']['mansolocor'];
		       }
...
$this->Bitacora('Guardo');
	      ...
	      {
	        return $this->redirect('licregrec/create');
	      }
	      else if ($this->getRequestParameter('save_and_list'))
	      {
	        return $this->redirect('licregrec/list');
	      }
	      else
	      {
	        return $this->redirect('licregrec/edit?id='.$this->carecaud->getId());
	      }
	    }
	    else
	    {
  ...
  protected function updateCarecaudFromRequest()
  {
    ...
    if (isset($carecaud['puntua']))
    {
      $this->carecaud->setPuntua($carecaud['puntua']);
    }
  }

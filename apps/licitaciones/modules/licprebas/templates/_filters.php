 ...
 * @version    SVN: $Id: _filters.php 38422 2010-05-27 15:04:45Z dmartinez $
 */
...
<?php echo form_tag('licprebas/list', array('method' => 'get')) ?>
  ...
  <ul class="sf_admin_actions">
    <li><?php echo button_to(__('reset'), 'licprebas/list?filter=filter', 'class=sf_admin_action_reset_filter') ?></li>

...
<?php echo form_tag('lictiprecpro/list', array('method' => 'get')) ?>
  ...
  <ul class="sf_admin_actions">
    <li><?php echo button_to(__('reset'), 'lictiprecpro/list?filter=filter', 'class=sf_admin_action_reset_filter') ?></li>

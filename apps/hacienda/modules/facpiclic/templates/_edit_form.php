...
?>
<?php echo form_tag('Facpiclic/edit', array(
...
<div class="form-row"><?php echo label_for('fcsollic[rifrep]', __($labels['fcsollic{rifrep}']), '') ?>
<div
...
<?php endif; ?> <?php $value = object_input_tag($fcsollic, 'getRifrep', array (
  ...
  )); echo $value ? $value : '&nbsp;' ?><?php echo button_to_popup('...','generales/catalogo?clase=Fcconrep&frame=sf_admin_edit_form&obj1=fcsollic_rifrep&obj2=fcsollic_nomconrep&obj3=fcsollic_dirconrep')?></div>
</div>

<div class="form-row"><?php echo label_for('fcsollic[nomconrep]', __($labels['fcsollic{nomconrep}']), '') ?>
<div
...
<div class="form-row"><?php echo label_for('fcsollic[dirconrep]', __($labels['fcsollic{dirconrep}']), '') ?>
<div
...
<ul class="sf_admin_actions">
	<li class="float-left"><?php if ($fcsollic->getId()): ?> <?php echo button_to(__('delete'), 'Facpiclic/delete?id='.$fcsollic->getId(), array (
  'post' => true,

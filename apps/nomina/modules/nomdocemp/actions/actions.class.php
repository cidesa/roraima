 ...
 *
 * @package    siga
 * @subpackage nomdocemp
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class nomdocempActions extends autonomdocempActions
{
  ...
  public function editing()
  {
    ...
    if (!$this->npdocemp->getId())
    {
        $t= new Criteria();
       $t->setLimit(1);
       $t->addDescendingOrderByColumn(NpdocempPeer::CODDOC);
       $reg= NpdocempPeer::doSelectOne($t);
       if ($reg)
       {
           $this->npdocemp->setCoddoc(str_pad(($reg->getCoddoc()+1),4,'0',STR_PAD_LEFT));
       }else $this->npdocemp->setCoddoc('0001');
    }

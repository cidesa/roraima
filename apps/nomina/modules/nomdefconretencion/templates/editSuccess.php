...
<h1><?php echo __('Edicion de Retenciones', 
array()) ?></h1>
...
<?php include_partial('nomdefconretencion/edit_form', array('npcontipaporet' => $npcontipaporet, 'tipo' => $tipo, 'nomina' => $nomina, 'concepto' => $concepto, 'rs' => $rs, 'labels' => $labels)) ?>
</div>

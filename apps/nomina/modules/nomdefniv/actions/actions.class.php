 ...
 *
 * @package    siga
 * @subpackage nomdefniv
 * @author     $Auhor$ <desarrollo@cidesa.com.ve>
 * @version    SVN: $Id: actions.class.php 32371 2009-09-01 16:06:59Z lhernandez $
 * @copyright  Copyright 2007, Cidesa C.A.
 */

class nomdefnivActions extends autonomdefnivActions
{

  // Para incluir funcionalidades al executeEdit()
  public function editing()
  {
	$this->rhdefniv->getTipcal() == '1' ? $val1=true : $val1=false;
	$this->rhdefniv->getTipcal() == '2' ? $val2=true : $val2=false;
	$this->rhdefniv->getTipcal() == '3' ? $val3=true : $val3=false;
	$this->params=array('val1'=>$val1,'val2'=>$val2,'val3'=>$val3);
  }

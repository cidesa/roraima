...
<?php include_partial('vacliquidacion/edit_form', array('nphojint' => $nphojint, 'labels' => $labels, 'objVac' => $objVac, 'objHis' => $objHis, 'ultsue' => $ultsue, 'suenor' => $suenor, 'sueult' => $sueult, 'suepro' => $suepro, 'suedia' => $suedia, 'suediario' => $suediario,'factorbonvf' => $factorbonvf,'factorvacv' => $factorvacv)) ?>
</div>

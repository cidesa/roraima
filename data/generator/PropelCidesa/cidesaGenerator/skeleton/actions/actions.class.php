...
class ##MODULE_NAME##Actions extends auto##MODULE_NAME##Actions
{
  ...
  public function validateEdit()
  {
    ...
    if($this->getRequest()->getMethod() == sfRequest::POST){
    	//Te permite traer los datos que estan en la vista
...
//    $this->update<?php echo $this->getClassName() ?>FromRequest();
      ...
      // $this->coderr = Compras::validarAlmajuoc($this->caajuoc,$grid);

       //$this->coderr =Herramientas::ValidarCodigo($valor,$this->tstipmov,$campo);
